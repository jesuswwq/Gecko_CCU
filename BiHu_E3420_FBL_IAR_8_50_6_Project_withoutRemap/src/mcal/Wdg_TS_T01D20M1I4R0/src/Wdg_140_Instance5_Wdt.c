 ...
 * @return   none
*/
FUNC(void, WDG_CODE) Wdg_140_Instance5_Wdt_Init
(
    P2CONST(Wdg_ConfigType, AUTOMATIC, WDG_APPL_CONST) ConfigPtr
)
{
    Wdg_Init(ConfigPtr, WDT5_INDEX);
}
...
*/
FUNC(Std_ReturnType, WDG_CODE) Wdg_140_Instance5_Wdt_SetMode
(
    VAR(WdgIf_ModeType, AUTOMATIC) Mode
)
{
    VAR(Std_ReturnType, AUTOMATIC) Ret = E_NOT_OK;
    Ret = Wdg_SetMode(Mode, WDT5_INDEX);
    return Ret;
}

/**
 * @brief Wdg driver instance 5 SetTriggerCondition
 * @param[in]  Timeout Wdg timeout value(in ms).
 * @return   none
*/
FUNC(void, WDG_CODE) Wdg_140_Instance5_Wdt_SetTriggerCondition
(
    VAR(uint16, AUTOMATIC) Timeout
)
{
    Wdg_SetTriggerCondition(Timeout, WDT5_INDEX);
}
 ...
 * @return   none
*/
FUNC(void, WDG_CODE) Wdg_140_Instance5_Wdt_TriggerRoutine
(
    void
)
{
    Wdg_Ip_TriggerRoutine(WDT5_INDEX);
}
 ...
 * @return   none
*/
FUNC(void, WDG_CODE) Wdg_140_Instance5_Wdt_GetVersionInfo
(
    P2VAR(Std_VersionInfoType, AUTOMATIC, WDG_APPL_DATA) VerInfoPtr
)
{
    Wdg_GetVersionInfo(VerInfoPtr, WDT5_INDEX);
}
