...
)
{
    ...
    Ret = Wdg_SetMode(Mode, WDT8_INDEX);
    return Ret;
}

/**
 * @brief Wdg driver instance 8 SetTriggerCondition
...
{
    Wdg_SetTriggerCondition(Timeout, WDT8_INDEX);
}
...
{
    Wdg_Ip_TriggerRoutine(WDT8_INDEX);
}
...
{
    Wdg_GetVersionInfo(VerInfoPtr, WDT8_INDEX);
}
