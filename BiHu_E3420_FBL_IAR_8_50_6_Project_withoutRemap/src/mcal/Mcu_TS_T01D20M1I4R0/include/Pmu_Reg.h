...
/* Version Info Begin */
#define PMU_REG_H_VENDOR_ID    0x8C
#define PMU_REG_H_AR_RELEASE_MAJOR_VERSION    4
#define PMU_REG_H_AR_RELEASE_MINOR_VERSION    3
#define PMU_REG_H_AR_RELEASE_REVISION_VERSION 1
#define PMU_REG_H_SW_MAJOR_VERSION    1
#define PMU_REG_H_SW_MINOR_VERSION    0
#define PMU_REG_H_SW_PATCH_VERSION    0
/* Version Info End */
...
#define FM_RUN_PWR_ON_SET_RUN_PWR_ON0_SET   (0xfU << 0U)
#define FV_RUN_PWR_ON_SET_RUN_PWR_ON0_SET(v) \
    (((v) << 0U) & FM_RUN_PWR_ON_SET_RUN_PWR_ON0_SET)
#define GFV_RUN_PWR_ON_SET_RUN_PWR_ON0_SET(v) \
    (((v) & FM_RUN_PWR_ON_SET_RUN_PWR_ON_SET) >> 0U)

#define BM_RUN_PWR_ON_SET_SF_PWR_ON_SET  (0x1U << 17U)
#define BM_RUN_PWR_ON_SET_AP_PWR_ON_SET  (0x1U << 16U)
...
#define FM_SLEEP_PWR_ON_SET_SLEEP_PWR_ON0_SET   (0xfU << 0U)
#define FV_SLEEP_PWR_ON_SET_SLEEP_PWR_ON0_SET(v) \
    (((v) << 0U) & FM_SLEEP_PWR_ON_SET_SLEEP_PWR_ON0_SET)
#define GFV_SLEEP_PWR_ON_SET_SLEEP_PWR_ON0_SET(v) \
    (((v) & FM_SLEEP_PWR_ON_SET_SLEEP_PWR_ON_SET) >> 0U)

#define BM_SLEEP_PWR_ON_SET_AP_PWR_ON_SET    (0x1U << 16U)
#define BM_SLEEP_PWR_ON_SET_SF_PWR_ON_SET    (0x1U << 17U)
...
#define FM_HIBERNATE_PWR_ON_SET_HIBERNATE_PWR_ON0_SET   (0xfU << 0U)

#define FV_HIBERNATE_PWR_ON_SET_HIBERNATE_PWR_ON0_SET(v) \
    (((v) << 0U) & FM_HIBERNATE_PWR_ON_SET_HIBERNATE_PWR_ON0_SET)
#define GFV_HIBERNATE_PWR_ON_SET_HIBERNATE_PWR_ON0_SET(v) \
    (((v) & FM_HIBERNATE_PWR_ON_SET_HIBERNATE_PWR_ON_SET) >> 0U)

#define BM_HIBERNATE_PWR_ON_SET_AP_PWR_ON_SET    (0x1U << 16U)
#define BM_HIBERNATE_PWR_ON_SET_SF_PWR_ON_SET    (0x1U << 17U)
