...
#ifndef DRV_LLD_TAISHAN_RSTGEN_H
#define DRV_LLD_TAISHAN_RSTGEN_H
...
//#define APB_ERR_INT_OFF                      0x4004U
...
//#define APB_LKSTEP_INT_OFF                   0x4008U
...
//#define WDT_LKSTEP_INT_OFF                     0x4010U
...
#define RETGEN_MODULE_MASK(index)            (0x1u << (index))
 ...
 */
sint32 taishan_rstgen_lld_core_control(uint32 base, uint32 core_idx, bool release);
 ...
 */
sint32 taishan_rstgen_lld_module_control(uint32 base, uint32 module_idx, bool reset);
 ...
 */
sint32 taishan_rstgen_lld_mission_control(uint32 base, uint32 mission_idx, bool reset);
 ...
 */
sint32 taishan_rstgen_lld_latent_control(uint32 base, uint32 latent_idx, bool reset);
...
void taishan_rstgen_lld_set_latent_reset_by_mode(uint32 base, uint32 index, uint32 mode,
        uint32 val);

void taishan_rstgen_lld_set_module_reset_by_mode(uint32 base, uint32 index, uint32 mode,
        uint32 val);
...
#endif /* DRV_LLD_taishan_RSTGEN_H */
