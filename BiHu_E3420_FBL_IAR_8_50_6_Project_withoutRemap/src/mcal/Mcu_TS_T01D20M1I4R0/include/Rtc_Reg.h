...
#ifndef SEC_RTC_REG_H
#define SEC_RTC_REG_H
...
/* Version Info Begin */
#define RTC_REG_H_VENDOR_ID    0x8C
#define RTC_REG_H_AR_RELEASE_MAJOR_VERSION    4
#define RTC_REG_H_AR_RELEASE_MINOR_VERSION    3
#define RTC_REG_H_AR_RELEASE_REVISION_VERSION 1
#define RTC_REG_H_SW_MAJOR_VERSION    1
#define RTC_REG_H_SW_MINOR_VERSION    0
#define RTC_REG_H_SW_PATCH_VERSION    0
/* Version Info End */
...
#define BM_REG_PARITY_ERR_INT_STAT_REG_PARITY_ERR   (0x1UL << 0)
...
//--------------------------------------------------------------------------
#define RTC_REG_H_HOLD_SHADOW   0x54
#define RTC_REG_L_HOLD_SHADOW   0x58
