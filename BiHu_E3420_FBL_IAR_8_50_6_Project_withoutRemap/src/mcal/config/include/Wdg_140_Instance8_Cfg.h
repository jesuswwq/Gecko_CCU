...
#define WDG_140_INSTANCE8_H_AR_RELEASE_MAJOR_VERSION    4
#define WDG_140_INSTANCE8_H_AR_RELEASE_MINOR_VERSION    3
#define WDG_140_INSTANCE8_H_AR_RELEASE_REVISION_VERSION 1
...
extern CONST(Wdg_ConfigType, WDG_CONST)  Wdg_Config8;
