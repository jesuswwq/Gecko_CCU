...
#define FEE_BLOCKS_CFG_NUMBER            11U

#define FEE_BLOCKS_FULL_SIZE                704U
#define FEE_BLOCKS_SIZE_MAX                64U

/* Fee CFG Index Info */
#define FeeBlockConfiguration_NvmInfo     16U
#define FeeBlockConfiguration_Factory     32U
#define FeeBlockConfiguration_SecurityAccess     48U
#define FeeBlockConfiguration_ProgramAttempt     64U
#define FeeBlockConfiguration_ProgramSuccess     80U
#define FeeBlockConfiguration_FingerPrint     96U
#define FeeBlockConfiguration_ForcSwap     112U
#define FeeBlockConfiguration_A_Counter     128U
#define FeeBlockConfiguration_B_Counter     144U
#define FeeBlockConfiguration_NvmInfoB     160U
#define FeeBlockConfiguration_FingerPrintB     176U
