...
uint8 sdrv_i2c_lld_recv_data(paddr_t base)
{
    return REG_READ32(base + I2C_RXFIFO);
}

void sdrv_i2c_lld_send_data(paddr_t base, uint8 data)
{
    REG_WRITE32(data, base + I2C_TXFIFO);
}

uint32 sdrv_i2c_lld_get_psr0_stat(paddr_t base)
{
    return REG_READ32(base + I2C_PSR0);
}

uint32 sdrv_i2c_lld_get_wspace(paddr_t base)
{
    return (REG_READ32(base + I2C_FSR) >> I2C_FSR_EMPTYLVL_BIT) & I2C_FSR_EMPTYLVL_MASK;
}

uint32 sdrv_i2c_lld_get_rspace(paddr_t base)
{
    return (REG_READ32(base + I2C_FSR) >> I2C_FSR_FILLLVL_BIT) & I2C_FSR_FILLLVL_MASK;
}

void sdrv_i2c_lld_set_watermark(paddr_t base, uint8 tx_lvl,
                                uint8 rx_lvl)
{
...
int sdrv_i2c_lld_clear_fifo(paddr_t base)
{
    uint32 val = 0U;
    uint32 timeout = 0U;
    int retval = 0U;
...
void sdrv_i2c_lld_set_cmdcsr0(paddr_t base, uint32 cmdcsr0)
{
    REG_WRITE32(cmdcsr0, base + I2C_CMDCSR0);
}

void sdrv_i2c_lld_set_cmdcsr1(paddr_t base, uint32 cmdcsr1)
{
    REG_WRITE32(cmdcsr1, base + I2C_CMDCSR1);
}

void sdrv_i2c_lld_set_cmdcsr2(paddr_t base, uint32 cmdcsr2)
{
    REG_WRITE32(cmdcsr2, base + I2C_CMDCSR2);
}

void sdrv_i2c_lld_set_cmdcsr3(paddr_t base, uint32 cmdcsr3)
{
    REG_WRITE32(cmdcsr3, base + I2C_CMDCSR3);
}

uint32 sdrv_i2c_lld_get_cmdcsr0(paddr_t base)
{
    return REG_READ32(base + I2C_CMDCSR0);
}

uint32 sdrv_i2c_lld_get_cmdcsr1(paddr_t base)
{
    return REG_READ32(base + I2C_CMDCSR1);
}

uint32 sdrv_i2c_lld_get_cmdcsr2(paddr_t base)
{
    return REG_READ32(base + I2C_CMDCSR2);
}

uint32 sdrv_i2c_lld_get_cmdcsr3(paddr_t base)
{
    return REG_READ32(base + I2C_CMDCSR3);
}

void sdrv_i2c_lld_clear_int(paddr_t base)
{
...
uint32 sdrv_i2c_lld_get_int0_stat(paddr_t base)
{
    return REG_READ32(base + I2C_INTR0);
}

uint32 sdrv_i2c_lld_get_int1_stat(paddr_t base)
{
    return REG_READ32(base + I2C_INTR1);
}

uint32 sdrv_i2c_lld_get_int2_stat(paddr_t base)
{
    return REG_READ32(base + I2C_INTR2);
}

uint32 sdrv_i2c_lld_get_int3_stat(paddr_t base)
{
    return REG_READ32(base + I2C_INTR3);
}

void sdrv_i2c_lld_unmask_int0(paddr_t base, uint32 int_flag)
{
    REG_WRITE32(int_flag, base + I2C_INTEN0);
}

void sdrv_i2c_lld_unmask_int1(paddr_t base, uint32 int_flag)
{
    REG_WRITE32(int_flag, base + I2C_INTEN1);
}

void sdrv_i2c_lld_unmask_int2(paddr_t base, uint32 int_flag)
{
    REG_WRITE32(int_flag, base + I2C_INTEN2);
}

void sdrv_i2c_lld_unmask_int3(paddr_t base, uint32 int_flag)
{
    REG_WRITE32(int_flag, base + I2C_INTEN3);
}

void sdrv_i2c_lld_set_IO0(paddr_t base, uint32 val)
{
    REG_WRITE32(val, base + I2C_PCR8);
}

void sdrv_i2c_lld_set_IO1(paddr_t base, uint32 val)
{
    REG_WRITE32(val, base + I2C_PCR9);
}

void sdrv_i2c_lld_set_IO2(paddr_t base, uint32 val)
{
    REG_WRITE32(val, base + I2C_PCR10);
}

void sdrv_i2c_lld_set_IO3(paddr_t base, uint32 val)
{
    REG_WRITE32(val, base + I2C_PCR11);
}

void sdrv_i2c_lld_set_speed(paddr_t base, uint32 speed_mode)
{
    REG_RMW32(base + I2C_PCR0, I2C_PCR0_SPEED_BIT, I2C_PCR0_SPEED_LEN, speed_mode);
}

void sdrv_i2c_lld_set_prescale(paddr_t base, uint32 prescale)
{
    REG_RMW32(base + I2C_PCR0, I2C_PCR0_PRESCALE_BIT, I2C_PCR0_PRESCALE_LEN, prescale);
}

void sdrv_i2c_lld_set_slvaddr(paddr_t base, uint16 addr)
{
    REG_RMW32(base + I2C_PCR1, I2C_PCR1_DAR_BIT, I2C_PCR1_DAR_LEN, addr);
}

void sdrv_i2c_lld_set_timing(paddr_t base,
...
void sdrv_i2c_lld_dump_reg(paddr_t base, uint32 *reg_val)
{
...
void sdrv_i2c_lld_write_reg(paddr_t base, uint32 reg, uint32 val)
{
    REG_WRITE32(val, base + reg);
}

void sdrv_i2c_lld_read_reg(paddr_t base, uint32 reg, uint32 *val)
{
    if (NULL_PTR != val)
