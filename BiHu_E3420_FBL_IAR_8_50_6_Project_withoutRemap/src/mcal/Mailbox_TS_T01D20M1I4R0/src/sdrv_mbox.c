 ...
 */
static inline uint32 sdrv_mbox_lld_readl(paddr_t base, uint32 offset)
{
 ...
 */
static inline void sdrv_mbox_lld_writel(paddr_t base, uint32 offset, uint32 val)
{
 ...
 */
void sdrv_mbox_lld_buff_clr(paddr_t base, uint32 size)
{
    uint32 addr;
 ...
 */
void sdrv_mbox_lld_init(paddr_t base, uint8 set_masterid_num)
{
    uint32 i, v;
 ...
 */
void sdrv_mbox_lld_fill_msg_head(paddr_t base, uint8 mid, uint8 mdp,
 ...
 */
void sdrv_mbox_lld_fill_short_msg(paddr_t base, uint64 data)
{
 ...
 */
void sdrv_mbox_lld_send(paddr_t base, uint8 msg_id)
{
    uint32 tmc;
 ...
 * @param[in] msg_id message id
 */
bool sdrv_mbox_lld_tx_done(paddr_t base, uint8 msg_id)
{
    uint32 tmc;
 ...
 * @param[in] msg_id message id
 */
void sdrv_mbox_lld_cancel_send(paddr_t base, uint8 msg_id)
{
    uint32 tmc;
 ...
 */
void sdrv_mbox_lld_wakeup(paddr_t base, uint8 msg_id, uint8 mdp)
{
    uint32 tmc;
 ...
 * @return rx msg id
 */
uint32 sdrv_mbox_lld_get_status(paddr_t base)
{
 ...
 * @param[in] msg_id message id
 */
void sdrv_mbox_lld_ack(paddr_t base, uint8 remote, uint8 msg_id)
{
    uint32 rmc;
 ...
 */
uint64 sdrv_mbox_lld_get_short_msg(paddr_t base, uint8 remote, uint8 msg_id)
{
 ...
 * @return message len
 */
uint16 sdrv_mbox_lld_get_msg_head(paddr_t base, uint8 remote, uint8 msg_id,
                                    uint8 *mbm)
{
    uint32 rmh0;
 ...
 */
uint8 *sdrv_mbox_lld_get_txbuf(paddr_t mem_base, uint8 buf_id)
{
 ...
 * @return buffer address
 */
uint8 *sdrv_mbox_lld_get_rxbuf(paddr_t mem_base, uint8 remote, uint8 buf_id)
{
    return (uint8 *)mem_base
 ...
 */
void sdrv_mbox_lld_semag_status_change_int(paddr_t base, uint32 semag_id, bool enable)
{
 ...
 * @param[in] semag_id sem gate id
 */
void sdrv_mbox_lld_semag_request_lock(paddr_t base, uint32 semag_id)
{
 ...
 * @param[in] semag_id sem gate id
 */
void sdrv_mbox_lld_semag_release_lock(paddr_t base, uint32 semag_id)
{
 ...
 * @return lock status
 */
uint8 sdrv_mbox_lld_semag_get_lock_status(paddr_t base, uint32 semag_id)
{
 ...
 */
uint32 sdrv_mbox_lld_semag_get_sgi(paddr_t base)
{
 ...
 */
void sdrv_mbox_lld_semag_set_sgi(paddr_t base, uint32 val)
{
 ...
 * @return lock status
 */
uint32 sdrv_mbox_lld_semag_get_sgls(paddr_t base, uint32 semag_id)
{
    uint32 v;
