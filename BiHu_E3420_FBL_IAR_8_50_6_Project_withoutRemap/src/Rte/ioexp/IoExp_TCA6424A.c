...
{
    {
        .I2C_Channel        = I2cConf_I2cChannel_IO_EXP_I2C1,
//        .I2C_CtrlBlock      = I2c_adap_dev_tca6424[TCA6424_CHIP_A],
        ...
        .RstPin             = DioConf_DioChannel_RESET_6424_A_C_IN,
    },
    {
        .I2C_Channel        = I2cConf_I2cChannel_IO_EXP_I2C1,
...
{
    int ret = 0;
    TCA6424_ChipID_e_ chipid = TCA6424_CHIP_C;
	// Regs->Output.all = 0x00FFFFFF;
	// Regs->PolarityInversion.all = 0x00000000;
...
{
    int ret = 0;
    TCA6424_ChipID_e_ chipid = TCA6424_CHIP_B;
	// Regs->Output.all = 0x00FFFFFF;
	// Regs->PolarityInversion.all = 0x00000000;
	// Regs->Config.all = 0x00000000;//all is output
	wbuf1[0] =TCA6424A_CONFIG_REG0 | 0x80;
...
{
    int ret = 0;
    TCA6424_ChipID_e_ chipid = TCA6424_CHIP_D;
	// Regs->Output.all = 0x00FFFFFF;
	// Regs->PolarityInversion.all = 0x00000000;
	// Regs->Config.all = 0x00000000;//all is output
	wbuf1[0] =TCA6424A_CONFIG_REG0 | 0x80;
