...
/** *****************************************************************************************************
 * \file     Wdg_140_Instance8_Wdt.c                                                                    *
 * \brief    AUTOSAR 4.3.1 MCAL WDG8 Driver                                                             *
 *                                                                                                      *
 * <table>                                                                                              *
...
/**
 *
 * \defgroup MCAL_WDG8_API WDG Driver API
 *
 * The WDG8 Driver MCAL provides low level access to onbaord WDG8 peripheral
 ...
 * The WDG8 Driver implements a standardized interface specified in the
 ...
 * The WDG8 Driver is part of the Communication Stack in the AUTOSAR Basic
 ...
 * The WDG8 Hardware Unit cntrolled by WDG Driver combines one or several WDG controllers,
...
#include "Wdg_140_Instance8_Wdt.h"
#include "Wdg.h"
#ifdef __cplusplus
extern "C" {
#endif
...
#define WDG_140_INSTANCE8_WDT_C_SW_MAJOR_VERSION    1
/** \brief Driver Implementation Minor Version */
#define WDG_140_INSTANCE8_WDT_C_SW_MINOR_VERSION    0
/** \brief Driver Implementation Patch Version */
#define WDG_140_INSTANCE8_WDT_C_SW_PATCH_VERSION    0
/** @} */
/********************************************************************************************************
...
#define WDG8_START_SEC_CODE
#include "Wdg8_MemMap.h"

/** *****************************************************************************************************
 * \brief This service initializes the WDG8 driver.
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance8_Wdt_Init(const Wdg_ConfigType* ConfigPtr)
 *
 * Service ID[hex]    : 0x00
 *
 ...
 *                      initialize all WDG8 relevant registers with the values of the structure
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance8_Wdt_Init(const Wdg_ConfigType *ConfigPtr)
{
    Wdg_140_Init(ConfigPtr, WDT8_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : Std_ReturnType Wdg_140_Instance8_Wdt_SetMode(WdgIf_ModeType Mode)
 *
 * Service ID[hex]    : 0x01
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
Std_ReturnType Wdg_140_Instance8_Wdt_SetMode(WdgIf_ModeType Mode)
{
    return Wdg_140_SetMode(Mode, WDT8_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance8_Wdt_SetTriggerCondition(uint16 timeout)
 *
 * Service ID[hex]    : 0x03
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance8_Wdt_SetTriggerCondition(uint16 timeout)
{
    Wdg_140_SetTriggerCondition(timeout, WDT8_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance8_Wdt_TriggerRoutine()
 *
 * Service ID[hex]    : 0x05
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance8_Wdt_TriggerRoutine(void)
{
    Wdg_140_TriggerRoutine(WDT8_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance8_Wdt_GetVersionInfo(Std_VersionInfoType* verInfoPtr)
 *
 * Service ID[hex]    : 0x04
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance8_Wdt_GetVersionInfo(Std_VersionInfoType *verInfoPtr)
{
    Wdg_140_GetVersionInfo(verInfoPtr, WDT8_INDEX);
}
#endif /* WDG_VERSION_INFO_API */
#define WDG8_STOP_SEC_CODE
#include "Wdg8_MemMap.h"
