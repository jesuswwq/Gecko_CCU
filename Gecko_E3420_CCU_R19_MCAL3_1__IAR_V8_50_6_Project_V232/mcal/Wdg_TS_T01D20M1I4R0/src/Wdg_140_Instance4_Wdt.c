 ...
 * \brief    AUTOSAR 4.3.1 MCAL WDG4 Driver                                                             *
 *                                                                                                      *
 * <table>                                                                                              *
...
/**
 *
 * \defgroup MCAL_WDG4_API WDG Driver API
 *
 * The WDG4 Driver MCAL provides low level access to onbaord WDG4 peripheral
 ...
 * The WDG4 Driver implements a standardized interface specified in the
 ...
 * The WDG4 Driver is part of the Communication Stack in the AUTOSAR Basic
 ...
 * The WDG4 Hardware Unit cntrolled by WDG Driver combines one or several WDG controllers,
...
#define WDG_140_INSTANCE4_WDT_C_SW_MAJOR_VERSION    1
/** \brief Driver Implementation Minor Version */
#define WDG_140_INSTANCE4_WDT_C_SW_MINOR_VERSION    0
/** \brief Driver Implementation Patch Version */
#define WDG_140_INSTANCE4_WDT_C_SW_PATCH_VERSION    0
/** @} */
/********************************************************************************************************
...
#define WDG4_START_SEC_CODE
#include "Wdg4_MemMap.h"

/** *****************************************************************************************************
 * \brief This service initializes the WDG4 driver.
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance4_Wdt_Init(const Wdg_ConfigType* ConfigPtr)
 *
 * Service ID[hex]    : 0x00
 *
 ...
 *                      initialize all WDG4 relevant registers with the values of the structure
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance4_Wdt_Init(const Wdg_ConfigType *ConfigPtr)
{
    Wdg_140_Init(ConfigPtr, WDT4_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : Std_ReturnType Wdg_140_Instance4_Wdt_SetMode(WdgIf_ModeType Mode)
 *
 * Service ID[hex]    : 0x01
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
Std_ReturnType Wdg_140_Instance4_Wdt_SetMode(WdgIf_ModeType Mode)
{
    return Wdg_140_SetMode(Mode, WDT4_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance4_Wdt_SetTriggerCondition(uint16 timeout)
 *
 * Service ID[hex]    : 0x03
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance4_Wdt_SetTriggerCondition(uint16 timeout)
{
    Wdg_140_SetTriggerCondition(timeout, WDT4_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance4_Wdt_TriggerRoutine()
 *
 * Service ID[hex]    : 0x05
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance4_Wdt_TriggerRoutine(void)
{
    Wdg_140_TriggerRoutine(WDT4_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance4_Wdt_GetVersionInfo(Std_VersionInfoType* verInfoPtr)
 *
 * Service ID[hex]    : 0x04
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance4_Wdt_GetVersionInfo(Std_VersionInfoType *verInfoPtr)
{
    Wdg_140_GetVersionInfo(verInfoPtr, WDT4_INDEX);
}
#endif /* WDG_VERSION_INFO_API */
#define WDG4_STOP_SEC_CODE
#include "Wdg4_MemMap.h"
