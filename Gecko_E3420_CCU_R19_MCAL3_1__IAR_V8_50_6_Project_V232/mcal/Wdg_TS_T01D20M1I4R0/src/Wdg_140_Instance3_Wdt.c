...
/** *****************************************************************************************************
 * \file     Wdg_140_Instance3_Wdt.c                                                                    *
 * \brief    AUTOSAR 4.3.1 MCAL WDG3 Driver                                                             *
 *                                                                                                      *
 * <table>                                                                                              *
...
/**
 *
 * \defgroup MCAL_WDG3_API WDG Driver API
 *
 * The WDG3 Driver MCAL provides low level access to onbaord WDG3 peripheral
 ...
 * The WDG3 Driver implements a standardized interface specified in the
 ...
 * The WDG3 Driver is part of the Communication Stack in the AUTOSAR Basic
 ...
 * The WDG3 Hardware Unit cntrolled by WDG Driver combines one or several WDG controllers,
...
#include "Wdg_140_Instance3_Wdt.h"
#include "Wdg.h"
#ifdef __cplusplus
extern "C" {
#endif
...
#define WDG_140_INSTANCE3_WDT_C_SW_MAJOR_VERSION    1
/** \brief Driver Implementation Minor Version */
#define WDG_140_INSTANCE3_WDT_C_SW_MINOR_VERSION    0
/** \brief Driver Implementation Patch Version */
#define WDG_140_INSTANCE3_WDT_C_SW_PATCH_VERSION    0
/** @} */
/********************************************************************************************************
...
#define WDG3_START_SEC_CODE
#include "Wdg3_MemMap.h"

/** *****************************************************************************************************
 * \brief This service initializes the WDG3 driver.
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance3_Wdt_Init(const Wdg_ConfigType* ConfigPtr)
 *
 * Service ID[hex]    : 0x00
 *
 ...
 *                      initialize all WDG3 relevant registers with the values of the structure
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance3_Wdt_Init(const Wdg_ConfigType *ConfigPtr)
{
    Wdg_140_Init(ConfigPtr, WDT3_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : Std_ReturnType Wdg_140_Instance3_Wdt_SetMode(WdgIf_ModeType Mode)
 *
 * Service ID[hex]    : 0x01
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
Std_ReturnType Wdg_140_Instance3_Wdt_SetMode(WdgIf_ModeType Mode)
{
    return Wdg_140_SetMode(Mode, WDT3_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance3_Wdt_SetTriggerCondition(uint16 timeout)
 *
 * Service ID[hex]    : 0x03
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance3_Wdt_SetTriggerCondition(uint16 timeout)
{
    Wdg_140_SetTriggerCondition(timeout, WDT3_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance3_Wdt_TriggerRoutine()
 *
 * Service ID[hex]    : 0x05
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance3_Wdt_TriggerRoutine(void)
{
    Wdg_140_TriggerRoutine(WDT3_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance3_Wdt_GetVersionInfo(Std_VersionInfoType* verInfoPtr)
 *
 * Service ID[hex]    : 0x04
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance3_Wdt_GetVersionInfo(Std_VersionInfoType *verInfoPtr)
{
    Wdg_140_GetVersionInfo(verInfoPtr, WDT3_INDEX);
}
#endif /* WDG_VERSION_INFO_API */
#define WDG3_STOP_SEC_CODE
#include "Wdg3_MemMap.h"
