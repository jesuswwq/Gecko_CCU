...
/** *****************************************************************************************************
 * \file     Wdg_140_Instance1_Wdt.c                                                                    *
 * \brief    AUTOSAR 4.3.1 MCAL WDG1 Driver                                                             *
 *                                                                                                      *
 * <table>                                                                                              *
...
/**
 *
 * \defgroup MCAL_WDG1_API WDG Driver API
 *
 * The WDG1 Driver MCAL provides low level access to onbaord WDG1 peripheral
 ...
 * The WDG1 Driver implements a standardized interface specified in the
 ...
 * The WDG1 Driver is part of the Communication Stack in the AUTOSAR Basic
 ...
 * The WDG1 Hardware Unit cntrolled by WDG Driver combines one or several WDG controllers,
...
#define WDG_140_INSTANCE1_WDT_C_SW_MAJOR_VERSION    1
/** \brief Driver Implementation Minor Version */
#define WDG_140_INSTANCE1_WDT_C_SW_MINOR_VERSION    0
/** \brief Driver Implementation Patch Version */
#define WDG_140_INSTANCE1_WDT_C_SW_PATCH_VERSION    0
/** @} */
/********************************************************************************************************
...
#define WDG1_START_SEC_CODE
#include "Wdg1_MemMap.h"

/** *****************************************************************************************************
 * \brief This service initializes the WDG1 driver.
 *
 * \verbatim
 ...
 *                      initialize all WDG1 relevant registers with the values of the structure
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance1_Wdt_Init(const Wdg_ConfigType *ConfigPtr)
{
    Wdg_140_Init(ConfigPtr, WDT1_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : Std_ReturnType Wdg_140_Instance1_Wdt_SetMode(WdgIf_ModeType Mode)
 *
 * Service ID[hex]    : 0x01
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
Std_ReturnType Wdg_140_Instance1_Wdt_SetMode(WdgIf_ModeType Mode)
{
    return Wdg_140_SetMode(Mode, WDT1_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance1_Wdt_SetTriggerCondition(uint16 timeout)
 *
 * Service ID[hex]    : 0x03
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance1_Wdt_SetTriggerCondition(uint16 timeout)
{
    Wdg_140_SetTriggerCondition(timeout, WDT1_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance1_Wdt_TriggerRoutine()
 *
 * Service ID[hex]    : 0x05
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance1_Wdt_TriggerRoutine(void)
{
    Wdg_140_TriggerRoutine(WDT1_INDEX);
}
 ...
 *
 * \verbatim
 * Syntax             : void Wdg_140_Instance1_Wdt_GetVersionInfo(Std_VersionInfoType* verInfoPtr)
 *
 * Service ID[hex]    : 0x04
 *
 * Sync/Async         : Synchronous
 ...
 *******************************************************************************************************/
void  Wdg_140_Instance1_Wdt_GetVersionInfo(Std_VersionInfoType *verInfoPtr)
{
    Wdg_140_GetVersionInfo(verInfoPtr, WDT1_INDEX);
}
#endif /* WDG_VERSION_INFO_API */
#define WDG1_STOP_SEC_CODE
#include "Wdg1_MemMap.h"
