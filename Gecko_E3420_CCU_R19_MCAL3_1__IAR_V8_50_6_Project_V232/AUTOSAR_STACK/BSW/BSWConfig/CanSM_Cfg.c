...
static CONST(uint8, CANSM_CONST) CanSM_MN_1ControllerId[1] = {CANIF_CANDRV_0_CANIF_CTR_DRV_CANFD4_XCP};/*CanSMControllerId*/
static CONST(uint8, CANSM_CONST) CanSM_MN_2ControllerId[1] = {CANIF_CANDRV_0_CANIF_CTR_DRV_CANFD5_BOD};/*CanSMControllerId*/
