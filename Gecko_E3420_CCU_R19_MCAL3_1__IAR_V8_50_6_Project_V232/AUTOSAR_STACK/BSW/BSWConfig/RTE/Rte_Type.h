...
typedef struct
{
    ...
    UInt8 AC_HV_PTC_MediumTemp;
    UInt8 AC_HV_PTC_InternalPCBTemp;
...
typedef struct
{
    Boolean VDAG_BACBusOffErrFlg_flg;
    Boolean VDAG_EPTBusOffErrFlg_flg;
    Boolean VDAG_BMSLostCommErrFlg_flg;
    Boolean VDAG_ESCLostCommErrFlg_flg;
    Boolean VDAG_CDCLostCommErrFlg_flg;
    Boolean VDAG_SRSLostCommErrFlg_flg;
    Boolean VDAG_INVLostCommErrFlg_flg;
    Boolean VDAG_IPULostCommErrFlg_flg;
    Boolean VDAG_CHABusOffErrFlg_flg;
    Boolean VDAG_BODBusOffErrFlg_flg;
    Boolean VDAG_SCSLostCommErrFlg_flg;
    Boolean VDAG_CCPLostCommErrFlg_flg;
    Boolean VDAG_ICULostCommErrFlg_flg;
    Boolean VDAG_TBOXLostCommErrFlg_flg;
    Boolean VDAG_ACCMLostCommErrFlg_flg;
    Boolean VDAG_PTCLostCommErrFlg_flg;
    Boolean VDAG_FCMLostCommErrFlg_flg;
    Boolean VDAG_CRRRLostCommErrFlg_flg;
    Boolean VDAG_PPLostCommErrFlg_flg;
    Boolean VDAG_EPSLostCommErrFlg_flg;
    Boolean VDAG_EHBLostCommErrFlg_flg;
} DAG_Comm_outputs;
...
{
    Boolean VEMS_ACCMOprtCmd_flg;
    UInt8 VHVM_PtReadyEna_enum;
} DT_Vcu2OpmBOD_outputs;

#define _DEFINED_TYPEDEF_FOR_DT_Vcu2OpmBOD_outputs_
...
typedef struct
{
    ...
    UInt8 FCM_AhdObjID;
    UInt8 FCM_AhdObjLatDst;
    UInt16 FCM_AhdObjLgtDst;
    UInt16 FCM_AhdObjLgtRelSpd;
    UInt8 FCM_AhdObjTyp;
    ...
    Boolean FCM_EBAReq;
    UInt8 FCM_ELKLaneOverSts;
    UInt8 FCM_ELKMode;
    UInt8 FCM_ELKRoadEdgeSts;
    ...
    UInt16 FCM_SpdLimKeepDst;
    UInt16 FCM_SteerTqReq;
...
typedef struct
{
    ...
    Float VHVM_MaxHVDCVoltAC_V;
    Float VHVM_MaxHVDCCurntAC_A;
    Float VHVM_MaxChrCurntSetAC_A;
    Float VHVM_ChrCurntSetFbAC_A;
    Float VHVM_DCCBuckLVVolt_V;
    Boolean VHVM_OTAModeSts_flg;
} HVM_outputs;
...
typedef struct
{
    ...
    Boolean TMS_PCUInletCooltTempV;
    UInt8 TMS_PCUInletCooltTemp;
    UInt8 VCU_PtReadyEna;
    Boolean VCU_IBSWakeup;
    Boolean VCU_ACCMOprtCmd;
} VCU_7_DrvRange_BOD;

#define _DEFINED_TYPEDEF_FOR_VCU_7_DrvRange_BOD_
