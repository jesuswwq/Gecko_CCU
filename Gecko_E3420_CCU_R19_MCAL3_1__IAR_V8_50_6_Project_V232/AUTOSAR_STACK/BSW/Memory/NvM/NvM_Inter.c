...
#include "NvM_MemMap.h"
VAR(uint8, NVM_VAR_NOINIT) NVM_RamMirror[NVM_MAX_LENGTH_CONFIGED_RAM_MIRROR]; /*PRQA S 1514*/ /* MISRA Rule 8.9 */
 ...
 */
/***********************************/
FUNC(Std_ReturnType, NVM_CODE) NvM_JobDequeue(void) /* PRQA S 1532 */ /* MISRA Rule 8.7 */
{
    uint8 l_JobQueueIndex;
    Std_ReturnType l_ReturnValue = E_OK;
 ...
 * CallByAPI           Up layer
 */
FUNC(void, NVM_CODE) NvM_InterReadRom(void) /* PRQA S 1532 */ /* MISRA Rule 8.7 */
{
 ...
 * CallByAPI           Up layer
 */
FUNC(void, NVM_CODE) NvM_InterCalcCrc(void) /* PRQA S 1532 */ /* MISRA Rule 8.7 */
{
    uint16 l_CrcLength;
#if (STD_ON == NVM_INCLUDE_CRC)
 ...
 * CallByAPI           Up layer
 */
FUNC(void, NVM_CODE) NvM_InterReadBlock(void) /* PRQA S 1532 */ /* MISRA Rule 8.7 */
{
 ...
 * CallByAPI           Up layer
 */
FUNC(void, NVM_CODE) NvM_InterWriteBlock(void) /* PRQA S 1532 */ /* MISRA Rule 8.7 */
{
    MemIf_JobResultType l_ReturnValue;
    uint8 CALCRAMBLOCKCRC;
 ...
 * CallByAPI           Up layer
 */
FUNC(void, NVM_CODE) NvM_InterSetRamStatus(void) /* PRQA S 1532 */ /* MISRA Rule 8.7 */
{
    if (NVM_JOB_STEP_CALC_CRC == NvM_Module.JobStep)
    {
        NvM_JobOverSetFlag(NVM_REQ_OK, NVM_CRC_UPDATE);
 ...
 * CallByAPI           Up layer
 */
FUNC(void, NVM_CODE) NvM_InterRestoreBlockDefaults(void) /* PRQA S 1532 */ /* MISRA Rule 8.7 */
{
    if (NVM_JOB_STEP_PENDING == NvM_Module.JobStep)
    {
        if ((NULL_PTR != NvM_BlockDescriptor[NvM_CurRunning.BlockId - 1U].NvmRomBlockDataAddress)
 ...
 * CallByAPI           Up layer
 */
FUNC(void, NVM_CODE) NvM_InterEraseNvBlock(void) /* PRQA S 1532 */ /* MISRA Rule 8.7 */
{
    MemIf_JobResultType l_ReturnValue;
 ...
 * CallByAPI           Up layer
 */
FUNC(void, NVM_CODE) NvM_InterReadAll(void) /* PRQA S 1532 */ /* MISRA Rule 8.7 */
{
 ...
 * CallByAPI           Up layer
 */
FUNC(void, NVM_CODE) NvM_InterWriteAll(void) /* PRQA S 1532 */ /* MISRA Rule 8.7 */
{
    uint8 l_RamValid;
    uint8 l_RamChanged;
    uint8 l_NvProt;
 ...
 * CallByAPI           Up layer
 */
FUNC(void, NVM_CODE) NvM_InterWriteVerification(void) /* PRQA S 1532 */ /* MISRA Rule 8.7 */
{
    MemIf_JobResultType l_ReturnValue;
 ...
 * CallByAPI           Up layer
 */
FUNC(void, NVM_CODE) NvM_InterValidateAll(void) /* PRQA S 1532 */ /* MISRA Rule 8.7 */
{
