 ...
 */
/*static inline*/  uint32 sdrv_btm_hw_readl(uint32 base, uint32 offset)
{
 ...
 */
/*static inline*/ void sdrv_btm_hw_writel(uint32 base, uint32 offset, uint32 val)
{
...
void sdrv_btm_hw_cnt_cfg(uint32 base, uint8 tmr_id, const sdrv_btm_hw_cnt_cfg_t *cnt_cfg)
{
    ...
    if (SDRV_BTM_G1 == tmr_id) {
        uint32 g1_upd_flag = BTM_BM_CNT_G1_UPD_FLAG_INC_WR_UPD | BTM_BM_CNT_G1_UPD_FLAG_SI_WR_UPD;
...
void sdrv_btm_hw_init(uint32 base, uint8 tmr_id, const sdrv_btm_hw_cnt_cfg_t *cnt_cfg)
{
    ...
    uint32 int_sta_en = sdrv_btm_hw_readl(base, BTM_INT_STAT_EN_OFF);
    uint32 int_sig_en = sdrv_btm_hw_readl(base, BTM_INT_SIG_EN_OFF);
