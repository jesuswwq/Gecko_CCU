...
uint8_t g_peps_ide[4] = {0x2e, 0x3c, 0xbc, 0x2b}; /**< \brief o?����IDE */
...
{
    uint8_t u8CmdBuff[1];  /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[12]; /**< \brief SPI��Ӧ���������� */
    uint8_t i;
...
{
    uint8_t u8CmdBuff[1]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5]; /**< \brief SPI��Ӧ���������� */
    uint8_t i;
...
{
    uint8_t u8CmdBuff[10]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5];  /**< \brief SPI��Ӧ���������� */
    uint8_t i;
...
stat_t JOKER_ClearPorStatus(uint8_t u8ProC)
{
    ...
    i = 0x00;
    u8CmdBuff[0] = u8ProC & 0x7F; /**< \brief ��־λȫ�����?*/
...
{
#if 1
    uint8_t u8CmdBuff[1] = {0}; /**< \brief SPI�������������?*/
...
{
    uint8_t u8CmdBuff[36]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5];  /**< \brief SPI��Ӧ���������� */
    uint8_t i;
    ...
    // 00    | 0 =   0�� | 0 = DIS | 00 = 2 kbit/s | 0   | 0 = with mid level
    //       | 1 = 180�� | 1 = EN  | 01 = 4 kbit/s |     | 1 = without mid level
    //       |          |         | 10 = 8 kbit/s |     |
    ...
    u8CmdBuff[0] = DRID2;     /**< \brief DRIDi  : LF����ͨ��1 */
    u8CmdBuff[1] = 0x08;      /**< \brief DRPARi : LFͨ�Ų�����4kbit/s */
    u8CmdBuff[2] = ch2_CURSi; /**< \brief CURSi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[3] = ch2_CURSi; /**< \brief CURMi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[4] = 0x40;      /**< \brief FREQi  : Ƶƫ */
    u8CmdBuff[5] = 0x00;      /**< \brief DITHRi : ������Χ */

    u8CmdBuff[6] = DRID3;     /**< \brief DRIDi  : LF����ͨ��2 */
    u8CmdBuff[7] = 0x08;      /**< \brief DRPARi : LFͨ�Ų�����4kbit/s */
    u8CmdBuff[8] = ch3_CURSi; /**< \brief CURSi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[9] = ch3_CURSi; /**< \brief CURMi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[10] = 0x40;     /**< \brief FREQi  : Ƶƫ */
    u8CmdBuff[11] = 0x00;     /**< \brief DITHRi : ������Χ */

    u8CmdBuff[12] = DRID4;     /**< \brief DRIDi  : LF����ͨ��3 */
    u8CmdBuff[13] = 0x08;      /**< \brief DRPARi : LFͨ�Ų�����4kbit/s */
    u8CmdBuff[14] = ch4_CURSi; /**< \brief CURSi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[15] = ch4_CURSi; /**< \brief CURMi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[16] = 0x40;      /**< \brief FREQi  : Ƶƫ */
    u8CmdBuff[17] = 0x00;      /**< \brief DITHRi : ������Χ */
...
stat_t JOKER_ConfigLfDriver(void)
{
    ...
    u8CmdBuff[0] = DRID2; /**< \brief DRIDi  : LF����ͨ��1 */
    u8CmdBuff[1] = 0x04;  /**< \brief DRPARi : LFͨ�Ų�����4kbit/s */
    u8CmdBuff[2] = 0x20;  /**< \brief CURSi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[3] = 0x20;  /**< \brief CURMi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[4] = 0x40;  /**< \brief FREQi  : Ƶƫ */
    u8CmdBuff[5] = 0x00;  /**< \brief DITHRi : ������Χ */

    u8CmdBuff[6] = DRID3; /**< \brief DRIDi  : LF����ͨ��2 */
    u8CmdBuff[7] = 0x04;  /**< \brief DRPARi : LFͨ�Ų�����4kbit/s */
    u8CmdBuff[8] = 0x20;  /**< \brief CURSi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[9] = 0x20;  /**< \brief CURMi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[10] = 0x40; /**< \brief FREQi  : Ƶƫ */
    u8CmdBuff[11] = 0x00; /**< \brief DITHRi : ������Χ */

    u8CmdBuff[12] = DRID4; /**< \brief DRIDi  : LF����ͨ��3 */
    u8CmdBuff[13] = 0x04;  /**< \brief DRPARi : LFͨ�Ų�����4kbit/s */
    u8CmdBuff[14] = 8;     /**< \brief CURSi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[15] = 8;     /**< \brief CURMi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[16] = 0x40;  /**< \brief FREQi  : Ƶƫ */
    u8CmdBuff[17] = 0x00;  /**< \brief DITHRi : ������Χ */
...
stat_t Lf_Use_ConfigLfDriver(uint8_t ant2_cur, uint8_t ant3_cur, uint8_t ant4_cur)
{
    ...
    u8CmdBuff[0] = DRID2;    /**< \brief DRIDi  : LF����ͨ��1 */
    u8CmdBuff[1] = 0x04;     /**< \brief DRPARi : LFͨ�Ų�����4kbit/s */
    u8CmdBuff[2] = ant2_cur; /**< \brief CURSi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[3] = ant2_cur; /**< \brief CURMi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[4] = 0x40;     /**< \brief FREQi  : Ƶƫ */
    u8CmdBuff[5] = 0x00;     /**< \brief DITHRi : ������Χ */

    u8CmdBuff[6] = DRID3;    /**< \brief DRIDi  : LF����ͨ��2 */
    u8CmdBuff[7] = 0x04;     /**< \brief DRPARi : LFͨ�Ų�����4kbit/s */
    u8CmdBuff[8] = ant3_cur; /**< \brief CURSi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[9] = ant3_cur; /**< \brief CURMi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[10] = 0x40;    /**< \brief FREQi  : Ƶƫ */
    u8CmdBuff[11] = 0x00;    /**< \brief DITHRi : ������Χ */

    u8CmdBuff[12] = DRID4;    /**< \brief DRIDi  : LF����ͨ��3 */
    u8CmdBuff[13] = 0x04;     /**< \brief DRPARi : LFͨ�Ų�����4kbit/s */
    u8CmdBuff[14] = ant4_cur; /**< \brief CURSi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[15] = ant4_cur; /**< \brief CURMi  : ��ͨ��LF��������ֵ */
    u8CmdBuff[16] = 0x40;     /**< \brief FREQi  : Ƶƫ */
    u8CmdBuff[17] = 0x00;     /**< \brief DITHRi : ������Χ */
...
{
    uint8_t u8CmdBuff[12]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5];  /**< \brief SPI��Ӧ���������� */
    uint8_t i;
...
{
    uint8_t u8CmdBuff[18]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5];  /**< \brief SPI��Ӧ���������� */
    uint8_t i;

    u8BytesLen &= 0x0F;

    u8CmdBuff[0] = u8DataIndex;     /**< \brief DATAID  : ���ݶα�ʶ */
    u8CmdBuff[1] = 0x00;            /**< \brief DATACFG : ���ݶ����ã�manchester */
    u8CmdBuff[2] = u8BytesLen << 3; /**< \brief DATALEN : ���ݳ��� */

    for (i = 0; i < u8BytesLen; i++)
    {
        u8CmdBuff[3 + i] = pu8DataBuff[i]; /**< \brief DATA : �������ݣ���λ�ȷ� */
    }
...
stat_t JOKER_SetLfNrz(uint8_t u8DataIndex, uint8_t u8BytesLen, uint8_t *pu8DataBuff)
{
    ...
    u8CmdBuff[0] = u8DataIndex; /**< \brief DATAID  : ���ݶα�ʶ */
    u8CmdBuff[1] = 0x02;        /**< \brief DATACFG : ���ݶ����ã�manchester */
    u8CmdBuff[2] = 18;          /**< \brief DATALEN : ���ݳ��� */
...
{
    uint8_t u8CmdBuff[8]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5]; /**< \brief SPI��Ӧ���������� */
    uint8_t i;

    u8CmdBuff[0] = u8Index;  /**< \brief DATAID  : ���ݶα�ʶ */
    u8CmdBuff[1] = sCarrier; /**< \brief DATACFG : ���ݶ����� */
    u8CmdBuff[2] = u8Time;   /**< \brief DATALEN : ���ݳ��� */
...
{
    uint8_t u8CmdBuff[20]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5];  /**< \brief SPI��Ӧ���������� */
    uint8_t i;

    u8CmdBuff[0] = sLfDRPi;   /**< \brief DRPi       : LF Driver */
    u8CmdBuff[1] = 0x00;      /**< \brief RFU        : */
    u8CmdBuff[2] = sLcDRPi;   /**< \brief LCDRPi     : �͹���LF Driver */
    u8CmdBuff[3] = 0x00;      /**< \brief RFU        : */
    u8CmdBuff[4] = u8BuffLen; /**< \brief LENDATAIDi : ���ݶ��� */
...
{
    uint8_t u8CmdBuff[50]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5];  /**< \brief SPI��Ӧ���������� */
    uint8_t i;
...
{
    uint8_t u8CmdBuff[1];  /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[50]; /**< \brief SPI��Ӧ���������� */
...
** @param	sDRPi ��Selects the LF driver for the antenna impedance measurement.
** @retval	stat_t Status flags
*********************************************************************************************************/
stat_t JOKER_MeasAntImp(drpi_t sDRPi)
{
    ...
    i = 0x00;
    u8CmdBuff[0] = sDRPi; /**< \brief DRiP : LF����ͨ�� */
    u8CmdBuff[1] = 0x00;  /**< \brief RFU */
...
{
    uint8_t u8CmdBuff[24]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[8];  /**< \brief SPI��Ӧ���������� */
    uint8_t i;

    u8CmdBuff[0] = DRID1; /**< \brief DRIDi : LF����ͨ��1 */
    u8CmdBuff[1] = 0x23;  /**< \brief Li    : ���ߵ����?*/
    u8CmdBuff[2] = 0x12;  /**< \brief Qi    : ����Qֵ */
    u8CmdBuff[3] = 0x80;  /**< \brief DETi  : ����ʧ����Χ */

    u8CmdBuff[4] = DRID2; /**< \brief DRIDi : LF����ͨ��2 */
    u8CmdBuff[5] = 0x23;  /**< \brief Li    : ���ߵ����?*/
    u8CmdBuff[6] = 0x12;  /**< \brief Qi    : ����Qֵ */
    u8CmdBuff[7] = 0x80;  /**< \brief DETi  : ����ʧ����Χ */

    u8CmdBuff[8] = DRID3; /**< \brief DRIDi : LF����ͨ��3 */
    u8CmdBuff[9] = 0x23;  /**< \brief Li    : ���ߵ����?*/
    u8CmdBuff[10] = 0x12; /**< \brief Qi    : ����Qֵ */
    u8CmdBuff[11] = 0x80; /**< \brief DETi  : ����ʧ����Χ */

    u8CmdBuff[12] = DRID4; /**< \brief DRIDi : LF����ͨ��4 */
    u8CmdBuff[13] = 0x23;  /**< \brief Li    : ���ߵ����?*/
    u8CmdBuff[14] = 0x12;  /**< \brief Qi    : ����Qֵ */
    u8CmdBuff[15] = 0x80;  /**< \brief DETi  : ����ʧ����Χ */
#if 0	
    u8CmdBuff[16] = DRID5;	  /**< \brief DRIDi : LF����ͨ��5 */
    u8CmdBuff[17] = 0x23;		/**< \brief Li    : ���ߵ����?*/
    u8CmdBuff[18] = 0x12;		/**< \brief Qi    : ����Qֵ */
    u8CmdBuff[19] = 0x80;		/**< \brief DETi  : ����ʧ����Χ */
    u8CmdBuff[20] = DRID6;	  /**< \brief DRIDi : LF����ͨ��6 */
    u8CmdBuff[21] = 0x23;		/**< \brief Li    : ���ߵ����?*/
    u8CmdBuff[22] = 0x12;		/**< \brief Qi    : ����Qֵ */
    u8CmdBuff[23] = 0x80;		/**< \brief DETi  : ����ʧ����Χ */
#endif
    i = 0x00;
...
{
    uint8_t u8CmdBuff[2];  /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[30]; /**< \brief SPI��Ӧ���������� */
    uint8_t i;
    uint8_t count = 0;
...
{
    uint8_t u8CmdBuff[13]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5];  /**< \brief SPI��Ӧ���������� */
    uint8_t i;
...
{
    uint8_t u8CmdBuff[15]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5];  /**< \brief SPI��Ӧ���������� */
    uint8_t i;
...
stat_t JOKER_ConfigTimerPolling(void)
{
    ...
    u8CmdBuff[2] = 0x00;            /**< \brief LCDRPi     : �͹���LF Driver */
    u8CmdBuff[3] = 0x00;            /**< \brief LCDRNi     : */
    u8CmdBuff[4] = 0x64;            /**< \brief PTIME_Li   : pollingʱ�䣬��λΪ1ms */
    u8CmdBuff[5] = 0x00;            /**< \brief PTIME_Hi   : */
    u8CmdBuff[6] = 0x03;            /**< \brief LENDATAIDi : ���ݶ��� */
    u8CmdBuff[7] = DATA_ID_WUP1;    /**< \brief DATAIDik   : WUP1 */
    u8CmdBuff[8] = DATA_ID_DATA_PE; /**< \brief DATAIDik : LF Data */
    u8CmdBuff[9] = DATA_ID_CC_5;    /**< \brief DATAIDik   : 5ms���ز� */
...
stat_t NJJ29C0_ConfigTimerPolling(uint8_t drpi, uint16_t ptime, uint8_t len, uint8_t *dataid)
{
    ...
    u8CmdBuff[2] = 0x00;                  /**< \brief LCDRPi     : �͹���LF Driver */
    u8CmdBuff[3] = 0x00;                  /**< \brief LCDRNi     : */
    u8CmdBuff[4] = (uint8_t)ptime;        // 0x64;					/**< \brief PTIME_Li   : pollingʱ�䣬��λΪ1ms */
    u8CmdBuff[5] = (uint8_t)(ptime >> 8); // 0x00;					/**< \brief PTIME_Hi   : */
    u8CmdBuff[6] = len;                   // 0x03;					/**< \brief LENDATAIDi : ���ݶ��� */
...
{
    uint8_t u8CmdBuff[32]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5];  /**< \brief SPI��Ӧ���������� */
    uint8_t i;
    uint8_t txlen = 0;
    ...
    if ((Cmd == 0x10) || (Cmd == 0x00))
    {
	    ...
	    u8CmdBuff[2] = 0x00;   /**< \brief LCDRPi     : �͹���LF Driver */
	    u8CmdBuff[3] = 0x00;      /**< \brief RFU        : */
	    u8CmdBuff[4] = 5; /**< \brief LENDATAIDi : ���ݶ��� */
        ...
        u8CmdBuff[14] = 0x00;            /**< \brief LCDRPi	   : �͹���LF Driver */
        u8CmdBuff[15] = 0x00;            /**< \brief LCDRNi	   : */
        u8CmdBuff[16] = (uint8_t)ptime1; /**< \brief PTIME_Li   : pollingʱ�䣬��λΪ1ms */
        u8CmdBuff[17] = (uint8_t)(ptime1 >> 8);
        u8CmdBuff[18] = 1; /**< \brief LENDATAIDi : ���ݶ��� */
        u8CmdBuff[19] = DATA_ID_DATA_RSSI;

        u8CmdBuff[20] = RfDoor_Ant;      /**< \brief DRPi	   : LF Driver */
        u8CmdBuff[21] = 0x00;            /**< \brief DRNi	   : */
        u8CmdBuff[22] = 0x00;            /**< \brief LCDRPi	   : �͹���LF Driver */
        u8CmdBuff[23] = 0x00;            /**< \brief LCDRNi	   : */
        u8CmdBuff[24] = (uint8_t)ptime2; /**< \brief PTIME_Li   : pollingʱ�䣬��λΪ1ms */
        u8CmdBuff[25] = (uint8_t)(ptime2 >> 8);
        u8CmdBuff[26] = 1; /**< \brief LENDATAIDi : ���ݶ��� */
    ...
    else if ((Cmd == 0x11) || (Cmd == 0x12))
    {
        ...
        u8CmdBuff[1] = 0x00;            /**< \brief DRNi       : */
        u8CmdBuff[2] = 0x00;            /**< \brief LCDRPi     : 低功耗LF Driver */
        u8CmdBuff[3] = 0x00;            /**< \brief LCDRNi     : */
        u8CmdBuff[4] = 5; /**< \brief LENDATAIDi : 数据段数 */
        u8CmdBuff[5] = DATA_ID_PREMABLE;
        u8CmdBuff[6] = DATA_ID_CV;
        u8CmdBuff[7] = DATA_ID_WUP1;
        u8CmdBuff[8] = DATA_ID_DATA_PE;
        ...
        u8CmdBuff[13] = 0x00;            /**< \brief DRNi	   : */
        u8CmdBuff[14] = 0x00;            /**< \brief LCDRPi	   : 低功耗LF Driver */
        u8CmdBuff[15] = 0x00;            /**< \brief LCDRNi	   : */
        u8CmdBuff[16] = (uint8_t)ptime0; /**< \brief PTIME_Li   : polling时间，单位为1ms */
        u8CmdBuff[17] = (uint8_t)(ptime0 >> 8);
        u8CmdBuff[18] = 1; /**< \brief LENDATAIDi : 数据段数 */
        u8CmdBuff[19] = DATA_ID_DATA_RSSI;
		txlen = 20;
#endif
    ...
    else if (Cmd == 0x13)
    {
        ...
        u8CmdBuff[2] = 0x00;                    /**< \brief LCDRPi     : 低功耗LF Driver */
        u8CmdBuff[3] = 0x00;                    /**< \brief LCDRNi     : */
        u8CmdBuff[4] = (uint8_t)ptime1;         /**< \brief PTIME_Li   : polling时间，单位为1ms */
        u8CmdBuff[5] = (uint8_t)(ptime1 >> 8);
        u8CmdBuff[6] = 5; /**< \brief LENDATAIDi : 数据段数 */
    ...
    else if (Cmd == 0x14)
    {
        ...
        u8CmdBuff[4] = (uint8_t)ptime1;         /**< \brief PTIME_Li   : polling时间，单位为1ms */
        u8CmdBuff[5] = (uint8_t)(ptime1 >> 8);
        u8CmdBuff[6] = 4; /**< \brief LENDATAIDi : 数据段数 */
        u8CmdBuff[7] = DATA_ID_PREMABLE;
        u8CmdBuff[8] = DATA_ID_CV;
        u8CmdBuff[9] = DATA_ID_WUP1;
        u8CmdBuff[10] = DATA_ID_DATA_PE;
...
stat_t WelcomeGuest_ConfigTimerPollingOne(uint8_t Incar_Ant, uint16_t ptime0, uint8_t LfDoor_Ant, uint16_t ptime1, uint8_t RfDoor_Ant, uint16_t ptime2)
{
    ...
    u8CmdBuff[2] = 0x00;            /**< \brief LCDRPi     : �͹���LF Driver */
    u8CmdBuff[3] = 0x00;            /**< \brief LCDRNi     : */
    u8CmdBuff[4] = (uint8_t)ptime0; /**< \brief PTIME_Li   : pollingʱ�䣬��λΪ1ms */
    ...
    u8CmdBuff[12] = LfDoor_Ant;      /**< \brief DRPi	   : LF Driver */
    u8CmdBuff[13] = 0x00;            /**< \brief LCDRPi	  : �͹���LF Driver */
    u8CmdBuff[14] = 0x00;            /**< \brief LCDRNi	  : */
    u8CmdBuff[15] = 0x00;            /**< \brief LCDRNi	   : */
    u8CmdBuff[16] = (uint8_t)ptime1; /**< \brief PTIME_Li   : polling时间，单位为1ms */
    u8CmdBuff[17] = (uint8_t)(ptime1 >> 8);
    u8CmdBuff[18] = 1; /**< \brief LENDATAIDi : 数据段数 */
    u8CmdBuff[19] = DATA_ID_DATA_RSSI;
    ...
    u8CmdBuff[20] = RfDoor_Ant;      /**< \brief DRPi	   : LF Driver */
    u8CmdBuff[21] = 0x00;            /**< \brief DRNi	   : */
    u8CmdBuff[22] = 0x00;            /**< \brief LCDRPi	   : 低功耗LF Driver */
    u8CmdBuff[23] = 0x00;            /**< \brief LCDRNi	   : */
    u8CmdBuff[24] = (uint8_t)ptime2; /**< \brief PTIME_Li   : polling时间，单位为1ms */
    u8CmdBuff[25] = (uint8_t)(ptime2 >> 8);
    u8CmdBuff[26] = 1; /**< \brief LENDATAIDi : 数据段数 */
    u8CmdBuff[27] = DATA_ID_DATA_RSSI;
...
stat_t WelcomeGuest_ConfigTimerPollingTwo(uint8_t wakeid_num, uint8_t drpi0, uint16_t ptime0, uint8_t drpi1, uint16_t ptime1, uint8_t Carrier_OnOff)
{
    ...
    if (wakeid_num == 1)
    {
        if (Carrier_OnOff > 0)
        {
            ...
            u8CmdBuff[4] = (uint8_t)ptime0; /**< \brief PTIME_Li   : pollingʱ�䣬��λΪ1ms */
            u8CmdBuff[5] = (uint8_t)(ptime0 >> 8);
            u8CmdBuff[6] = 5; /**< \brief LENDATAIDi : ���ݶ��� */
            u8CmdBuff[7] = DATA_ID_PREMABLE;
            u8CmdBuff[8] = DATA_ID_CV;
            u8CmdBuff[9] = DATA_ID_WUP1;
            u8CmdBuff[10] = DATA_ID_DATA_PE;
        ...
        else
        {
            ...
            u8CmdBuff[4] = (uint8_t)ptime0; /**< \brief PTIME_Li   : pollingʱ�䣬��λΪ1ms */
            u8CmdBuff[5] = (uint8_t)(ptime0 >> 8);
            u8CmdBuff[6] = 4; /**< \brief LENDATAIDi : ���ݶ��� */
            u8CmdBuff[7] = DATA_ID_PREMABLE;
            u8CmdBuff[8] = DATA_ID_CV;
            u8CmdBuff[9] = DATA_ID_WUP1;
            u8CmdBuff[10] = DATA_ID_DATA_PE;
    ...
    else if (wakeid_num >= 2)
    {
        ...
        else
        {
            ...
            u8CmdBuff[13] = 0x00;                   /**< \brief LCDRPi	  : �͹���LF Driver */
            u8CmdBuff[14] = 0x00;                   /**< \brief LCDRNi	  : */
            u8CmdBuff[15] = (uint8_t)ptime1;        /**< \brief PTIME_Li   : pollingʱ�䣬��λΪ1ms */
...
{
    uint8_t u8CmdBuff[5]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5]; /**< \brief SPI��Ӧ���������� */
    uint8_t i;

    i = 0x00;
    u8CmdBuff[0] = DATA_ID_PREMABLE; /**< \brief DATAID  : ���ݶα�ʶ(premable) */
    u8CmdBuff[1] = 0x00;             /**< \brief DATACFG : ���ݶ����ã�manchester */
    u8CmdBuff[2] = 0x08;             /**< \brief DATALEN : ���ݳ��ȣ�7(bit) */
    u8CmdBuff[3] = 0x00;             /**< \brief DATAi   : �������ݣ�0x00����λ�ȷ� */
...
stat_t JOKER_SetCodeViolation(void)
{
    ...
    i = 0x00;
    u8CmdBuff[0] = DATA_ID_CV; /**< \brief DATAID  : ���ݶα�ʶ(CV) */
    u8CmdBuff[1] = 0x02;       /**< \brief DATACFG : ���ݶ����ã�HBW_NRZ */
    u8CmdBuff[2] = 0x12;       /**< \brief DATALEN : ���ݳ��ȣ�18(bit) */
    u8CmdBuff[3] = 0xE2;       /**< \brief DATA0   : �������ݣ���λ�ȷ� */
    u8CmdBuff[4] = 0xCC;       /**< \brief DATA1   : �������ݣ���λ�ȷ� */
    u8CmdBuff[5] = 0x80;       /**< \brief DATA2   : ��λ�ȷ���ʣ��ĵ�λ����?*/
...
{
    uint8_t u8CmdBuff[6]; /**< \brief SPI�������������?*/
    uint8_t u8ResBuff[5]; /**< \brief SPI��Ӧ���������� */
    uint8_t i;

    i = 0x00;
    u8CmdBuff[0] = DATA_ID_DATA_CB; /**< \brief DATAID  : ���ݶα�ʶ(LF DATA) */
    u8CmdBuff[1] = 0x00;            /**< \brief DATACFG : ���ݶ����ã�manchester */
    u8CmdBuff[2] = 0x18;            /**< \brief DATALEN : ���ݳ��ȣ�16(bit) */
    u8CmdBuff[3] = 0x03;            /**< \brief FT      : �������ݣ���λ�ȷ� */
    u8CmdBuff[4] = coordinate;      /**< \brief DATA0   : �������ݣ���λ�ȷ� */
...
void njj29c0_set_datacontent_check(void)
{
    ...
    i = 0x00;
    u8CmdBuff[0] = DATA_ID_DATA_CHECK; /**< \brief DATAID  : ���ݶα�ʶ(LF DATA) */
    u8CmdBuff[1] = 0x00;               /**< \brief DATACFG : ���ݶ����ã�manchester */
    u8CmdBuff[2] = 0x10;               /**< \brief DATALEN : ���ݳ��ȣ�16(bit) */
    u8CmdBuff[3] = 0x05;               /**< \brief FT      : �������ݣ���λ�ȷ� */
    u8CmdBuff[4] = 0x01;               /**< \brief DATA0   : �������ݣ���λ�ȷ� */
