 ...
 * </table>                                                                                             *
 *******************************************************************************************************/
#ifndef WDG_140_INSTANCE1_CFG_H
#define WDG_140_INSTANCE1_CFG_H
/**
 *
...
/**
 *
 * \addtogroup MCAL_WDG1_CFG WDG1 CFG Driver
 * 
 */
 /** @{ */
...
/**
 *  \name WDG1 CFG Driver ID Info
 *  @{
 */
/** \brief SemiDriver Instruments Vendor ID */
#define WDG_140_INSTANCE1_H_VENDOR_ID    0x8C
/* @} */

/**
 *  \name WDG1 CFG Driver Module AUTOSAR Version Info
 *
 *  Defines for WDG1 CFG Driver AUTOSAR version used for compatibility checks
 *  @{
 */
/** \brief AUTOSAR Major version specification implemented by WDG1 CFG Driver */
#define WDG_140_INSTANCE1_H_AR_MAJOR_VERSION    4
/** \brief AUTOSAR Minor  version specification implemented by WDG1 CFG Driver */
#define WDG_140_INSTANCE1_H_AR_MINOR_VERSION    3
/** \brief AUTOSAR Patch version specification implemented by WDG1 CFG Driver */
#define WDG_140_INSTANCE1_H_AR_REVISION_VERSION 1
/* @} */

/**
 *  \name WDG1 CFG Driver Module SW Version Info
 *
 *  Defines for WDG1 CFG Driver version used for compatibility checks
 *  @{
 */
/** \brief Driver Implementation Major Version */
#define WDG_140_INSTANCE1_H_SW_MAJOR_VERSION    1
/** \brief Driver Implementation Minor Version */
#define WDG_140_INSTANCE1_H_SW_MINOR_VERSION    0
/** \brief Driver Implementation Patch Version */
#define WDG_140_INSTANCE1_H_SW_PATCH_VERSION    0
/* @} */
...
extern const Wdg_ConfigType  Wdg_Config1;
/* @} */
/** @} */
#ifdef __cplusplus
}
