...
CALDATA const volatile float32 ACPT_Pwr2MotorTqGen_X_kW[22] = { -180.0F, -160.0F,
  ...
  0.0F } ;                 /* Referenced by: '<S551>/MCPT_Pwr2MotorTqMot_Nm1' */
...
CALDATA const volatile float32 ACPT_Pwr2MotorTqGen_Y_rpm[28] = { 100.0F, 500.0F,
  ...
  12500.0F, 13000.0F } ;   /* Referenced by: '<S551>/MCPT_Pwr2MotorTqMot_Nm1' */
...
CALDATA const volatile float32 ADAC_ACCDsrdTqKi_X_N[15] = { -700.0F, -500.0F,
  ...
  300.0F, 400.0F, 500.0F, 700.0F } ;
                           /* Referenced by: '<S579>/ADAC_CCSDsrdTqKi_X_N_PL' */
...
CALDATA const volatile float32 ADAC_ACCDsrdTqKi_Y_mps2[15] = { -2.0F, -0.5F,
  ...
  0.5F, 2.0F } ;        /* Referenced by: '<S579>/ADAC_CCSDsrdTqKi_Y_mps2_PL' */
...
CALDATA const volatile float32 ADAC_ACCDsrdTqKp_X_mps2[15] = { -2.0F, -1.5F,
  ...
  1.5F, 2.0F } ;        /* Referenced by: '<S579>/ADAC_CCSDsrdTqKp_X_mps2_PL' */

CALDATA const volatile float32 ADAC_ACCOvrdTq_X_kph[7] = { 0.0F, 2.0F, 4.0F,
  6.0F, 8.0F, 10.0F, 20.0F } ;
                         /* Referenced by: '<S573>/ATQD_RegenTqBrk_X_kph_PL1' */
...
CALDATA const volatile float32 ADAC_CCDsrdAcceltnDec_X_mps2[12] = { -2.0F, -1.4F,
  -1.2F, -0.7F, -0.6F, -0.5F, -0.4F, -0.3F, -0.2F, -0.07F, 0.0F, 0.07F } ;
                 /* Referenced by: '<S599>/Lookup_MTQD_CstRegenTqReqWhlR_Nm1' */
...
CALDATA const volatile float32 ADAC_CCDsrdAcceltnDeltaSpd_X_kph[21] = { -30.0F,
  ...
  2.0F, 3.0F, 4.0F, 6.0F, 8.0F, 10.0F, 15.0F, 20.0F, 30.0F } ;
                /* Referenced by: '<S599>/ATQD_TqRateLimEndErrIncE_X_pct_PL1' */
...
CALDATA const volatile float32 ADAC_HDCTgtAcceltnDeltaSpd_X_kph[16] = { -10.0F,
  ...
  2.0F, 3.0F, 5.0F } ;           /* Referenced by: '<S670>/1-D Lookup Table3' */
...
CALDATA const volatile float32 ADSA_SprtIdxVehSpd_X_kph[15] = { 0.0F, 10.0F,
  ...
  140.0F, 160.0F } ;      /* Referenced by: '<S72>/ATQD_RegenTqBrk_X_kph_PL1' */

CALDATA const volatile float32 AEMS_CellTempMinFac_X_C[5] = { 0.0F, 25.0F, 30.0F,
  40.0F, 55.0F } ;               /* Referenced by: '<S908>/MTQD_TMOverDrt_c5' */
...
CALDATA const volatile float32 AEMS_ChrgCurFbKi_X_mV[15] = { -100.0F, -50.0F,
  ...
  160.0F, 200.0F } ;             /* Referenced by: '<S961>/lu1d_BatLimHiSoC1' */
...
CALDATA const volatile float32 AEMS_DchaCurFbKi_X_mV[15] = { -200.0F, -160.0F,
  ...
  30.0F, 50.0F, 100.0F } ;       /* Referenced by: '<S962>/lu1d_BatLimHiSoC1' */
...
CALDATA const volatile float32 AEMS_DchaCurFbKp_X_mV[11] = { -200.0F, -160.0F,
  -120.0F, -80.0F, -50.0F, -40.0F, -30.0F, -20.0F, -10.0F, 0.0F, 10.0F } ;
                                  /* Referenced by: '<S962>/lu1d_BatLimHiSoC' */
...
CALDATA const volatile float32 AEMS_MaxInsChrgCurr_X_C[17] = { -30.0F, -15.0F,
  ...
  47.0F, 48.0F, 49.0F, 50.0F } ;
                    /* Referenced by: '<S903>/Lookup2D_MEMS_MaxInsDchaCurr_A' */
...
CALDATA const volatile float32 AEMS_MaxInsChrgCurr_Y_pct[10] = { 0.0F, 50.0F,
  60.0F, 70.0F, 75.0F, 80.0F, 85.0F, 90.0F, 95.0F, 100.0F } ;/* Referenced by:
                                                              * '<S903>/Lookup2D_MEMS_MaxInsDchaCurrFac_c'
                                                              * '<S903>/Lookup2D_MEMS_MaxInsDchaCurr_A'
                                                              */

CALDATA const volatile float32 AEMS_MaxInsDchaCurOfst_X_A[8] = { 0.0F, 10.0F,
  20.0F, 30.0F, 50.0F, 70.0F, 100.0F, 200.0F } ;
                                 /* Referenced by: '<S905>/MTQD_TMOverDrt_c2' */
...
CALDATA const volatile float32 AEMS_MaxInsDchaCurr_X_C[17] = { -31.0F, -30.0F,
  ...
  40.0F, 45.0F, 50.0F, 55.0F } ;
                    /* Referenced by: '<S905>/Lookup2D_MEMS_MaxInsDchaCurr_A' */
...
CALDATA const volatile float32 AEMS_MaxInsDchaCurr_Y_pct[10] = { 0.0F, 2.0F,
  5.0F, 10.0F, 15.0F, 20.0F, 25.0F, 30.0F, 40.0F, 100.0F } ;/* Referenced by:
                                                             * '<S905>/Lookup2D_MEMS_MaxInsDchaCurrFac_c'
                                                             * '<S905>/Lookup2D_MEMS_MaxInsDchaCurr_A'
                                                             */

CALDATA const volatile float32 AIBS_EnvirTemp_X_C[6] = { -15.0F, -10.0F, -5.0F,
  0.0F, 5.0F, 10.0F } ;                /* Referenced by:
                                        * '<S261>/MIBS_MustChrgVolt_V'
...
CALDATA const volatile uint8 ASYS_HVBatPackTyp_X_Ah[10] = { 1U, 2U, 3U, 4U, 5U,
  6U, 7U, 8U, 9U, 10U } ;              /* Referenced by:
                                        ...
                                        * '<S905>/PwrDrt2'
                                        * '<S905>/PwrDrt3'
                                        * '<S908>/ASYS_HVBatPackTyp_X_Ah'
                                        * '<S908>/PwrDrt4'
                                        * '<S980>/MDAG_CellTempLoThr_C'
                                        * '<S980>/MDAG_CellUndrVoltThr1_mV'
                                        * '<S980>/MDAG_CellUndrVoltThr2_mV'
                                        * '<S1519>/MHVM_BMSCelMaxVol_mV'
                                        * '<S1519>/MHVM_BMSTotMaxVol_V'
                                        * '<S1519>/MHVM_MaxChrgCurntDC_A'
                                        * '<S1519>/MHVM_MaxChrgVoltDC_V'
                                        * '<S211>/  '
                                        * '<S216>/MRME_WLTPStdRmnMil_km'
                                        * '<S216>/MRME_WLTPStdRmnMil_km1'
                                        * '<S961>/PwrDrt'
                                        * '<S962>/PwrDrt'
                                        * '<S962>/PwrDrt1'
                                        * '<S983>/BMS_BMSCTL_LMPRECSOC1_CAL'
                                        * '<S983>/BMS_BMSCTL_LMPRECSOC2_CAL'
                                        * '<S983>/BMS_BMSCTL_LMPSOC1_CAL'
                                        * '<S983>/BMS_BMSCTL_LMPSOC2_CAL'
                                        * '<S240>/MRME_WLTPStdSOCCnsm_pct100km '
                                        */

CALDATA const volatile float32 ATQC_RegenMaxTqDecRate_X_kph[4] = { 20.0F, 40.0F,
  60.0F, 80.0F } ;
                 /* Referenced by: '<S699>/ATQD_TqRateLimEndErrIncE_X_pct_PL' */

CALDATA const volatile float32 ATQC_RegenMaxTqDecRate_Y_pct[5] = { 0.0F, 5.0F,
  10.0F, 20.0F, 30.0F } ;
                /* Referenced by: '<S699>/ATQD_TqRateLimEndErrIncE_X_pct_PL1' */

CALDATA const volatile float32 ATQC_RegenMaxTqIncRate_X_Nm[8] = { -2000.0F,
  -1500.0F, -1000.0F, -800.0F, -500.0F, -300.0F, -200.0F, -100.0F } ;
                         /* Referenced by: '<S699>/ATQD_RegenTqBrk_X_kph_PL1' */
...
CALDATA const volatile float32 ATQD_AdaptCstDsrdTqKi_X_N[15] = { -700.0F,
  ...
  200.0F, 300.0F, 400.0F, 500.0F, 700.0F } ;
                           /* Referenced by: '<S734>/ADAC_CCSDsrdTqKi_X_N_PL' */

CALDATA const volatile float32 ATQD_AdaptCstDsrdTqKi_Y_mps2[15] = { -2.0F, -0.5F,
  -0.3F, -0.2F, -0.15F, -0.1F, -0.05F, 0.0F, 0.05F, 0.1F, 0.15F, 0.2F, 0.3F,
  0.5F, 2.0F } ;        /* Referenced by: '<S734>/ADAC_CCSDsrdTqKi_Y_mps2_PL' */

CALDATA const volatile float32 ATQD_AdaptCstDsrdTqKp_X_mps2[15] = { -2.0F, -1.5F,
  -1.2F, -0.8F, -0.5F, -0.15F, -0.05F, 0.0F, 0.05F, 0.15F, 0.5F, 0.8F, 1.2F,
  1.5F, 2.0F } ;        /* Referenced by: '<S734>/ADAC_CCSDsrdTqKp_X_mps2_PL' */
...
CALDATA const volatile float32 ATQD_CstRegenEndPstnV_X_kph[14] = { 2.0F, 4.0F,
  ...
  120.0F } ;                     /* Referenced by: '<S729>/1-D Lookup Table1' */
...
CALDATA const volatile float32 ATQD_CstRegenTqReqWhlR_X_kph[12] = { -150.0F,
  ...
  0.0F } ;                       /* Referenced by: '<S728>/1-D Lookup Table2' */
...
CALDATA const volatile float32 ATQD_CstRegenTqReqWhlV_X_kph[14] = { 2.0F, 4.0F,
  ...
  160.0F } ;                     /* Referenced by: '<S728>/1-D Lookup Table1' */
...
CALDATA const volatile float32 ATQD_FwdPedMapSnow_X_kph[18] = { 0.0F, 10.0F,
  20.0F, 30.0F, 40.0F, 50.0F, 60.0F, 70.0F, 80.0F, 90.0F, 100.0F, 110.0F, 120.0F,
  130.0F, 140.0F, 150.0F, 170.0F, 180.0F } ;
                           /* Referenced by: '<S721>/MTQD_PedMapBasTqEco_pct' */

CALDATA const volatile float32 ATQD_FwdPedMapSnow_Y_pct[21] = { 0.0F, 5.0F,
  10.0F, 15.0F, 20.0F, 25.0F, 30.0F, 35.0F, 40.0F, 45.0F, 50.0F, 55.0F, 60.0F,
  65.0F, 70.0F, 75.0F, 80.0F, 85.0F, 90.0F, 95.0F, 100.0F } ;/* Referenced by:
                                                              * '<S721>/MTQD_PedMapBasTqEco_pct'
...
CALDATA const volatile float32 ATQD_LimpHomeMaxTq_X_kph[8] = { -15.0F, -10.0F,
  -5.0F, 0.0F, 5.0F, 10.0F, 20.0F, 30.0F } ;
                         /* Referenced by: '<S716>/ATQD_RegenTqBrk_X_kph_PL2' */
...
CALDATA const volatile float32 ATQD_TqDrtFacHiddenLmtPwr_X_kph[7] = { -22.0F,
  -18.0F, -15.0F, 0.0F, 55.0F, 58.0F, 62.0F } ;
                /* Referenced by: '<S763>/Lookup_MTQD_TqDrtFacHiddenLmtPwr_c' */

CALDATA const volatile float32 ATQD_TqDrtFacLimpHome_X_kph[7] = { -42.0F, -38.0F,
  -25.0F, 0.0F, 25.0F, 38.0F, 42.0F } ;
                 /* Referenced by: '<S762>/Lookup_MTQD_TqDrtFacVehSpdSnow_c1' */
...
CALDATA const volatile float32 ATQD_TqDrtFacMotorSpd_X_rpm[5] = { -15800.0F,
  -15300.0F, 0.0F, 15300.0F, 15800.0F } ;
                                  /* Referenced by: '<S758>/MTQD_TMOverDrt_c' */
...
CALDATA const volatile float32 ATQF_IncRateFiltTm_X_Nmps[12] = { -100.0F, 0.0F,
  ...
  8000.0F } ;            /* Referenced by: '<S778>/ATQD_RegenTqBrk_X_kph_PL1' */
...
CALDATA const volatile float32 ATQF_TipOutTqDecRateCoeff_Nm[8] = { 0.0F, 100.0F,
  300.0F, 500.0F, 700.0F, 1000.0F, 1500.0F, 2000.0F } ;
                                 /* Referenced by: '<S777>/1-D Lookup Table1' */
...
CALDATA const volatile float32 ATQF_TqRateDecMaxRegen_X_pct[7] = { -20.0F,
  -10.0F, -5.0F, 0.0F, 5.0F, 10.0F, 20.0F } ;
                /* Referenced by: '<S777>/ATQD_TqRateLimEndErrIncE_X_pct_PL6' */
...
CALDATA const volatile float32 ATQF_TqRateDecMaxRegen_Y_kph[13] = { -10.0F,
  ...
  100.0F } ;    /* Referenced by: '<S777>/ATQD_TqRateLimEndErrIncE_X_pct_PL7' */
...
CALDATA const volatile float32 ATQF_TqRateIncMaxACC_X_Nm[8] = { 0.0F, 200.0F,
  400.0F, 600.0F, 800.0F, 1000.0F, 1500.0F, 2000.0F } ;
                                     /* Referenced by: '<S778>/Lookup Table5' */
...
CALDATA const volatile float32 ATQF_TqRateIncMax_X_pct[12] = { -5.0F, 0.0F, 5.0F,
  15.0F, 35.0F, 55.0F, 70.0F, 75.0F, 80.0F, 90.0F, 95.0F, 100.0F } ;
                 /* Referenced by: '<S778>/ATQD_TqRateLimEndErrIncE_X_pct_PL' */
...
CALDATA const volatile float32 ATQF_TqRateIncMax_Y_kph[13] = { -10.0F, -4.0F,
  0.0F, 4.0F, 10.0F, 20.0F, 30.0F, 40.0F, 50.0F, 60.0F, 80.0F, 100.0F, 200.0F } ;
                /* Referenced by: '<S778>/ATQD_TqRateLimEndErrIncE_X_pct_PL1' */
...
CALDATA const volatile float32 ATQF_TqRateLimEndErr_X_pct[14] = { -20.0F, -10.0F,
  ...
  100.0F } ;     /* Referenced by: '<S776>/ATQD_TqRateLimEndErrIncE_X_pct_PL' */
...
CALDATA const volatile float32 ATZX_ZeroTqOfstDecACC_X_kph[12] = { -15.0F,
  -10.0F, -5.0F, 0.0F, 5.0F, 10.0F, 15.0F, 20.0F, 30.0F, 50.0F, 70.0F, 100.0F } ;
                    /* Referenced by: '<S836>/MTZX_ZeroTqOfstTipOutTMOly_Nm5' */
...
CALDATA const volatile float32 AVTM_MotorMaxDrvTqWT_X_rpm[23] = { 0.0F, 500.0F,
  ...
  12000.0F, 13000.0F, 14000.0F, 15000.0F, 16000.0F } ;
                                  /* Referenced by: '<S887>/MTQD_PTBaseTq_Nm' */

CALDATA const volatile float32 AVTM_MotorSpdFiltCoeff_X_rpm[8] = { 0.0F, 10.0F,
  20.0F, 30.0F, 50.0F, 100.0F, 200.0F, 300.0F } ;
                       /* Referenced by: '<S878>/MPPC_OutSftSpdFiltCoeff_rat' */

CALDATA const volatile float32 AVTM_VehSpdFiltCoeff_X_kph[8] = { 0.0F, 0.1F,
  0.2F, 0.3F, 0.4F, 1.0F, 2.0F, 5.0F } ;
                   /* Referenced by: '<S878>/Lookup_MVTM_VehSpdFiltCoeff_rat' */

CALDATA const volatile float32 KCPT_GenMaxTqDecRate_Nmps = -800.0F;/* Referenced by: '<S551>/Constant18' */
CALDATA const volatile float32 KCPT_GenMaxTqIncRate_Nmps = 50000.0F;/* Referenced by: '<S551>/Constant19' */
CALDATA const volatile float32 KCPT_MotMaxTqDecRate_Nmps = -50000.0F;/* Referenced by: '<S551>/Constant11' */
CALDATA const volatile float32 KCPT_MotMaxTqFiltAchvd_Nm = 2.0F;/* Referenced by:
                                                                 * '<S551>/KCPT_MotorMaxTqFiltAchvd_Nm'
                                                                 * '<S551>/KCPT_MotorMaxTqFiltAchvd_Nm1'
                                                                 */
CALDATA const volatile float32 KCPT_MotMaxTqIncRate_Nmps = 800.0F;/* Referenced by: '<S551>/Constant3' */
CALDATA const volatile float32 KCPT_MotorDrgMaxTqAllwd_Nm = -300.0F;
                      /* Referenced by: '<S551>/KCPT_MotorMaxTqFiltAchvd_Nm2' */
CALDATA const volatile float32 KCPT_MotorMaxTqFiltCoeff_c = 0.8F;/* Referenced by:
                                                                  * '<S551>/KCPT_MotorMaxTqFiltCoeff_c'
                                                                  * '<S551>/KCPT_MotorMaxTqFiltCoeff_c1'
                                                                  */
CALDATA const volatile float32 KCPT_MotorRvrsSpdOffD_rpm = -50.0F;/* Referenced by: '<S551>/Constant8' */
CALDATA const volatile float32 KCPT_MotorRvrsSpdOffR_rpm = 100.0F;/* Referenced by: '<S551>/Constant10' */
CALDATA const volatile float32 KCPT_MotorRvrsSpdOnD_rpm = -100.0F;/* Referenced by: '<S551>/Constant9' */
CALDATA const volatile float32 KCPT_MotorRvrsSpdOnR_rpm = 50.0F;/* Referenced by: '<S551>/Constant5' */
CALDATA const volatile float32 KDAC_ABSActvDlyTm4CC_s = 0.8F;/* Referenced by: '<S619>/Constant2' */
CALDATA const volatile float32 KDAC_ACCDsrdTqIMax_N = 5000.0F;/* Referenced by: '<S579>/Saturation1' */
CALDATA const volatile float32 KDAC_ACCDsrdTqIMin_N = -30000.0F;/* Referenced by: '<S579>/Saturation1' */
CALDATA const volatile float32 KDAC_AccReqStopAllwdSpd_kph = 3.0F;
                         /* Referenced by: '<S575>/KVTM_LimpHomeOvrdVal_flg2' */
CALDATA const volatile float32 KDAC_BrkPedPrsdOff_pct = 0.5F;
                            /* Referenced by: '<S568>/KTQD_BrkPedPstnHi_pct1' */
CALDATA const volatile float32 KDAC_BrkPedPrsdOn_pct = 2.0F;
                             /* Referenced by: '<S568>/KTQD_BrkPedPstnHi_pct' */
...
CALDATA const volatile boolean KDAC_BypCruiseSdnCC_flg = false;
                         /* Referenced by: '<S619>/KVTM_LimpHomeOvrdVal_flg3' */
CALDATA const volatile boolean KDAC_BypCruiseSdn_flg = false;
                         /* Referenced by: '<S572>/KVTM_LimpHomeOvrdVal_flg2' */
CALDATA const volatile boolean KDAC_BypESPTqIntv_flg = true;
                         /* Referenced by: '<S572>/KVTM_LimpHomeOvrdVal_flg3' */
CALDATA const volatile float32 KDAC_CCAccelPedPrsdOff_pct = 1.0F;
                        /* Referenced by: '<S608>/KTQD_CstRegenVehSpdOn_kph1' */
CALDATA const volatile float32 KDAC_CCAccelPedPrsdOn_pct = 3.0F;
                         /* Referenced by: '<S608>/KTQD_CstRegenVehSpdOn_kph' */
CALDATA const volatile float32 KDAC_CCDsrdAcceltnMax_mps2 = 2.0F;/* Referenced by: '<S599>/Saturation1' */
CALDATA const volatile float32 KDAC_CCDsrdAcceltnMin_mps2 = -2.0F;/* Referenced by: '<S599>/Saturation1' */
CALDATA const volatile float32 KDAC_CCDsrdTqDecIDlyTm_s = 0.5F;/* Referenced by: '<S608>/Constant4' */
CALDATA const volatile float32 KDAC_CCDsrdTqIMax_N = 2000.0F;/* Referenced by: '<S606>/Saturation1' */
CALDATA const volatile float32 KDAC_CCDsrdTqIMin_N = -2000.0F;/* Referenced by: '<S606>/Saturation1' */
CALDATA const volatile float32 KDAC_CCDsrdTqIncIDlyTm_s = 0.5F;/* Referenced by: '<S608>/Constant1' */
CALDATA const volatile float32 KDAC_CCHldISpdOverOff_kph = 0.5F;
                        /* Referenced by: '<S608>/KTQD_CstRegenVehSpdOn_kph3' */
CALDATA const volatile float32 KDAC_CCHldISpdOverOn_kph = 1.0F;
                        /* Referenced by: '<S608>/KTQD_CstRegenVehSpdOn_kph2' */
CALDATA const volatile float32 KDAC_CCMaxSpdOfst_kph = 5.0F;/* Referenced by: '<S619>/Constant150' */
CALDATA const volatile uint8 KDAC_CCMaxTgtSpdE_kph = 140U;/* Referenced by: '<S646>/Constant3' */
CALDATA const volatile uint8 KDAC_CCMaxTgtSpdN_kph = 150U;/* Referenced by: '<S646>/Constant164' */
CALDATA const volatile uint8 KDAC_CCMaxTgtSpdS_kph = 150U;/* Referenced by: '<S646>/Constant4' */
CALDATA const volatile uint8 KDAC_CCMaxTgtSpdSnow_kph = 120U;/* Referenced by: '<S646>/Constant8' */
CALDATA const volatile float32 KDAC_CCMinSpdOfst_kph = 5.0F;/* Referenced by: '<S619>/Constant148' */
CALDATA const volatile uint8 KDAC_CCMinTgtSpd_kph = 30U;/* Referenced by: '<S646>/Constant9' */
CALDATA const volatile float32 KDAC_CCOvrdTqOff_Nm = 5.0F;/* Referenced by: '<S593>/Constant5' */
CALDATA const volatile float32 KDAC_CCOvrdTqOn_Nm = 20.0F;/* Referenced by: '<S593>/Constant174' */
CALDATA const volatile uint8 KDAC_CCSpdChgLongDiv_cnt = 100U;
                          /* Referenced by: '<S595>/KDAC_CCSpdChgLongDiv_cnt' */
CALDATA const volatile uint8 KDAC_CCSpdChgShort_kph = 1U;
                            /* Referenced by: '<S595>/KDAC_CCSpdChgShort_kph' */
CALDATA const volatile float32 KDAC_CCTgtSpdChgRate_kphps = 5.0F;
                        /* Referenced by: '<S595>/KDAC_CCTgtSpdChgRate_kphps' */
CALDATA const volatile float32 KDAC_CCTqReqWhlAchvd_Nm = 100.0F;
                               /* Referenced by: '<S607>/KDAC_TapDwnTmOut_s2' */
CALDATA const volatile float32 KDAC_CCTqReqWhlDec_Nmps = -10000.0F;
                               /* Referenced by: '<S607>/KDAC_TapDwnTmOut_s1' */
CALDATA const volatile float32 KDAC_CCTqReqWhlInc_Nmps = 10000.0F;
                               /* Referenced by: '<S607>/KDAC_TapDwnTmOut_s3' */
CALDATA const volatile uint8 KDAC_CruzSetSwOpCntr_cnt = 2U;/* Referenced by: '<S648>/Constant4' */
CALDATA const volatile float32 KDAC_CruzSetSwOpTm_s = 1.0F;
                              /* Referenced by: '<S596>/KDAC_CruzSetSwOpTm_s' */
CALDATA const volatile float32 KDAC_DrvAsstTqSplitEHBMin_Nm = -20.0F;/* Referenced by: '<S568>/Constant19' */
CALDATA const volatile float32 KDAC_ESCIntvDlyTm4CC_s = 0.8F;/* Referenced by: '<S619>/Constant1' */
CALDATA const volatile float32 KDAC_ESPActvDlyTm4CC_s = 0.8F;/* Referenced by: '<S619>/Constant3' */
CALDATA const volatile float32 KDAC_HDCActvSlopOff_pct = -3.0F;/* Referenced by: '<S667>/Cnst7' */
CALDATA const volatile float32 KDAC_HDCActvSlopOn_pct = -10.0F;/* Referenced by: '<S667>/Cnst5' */
CALDATA const volatile uint8 KDAC_HDCActvSpdHiOfst_kph = 10U;/* Referenced by: '<S667>/Cnst10' */
CALDATA const volatile uint8 KDAC_HDCActvSpdHi_kph = 25U;/* Referenced by:
                                                          * '<S667>/Cnst2'
                                                          * '<S667>/Cnst3'
                                                          */
CALDATA const volatile uint8 KDAC_HDCActvSpdLoOfst_kph = 3U;/* Referenced by: '<S667>/Cnst11' */
CALDATA const volatile uint8 KDAC_HDCActvSpdLo_kph = 5U;/* Referenced by:
                                                         * '<S667>/Cnst4'
                                                         * '<S667>/Cnst6'
                                                         */
CALDATA const volatile float32 KDAC_HDCDsrdTqIMax_N = 1000.0F;/* Referenced by: '<S672>/Saturation1' */
CALDATA const volatile float32 KDAC_HDCDsrdTqIMin_N = -10000.0F;/* Referenced by: '<S672>/Saturation1' */
CALDATA const volatile boolean KDAC_HDCFuncEnbl_flg = false;/* Referenced by: '<S667>/Cnst1' */
CALDATA const volatile uint8 KDAC_HDCStdbyAllwdSpd_kph = 60U;/* Referenced by:
                                                              * '<S667>/Cnst'
                                                              * '<S667>/Cnst9'
                                                              */
CALDATA const volatile float32 KDAC_HDCTgtAcceltnFiltCoeff_rat = 0.8F;/* Referenced by: '<S670>/Cnst5' */
CALDATA const volatile float32 KDAC_HDCTqReqWhlAchvd_Nm = 30.0F;/* Referenced by:
                                                                 * '<S568>/KDAC_TapDwnTmOut_s2'
                                                                 * '<S671>/KDAC_TapDwnTmOut_s2'
                                                                 */
CALDATA const volatile float32 KDAC_HDCTqReqWhlDec_Nmps = -2000.0F;/* Referenced by:
                                                                    * '<S568>/KDAC_TapDwnTmOut_s1'
                                                                    * '<S671>/KDAC_TapDwnTmOut_s1'
                                                                    */
CALDATA const volatile float32 KDAC_HDCTqReqWhlInc_Nmps = 1500.0F;/* Referenced by:
                                                                   * '<S568>/KDAC_TapDwnTmOut_s3'
                                                                   * '<S671>/KDAC_TapDwnTmOut_s3'
                                                                   */
CALDATA const volatile boolean KDAC_OPDTqRespFst_flg = false;/* Referenced by: '<S568>/Constant15' */
CALDATA const volatile boolean KDAC_OPDTqRespSprt_flg = true;/* Referenced by: '<S568>/Constant14' */
CALDATA const volatile float32 KDAC_SpdOutRngDlyTm4CC_s = 1.0F;/* Referenced by: '<S619>/Constant164' */
CALDATA const volatile float32 KDAC_SpdStabDlyTm4CC_s = 5.0F;/* Referenced by: '<S635>/Constant8' */
CALDATA const volatile float32 KDAC_SpdUnstabDlyTm4CC_s = 40.0F;/* Referenced by: '<S635>/Constant4' */
CALDATA const volatile float32 KDAC_TCSActvDlyTm4CC_s = 0.8F;/* Referenced by: '<S619>/Constant4' */
CALDATA const volatile float32 KDAC_TapDwnTmOut_s = 0.5F;
                                /* Referenced by: '<S595>/KDAC_TapDwnTmOut_s' */
CALDATA const volatile float32 KDAC_TapUpTmOut_s = 0.5F;
                                 /* Referenced by: '<S595>/KDAC_TapUpTmOut_s' */
CALDATA const volatile float32 KDAC_VehResistA_fac = 143.4F;/* Referenced by:
                                                             * '<S483>/KDAC_TapDwnTmOut_s4'
                                                             * '<S605>/KDAC_TapDwnTmOut_s3'
                                                             */
CALDATA const volatile float32 KDAC_VehResistB_fac = 0.774F;/* Referenced by:
                                                             * '<S483>/KDAC_TapDwnTmOut_s3'
                                                             * '<S605>/KDAC_TapDwnTmOut_s2'
                                                             */
CALDATA const volatile float32 KDAC_VehResistC_fac = 0.031F;/* Referenced by:
                                                             * '<S483>/KDAC_TapDwnTmOut_s2'
                                                             * '<S605>/KDAC_TapDwnTmOut_s1'
                                                             */
CALDATA const volatile float32 KDAC_VirtAccelPedPstnOff_pct = 0.2F;/* Referenced by: '<S568>/Constant7' */
CALDATA const volatile float32 KDAC_VirtAccelPedPstnOn_pct = 0.5F;/* Referenced by: '<S568>/Constant6' */
CALDATA const volatile float32 KDAC_WhlSlipDiffSpd4CC_kph = 5.0F;/* Referenced by:
                                                                  * '<S619>/Constant174'
                                                                  * '<S619>/Constant6'
                                                                  */
CALDATA const volatile float32 KDAC_WhlSlipDiffSpdOfst4CC_kph = 5.0F;/* Referenced by: '<S619>/Constant5' */
CALDATA const volatile float32 KDAC_WhlSlipDlyTm4CC_s = 0.5F;/* Referenced by: '<S619>/Constant8' */
CALDATA const volatile uint16 KDAG_ACCMCRCFltActnMsk_enum = 8192U;
                       /* Referenced by: '<S1044>/KDAG_BMSCmdTmOutFailTm_s15' */
CALDATA const volatile uint16 KDAG_ACCMHVILActnMsk_enum = 24576U;
                        /* Referenced by: '<S1435>/KDAG_BMSCmdTmOutFailTm_s2' */

/* 压缩机高压互锁故障动作 */
CALDATA const volatile uint16 KDAG_ACCMLostCommActnMsk_enum = 8192U;
                       /* Referenced by: '<S1044>/KDAG_BMSCmdTmOutFailTm_s38' */

/* ACCM通信丢失级故障动作 */
CALDATA const volatile uint16 KDAG_ACChrgStFailActnMsk_enum = 0U;
                       /* Referenced by: '<S1258>/KDAG_BMSCmdTmOutFailTm_s24' */

/* ACChargeStateFail故障动作 */
CALDATA const volatile float32 KDAG_ACChrgStFailFailTm_s = 3.0F;
                       /* Referenced by: '<S1258>/KDAG_BMSCmdTmOutFailTm_s20' */

/* ACChargeStateFail故障确认时间 */
CALDATA const volatile uint16 KDAG_ACDchaBMSPwrLoActnMsk_enum = 4096U;
                       /* Referenced by: '<S1258>/KDAG_BMSCmdTmOutFailTm_s21' */

/* AC放电BMS功率低故障动作 */
CALDATA const volatile float32 KDAG_ACDchaBMSPwrLoFailTm_s = 3.0F;
                       /* Referenced by: '<S1258>/KDAG_BMSCmdTmOutFailTm_s19' */

/* AC放电BMS功率低确认时间 */
CALDATA const volatile float32 KDAG_ACDchaBMSPwrLo_A = 5.0F;
                       /* Referenced by: '<S1258>/KDAG_BMSCmdTmOutFailTm_s18' */

/* AC放电BMS功率低电流能力门槛 */
CALDATA const volatile uint16 KDAG_ACDchaBMSSOCLoActnMsk_enum = 4096U;
                        /* Referenced by: '<S1258>/KDAG_BMSCmdTmOutFailTm_s9' */

/* AC放电BMSSOC低故障动作 */
CALDATA const volatile float32 KDAG_ACDchaBMSSOCLoFailTm_s = 3.0F;
                       /* Referenced by: '<S1258>/KDAG_BMSCmdTmOutFailTm_s10' */

/* AC放电BMSSOC低确认时间 */
CALDATA const volatile float32 KDAG_ACDchaBMSSOCLo_pct = 15.0F;
                       /* Referenced by: '<S1258>/KDAG_BMSCmdTmOutFailTm_s16' */

/* AC放电BMSSOC低触发门槛 */
CALDATA const volatile uint16 KDAG_ACDchaOverPwrActnMsk_enum = 4096U;
                       /* Referenced by: '<S1258>/KDAG_BMSCmdTmOutFailTm_s23' */

/* AC放电功率超限故障动作 */
CALDATA const volatile float32 KDAG_ACDchaOverPwrFailTm_s = 3.0F;/* Referenced by:
                                                                  * '<S1258>/KDAG_BMSCmdTmOutFailTm_s22'
                                                                  * '<S1259>/KDAG_BMSCmdTmOutFailTm_s22'
                                                                  */

/* AC放电功率超限确认时间 */
CALDATA const volatile uint16 KDAG_ACSCmdTmOutActnMsk_enum = 0U;
                        /* Referenced by: '<S980>/KDAG_BMSCmdTmOutFailTm_s25' */

/* ACSCmd超时故障动作 */
CALDATA const volatile float32 KDAG_ACSCmdTmOutFailTm_s = 180.0F;
                        /* Referenced by: '<S980>/KDAG_BMSCmdTmOutFailTm_s24' */
...
CALDATA const volatile uint16 KDAG_AccPedBothFailActnMsk_enum = 114U;
                       /* Referenced by: '<S1404>/KDAG_BMSCmdTmOutFailTm_s23' */

/* 加速踏板双路失效故障动作 */
CALDATA const volatile uint16 KDAG_AccPedCrsChkActnMsk_enum = 114U;
                       /* Referenced by: '<S1404>/KDAG_BMSCmdTmOutFailTm_s21' */

/* 加速踏板双路校验故障动作 */
CALDATA const volatile float32 KDAG_AccPedCrsChkFailTm_s = 0.1F;
                       /* Referenced by: '<S1404>/KDAG_BMSCmdTmOutFailTm_s20' */

/* 加速踏板双路校验偏差确认时间 */
CALDATA const volatile float32 KDAG_AccPedCrsChkThr_pct = 10.0F;/* Referenced by: '<S1405>/Constant81' */

/* 加速踏板双路校验偏差门槛 */
CALDATA const volatile uint16 KDAG_AccPedShtCircActnMsk_enum = 116U;/* Referenced by:
                                                                     * '<S1404>/KDAG_BMSCmdTmOutFailTm_s11'
                                                                     * '<S1404>/KDAG_BMSCmdTmOutFailTm_s15'
                                                                     * '<S1404>/KDAG_BMSCmdTmOutFailTm_s17'
                                                                     * '<S1404>/KDAG_BMSCmdTmOutFailTm_s19'
                                                                     * '<S1404>/KDAG_BMSCmdTmOutFailTm_s6'
                                                                     */

/* 加速踏板短路故障动作 */
CALDATA const volatile float32 KDAG_AccPedShtCircFailTm_s = 0.1F;/* Referenced by:
                                                                  * '<S1404>/KDAG_BMSCmdTmOutFailTm_s12'
                                                                  * '<S1404>/KDAG_BMSCmdTmOutFailTm_s13'
                                                                  * '<S1404>/KDAG_BMSCmdTmOutFailTm_s14'
                                                                  * '<S1404>/KDAG_BMSCmdTmOutFailTm_s16'
                                                                  * '<S1404>/KDAG_BMSCmdTmOutFailTm_s18'
                                                                  * '<S1404>/KDAG_BMSCmdTmOutFailTm_s5'
                                                                  */
...
/* 加速踏板供电过低电压门槛 */
CALDATA const volatile uint16 KDAG_BACBusOffActnMsk_enum = 114U;
                       /* Referenced by: '<S1044>/KDAG_BMSCmdTmOutFailTm_s11' */
CALDATA const volatile uint16 KDAG_BMSCRCFltActnMsk_enum = 32505U;
                       /* Referenced by: '<S1044>/KDAG_BMSCmdTmOutFailTm_s30' */
CALDATA const volatile uint16 KDAG_BMSCmdTmOutActnMsk_enum = 16121U;
                         /* Referenced by: '<S980>/KDAG_BMSCmdTmOutFailTm_s2' */

/* BMS继电器指令响应超时故障动作 */
CALDATA const volatile float32 KDAG_BMSCmdTmOutFailTm1_s = 5.0F;
                          /* Referenced by: '<S982>/KDAG_BMSCmdTmOutFailTm_s' */

/* BMS继电器指令响应超时确认时间_非直流充电闭合等待时间 */
CALDATA const volatile float32 KDAG_BMSCmdTmOutFailTm2_s = 10.0F;
                         /* Referenced by: '<S982>/KDAG_BMSCmdTmOutFailTm_s1' */

/* BMS继电器指令响应超时确认时间_直流充电闭合等待时间 */
CALDATA const volatile float32 KDAG_BMSCmdTmOutFailTm3_s = 10.0F;
                         /* Referenced by: '<S982>/KDAG_BMSCmdTmOutFailTm_s2' */

/* BMS继电器指令响应超时确认时间_BMS自己断开继电器等待时间 */
CALDATA const volatile uint16 KDAG_BMSEmgcySdnActnMsk_enum = 16121U;
                        /* Referenced by: '<S980>/KDAG_BMSCmdTmOutFailTm_s11' */

/* BMS紧急下电故障动作 */
CALDATA const volatile float32 KDAG_BMSEmgcySdnFailTm_s = 0.1F;
                        /* Referenced by: '<S980>/KDAG_BMSCmdTmOutFailTm_s12' */

/* BMS紧急下电故障确认时间 */
CALDATA const volatile uint16 KDAG_BMSLostCommActnMsk_enum = 32505U;
                        /* Referenced by: '<S1044>/KDAG_BMSCmdTmOutFailTm_s4' */
CALDATA const volatile uint16 KDAG_BMSSOCLoActnMsk_enum = 114U;
                        /* Referenced by: '<S980>/KDAG_BMSCmdTmOutFailTm_s10' */

/* BMSSOC低故障动作 */
CALDATA const volatile float32 KDAG_BMSSOCLoFailTm_s = 1.0F;
                         /* Referenced by: '<S980>/KDAG_BMSCmdTmOutFailTm_s9' */

/* BMSSOC低故障确认时间 */
CALDATA const volatile float32 KDAG_BMSSysFailFailTm_s = 0.1F;/* Referenced by:
                                                               * '<S980>/KDAG_BMSCmdTmOutFailTm_s4'
                                                               * '<S980>/KDAG_BMSCmdTmOutFailTm_s5'
                                                               * '<S980>/KDAG_BMSCmdTmOutFailTm_s7'
                                                               */

/* BMSFail故障确认时间 */
CALDATA const volatile uint16 KDAG_BMSSysFailLvl2ActnMsk_enum = 116U;
                         /* Referenced by: '<S980>/KDAG_BMSCmdTmOutFailTm_s6' */

/* BMSFailLevel2故障动作 */
CALDATA const volatile uint16 KDAG_BMSSysFailLvl3ActnMsk_enum = 16121U;
                         /* Referenced by: '<S980>/KDAG_BMSCmdTmOutFailTm_s8' */

/* BMSFailLevel3故障动作 */
CALDATA const volatile uint16 KDAG_BMSUndrVoltActnMsk1_enum = 0U;
                        /* Referenced by: '<S984>/KDAG_BMSCmdTmOutFailTm_s13' */

/* BMSPack欠压故障动作_升级前 */
CALDATA const volatile uint16 KDAG_BMSUndrVoltActnMsk2_enum = 0U;
                        /* Referenced by: '<S984>/KDAG_BMSCmdTmOutFailTm_s15' */

/* BMSPack欠压故障动作_升级后 */
CALDATA const volatile float32 KDAG_BMSUndrVoltFailTm_s = 1.0F;
                        /* Referenced by: '<S980>/KDAG_BMSCmdTmOutFailTm_s14' */

/* BMSPack欠压故障确认时间 */
CALDATA const volatile uint16 KDAG_BODBusOffActnMsk_enum = 8304U;
                        /* Referenced by: '<S1044>/KDAG_BMSCmdTmOutFailTm_s2' */
CALDATA const volatile float32 KDAG_BrkPedVoltMax_mV = 4500.0F;/* Referenced by: '<S1435>/Constant1' */

/* 制动踏板电压过高门槛 */
CALDATA const volatile float32 KDAG_BrkPedVoltMin_mV = 500.0F;/* Referenced by: '<S1435>/Constant48' */

/* 制动踏板电压过低门槛 */
CALDATA const volatile uint16 KDAG_BrkSwCrsChkActnMsk_enum = 112U;
                       /* Referenced by: '<S1435>/KDAG_BMSCmdTmOutFailTm_s23' */

/* 制动开关双路校验故障动作 */
CALDATA const volatile uint8 KDAG_BrkSwCrsChkCntDec_cnt = 1U;/* Referenced by: '<S1436>/Constant11' */

/* 制动开关双路校验计数减少步长 */
CALDATA const volatile uint8 KDAG_BrkSwCrsChkCntHi_cnt = 20U;/* Referenced by: '<S1436>/Constant1' */

/* 制动开关双路校验计数High_高于此值判定有故障 */
CALDATA const volatile uint8 KDAG_BrkSwCrsChkCntInc_cnt = 1U;/* Referenced by: '<S1436>/Constant10' */

/* 制动开关双路校验计数增加步长 */
CALDATA const volatile uint8 KDAG_BrkSwCrsChkCntLo_cnt = 10U;/* Referenced by: '<S1436>/Constant3' */

/* 制动开关双路校验计数Low_低于此值判定无故障 */
CALDATA const volatile uint8 KDAG_BrkSwCrsChkCntMax_cnt = 30U;/* Referenced by: '<S1436>/Constant12' */

/* 制动开关双路校验计数Max */
CALDATA const volatile float32 KDAG_BrkSwCrsChkIntvlTm_s = 2.0F;/* Referenced by: '<S1436>/Constant5' */

/* 两次制动开关校验至少需要间隔的时间 */
CALDATA const volatile float32 KDAG_BrkSwDisagreeTmHi_s = 1.0F;/* Referenced by: '<S1436>/Constant4' */

/* 制动开关不一致时间High_高于此值表示此次校验不通过 */
CALDATA const volatile float32 KDAG_BrkSwDisagreeTmLo_s = 0.2F;/* Referenced by: '<S1436>/Constant2' */

/* 制动开关不一致时间Low_低于此值表示此次校验通过 */
CALDATA const volatile float32 KDAG_BrkSwDisagreeTmLong_s = 10.0F;/* Referenced by: '<S1436>/Constant6' */

/* 制动开关不一致时间Long_高于此值直接报校验故障 */
CALDATA const volatile uint16 KDAG_CCPCRCFltActnMsk_enum = 32U;
                       /* Referenced by: '<S1044>/KDAG_BMSCmdTmOutFailTm_s13' */
CALDATA const volatile uint16 KDAG_CHABusOffActnMsk_enum = 114U;
                        /* Referenced by: '<S1044>/KDAG_BMSCmdTmOutFailTm_s3' */
CALDATA const volatile uint16 KDAG_CRRRCRCFltActnMsk_enum = 64U;
                       /* Referenced by: '<S1044>/KDAG_BMSCmdTmOutFailTm_s21' */
CALDATA const volatile uint16 KDAG_CellUndrVoltActnMsk_enum = 0U;
                        /* Referenced by: '<S980>/KDAG_BMSCmdTmOutFailTm_s13' */

/* BMSCell欠压故障动作 */
CALDATA const volatile float32 KDAG_CellUndrVoltFailTm_s = 3.0F;
                        /* Referenced by: '<S980>/KDAG_BMSCmdTmOutFailTm_s15' */

/* BMSCell欠压故障确认时间 */
CALDATA const volatile uint16 KDAG_DCCCmdTmOutActnMsk1_enum = 0U;
                       /* Referenced by: '<S1165>/KDAG_BMSCmdTmOutFailTm_s13' */

/* DCDC模式指令响应超时故障动作_升级前 */
CALDATA const volatile uint16 KDAG_DCCCmdTmOutActnMsk2_enum = 0U;
                       /* Referenced by: '<S1165>/KDAG_BMSCmdTmOutFailTm_s15' */

/* DCDC模式指令响应超时故障动作_升级后 */
CALDATA const volatile float32 KDAG_DCCCmdTmOutFailTm_s = 5.0F;
                       /* Referenced by: '<S1158>/KDAG_BMSCmdTmOutFailTm_s14' */

/* DCDC模式指令响应超时故障确认时间 */
CALDATA const volatile uint16 KDAG_DCCInVoltLoActnMsk_enum = 0U;
                        /* Referenced by: '<S1158>/KDAG_BMSCmdTmOutFailTm_s1' */

/* DCDC输入电压低故障动作 */
CALDATA const volatile float32 KDAG_DCCInVoltLoFailTm_s = 3.0F;
                       /* Referenced by: '<S1158>/KDAG_BMSCmdTmOutFailTm_s13' */

/* DCDC输入电压低故障确认时间 */
CALDATA const volatile uint16 KDAG_DCCModeFltActnMsk1_enum = 0U;
                        /* Referenced by: '<S1167>/KDAG_BMSCmdTmOutFailTm_s1' */

/* DCDCModeFault故障动作_升级前 */
CALDATA const volatile uint16 KDAG_DCCModeFltActnMsk2_enum = 0U;
                       /* Referenced by: '<S1167>/KDAG_BMSCmdTmOutFailTm_s11' */

/* DCDCModeFault故障动作_升级后 */
CALDATA const volatile float32 KDAG_DCCModeFltFailTm_s = 60.0F;
                       /* Referenced by: '<S1158>/KDAG_BMSCmdTmOutFailTm_s12' */

/* DCDCModeFault故障确认时间 */
CALDATA const volatile float32 KDAG_DCCSysFailFailTm_s = 1.5F;/* Referenced by:
                                                               * '<S1158>/KDAG_BMSCmdTmOutFailTm_s4'
                                                               * '<S1158>/KDAG_BMSCmdTmOutFailTm_s5'
                                                               * '<S1158>/KDAG_BMSCmdTmOutFailTm_s7'
                                                               * '<S1158>/KDAG_BMSCmdTmOutFailTm_s9'
                                                               */
...
CALDATA const volatile float32 KEMS_AccPwrIncFiltCoeff_c = 0.9F;
                          /* Referenced by: '<S903>/KVTM_LimpHomeOvrdSw_flg4' */

/* 充电附件功率滤波系数（只滤上降） */
CALDATA const volatile float32 KEMS_CellTempSynDecRate_Cps = -0.5F;
                          /* Referenced by: '<S908>/KVTM_LimpHomeOvrdSw_flg6' */

/* 电芯温度下降斜率 */
CALDATA const volatile float32 KEMS_CellTempSynIncRate_Cps = 0.5F;
                          /* Referenced by: '<S908>/KVTM_LimpHomeOvrdSw_flg7' */

/* 电芯温度上升斜率 */
CALDATA const volatile float32 KEMS_ChrgCurFbKiMax_A = 300.0F;/* Referenced by: '<S961>/Saturation' */

/* 充电KI上限限制 */
CALDATA const volatile float32 KEMS_ChrgCurFbKiMin_A = 0.0F;/* Referenced by: '<S961>/Saturation' */

/* 充电KI下限限制 */
CALDATA const volatile float32 KEMS_ChrgCurFbMax_A = 500.0F;/* Referenced by: '<S961>/Saturation2' */

/* 充电KP+KI上限限制 */
CALDATA const volatile float32 KEMS_ChrgCurFbMin_A = 0.0F;/* Referenced by: '<S961>/Saturation2' */
...
CALDATA const volatile float32 KEMS_ChrgPwr2MotRawFiltCoeff_c = 0.9F;
                          /* Referenced by: '<S903>/KVTM_LimpHomeOvrdSw_flg5' */
...
/* 充电功率闭环滤波系数 */
CALDATA const volatile float32 KEMS_ChrgPwrFbKiMax_kW = 20.0F;/* Referenced by: '<S923>/Saturation' */

/* 充电功率闭环KI上限限制 */
CALDATA const volatile float32 KEMS_ChrgPwrFbKiMin_kW = 0.0F;/* Referenced by: '<S923>/Saturation' */

/* 充电功率闭环KI下限限制 */
CALDATA const volatile float32 KEMS_ChrgPwrFbMax_kW = 30.0F;/* Referenced by: '<S923>/Saturation2' */

/* 充电功率闭环KI+KP上限限制 */
CALDATA const volatile float32 KEMS_ChrgPwrFbMin_kW = 0.0F;/* Referenced by: '<S923>/Saturation2' */

/* 充电功率闭环KI+KP下限限制 */
CALDATA const volatile float32 KEMS_ChrgPwrFbOff_kW = -10.0F;
                          /* Referenced by: '<S904>/KVTM_LimpHomeOvrdSw_flg1' */

/* 充电功率闭环进入阀值 */
CALDATA const volatile float32 KEMS_ChrgPwrFbOn_kW = -5.0F;
                         /* Referenced by: '<S904>/KVTM_LimpHomeOvrdSw_flg15' */

/* 充电功率闭环退出阀值 */
CALDATA const volatile float32 KEMS_DCCHeatgRsrvPwr_kW = 0.5F;
...
/* DCC涌动功率 */
CALDATA const volatile float32 KEMS_DchaCurFbKiMax_A = 0.0F;/* Referenced by: '<S962>/Saturation' */

/* 放电Ki上限限制 */
CALDATA const volatile float32 KEMS_DchaCurFbKiMin_A = -450.0F;/* Referenced by: '<S962>/Saturation' */

/* 放电Ki下限限制 */
CALDATA const volatile float32 KEMS_DchaCurFbMax_A = 0.0F;/* Referenced by: '<S962>/Saturation2' */

/* 放电KP+Ki上限限制 */
CALDATA const volatile float32 KEMS_DchaCurFbMin_A = -650.0F;/* Referenced by: '<S962>/Saturation2' */
...
/* 放电功率闭环滤波系数 */
CALDATA const volatile float32 KEMS_DchaPwrFbKiMax_kW = 0.0F;/* Referenced by: '<S941>/Saturation' */

/* 放电功率闭环KI上限限制 */
CALDATA const volatile float32 KEMS_DchaPwrFbKiMin_kW = -20.0F;/* Referenced by: '<S941>/Saturation' */

/* 放电功率闭环KI下限限制 */
CALDATA const volatile float32 KEMS_DchaPwrFbMax_kW = 0.0F;/* Referenced by: '<S941>/Saturation2' */

/* 放电功率闭环KI+KP上限限制 */
CALDATA const volatile float32 KEMS_DchaPwrFbMin_kW = -30.0F;/* Referenced by: '<S941>/Saturation2' */
...
CALDATA const volatile float32 KEMS_TMSPwrEnblOff_kW = 0.5F;
                          /* Referenced by: '<S907>/KVTM_LimpHomeOvrdSw_flg3' */
...
CALDATA const volatile float32 KEMS_TMSPwrOffDlyTm_s = 1.8F;
                          /* Referenced by: '<S907>/KVTM_LimpHomeOvrdSw_flg8' */

/* 关闭TMS工作功率确认时间 */
CALDATA const volatile boolean KGSM_DRFlt2NSw_flg = false;/* Referenced by: '<S1677>/Constant3' */

/* 驱动档故障进N档强控 */
CALDATA const volatile boolean KGSM_DRFlt2NVal_flg = false;/* Referenced by: '<S1677>/Constant2' */

/* 驱动档故障进N档-观测量：VGSM_DRFlt2N_flg */
CALDATA const volatile float32 KGSM_EPBApld2PDlyTm_s = 2.0F;/* Referenced by: '<S1715>/Constant4' */

/* 规范：EPB拉起入P需求判断时间阈值 */
CALDATA const volatile float32 KGSM_EPBReld2NDlyTm_s = 2.0F;/* Referenced by: '<S1716>/Constant4' */
...
/* 规范：EPB拉起操作时间阈值 */
CALDATA const volatile boolean KGSM_GrNReq2PSw_flg = false;/* Referenced by: '<S1677>/Constant5' */

/* N档非换挡请求进P档请求强控 */
CALDATA const volatile boolean KGSM_GrNReq2PVal_flg = false;/* Referenced by: '<S1677>/Constant4' */
...
/* 规范：换挡车速阈值 */
CALDATA const volatile float32 KGSM_GrSlopMaxVehSpd_kph = 5.0F;/* Referenced by:
                                                                * '<S1716>/Constant10'
                                                                * '<S1716>/Constant3'
                                                                */

/* 规范：P2D/P2R溜坡车速 */
CALDATA const volatile boolean KGSM_HldGearPSw_flg = false;/* Referenced by: '<S1677>/Constant1' */

/* 保持P档请求强控 */
CALDATA const volatile boolean KGSM_HldGearPVal_flg = false;/* Referenced by: '<S1677>/Constant' */

/* 保持P档请求-观测量：VGSM_HldGearP_flg */
CALDATA const volatile float32 KGSM_INVTrnOffDly_s = 2.0F;/* Referenced by: '<S1655>/Constant1' */
...
/* 规范：Perror置位时间阈值 */
CALDATA const volatile boolean KGSM_ReqEPBSw_flg = false;/* Referenced by: '<S1654>/Constant1' */

/* 请求EPB状态强控 */
CALDATA const volatile EnumEPBReq KGSM_ReqEPBVal_enum = EnumEPBReq_NoCmd;/* Referenced by: '<S1654>/Constant' */
...
CALDATA const volatile boolean KGSM_VehActGearPstnSw_flg = false;
                                      /* Referenced by: '<S1655>/APA_Switdh4' */

/* 实际输出档位控制强控 */
CALDATA const volatile EnumGearPstn KGSM_VehActGearPstnVal_enum = EnumGearPstn_P;
                                      /* Referenced by: '<S1655>/APA_Switdh5' */

/* 实际输出档位控制 0-P 1-N 2-D 3-R-观测量：VGSM_VehActGearPstn_enum */
CALDATA const volatile float32 KHMI_BackwSldgBgnEnd_kph = -3.0F;/* Referenced by: '<S95>/Constant1' */
CALDATA const volatile float32 KHMI_BackwSldgBgnSpd_kph = -0.5F;/* Referenced by: '<S95>/Constant' */
CALDATA const volatile float32 KHMI_BackwSldgDst_m = -0.5F;/* Referenced by: '<S95>/Constant2' */
CALDATA const volatile float32 KHMI_BatCellMaxTemWarning_C = 48.0F;/* Referenced by: '<S87>/Constant' */

/* 电芯（最高温度）限功率温度 */
CALDATA const volatile float32 KHMI_BothAccBrkTime_s = 0.2F;/* Referenced by: '<S88>/Constant1' */

/* 回馈能力受限判断时长 */
CALDATA const volatile float32 KHMI_CellOverTempTime_s = 5.0F;/* Referenced by: '<S87>/Constant1' */

/* 电芯过温判断时长 */
CALDATA const volatile float32 KHMI_DriPwrLmtTime_s = 5.0F;/* Referenced by: '<S92>/Constant1' */

/* 驱动能力受限判断时长 */
CALDATA const volatile float32 KHMI_DriPwrLmtVa_kw = 25.0F;/* Referenced by: '<S92>/Constant' */

/* 驱动能力受限阈值 */
CALDATA const volatile float32 KHMI_FwdSldgBgnEnd_kph = 3.0F;/* Referenced by: '<S95>/Constant5' */
CALDATA const volatile float32 KHMI_FwdSldgBgnSpd_kph = 0.5F;/* Referenced by: '<S95>/Constant4' */
CALDATA const volatile float32 KHMI_FwdSldgDst_m = 0.5F;/* Referenced by: '<S95>/Constant6' */
CALDATA const volatile float32 KHMI_InfoDispIntervalTm_s = 2.5F;/* Referenced by: '<S84>/Constant27' */

/* InfoDisp发送给仪表维持时长 */
CALDATA const volatile float32 KHMI_RecPwrLmtTime_s = 5.0F;/* Referenced by: '<S94>/Constant1' */

/* 回馈能力受限判断时长 */
CALDATA const volatile float32 KHMI_RecPwrLmtVa_kw = -10.0F;/* Referenced by: '<S94>/Constant' */

/* 回馈能力受限阈值 */
CALDATA const volatile float32 KHMI_SnowModWarnSpd_kph = 120.0F;/* Referenced by: '<S96>/Constant1' */
...
/* InfoDisp提醒维持发送时间 */
CALDATA const volatile float32 KHVM_ACChrgFltWaitTm_s = 100.0F;/* Referenced by:
                                                                * '<S1548>/Constant10'
                                                                * '<S1548>/Constant11'
                                                                */

/* 交流充放电错误兜底时间 */
CALDATA const volatile float32 KHVM_ChrgStopWaitTm_s = 1.0F;/* Referenced by: '<S1518>/MainState' */
...
/* 交直流充电达到截止电压确认时间 */
CALDATA const volatile float32 KHVM_DCCBuckLVVolt_V = 14.41F;/* Referenced by: '<S1518>/MainState' */

/* DCDC BUCK 电压 */
CALDATA const volatile float32 KHVM_DchaStopWaitTm_s = 2.0F;/* Referenced by: '<S1518>/MainState' */

/* OBC放电电唤醒源断开等待时间 */
CALDATA const volatile float32 KHVM_ECURstWaitTm_s = 0.5F;/* Referenced by: '<S1518>/MainState' */

/* ECU复位状态保持时间 */
CALDATA const volatile boolean KHVM_F1B1PwrOffReq_ovrdflg = false;/* Referenced by: '<S1521>/Constant8' */

/* F1B1下电控制开关 */
CALDATA const volatile boolean KHVM_F1B1PwrOffReq_ovrdval = false;/* Referenced by: '<S1521>/Constant6' */

/* F1B1下电控制值 */
CALDATA const volatile boolean KHVM_F1B1PwrOnReq_ovrdflg = false;/* Referenced by: '<S1521>/Constant5' */

/* F1B1上电控制开关 */
CALDATA const volatile boolean KHVM_F1B1PwrOnReq_ovrdval = false;/* Referenced by: '<S1521>/Constant' */

/* F1B1上电控制值 */
CALDATA const volatile float32 KHVM_HUChrgngReqHldTm_s = 15.0F;/* Referenced by: '<S1548>/Constant8' */

/* HU预约充电请求保持时间 */
CALDATA const volatile float32 KHVM_HVCheckTmout_s = 4.0F;/* Referenced by: '<S1518>/MainState' */

/* INV&DCDC高压建立等待时间 */
CALDATA const volatile float32 KHVM_HVCutOffTmout_s = 180.0F;/* Referenced by: '<S1518>/MainState' */

/* BMS主继电器断开等待时间 */
CALDATA const volatile float32 KHVM_HVDeviceOffTmout_s = 10.0F;/* Referenced by: '<S1518>/MainState' */

/* 下电关闭设备（空调&DCDC）等待时间 */
CALDATA const volatile float32 KHVM_HVDschrgTmout_s = 180.0F;/* Referenced by: '<S1518>/MainState' */

/* INV泄放等待时间 */
CALDATA const volatile float32 KHVM_HVSetUpTmout_s = 61.0F;/* Referenced by: '<S1518>/MainState' */

/* 主继电器闭合等待时间 */
CALDATA const volatile boolean KHVM_INVPreprogm_ovrdflg = false;/* Referenced by: '<S1543>/Constant1' */

/* INV与编程标定控制开关 */
CALDATA const volatile boolean KHVM_INVPreprogm_ovrdval = false;/* Referenced by: '<S1543>/Constant' */

/* INV与编程标定控制值 */
CALDATA const volatile float32 KHVM_INVholdTm_s = 2.0F;/* Referenced by: '<S1518>/MainState' */

/* 下电保持INV硬线使能延迟时间 */
CALDATA const volatile float32 KHVM_KL15OffPwrDwnCfmTm_s = 0.5F;/* Referenced by: '<S1547>/Constant4' */

/* KL15断开确认时间 */
CALDATA const volatile float32 KHVM_MaxHVDCCurntAC_A = 32.0F;/* Referenced by: '<S1519>/Constant1' */

/* VCU反馈给OBC最大电流限制(直流侧) */
CALDATA const volatile float32 KHVM_MaxHVDCVoltAC_V = 455.0F;/* Referenced by: '<S1519>/Constant12' */

/* 交流充电最大电压 */
CALDATA const volatile float32 KHVM_OBCS2ClsTmout_s = 6.0F;/* Referenced by: '<S1518>/MainState' */

/* S2闭合等待时间 */
CALDATA const volatile boolean KHVM_PTRdy2PTStdby_ovrdflg = false;/* Referenced by: '<S1545>/Constant7' */

/* Rdy退回Stdby开关 */
CALDATA const volatile boolean KHVM_PTRdy2PTStdby_ovrdval = false;/* Referenced by: '<S1545>/Constant4' */

/* Rdy退回Stdby控制值 */
CALDATA const volatile float32 KHVM_PTRdyBrkSwEffctvTm_s = 2.0F;/* Referenced by: '<S1545>/Constant1' */

/* 刹车上升沿保持时间 */
CALDATA const volatile boolean KHVM_PTStdby2PTRdy_ovrdflg = false;/* Referenced by: '<S1545>/Constant3' */

/* Stdby进入Rdy开关 */
CALDATA const volatile boolean KHVM_PTStdby2PTRdy_ovrdval = false;/* Referenced by: '<S1545>/Constant' */

/* Stdby进入Rdy控制值 */
CALDATA const volatile boolean KHVM_PowUpSelfChek_ovrdflg = false;/* Referenced by: '<S1546>/Constant3' */

/* 高压自检条件控制开关 */
CALDATA const volatile boolean KHVM_PowUpSelfChek_ovrdval = false;/* Referenced by: '<S1546>/Constant' */

/* 高压自检条件控制值 */
CALDATA const volatile boolean KHVM_PwrOn2PwrDwn_ovrdflg = false;/* Referenced by: '<S1547>/Constant3' */

/* 高压下电条件满足开关 */
CALDATA const volatile boolean KHVM_PwrOn2PwrDwn_ovrdval = false;/* Referenced by: '<S1547>/Constant' */

/* 高压下电条件满足控制值 */
CALDATA const volatile float32 KHVM_PwrUpACChrgEffctvTm_s = 2.0F;/* Referenced by: '<S1548>/Constant1' */

/* OBC唤醒源上升沿保持时间 */
CALDATA const volatile float32 KHVM_PwrUpDCChrgEffctvTm_s = 2.0F;/* Referenced by: '<S1548>/Constant4' */

/* BMS唤醒源上升沿保持时间 */
CALDATA const volatile float32 KHVM_PwrUpIBSDlyTm_s = 3.0F;/* Referenced by: '<S1548>/Constant5' */

/* IBS唤醒源延迟时间 */
CALDATA const volatile float32 KHVM_PwrUpIBSEffctvTm_s = 5.0F;/* Referenced by: '<S1548>/Constant9' */

/* IBS上升沿保持时间 */
CALDATA const volatile float32 KHVM_PwrUpKL15EffctvTm_s = 2.0F;/* Referenced by: '<S1548>/Constant17' */

/* KL15上升沿保持时间 */
CALDATA const volatile float32 KHVM_SOCExtrmLo_pct = 0.0F;/* Referenced by: '<S1521>/Constant9' */

/* SOC极低阈值 */
CALDATA const volatile float32 KHVM_SOCLoPwrDwnDlyTm_s = 10.0F;/* Referenced by: '<S1547>/Constant2' */

/* SOC极低确认时间 */
CALDATA const volatile float32 KHVM_SOPExtrmLo_kW = 0.1F;/* Referenced by: '<S1521>/Constant3' */

/* SOP极低阈值 */
CALDATA const volatile float32 KHVM_SleepWaitTm_s = 5.0F;/* Referenced by: '<S1518>/MainState' */

/* 下电可以休眠等待时间 */
CALDATA const volatile float32 KHVM_TBOXReSetACChgTm_s = 2.0F;/* Referenced by: '<S1519>/Constant6' */

/* TBOX远程充电请求保持时间 */
CALDATA const volatile boolean KHVM_Tbox2OBCOprtCmd_ovrdflg = false;/* Referenced by: '<S1519>/Constant9' */

/* TBOX远程充电开关 */
CALDATA const volatile uint8 KHVM_Tbox2OBCOprtCmd_ovrdval = 0U;/* Referenced by: '<S1519>/Constant' */

/* TBOX远程充电标定值 */
CALDATA const volatile float32 KHVM_VehHaltCfmTm_s = 0.5F;/* Referenced by: '<S1521>/Constant7' */

/* 车辆停止车速确认时间 */
CALDATA const volatile float32 KHVM_VehHaltSpd_kph = 1.0F;/* Referenced by: '<S1521>/Constant10' */

/* 车辆停止车速阈值 */
CALDATA const volatile float32 KHVM_VehMoveCfmTm_s = 1.0F;/* Referenced by: '<S1521>/Constant12' */

/* 车辆运动车速确认时间 */
CALDATA const volatile float32 KHVM_VehSpdLo_kph = 3.0F;/* Referenced by: '<S1521>/Constant2' */

/* 低车速阈值 */
CALDATA const volatile boolean KHVM_WakeUp2PwrUp_ovrdflg = false;/* Referenced by: '<S1548>/Constant6' */

/* 唤醒到上高压条件开关 */
CALDATA const volatile boolean KHVM_WakeUp2PwrUp_ovrdval = false;/* Referenced by: '<S1548>/Constant' */

/* 唤醒到上高压条件控制值 */
CALDATA const volatile boolean KHVM_WakeUpVCU_ovrdflg = false;/* Referenced by: '<S1549>/Constant1' */

/* 休眠到唤醒条件控制开关 */
CALDATA const volatile boolean KHVM_WakeUpVCU_ovrdval = false;/* Referenced by: '<S1549>/Constant' */
...
/* 最大补电次数阈值_versteckt */
CALDATA const volatile float32 KIBS_ChrgCurntOKThr_A = 0.05F;/* Referenced by: '<S258>/ChrgSt' */

/* IBS充电电流阈值_versteckt */
CALDATA const volatile uint16 KIBS_ChrgFailTmThr_min = 1U;/* Referenced by: '<S258>/ChrgSt' */

/* IBS补电故障时间阈值_versteckt */
CALDATA const volatile float32 KIBS_ChrgTempThr1_C = -15.0F;/* Referenced by: '<S261>/VoltState' */

/* IBS补电温度阈值1_versteckt */
CALDATA const volatile float32 KIBS_ChrgTempThr2_C = -5.0F;/* Referenced by: '<S261>/VoltState' */

/* IBS补电温度阈值2_versteckt */
CALDATA const volatile float32 KIBS_ChrgTempThr3_C = 5.0F;/* Referenced by: '<S261>/VoltState' */

/* IBS补电温度阈值3_versteckt */
CALDATA const volatile float32 KIBS_ChrgVoltThr1_V = 12.4F;/* Referenced by: '<S261>/VoltState' */

/* IBS补电电压阈值1_versteckt */
CALDATA const volatile float32 KIBS_ChrgVoltThr2_V = 12.5F;/* Referenced by: '<S261>/VoltState' */

/* IBS补电电压阈值2_versteckt */
CALDATA const volatile float32 KIBS_ChrgVoltThr3_V = 12.6F;/* Referenced by: '<S261>/VoltState' */

/* IBS补电电压阈值3_versteckt */
CALDATA const volatile float32 KIBS_ChrgVoltThr4_V = 12.7F;/* Referenced by: '<S261>/VoltState' */

/* IBS补电电压阈值4_versteckt */
CALDATA const volatile uint16 KIBS_CurntOKTmThr_min = 1U;/* Referenced by: '<S258>/ChrgSt' */

/* IBS充电电流达到阈值确认时间_versteckt */
CALDATA const volatile float32 KIBS_DfltEnvirTemp_C = 5.0F;/* Referenced by: '<S261>/Constant1' */

/* AC环境温度失效时，默认的环境温度_versteckt */
CALDATA const volatile float32 KIBS_EnvirTemptFiltCoeff_c = 0.1F;/* Referenced by: '<S261>/Constant3' */
...
CALDATA const volatile boolean KIBS_FbIBSWup_flg = true;/* Referenced by: '<S260>/Constant17' */

/* 禁止IBS唤醒手动开关_versteckt */
CALDATA const volatile uint16 KIBS_FbRctWupThr_min = 65535U;/* Referenced by: '<S261>/Constant10' */

/* 禁止RTC唤醒配置的时间_versteckt */
CALDATA const volatile uint16 KIBS_HoldNMTmThr_s = 8U;/* Referenced by: '<S260>/Constant14' */

/* IBS唤醒保持网络时间_versteckt */
CALDATA const volatile uint8 KIBS_KL30VoltDebNumThr_cnt = 5U;/* Referenced by: '<S281>/Constant2' */

/* KL30电压低于补电电压总次数_versteckt */
CALDATA const volatile float32 KIBS_KL30VoltDebTmThr_s = 1.0F;/* Referenced by: '<S261>/Constant7' */

/* KL30电压是否满足诊断时间_versteckt */
CALDATA const volatile float32 KIBS_KL30VoltFiltCoeff_c = 0.2F;/* Referenced by: '<S261>/Constant2' */

/* KL30电压滤波系数_versteckt */
CALDATA const volatile float32 KIBS_MustChrgVoltDebTm_s = 2.0F;/* Referenced by: '<S261>/Constant11' */

/* 兜底电压确认时间_versteckt */
CALDATA const volatile uint16 KIBS_StWaitTm_s = 5U;/* Referenced by: '<S261>/Constant5' */

/* IBS状态（电压&温度）稳定时间_versteckt */
CALDATA const volatile float32 KIBS_UseTblThr_min = 5.0F;/* Referenced by: '<S261>/Constant16' */

/* 切换到查表时间倒计时_versteckt */
CALDATA const volatile uint8 KIBS_WakeupReas_enum = 34U;/* Referenced by: '<S278>/Constant' */

/* 底层唤醒原因枚举值_versteckt */
CALDATA const volatile uint16 KIBS_WupChgTmThr1_min = 15U;/* Referenced by: '<S258>/ChrgSt' */

/* IBS补电时间阈值1_versteckt */
CALDATA const volatile boolean KIPC_ACCCfgOvrdSw_flg = false;
                          /* Referenced by: '<S366>/KIPC_LimpHomeOvrdSw_flg2' */
CALDATA const volatile boolean KIPC_ACCCfgOvrdVal_flg = false;
                         /* Referenced by: '<S366>/KIPC_LimpHomeOvrdVal_flg2' */
CALDATA const volatile float32 KIPC_AccPed1FullPstn_pct = 74.0F;/* Referenced by: '<S374>/Constant2' */
CALDATA const volatile float32 KIPC_AccPed2FullPstn_pct = 74.0F;/* Referenced by: '<S376>/Constant6' */
CALDATA const volatile float32 KIPC_AccPedDbnd_pct = 2.0F;
                   /* Referenced by: '<S368>/cnst_ValidCheck_EngCoolantTemp1' */
CALDATA const volatile float32 KIPC_AccPedInitTm_s = 0.3F;
                               /* Referenced by: '<S371>/KIPC_AccPedInitTm_s' */
CALDATA const volatile float32 KIPC_AccPedLrnDwnFiltCoeff_rat = 0.91F;/* Referenced by:
                                                                      * '<S373>/KIPC_AccPedLrnDwnFiltCoeff_rat'
                                                                      * '<S375>/KIPC_AccPedLrnDwnFiltCoeff_rat'
                                                                      */
CALDATA const volatile float32 KIPC_AccPedLrnDwnStabThr_pct = 0.5F;/* Referenced by:
                                                                    * '<S373>/KAccPed_Threshold1ISLow_V6'
                                                                    * '<S375>/KAccPed_Threshold1ISLow_V6'
                                                                    */
CALDATA const volatile float32 KIPC_AccPedLrnDwnStabTm_s = 2.0F;/* Referenced by:
                                                                 * '<S373>/KAccPed_Threshold1ISLow_V5'
                                                                 * '<S375>/KAccPed_Threshold1ISLow_V5'
                                                                 */
CALDATA const volatile float32 KIPC_AccPedMinPstnHi_pct = 21.0F;/* Referenced by:
                                                                 * '<S373>/KAccPed_Threshold1ISLow_V10'
                                                                 * '<S373>/KAccPed_Threshold1ISLow_V11'
                                                                 * '<S375>/KAccPed_Threshold1ISLow_V10'
                                                                 * '<S375>/KAccPed_Threshold1ISLow_V11'
                                                                 */
CALDATA const volatile float32 KIPC_AccPedMinPstnLo_pct = 13.0F;/* Referenced by:
                                                                 * '<S373>/KAccPed_Threshold1ISLow_V8'
                                                                 * '<S375>/KAccPed_Threshold1ISLow_V8'
                                                                 */
CALDATA const volatile float32 KIPC_AccPedMinPstnLrnUpHi_pct = 80.0F;/* Referenced by:
                                                                      * '<S373>/KAccPed_Threshold1ISLow_V2'
                                                                      * '<S375>/KAccPed_Threshold1ISLow_V2'
                                                                      */
CALDATA const volatile float32 KIPC_AccPedMinPstnLrnUpLo_pct = 20.0F;/* Referenced by:
                                                                      * '<S373>/KAccPed_Threshold1ISLow_V1'
                                                                      * '<S375>/KAccPed_Threshold1ISLow_V1'
                                                                      */
CALDATA const volatile float32 KIPC_AccPedMinPstnUpOfst_pct = 0.2F;/* Referenced by:
                                                                    * '<S373>/KAccPed_Threshold1ISLow_V7'
                                                                    * '<S375>/KAccPed_Threshold1ISLow_V7'
                                                                    */
CALDATA const volatile float32 KIPC_AccPedNormzPstnFiltTm_s = 0.02F;/* Referenced by:
                                                                     * '<S370>/KIPC_AccPedLrnDwnFiltCoeff_rat'
                                                                     * '<S370>/KIPC_AccPedLrnDwnFiltCoeff_rat1'
                                                                     */
CALDATA const volatile float32 KIPC_AccPedPrsdThr4Stk_pct = 2.0F;
                           /* Referenced by: '<S371>/KAPD_Threshold1ISLow_V1' */
CALDATA const volatile float32 KIPC_AccPedPstnLmt_pct = 100.0F;
                   /* Referenced by: '<S368>/cnst_ValidCheck_EngCoolantTemp5' */
CALDATA const volatile boolean KIPC_AccPedPstnOvrdSw_flg = false;
                   /* Referenced by: '<S368>/cnst_ValidCheck_EngCoolantTemp3' */
CALDATA const volatile float32 KIPC_AccPedPstnOvrdVal_pct = 0.0F;
                   /* Referenced by: '<S368>/cnst_ValidCheck_EngCoolantTemp4' */
CALDATA const volatile float32 KIPC_AccPedSclRng_pct = 106.0F;/* Referenced by:
                                                               * '<S374>/cnst_ValidCheck_EngCoolantTemp1'
                                                               * '<S376>/cnst_ValidCheck_EngCoolantTemp3'
                                                               */
CALDATA const volatile boolean KIPC_AccPedStkDiagEnbl_flg = true;
                           /* Referenced by: '<S371>/KAPD_Threshold1ISLow_V7' */
CALDATA const volatile float32 KIPC_AccPedStkFiltCoeff_rat = 0.91F;
                       /* Referenced by: '<S371>/KIPC_AccPedStkFiltCoeff_rat' */
CALDATA const volatile float32 KIPC_AccPedStkStabThr_pct = 0.5F;
                        /* Referenced by: '<S371>/KAccPed_Threshold1ISLow_V6' */
CALDATA const volatile float32 KIPC_AccPedStkStabTm_s = 5.0F;
                        /* Referenced by: '<S371>/KAccPed_Threshold1ISLow_V5' */
CALDATA const volatile float32 KIPC_AccPedSwThr_pct = 2.0F;
                   /* Referenced by: '<S368>/cnst_ValidCheck_EngCoolantTemp2' */

/* 油门开关开启阈值 */
CALDATA const volatile float32 KIPC_AccPedZeroPstnDecRate_pctps = -100.0F;
                          /* Referenced by: '<S371>/KAPD_Threshold1ISLow_V18' */
CALDATA const volatile float32 KIPC_AccPedZeroPstnIncRate_pctps = 100.0F;
                          /* Referenced by: '<S371>/KAPD_Threshold1ISLow_V17' */
CALDATA const volatile float32 KIPC_BrkPedPrsdThr4Stk_pct = 10.0F;
                          /* Referenced by: '<S371>/KAPD_Threshold1ISLow_V11' */
CALDATA const volatile float32 KIPC_BrkPedPstnDfltPrsd_pct = 100.0F;/* Referenced by: '<S363>/Constant2' */
CALDATA const volatile boolean KIPC_BrkPedPstnOvrdSw_flg = false;
                   /* Referenced by: '<S363>/cnst_ValidCheck_EngCoolantTemp2' */
CALDATA const volatile float32 KIPC_BrkPedPstnOvrdVal_pct = 0.0F;
                   /* Referenced by: '<S363>/cnst_ValidCheck_EngCoolantTemp3' */
CALDATA const volatile float32 KIPC_BrkPedReldThr4Stk_pct = 3.0F;
                           /* Referenced by: '<S371>/KAPD_Threshold1ISLow_V2' */
CALDATA const volatile float32 KIPC_BrkSwPrsdPedPstn_pct = 5.0F;
                             /* Referenced by: '<S363>/KTQD_BrkPedPstnHi_pct' */
CALDATA const volatile boolean KIPC_CCSCfgOvrdSw_flg = false;
                          /* Referenced by: '<S366>/KIPC_LimpHomeOvrdSw_flg1' */
CALDATA const volatile boolean KIPC_CCSCfgOvrdVal_flg = false;
                         /* Referenced by: '<S366>/KIPC_LimpHomeOvrdVal_flg1' */
CALDATA const volatile boolean KIPC_CrpCtrlCfgOvrdSw_flg = false;
                          /* Referenced by: '<S366>/KIPC_LimpHomeOvrdSw_flg3' */
CALDATA const volatile boolean KIPC_CrpCtrlCfgOvrdVal_flg = false;
                         /* Referenced by: '<S366>/KIPC_LimpHomeOvrdVal_flg3' */
CALDATA const volatile boolean KIPC_CrpModeActOvrdSw_flg = false;
                           /* Referenced by: '<S365>/KIPC_LimpHomeOvrdSw_flg' */
CALDATA const volatile EnumCrpModeAct KIPC_CrpModeActOvrdVal_enum =
  EnumCrpModeAct_Open;    /* Referenced by: '<S365>/KIPC_LimpHomeOvrdVal_flg' */
...
CALDATA const volatile EnumDrvModeAct KIPC_DrvModeActOvrdVal_enum =
  EnumDrvModeAct_Eco;    /* Referenced by: '<S365>/KIPC_LimpHomeOvrdVal_flg1' */
...
CALDATA const volatile boolean KIPC_ESCVehSpdPrio_flg = true;
                                /* Referenced by: '<S434>/KSYS_VehTransRto_c' */
CALDATA const volatile boolean KIPC_ESCWhlSpdPrio_flg = true;
                               /* Referenced by: '<S434>/KSYS_VehTransRto_c2' */
CALDATA const volatile boolean KIPC_EnblFltRstAccPedZP_flg = true;
                           /* Referenced by: '<S371>/KAPD_Threshold1ISLow_V3' */
CALDATA const volatile boolean KIPC_EnblVpedAutoCrp_flg = true;/* Referenced by: '<S402>/Shift_enum1' */
CALDATA const volatile float32 KIPC_ExitAutoCrpDrvDist_m = 1.0F;
                         /* Referenced by: '<S402>/KIPC_ExitAutoCrpDrvDist_m' */
CALDATA const volatile float32 KIPC_ExitAutoCrpPNDurTm_s = 5.0F;/* Referenced by: '<S402>/Shift_enum4' */
CALDATA const volatile float32 KIPC_ExitAutoCrpVehSpd_kph = 15.0F;
                        /* Referenced by: '<S402>/KIPC_ExitAutoCrpVehSpd_kph' */
CALDATA const volatile boolean KIPC_HDCCfgOvrdSw_flg = false;
                          /* Referenced by: '<S366>/KIPC_LimpHomeOvrdSw_flg4' */
CALDATA const volatile boolean KIPC_HDCCfgOvrdVal_flg = false;
                         /* Referenced by: '<S366>/KIPC_LimpHomeOvrdVal_flg4' */
...
CALDATA const volatile EnumRegenModeAct KIPC_RegenModeActOvrdVal_enum =
  EnumRegenModeAct_Weak; /* Referenced by: '<S365>/KIPC_LimpHomeOvrdVal_flg3' */
...
CALDATA const volatile boolean KIPC_SnowModeDft_flg = false;/* Referenced by: '<S365>/Unit Delay3' */
...
CALDATA const volatile boolean KIPC_iTPMSCfgOvrdSw_flg = false;
                          /* Referenced by: '<S366>/KIPC_LimpHomeOvrdSw_flg5' */
CALDATA const volatile boolean KIPC_iTPMSCfgOvrdVal_flg = false;
                         /* Referenced by: '<S366>/KIPC_LimpHomeOvrdVal_flg5' */
CALDATA const volatile float32 KIPM_HwAccPedCh1SuplyVoltHi_mV = 15000.0F;/* Referenced by: '<S15>/sat6' */
CALDATA const volatile float32 KIPM_HwAccPedCh1SuplyVoltLo_mV = 0.0F;/* Referenced by: '<S15>/sat7' */
CALDATA const volatile boolean KIPM_HwAccPedCh1SuplyVolt_mV_ovrdflg = false;/* Referenced by: '<S15>/sat3' */
CALDATA const volatile float32 KIPM_HwAccPedCh1SuplyVolt_mV_ovrdval = 0.0F;/* Referenced by: '<S15>/sat4' */
CALDATA const volatile float32 KIPM_HwAccPedCh1VoltHi_mV = 5500.0F;/* Referenced by: '<S16>/sat6' */
CALDATA const volatile float32 KIPM_HwAccPedCh1VoltLo_mV = 0.0F;/* Referenced by: '<S16>/sat7' */
CALDATA const volatile boolean KIPM_HwAccPedCh1Volt_mV_ovrdflg = false;/* Referenced by: '<S16>/sat3' */
CALDATA const volatile float32 KIPM_HwAccPedCh1Volt_mV_ovrdval = 0.0F;/* Referenced by: '<S16>/sat4' */
CALDATA const volatile float32 KIPM_HwAccPedCh2SuplyVoltHi_mV = 15000.0F;/* Referenced by: '<S17>/sat6' */
CALDATA const volatile float32 KIPM_HwAccPedCh2SuplyVoltLo_mV = 0.0F;/* Referenced by: '<S17>/sat7' */
CALDATA const volatile boolean KIPM_HwAccPedCh2SuplyVolt_mV_ovrdflg = false;/* Referenced by: '<S17>/sat3' */
CALDATA const volatile float32 KIPM_HwAccPedCh2SuplyVolt_mV_ovrdval = 0.0F;/* Referenced by: '<S17>/sat4' */
CALDATA const volatile float32 KIPM_HwAccPedCh2VoltHi_mV = 5500.0F;/* Referenced by: '<S18>/sat6' */
CALDATA const volatile float32 KIPM_HwAccPedCh2VoltLo_mV = 0.0F;/* Referenced by: '<S18>/sat7' */
CALDATA const volatile boolean KIPM_HwAccPedCh2Volt_mV_ovrdflg = false;/* Referenced by: '<S18>/sat3' */
CALDATA const volatile float32 KIPM_HwAccPedCh2Volt_mV_ovrdval = 0.0F;/* Referenced by: '<S18>/sat4' */
CALDATA const volatile boolean KIPM_HwBMSWakeup_flg_ovrdflg = false;/* Referenced by: '<S19>/sat3' */
CALDATA const volatile boolean KIPM_HwBMSWakeup_flg_ovrdval = false;/* Referenced by: '<S19>/sat4' */
CALDATA const volatile boolean KIPM_HwBrkSwHi_flg_ovrdflg = false;/* Referenced by: '<S20>/sat3' */
CALDATA const volatile boolean KIPM_HwBrkSwHi_flg_ovrdval = false;/* Referenced by: '<S20>/sat4' */
CALDATA const volatile boolean KIPM_HwBrkSwLo_flg_ovrdflg = false;/* Referenced by: '<S21>/sat3' */
CALDATA const volatile boolean KIPM_HwBrkSwLo_flg_ovrdval = false;/* Referenced by: '<S21>/sat4' */
CALDATA const volatile boolean KIPM_HwCrpModeSw_flg_ovrdflg = false;/* Referenced by: '<S22>/sat3' */
CALDATA const volatile boolean KIPM_HwCrpModeSw_flg_ovrdval = false;/* Referenced by: '<S22>/sat4' */
CALDATA const volatile boolean KIPM_HwDrvModeSw_flg_ovrdflg = false;/* Referenced by: '<S23>/sat3' */
CALDATA const volatile boolean KIPM_HwDrvModeSw_flg_ovrdval = false;/* Referenced by: '<S23>/sat4' */
CALDATA const volatile boolean KIPM_HwEmgcyShutOff_flg_ovrdflg = false;/* Referenced by: '<S24>/sat3' */
CALDATA const volatile boolean KIPM_HwEmgcyShutOff_flg_ovrdval = false;/* Referenced by: '<S24>/sat4' */
CALDATA const volatile float32 KIPM_HwHVIL1VoltHi_mV = 5500.0F;/* Referenced by: '<S25>/sat6' */
CALDATA const volatile float32 KIPM_HwHVIL1VoltLo_mV = 0.0F;/* Referenced by: '<S25>/sat7' */
CALDATA const volatile boolean KIPM_HwHVIL1Volt_mV_ovrdflg = false;/* Referenced by: '<S25>/sat3' */
CALDATA const volatile float32 KIPM_HwHVIL1Volt_mV_ovrdval = 0.0F;/* Referenced by: '<S25>/sat4' */
CALDATA const volatile float32 KIPM_HwHVIL2VoltHi_mV = 5500.0F;/* Referenced by: '<S26>/sat6' */
CALDATA const volatile float32 KIPM_HwHVIL2VoltLo_mV = 0.0F;/* Referenced by: '<S26>/sat7' */
CALDATA const volatile boolean KIPM_HwHVIL2Volt_mV_ovrdflg = false;/* Referenced by: '<S26>/sat3' */
CALDATA const volatile float32 KIPM_HwHVIL2Volt_mV_ovrdval = 0.0F;/* Referenced by: '<S26>/sat4' */
CALDATA const volatile boolean KIPM_HwKL15A_flg_ovrdflg = false;/* Referenced by: '<S27>/sat3' */
CALDATA const volatile boolean KIPM_HwKL15A_flg_ovrdval = false;/* Referenced by: '<S27>/sat4' */
CALDATA const volatile boolean KIPM_HwKL15B_flg_ovrdflg = false;/* Referenced by: '<S28>/sat3' */
CALDATA const volatile boolean KIPM_HwKL15B_flg_ovrdval = false;/* Referenced by: '<S28>/sat4' */
CALDATA const volatile uint16 KIPM_HwKL30Hi_mV = 20000U;/* Referenced by: '<S29>/sat6' */
CALDATA const volatile uint16 KIPM_HwKL30Lo_mV = 0U;/* Referenced by: '<S29>/sat7' */
CALDATA const volatile boolean KIPM_HwKL30_mV_ovrdflg = false;/* Referenced by: '<S29>/sat3' */
CALDATA const volatile uint16 KIPM_HwKL30_mV_ovrdval = 0U;/* Referenced by: '<S29>/sat4' */
CALDATA const volatile boolean KIPM_HwOBCWakeup_flg_ovrdflg = false;/* Referenced by: '<S30>/sat3' */
CALDATA const volatile boolean KIPM_HwOBCWakeup_flg_ovrdval = false;/* Referenced by: '<S30>/sat4' */
CALDATA const volatile boolean KIPM_HwRearFogLampSwt_flg_ovrdflg = false;/* Referenced by: '<S31>/sat3' */
CALDATA const volatile boolean KIPM_HwRearFogLampSwt_flg_ovrdval = false;/* Referenced by: '<S31>/sat4' */
CALDATA const volatile uint16 KIPM_HwShftPstnSwPrsdHi_Ohm = 6000U;/* Referenced by: '<S34>/Constant' */
CALDATA const volatile uint16 KIPM_HwShftPstnSwPrsdLo_Ohm = 4000U;/* Referenced by: '<S34>/Constant1' */
CALDATA const volatile uint16 KIPM_HwShftPstnSwReldHi_Ohm = 40000U;/* Referenced by: '<S34>/Constant3' */
CALDATA const volatile uint16 KIPM_HwShftPstnSwReldLo_Ohm = 36000U;/* Referenced by: '<S34>/Constant4' */
CALDATA const volatile uint16 KIPM_HwShftPstnSwShtBatt_Ohm = 65000U;/* Referenced by: '<S34>/Constant5' */
CALDATA const volatile uint16 KIPM_HwShftPstnSwShtGnd_Ohm = 500U;/* Referenced by: '<S34>/Constant7' */
CALDATA const volatile boolean KIPM_HwShftPstnSwSts_enum_ovrdflg = false;/* Referenced by: '<S32>/sat3' */
CALDATA const volatile EnumPGearSwSts KIPM_HwShftPstnSwSts_enum_ovrdval =
  EnumPGearSwSts_Reld;                 /* Referenced by: '<S32>/sat4' */
CALDATA const volatile boolean KIPM_HwVehCrash_flg_ovrdflg = false;/* Referenced by: '<S33>/sat3' */
CALDATA const volatile boolean KIPM_HwVehCrash_flg_ovrdval = false;/* Referenced by: '<S33>/sat4' */
CALDATA const volatile boolean KOPM_HwWakeupBMS_flg_ovrdflg = false;/* Referenced by: '<S47>/sat3' */
CALDATA const volatile boolean KOPM_HwWakeupBMS_flg_ovrdval = false;/* Referenced by: '<S47>/sat4' */
CALDATA const volatile float32 KRME_AvgSOCCnsm100NumWghtFac_c = 0.0F;/* Referenced by: '<S241>/Constant9' */

/* 前100个数组能耗加权系数 */
CALDATA const volatile float32 KRME_AvgSOCCnsm10NumWghtFac_c = 0.2F;/* Referenced by: '<S241>/Constant5' */

/* 前10个数组能耗加权系数 */
CALDATA const volatile float32 KRME_AvgSOCCnsm15NumWghtFac_c = 0.2F;/* Referenced by: '<S241>/Constant6' */

/* 前15个数组能耗加权系数 */
CALDATA const volatile float32 KRME_AvgSOCCnsm1NumWghtFac_c = 0.0F;/* Referenced by: '<S241>/Constant3' */

/* 初始数组加权系数 */
CALDATA const volatile float32 KRME_AvgSOCCnsm25NumWghtFac_c = 0.2F;/* Referenced by: '<S241>/Constant7' */

/* 前25个数组能耗加权系数 */
CALDATA const volatile float32 KRME_AvgSOCCnsm50NumWghtFac_c = 0.2F;/* Referenced by: '<S241>/Constant8' */

/* 前50个数组能耗加权系数 */
CALDATA const volatile float32 KRME_AvgSOCCnsm5NumWghtFac_c = 0.2F;/* Referenced by: '<S241>/Constant4' */

/* 前5个数组能耗加权系数 */
CALDATA const volatile boolean KRME_AvgSOCCnsmWghtSw_flg = false;/* Referenced by: '<S241>/Constant10' */

/* 加权SOC消耗强控开关 */
CALDATA const volatile float32 KRME_AvgSOCCnsmWghtVal_pctp100km = 30.0F;/* Referenced by: '<S241>/Constant11' */

/* 加权SOC消耗强控值（按照100km折算） */
CALDATA const volatile float32 KRME_CHTCRmnMilEstVldOff_km = 25.0F;/* Referenced by: '<S207>/Constant4' */

/* 标准续航CHTC有效性Off */
CALDATA const volatile float32 KRME_CHTCRmnMilEstVldOn_km = 30.0F;/* Referenced by: '<S207>/Constant7' */
...
/* 计算Pwr功耗单位里程 */
CALDATA const volatile float32 KRME_CalPwrCnsmVehThr_kph = 0.5F;/* Referenced by: '<S211>/Constant1' */
...
/* 充电模式SOC偏移值 */
CALDATA const volatile float32 KRME_DchaVehStallDlyTm_s = 2.0F;/* Referenced by: '<S238>/Constant11' */

/* 车辆停止确认时间 */
CALDATA const volatile float32 KRME_NVMMilDwLim_km = 0.0F;/* Referenced by: '<S217>/Constant3' */

/* NVM存储动态续航下限值 */
CALDATA const volatile float32 KRME_NVMMilUpLim_km = 1000.0F;/* Referenced by: '<S217>/Constant8' */

/* NVM存储动态续航上限值 */
CALDATA const volatile float32 KRME_NVMSOCCnsmDwLim_pctp100km = 0.0F;/* Referenced by: '<S241>/Constant2' */

/* NVM存储SOC消耗下限值（按照100km折算） */
CALDATA const volatile float32 KRME_NVMSOCCnsmUpLim_pctp100km = 200.0F;/* Referenced by: '<S241>/Constant1' */

/* NVM存储SOC消耗上限值（按照100km折算） */
CALDATA const volatile uint8 KRME_SOCCnsmStorRst_enum = 0U;/* Referenced by: '<S241>/Constant64' */

/* 重置SOCCnse数组存储值(标定使用) */
CALDATA const volatile boolean KRME_SOHCrctFacEnbl_flg = false;/* Referenced by: '<S207>/Constant2' */

/* 使用SOH对RptSOC修正 */
CALDATA const volatile boolean KRME_WLTPDynModeEnbl_flg = true;/* Referenced by: '<S209>/Constant13' */

/* WLTP控制方式选择:0-查表WLTP续航 1-动态续航  */
CALDATA const volatile float32 KRME_WLTPRmnMilEstVldOff_km = 25.0F;/* Referenced by: '<S209>/Constant17' */

/* 动态续航WLTP有效性Off */
CALDATA const volatile float32 KRME_WLTPRmnMilEstVldOn_km = 30.0F;/* Referenced by: '<S209>/Constant18' */

/* 动态续航WLTP有效性On */
CALDATA const volatile float32 KRME_WLTPStdUpLimFac_c = 1.16F;/* Referenced by:
                                                               * '<S216>/Constant2'
                                                               * '<S216>/Constant7'
                                                               */
...
CALDATA const volatile float32 KSYS_VehMass_kg = 1800.0F;/* Referenced by:
                                                          * '<S72>/KVTM_VehMass_kg'
                                                          * '<S529>/KDAC_TapDwnTmOut_s6'
                                                          * '<S483>/KDAC_TapDwnTmOut_s6'
                                                          * '<S734>/KDAC_TapDwnTmOut_s1'
                                                          * '<S605>/KDAC_TapDwnTmOut_s'
                                                          */
CALDATA const volatile float32 KSYS_VehTransRto_c = 12.1F;/* Referenced by:
                                                           * '<S367>/KSYS_VehTransRto_c'
                                                           * '<S551>/KSYS_VehTransRto_c'
                                                           * '<S551>/KSYS_VehTransRto_c1'
                                                           * '<S885>/KSYS_VehTransRto_c3'
                                                           * '<S886>/KSYS_VehTransRto_c1'
                                                           * '<S886>/KSYS_VehTransRto_c2'
                                                           * '<S534>/KSYS_VehTransRto_c1'
                                                           * '<S698>/KSYS_VehTransRto_c'
                                                           * '<S835>/KSYS_VehTransRto_c1'
                                                           * '<S835>/KSYS_VehTransRto_c2'
                                                           * '<S777>/KSYS_VehTransRto_c'
                                                           * '<S778>/KSYS_VehTransRto_c'
                                                           * '<S795>/KSYS_VehTransRto_c'
                                                           * '<S795>/KSYS_VehTransRto_c1'
                                                           * '<S752>/KSYS_VehTransRto_c'
                                                           */
CALDATA const volatile float32 KTBX_ChrgCondCfmTmr_s = 5.0F;/* Referenced by: '<S318>/Constant3' */

/* 充电条件判断时间 */
CALDATA const volatile float32 KTBX_CnclSpdLimTmr_s = 2.0F;/* Referenced by: '<S318>/Constant9' */

/* 取消限速等级确认时间 */
CALDATA const volatile float32 KTBX_LckVerCfmTmr_s = 10.0F;/* Referenced by: '<S318>/Constant1' */

/* 锁车版本确认时间 */
CALDATA const volatile float32 KTBX_LoSpdCfmTmr_s = 5.0F;/* Referenced by: '<S318>/Constant6' */

/* 低车速确认时间 */
CALDATA const volatile float32 KTBX_RecryCommCfmTmr_s = 2.0F;/* Referenced by: '<S318>/Constant10' */

/* TBOX通讯恢复确认时间 */
CALDATA const volatile float32 KTBX_RmtACStFbMaxTmr_s = 10.0F;
                          /* Referenced by: '<S298>/KVTM_LimpHomeOvrdSw_flg5' */

/* 远程空调状态反馈最大时间 */
CALDATA const volatile float32 KTBX_RmtEnblACLwSOC_pct = 20.0F;/* Referenced by:
                                                                * '<S298>/KVTM_LimpHomeOvrdSw_flg1'
                                                                * '<S298>/KVTM_LimpHomeOvrdSw_flg2'
                                                                */
...
/* 限速等级确认时间 */
CALDATA const volatile float32 KTBX_TBOXLostCommTmr_s = 120.0F;/* Referenced by: '<S318>/Constant2' */

/* TBOX通讯丢失确认时间 */
CALDATA const volatile float32 KTBX_UnlckVerCfmTmr_s = 10.0F;/* Referenced by: '<S318>/Constant' */
...
CALDATA const volatile uint8 KTQR_ASDSpdPhCompCout_Cnt = 1U;
                           /* Referenced by: '<S806>/KTQR_MotDampngLmtFac_c4' */
...
/* _versteckt */
CALDATA const volatile uint8 KVCU_EcuResetTrig_enum = 0U;
...
/* _versteckt */
CALDATA const volatile float32 KVSO_AirBlowArea_m2 = 4.251F;/* Referenced by: '<S529>/A' */
CALDATA const volatile float32 KVSO_AirResistCoeff_c = 0.3787F;/* Referenced by: '<S529>/Cd' */
CALDATA const volatile float32 KVSO_AvgXWhlDistErr1Fac_c = 0.0F;/* Referenced by: '<S513>/Cnst3' */
CALDATA const volatile float32 KVSO_AvgXWhlDistErr2Fac_c = 0.0F;/* Referenced by: '<S513>/Cnst1' */
CALDATA const volatile float32 KVSO_AvgXWhlDistErr3Fac_c = 1.0F;/* Referenced by: '<S513>/Cnst2' */
CALDATA const volatile float32 KVSO_AvgXWhlDistErr4Fac_c = 0.0F;/* Referenced by: '<S513>/Cnst4' */
CALDATA const volatile float32 KVSO_AvgXWhlDistErr5Fac_c = 0.0F;/* Referenced by: '<S513>/Cnst5' */
CALDATA const volatile float32 KVSO_DistErrHldSlip_kph = 1.0F;/* Referenced by: '<S517>/Cnst' */
CALDATA const volatile float32 KVSO_DistErrHldSpd_kph = 10.0F;/* Referenced by: '<S517>/Cnst2' */
CALDATA const volatile float32 KVSO_DistErrHldStrg_kph = 1.0F;/* Referenced by:
                                                               * '<S517>/Cnst1'
                                                               * '<S517>/Cnst3'
                                                               */
CALDATA const volatile float32 KVSO_IMUPosnXCmp_m = 1.6F;/* Referenced by:
                                                          * '<S451>/KVSO_IMUPosnXCmp_m'
                                                          * '<S452>/KVSO_IMUPosnXCmp_m'
                                                          */

/* 加速度传感器安装位置离质心纵向偏移 */
CALDATA const volatile float32 KVSO_IMUPosnYCmp_m = 0.35F;/* Referenced by:
                                                           * '<S451>/KVSO_IMUPosnYCmp_m'
                                                           * '<S452>/KVSO_IMUPosnYCmp_m'
                                                           */

/* 加速度传感器安装位置离质心横向偏移 */
CALDATA const volatile float32 KVSO_LatAccRawFiltTm_s = 0.04F;
                            /* Referenced by: '<S452>/KVSO_LatAccRawFiltTm_s' */

/* 横向加速度传感器处理滤波时间 */
CALDATA const volatile float32 KVSO_LatAccSnsrValOfst_mps2 = 0.025F;
                       /* Referenced by: '<S452>/KVSO_LatAccSnsrValOfst_mps2' */

/* 横向加速度传感器安装偏差纠正 */
CALDATA const volatile float32 KVSO_LgtAccRawFiltTm_s = 0.04F;
                            /* Referenced by: '<S451>/KVSO_LgtAccRawFiltTm_s' */

/* 纵向加速度传感器处理滤波时间 */
CALDATA const volatile float32 KVSO_LgtAccSnsrValOfst_mps2 = -0.355F;
                       /* Referenced by: '<S451>/KVSO_LgtAccSnsrValOfst_mps2' */

/* 纵向加速度传感器安装偏差纠正 */
CALDATA const volatile float32 KVSO_MassEstBrkPrsd_bar = 3.0F;
                           /* Referenced by: '<S529>/KVSO_MassEstBrkPrsd_bar' */

/* 液压大于此门槛时不进行车重估算 */
CALDATA const volatile float32 KVSO_MassEstBrkPrsd_pct = 2.0F;
                           /* Referenced by: '<S529>/KVSO_MassEstBrkPrsd_pct' */
CALDATA const volatile float32 KVSO_MassEstFrcLo_N = 300.0F;
                               /* Referenced by: '<S529>/KVSO_MassEstFrcLo_N' */

/* 驱动或回收力的绝对值小于此门槛时不进行车重估算 */
CALDATA const volatile float32 KVSO_MassEstPkInit_c = 1.0F;/* Referenced by:
                                                            * '<S529>/KVSO_MassEstPkInit_c'
                                                            * '<S529>/Unit Delay2'
                                                            */

/* 载重估算Pk初始值 */
CALDATA const volatile float32 KVSO_MassEstSpdLo_kph = 3.0F;
                             /* Referenced by: '<S529>/KVSO_MassEstSpdLo_kph' */
CALDATA const volatile float32 KVSO_MassEstYawRateHi_degps = 12.0F;
                       /* Referenced by: '<S529>/KVSO_MassEstYawRateHi_degps' */

/* 横摆角速度大于此门槛时不进行车重估算 */
CALDATA const volatile float32 KVSO_MassLoadTm_s = 60.0F;
                                 /* Referenced by: '<S529>/KVSO_MassLoadTm_s' */

/* 车辆装载或卸载货物时间门槛，停车货舱门打开超过此时间重新估算载重 */
CALDATA const volatile float32 KVSO_RSEAxSnsrFiltTm_s = 0.3F;
                            /* Referenced by: '<S482>/KVSO_RSEAxSnsrFiltTm_s' */

/* 用于坡道估计的纵向加速度传感器信号滤波时间 */
CALDATA const volatile float32 KVSO_RSEConfAxSnsrDerFiltTm_s = 0.7F;
                     /* Referenced by: '<S500>/KVSO_RSEConfAxSnsrDerFiltTm_s' */

/* 用于坡道估计的纵向加速度微分(冲击度)滤波时间 */
CALDATA const volatile float32 KVSO_RSEConfBrkPresrDerFiltTm_s = 0.7F;
                   /* Referenced by: '<S498>/KVSO_RSEConfBrkPresrDerFiltTm_s' */

/* 用于坡道估计的液压微分(变化率)滤波时间 */
CALDATA const volatile float32 KVSO_RSEConfBrkPresrDerMax_kPaps = 1000.0F;
                  /* Referenced by: '<S498>/KVSO_RSEConfBrkPresrDerMax_kPaps' */

/* 踩刹车液压变化率大于此门槛则不进行坡道估算 */
CALDATA const volatile float32 KVSO_RSEConfSpdDerFiltTm_s = 0.7F;
                        /* Referenced by: '<S500>/KVSO_RSEConfSpdDerFiltTm_s' */

/* 用于坡道估计的车速微分(减速度)滤波时间 */
CALDATA const volatile float32 KVSO_RSEConfStopSpdDer_mps2 = -0.5F;
                       /* Referenced by: '<S500>/KVSO_RSEConfStopSpdDer_mps2' */

/* 刹停时车辆减速度大于(负值，实际上是小于)此门槛则不进行坡道估算 */
CALDATA const volatile float32 KVSO_RSEConfStopVehSpdMax_mps = 0.5F;
                     /* Referenced by: '<S500>/KVSO_RSEConfStopVehSpdMax_mps' */

/* 用于坡道估计的刹停车速门槛，小于此值时若减速度较大则不进行估算 */
CALDATA const volatile float32 KVSO_RSEConfStrtAxSnsrDer_mps3 = 0.5F;
                    /* Referenced by: '<S500>/KVSO_RSEConfStrtAxSnsrDer_mps3' */

/* 低速时车辆起步冲击度大于此门槛则不进行坡道估算 */
CALDATA const volatile float32 KVSO_RSEConfStrtVehSpdMax_mps = 0.15F;
                     /* Referenced by: '<S500>/KVSO_RSEConfStrtVehSpdMax_mps' */

/* 用于坡道估计的车速起步门槛，小于此值时若冲击度较大则不进行估算 */
CALDATA const volatile float32 KVSO_RSEConfWhlSlipCfmTm_s = 0.2F;
                        /* Referenced by: '<S501>/KVSO_RSEConfWhlSlipCfmTm_s' */

/* 用于坡道估计的驱动轮和非驱动轮打滑确认时间 */
CALDATA const volatile float32 KVSO_RSEConfWhlSlipSpd_kph = 5.0F;
                        /* Referenced by: '<S501>/KVSO_RSEConfWhlSlipSpd_kph' */

/* 用于坡道估计的驱动轮和非驱动轮打滑判断速度差 */
CALDATA const volatile float32 KVSO_RSEConfYawRateDerFiltTm_s = 0.7F;
                    /* Referenced by: '<S502>/KVSO_RSEConfYawRateDerFiltTm_s' */

/* 用于坡道估计的横摆角速度微分(变化率)滤波时间 */
CALDATA const volatile float32 KVSO_RSEConfYawRateDerMax_degps2 = 8.0F;
                  /* Referenced by: '<S502>/KVSO_RSEConfYawRateDerMax_degps2' */

/* 横摆角速度微分(变化率)大于此门槛时不进行坡道估计 */
CALDATA const volatile float32 KVSO_RSEConfYawRateMax_degps = 10.0F;
                      /* Referenced by: '<S502>/KVSO_RSEConfYawRateMax_degps' */

/* 横摆角速度大于此门槛时不进行坡道估计 */
CALDATA const volatile float32 KVSO_RSEVehSpdDerFiltTm_s = 0.3F;
                         /* Referenced by: '<S482>/KVSO_RSEVehSpdDerFiltTm_s' */

/* 用于坡道估计的车速微分(变化率)滤波时间 */
CALDATA const volatile float32 KVSO_RoadSlopEstEnblDlyTm_s = 0.5F;
                       /* Referenced by: '<S481>/KVSO_RoadSlopEstEnblDlyTm_s' */

/* 当前整车条件满足以后切人此标定时间开始进行坡道估计 */
CALDATA const volatile float32 KVSO_RoadSlopEstFiltTm_s = 0.3F;
                          /* Referenced by: '<S481>/KVSO_RoadSlopEstFiltTm_s' */

/* 坡道估计原始值的滤波处理时间 */
CALDATA const volatile float32 KVSO_RoadSlopTqFiltTm_s = 0.06F;
                                 /* Referenced by: '<S483>/KTQD_CovVehSpd_c4' */
CALDATA const volatile float32 KVSO_RoadSlopTqMax_Nm = 1800.0F;
                                 /* Referenced by: '<S483>/KTQD_CovVehSpd_c5' */
CALDATA const volatile float32 KVSO_RoadSlopTqMin_Nm = -1800.0F;
                                 /* Referenced by: '<S483>/KTQD_CovVehSpd_c6' */
CALDATA const volatile float32 KVSO_RollgResistCoeff_c = 0.013F;/* Referenced by: '<S529>/f' */
CALDATA const volatile float32 KVSO_TPMSLrnReqCfmTm_s = 2.0F;/* Referenced by: '<S513>/Cnst7' */
CALDATA const volatile float32 KVSO_VehMassFiltTm_s = 0.2F;
                              /* Referenced by: '<S529>/KVSO_VehMassFiltTm_s' */
CALDATA const volatile float32 KVSO_VehResistPosTh_mps = 0.0556F;
                               /* Referenced by: '<S483>/KDAC_TapDwnTmOut_s5' */
CALDATA const volatile float32 KVSO_VehSpdFiltTm_s = 0.05F;/* Referenced by: '<S529>/Const' */
CALDATA const volatile float32 KVSO_VehTransEff_c = 0.92F;
                                /* Referenced by: '<S534>/KVSO_VehTransEff_c' */
CALDATA const volatile float32 KVSO_WhlDistErrRecThr_m = 250.0F;
                              /* Referenced by: '<S526>/KVSO_SpdErrRecDist_m' */
CALDATA const volatile float32 KVSO_WhlDistErrRefRecThr_m = 2000.0F;
                             /* Referenced by: '<S526>/KVSO_SpdErrRecDist_m1' */
CALDATA const volatile float32 KVSO_WhlLgtFrcFiltTm_s = 0.05F;
                           /* Referenced by: '<S529>/KVSO_MotorActTqFiltTm_s' */

/* 轮胎纵向力滤波时间 */
CALDATA const volatile float32 KVSO_WhlMomOfJ_kgm2 = 3.5F;/* Referenced by:
                                                           * '<S536>/KVSO_WhlMomOfJ_kgm2'
                                                           * '<S537>/KVSO_WhlMomOfJ_kgm2'
                                                           * '<S538>/KVSO_WhlMomOfJ_kgm2'
                                                           * '<S539>/KVSO_WhlMomOfJ_kgm2'
                                                           */

/* 轮胎转动惯量 */
CALDATA const volatile float32 KVSO_XWhlDistErrExcd_mpkm = 1.8F;/* Referenced by: '<S513>/Cnst6' */
CALDATA const volatile float32 KVSO_YawRateFiltTm_s = 0.04F;
                              /* Referenced by: '<S453>/KVSO_YawRateFiltTm_s' */

/* 原始横摆角速度值转换成radps后滤波时间 */
CALDATA const volatile float32 KVSO_YawRateRawFiltTm_s = 0.035F;
                           /* Referenced by: '<S453>/KVSO_YawRateRawFiltTm_s' */

/* 原始横摆角速度处理滤波时间 */
CALDATA const volatile float32 KVTM_BrkLampOffRegenTq_Nm = -620.0F;/* Referenced by: '<S885>/Constant8' */
CALDATA const volatile float32 KVTM_BrkLampOnRegenTq_Nm = -670.0F;/* Referenced by: '<S885>/Constant9' */
CALDATA const volatile float32 KVTM_BrkPedReld_pct = 2.0F;
                             /* Referenced by: '<S878>/KTQD_BrkPedPstnHi_pct' */
CALDATA const volatile boolean KVTM_DrvTqReq2ESCUseTqd_flg = false;
                               /* Referenced by: '<S886>/KSYS_VehTransRto_c3' */

/* 标成true时送给底盘的驾驶员扭矩需求为TQD计算值 */
CALDATA const volatile float32 KVTM_MotorMaxDrvPwr_kW = 160.0F;
                               /* Referenced by: '<S887>/KSYS_VehTransRto_c2' */
CALDATA const volatile float32 KVTM_MotorMaxRegenPwr_kW = -50.0F;
                               /* Referenced by: '<S887>/KSYS_VehTransRto_c1' */
CALDATA const volatile float32 KVTM_MotorPwrTypeRecup_Nm = -2.8F;
                               /* Referenced by: '<S887>/KSYS_VehTransRto_c4' */
CALDATA const volatile float32 KVTM_MotorSpdFiltCoeff_rat = 0.65F;
                        /* Referenced by: '<S878>/KVTM_MotorSpdFiltCoeff_rat' */
CALDATA const volatile float32 KVTM_VehAcceltnFiltCoeff_rat = 0.93F;
                               /* Referenced by: '<S878>/KDAC_TapDwnTmOut_s1' */
CALDATA const volatile float32 KVTM_VehAcceltnMax_mps2 = 10.0F;/* Referenced by: '<S878>/Saturation1' */
CALDATA const volatile float32 KVTM_VehAcceltnMin_mps2 = -10.0F;/* Referenced by: '<S878>/Saturation1' */
CALDATA const volatile float32 KVTM_VehSpdFiltCoeff_rat = 0.5F;
                       /* Referenced by: '<S878>/KVTM_MotorSpdFiltCoeff_rat1' */
...
CALDATA const volatile float32 MCPT_Pwr2MotorTqGen_Nm[616] = { -330.0F, -330.0F,
  ...
  -17.7531929F, -14.2077513F, -10.6623106F, -5.51513052F, -2.2060523F, 0.0F } ;
                           /* Referenced by: '<S551>/MCPT_Pwr2MotorTqMot_Nm1' */
...
CALDATA const volatile float32 MDAC_ACCDsrdTqKi_c[225] = { 1125.0F, 1215.0F,
  ...
  1346.0F, 1285.0F, 1215.0F, 1125.0F } ;
                       /* Referenced by: '<S579>/MDAC_CCSDsrdTqKi_fac_IntTbl' */
...
CALDATA const volatile float32 MDAC_ACCDsrdTqKp_c[15] = { 2000.0F, 1000.0F,
  ...
  600.0F, 1000.0F, 2000.0F } ;
                       /* Referenced by: '<S579>/MDAC_CCSDsrdTqKp_fac_IntTbl' */

CALDATA const volatile float32 MDAC_ACCOvrdTqOff_Nm[7] = { 5.0F, 5.0F, 5.0F,
  5.0F, 5.0F, 5.0F, 5.0F } ; /* Referenced by: '<S573>/MTQD_CstTqReqWhlS_Nm1' */

CALDATA const volatile float32 MDAC_ACCOvrdTqOn_Nm[7] = { 20.0F, 20.0F, 20.0F,
  20.0F, 20.0F, 20.0F, 20.0F } ;
                              /* Referenced by: '<S573>/MTQD_CstTqReqWhlS_Nm' */
...
CALDATA const volatile float32 MDAC_CCDsrdAcceltn_mps2[126] = { -0.9F, -0.9F,
  ...
  1.1F, 1.0F, 1.0F, 1.0F, 1.2F, 1.2F, 1.1F, 1.0F, 1.0F, 1.0F } ;
                    /* Referenced by: '<S599>/MTQD_TqRateLimEndErr_Nm_IntTbl' */
...
CALDATA const volatile float32 MDAC_CCDsrdTqKi_c[225] = { 100.0F, 100.0F, 100.0F,
  ...
  1440.0F, 1384.0F, 1285.0F, 1285.0F, 1125.0F } ;
                       /* Referenced by: '<S606>/MDAC_CCSDsrdTqKi_fac_IntTbl' */
...
CALDATA const volatile float32 MDAC_CCDsrdTqKp_c[15] = { 2000.0F, 800.0F, 600.0F,
  ...
  1000.0F, 2000.0F } ; /* Referenced by: '<S606>/MDAC_CCSDsrdTqKp_fac_IntTbl' */
...
CALDATA const volatile float32 MDAC_HDCDsrdTqKi_c[225] = { 1125.0F, 1215.0F,
  ...
  1800.0F, 1714.0F, 1615.0F, 1520.0F, 1480.0F, 1462.0F, 1435.0F, 1398.0F,
  1346.0F, 1285.0F, 1215.0F, 1125.0F } ;
                       /* Referenced by: '<S672>/MDAC_CCSDsrdTqKi_fac_IntTbl' */

CALDATA const volatile float32 MDAC_HDCDsrdTqKp_c[15] = { 2000.0F, 1000.0F,
  600.0F, 500.0F, 400.0F, 200.0F, 0.0F, 0.0F, 0.0F, 200.0F, 400.0F, 500.0F,
  600.0F, 1000.0F, 2000.0F } ;
                       /* Referenced by: '<S672>/MDAC_CCSDsrdTqKp_fac_IntTbl' */
...
CALDATA const volatile float32 MDAC_HDCTgtAcceltn_mps2[16] = { -2.0F, -2.0F,
  ...
  0.5F, 0.8F, 1.1F } ;           /* Referenced by: '<S670>/1-D Lookup Table3' */
...
CALDATA const volatile float32 MDAC_INVMaxDrgTqWhl_Nm[12] = { 0.0F, 0.0F,
  ...
  -2000.0F, -2000.0F } ;         /* Referenced by: '<S568>/1-D Lookup Table1' */
...
CALDATA const volatile float32 MDSA_MildDrvMap_mps2[15] = { 1.5F, 1.4F, 1.3F,
  1.0F, 0.7F, 0.5F, 0.3F, 0.25F, 0.2F, 0.2F, 0.18F, 0.15F, 0.1F, 0.05F, 0.05F } ;
                         /* Referenced by: '<S72>/MTQD_RegenTqBrk_Nm_IntTbl3' */
...
CALDATA const volatile float32 MDSA_SprtIdxHldINVTq_Nm[15] = { -999.0F, -999.0F,
  ...
  -999.0F, -999.0F, -999.0F, -999.0F, -999.0F } ;
                         /* Referenced by: '<S72>/MTQD_RegenTqBrk_Nm_IntTbl4' */
...
CALDATA const volatile float32 MDSA_VehDrgTq_Nm[15] = { 43.0F, 48.0F, 55.0F,
  ...
  304.0F, 342.0F } ;     /* Referenced by: '<S72>/MTQD_RegenTqBrk_Nm_IntTbl1' */
...
CALDATA const volatile float32 MDSA_WildDrvMap_mps2[15] = { 4.5F, 4.0F, 3.8F,
  3.6F, 3.5F, 3.2F, 3.0F, 2.6F, 2.2F, 1.8F, 1.5F, 1.0F, 0.5F, 0.3F, 0.3F } ;
                         /* Referenced by: '<S72>/MTQD_RegenTqBrk_Nm_IntTbl2' */

CALDATA const volatile float32 MEMS_CellOverVoltBgn_mV[10] = { 3700.0F, 3700.0F,
  3700.0F, 3700.0F, 3700.0F, 3700.0F, 3700.0F, 3700.0F, 3700.0F, 3700.0F } ;/* Referenced by: '<S903>/PwrDrt2' */

/* 过压修正Begin值（优先使用过压闭环） */
CALDATA const volatile float32 MEMS_CellOverVoltRng_mV[10] = { 40.0F, 40.0F,
  40.0F, 40.0F, 40.0F, 40.0F, 40.0F, 40.0F, 40.0F, 40.0F } ;/* Referenced by: '<S903>/PwrDrt4' */

/* 过压修正Range值（优先使用过压闭环） */
CALDATA const volatile float32 MEMS_CellOverVoltThr_mV[10] = { 3650.0F, 3650.0F,
  3650.0F, 3650.0F, 3650.0F, 3650.0F, 3650.0F, 3650.0F, 3650.0F, 3650.0F } ;/* Referenced by: '<S961>/PwrDrt' */

/* 过压闭环控制目标电压 */
CALDATA const volatile float32 MEMS_CellTempLoThr_C[10] = { 0.0F, 0.0F, 0.0F,
  0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F } ;/* Referenced by: '<S908>/PwrDrt4' */

/* 电芯常温和低温区分值 */
CALDATA const volatile float32 MEMS_CellTempMinFac_rat[5] = { 1.0F, 1.0F, 0.0F,
  0.0F, 0.0F } ;                 /* Referenced by: '<S908>/MTQD_TMOverDrt_c5' */

/* 电芯温度切换过渡系数 */
CALDATA const volatile float32 MEMS_CellUndrVoltBgn1_mV[10] = { 2300.0F, 2300.0F,
  2300.0F, 2300.0F, 2300.0F, 2300.0F, 2300.0F, 2300.0F, 2300.0F, 2300.0F } ;/* Referenced by: '<S905>/PwrDrt' */

/* 低温放电欠压修正Begin值（优先使用电压闭环） */
CALDATA const volatile float32 MEMS_CellUndrVoltBgn2_mV[10] = { 2700.0F, 2700.0F,
  2700.0F, 2700.0F, 2700.0F, 2700.0F, 2700.0F, 2700.0F, 2700.0F, 2700.0F } ;/* Referenced by: '<S905>/PwrDrt1' */

/* 常温放电欠压修正Begin值(优先使用电压闭环) */
CALDATA const volatile float32 MEMS_CellUndrVoltRng1_mV[10] = { 100.0F, 100.0F,
  100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F } ;/* Referenced by: '<S905>/PwrDrt2' */

/* 低温放电欠压修正Rang值（优先使用电压闭环） */
CALDATA const volatile float32 MEMS_CellUndrVoltRng2_mV[10] = { 150.0F, 150.0F,
  150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F } ;/* Referenced by: '<S905>/PwrDrt3' */

/* 常温放电欠压修正Rang值(优先使用电压闭环) */
CALDATA const volatile float32 MEMS_CellUndrVoltThr1_mV[10] = { 2400.0F, 2400.0F,
  2400.0F, 2400.0F, 2400.0F, 2400.0F, 2400.0F, 2400.0F, 2400.0F, 2400.0F } ;/* Referenced by: '<S962>/PwrDrt' */

/* 低温电压闭环控制目标电压 */
CALDATA const volatile float32 MEMS_CellUndrVoltThr2_mV[10] = { 2800.0F, 2800.0F,
  2800.0F, 2800.0F, 2800.0F, 2800.0F, 2800.0F, 2800.0F, 2800.0F, 2800.0F } ;/* Referenced by: '<S962>/PwrDrt1' */
...
CALDATA const volatile float32 MEMS_ChrgPwrFbKi_c[15] = { 0.5F, 0.5F, 0.5F, 0.2F,
  0.2F, 5.4F, 5.4F, 5.4F, 5.4F, 5.4F, 5.4F, 5.4F, 5.4F, 5.4F, 5.4F } ;
                                 /* Referenced by: '<S923>/lu1d_BatLimHiSoC1' */
...
CALDATA const volatile float32 MEMS_DchaCurFbKi_c[15] = { 3.0F, 2.0F, 1.5F, 1.5F,
  1.5F, 1.5F, 1.5F, 1.5F, 1.5F, 1.5F, 0.05F, 0.1F, 0.1F, 0.1F, 0.15F } ;
                                 /* Referenced by: '<S962>/lu1d_BatLimHiSoC1' */
...
CALDATA const volatile float32 MEMS_DchaPwrFbKi_c[15] = { 5.4F, 5.4F, 5.4F, 5.4F,
  5.4F, 5.4F, 5.4F, 5.4F, 5.4F, 5.4F, 0.2F, 0.2F, 0.5F, 0.5F, 0.5F } ;
                                 /* Referenced by: '<S941>/lu1d_BatLimHiSoC1' */
...
CALDATA const volatile float32 MEMS_MaxInsChrgCurrFac_c[100] = { 1.0F, 1.0F,
  ...
  1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F } ;
                 /* Referenced by: '<S903>/Lookup2D_MEMS_MaxInsDchaCurrFac_c' */
...
CALDATA const volatile float32 MEMS_MaxInsDchaCurrFac_c[100] = { 1.0F, 1.0F,
  ...
  1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F,
  1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F } ;
                 /* Referenced by: '<S905>/Lookup2D_MEMS_MaxInsDchaCurrFac_c' */
...
CALDATA const volatile float32 MHVM_BMSCelMaxVol_mV[10] = { 3660.0F, 3660.0F,
  3660.0F, 3660.0F, 3660.0F, 3660.0F, 3660.0F, 3660.0F, 3660.0F, 3660.0F } ;
                             /* Referenced by: '<S1519>/MHVM_BMSCelMaxVol_mV' */
...
CALDATA const volatile float32 MHVM_BMSTotMaxVol_V[10] = { 453.0F, 453.0F,
  453.0F, 453.0F, 453.0F, 453.0F, 453.0F, 453.0F, 453.0F, 453.0F } ;
                              /* Referenced by: '<S1519>/MHVM_BMSTotMaxVol_V' */
...
CALDATA const volatile float32 MIBS_IBSEnMinSOC_pct[10] = { 10.0F, 10.0F, 10.0F,
  10.0F, 10.0F, 10.0F, 10.0F, 10.0F, 10.0F, 10.0F } ;
                              /* Referenced by: '<S260>/MIBS_IBSEnMinSOC_pct' */

/* IBS补电动力电池SOC阈值_versteckt */
CALDATA const volatile float32 MIBS_MustChrgVolt_V[6] = { 12.3F, 12.3F, 12.3F,
  12.3F, 12.3F, 12.3F } ;      /* Referenced by: '<S261>/MIBS_MustChrgVolt_V' */
...
CALDATA const volatile uint16 MIBS_NextRtcWupThr_min[60] = { 120U, 120U, 120U,
  ...
  330U, 300U, 300U, 240U } ;/* Referenced by: '<S261>/MIBS_NextRtcWupThr_min' */
...
} ;                           /* Referenced by: '<S261>/MIBS_WupChgTmThr_min' */
...
CALDATA const volatile float32 MIPC_TireRadius_m[6] = { 0.3412F, 0.3412F,
  0.3412F, 0.3412F, 0.3412F, 0.3412F } ;
                                     /* Referenced by: '<S366>/TireSizeTable' */
...
CALDATA const volatile float32 MRME_CHTCStdRmnMil_km[120] = { 0.0F, 0.0F, 0.0F,
  ...
  280.0F, 278.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F } ;
                             /* Referenced by: '<S207>/MRME_CHTCStdRmnMil_km' */
...
CALDATA const volatile float32 MRME_WLTPStdDwLimFac_c[6] = { 0.4F, 0.5F, 0.6F,
  0.7F, 0.8F, 0.9F } ;         /* Referenced by: '<S216>/MRME_WLTPDwLimFac_c' */

/* 基于标准续航WLTP最小下限系数(使用电芯温度修正) */
CALDATA const volatile float32 MRME_WLTPStdPwrCnsm_kWh100km[10] = { 28.0F, 30.0F,
  30.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F } ;/* Referenced by: '<S211>/  ' */
...
CALDATA const volatile float32 MRME_WLTPStdRmnMil_km[120] = { 0.0F, 0.0F, 0.0F,
  ...
  285.0F, 285.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F } ;/* Referenced by:
                                                               * '<S216>/MRME_WLTPStdRmnMil_km'
                                                               * '<S216>/MRME_WLTPStdRmnMil_km1'
                                                               */
...
CALDATA const volatile float32 MRME_WLTPStdSOCCnsm_pct100km[10] = { 50.0F, 37.0F,
  35.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F } ;
                     /* Referenced by: '<S240>/MRME_WLTPStdSOCCnsm_pct100km ' */
...
CALDATA const volatile float32 MTQC_RegenMaxTqDecRate_Nmps[20] = { -10000.0F,
  ...
  -10000.0F, -10000.0F, -10000.0F, -10000.0F, -10000.0F } ;
                    /* Referenced by: '<S699>/MTQD_TqRateLimEndErr_Nm_IntTbl' */
...
CALDATA const volatile float32 MTQC_RegenMaxTqIncRate_Nmps[8] = { 12000.0F,
  12000.0F, 10000.0F, 10000.0F, 8000.0F, 5000.0F, 1000.0F, 500.0F } ;
                              /* Referenced by: '<S699>/MTQD_CstTqReqWhlS_Nm' */

CALDATA const volatile float32 MTQD_AdaptCstAcceltnReqWhlEndPstn_mps2[14] = {
  0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
  0.0F } ;                   /* Referenced by: '<S734>/MTQD_CstTqReqWhlS_Nm2' */
...
CALDATA const volatile float32 MTQD_AdaptCstAcceltnReqWhlS_mps2[14] = { 0.0F,
  ...
  -2.0F, -2.0F } ;            /* Referenced by: '<S734>/MTQD_CstTqReqWhlS_Nm' */
...
CALDATA const volatile float32 MTQD_AdaptCstAcceltnReqWhlW_mps2[14] = { 0.0F,
  ...
  -1.0F, -1.0F } ;           /* Referenced by: '<S734>/MTQD_CstTqReqWhlS_Nm1' */
...
CALDATA const volatile float32 MTQD_AdaptCstDsrdTqKi_c[225] = { 1125.0F, 1285.0F,
  ...
  600.0F, 550.0F, 550.0F, 550.0F, 550.0F, 500.0F } ;
                       /* Referenced by: '<S734>/MDAC_CCSDsrdTqKi_fac_IntTbl' */

CALDATA const volatile float32 MTQD_AdaptCstDsrdTqKp_c[15] = { 2000.0F, 1000.0F,
  600.0F, 500.0F, 400.0F, 200.0F, 0.0F, 0.0F, 0.0F, 200.0F, 400.0F, 500.0F,
  600.0F, 1000.0F, 2000.0F } ;
                       /* Referenced by: '<S734>/MDAC_CCSDsrdTqKp_fac_IntTbl' */
...
CALDATA const volatile float32 MTQD_AdaptCstMaxTqWhl_Nm[14] = { 0.0F, -20.0F,
  ...
  -1600.0F, -1600.0F, -1600.0F, -1600.0F } ;
                             /* Referenced by: '<S730>/MTQD_CstTqReqWhlS_Nm4' */
...
CALDATA const volatile float32 MTQD_AdaptCstMinTqWhl_Nm[14] = { 0.0F, -20.0F,
  ...
  -30.0F, -30.0F } ;         /* Referenced by: '<S730>/MTQD_CstTqReqWhlS_Nm3' */
...
CALDATA const volatile float32 MTQD_CstRegenEndPstnA_pct[15] = { 0.0F, 1.0F,
  ...
  12.0F } ;                  /* Referenced by: '<S729>/MTQD_CstTqReqWhlA_Nm1' */
...
CALDATA const volatile float32 MTQD_CstRegenEndPstnS_pct[15] = { 0.0F, 1.0F,
  ...
  15.0F } ;                  /* Referenced by: '<S729>/MTQD_CstTqReqWhlS_Nm2' */
...
CALDATA const volatile float32 MTQD_CstRegenEndPstnV_pct[14] = { 15.0F, 15.0F,
  ...
  15.0F } ;                      /* Referenced by: '<S729>/1-D Lookup Table1' */
...
CALDATA const volatile float32 MTQD_CstRegenEndPstnW_pct[15] = { 0.0F, 1.0F,
  ...
  10.0F } ;                  /* Referenced by: '<S729>/MTQD_CstTqReqWhlS_Nm3' */
...
CALDATA const volatile float32 MTQD_CstRegenTqReqWhlInc_Nmps[8] = { 200.0F,
  200.0F, 800.0F, 1500.0F, 3000.0F, 5000.0F, 6000.0F, 8000.0F } ;
                             /* Referenced by: '<S731>/MTQD_CstTqReqWhlS_Nm3' */
...
CALDATA const volatile float32 MTQD_CstRegenTqReqWhlOff_Nm[70] = { 0.0F, 0.0F,
  ...
  -145.0F, -145.0F } ;     /* Referenced by: '<S728>/MTQD_PedMapBasTqEco_pct' */
...
CALDATA const volatile float32 MTQD_CstRegenTqReqWhlR_Nm[12] = { -100.0F,
  ...
  0.0F, 0.0F } ;                 /* Referenced by: '<S728>/1-D Lookup Table2' */

CALDATA const volatile float32 MTQD_CstRegenTqReqWhlS_Nm[14] = { 0.0F, -20.0F,
  -20.0F, -30.0F, -50.0F, -135.0F, -377.0F, -586.0F, -616.0F, -624.0F, -585.0F,
  -536.0F, -425.0F, -261.0F } ;
                              /* Referenced by: '<S728>/MTQD_CstTqReqWhlS_Nm' */
...
CALDATA const volatile float32 MTQD_CstRegenTqReqWhlW_Nm[14] = { 0.0F, -20.0F,
  ...
  -230.0F, -200.0F, -145.0F } ;
                             /* Referenced by: '<S728>/MTQD_CstTqReqWhlS_Nm1' */
...
CALDATA const volatile float32 MTQD_FwdFullPedDrvTqWhlSprt_Nm[19] = { 4000.0F,
  ...
  1245.42F, 1147.74F } ;         /* Referenced by: '<S721>/MTQD_PTBaseTq_Nm1' */

CALDATA const volatile float32 MTQD_FwdFullPedDrvTqWhl_Nm[19] = { 4000.0F,
  4000.0F, 4000.0F, 4000.0F, 4000.0F, 4000.0F, 4000.0F, 4000.0F, 3907.2F,
  3528.69F, 3174.6F, 2808.3F, 2380.95F, 2039.07F, 1807.08F, 1562.88F, 1404.15F,
  1245.42F, 1147.74F } ;          /* Referenced by: '<S721>/MTQD_PTBaseTq_Nm' */
...
CALDATA const volatile float32 MTQD_FwdPedMapNorm_pct[378] = { 0.0F, 0.0F, 0.0F,
  ...
  100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F,
  100.0F, 100.0F } ;      /* Referenced by: '<S721>/MTQD_PedMapBasTqEco_pct3' */
...
CALDATA const volatile float32 MTQD_FwdPedMapSnow_pct[378] = { 0.0F, 0.0F, 0.0F,
  ...
  92.0F, 92.0F, 92.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F,
  100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F, 100.0F,
  100.0F } ;               /* Referenced by: '<S721>/MTQD_PedMapBasTqEco_pct' */
...
CALDATA const volatile float32 MTQD_LimpHomeMaxTq_Nm[8] = { 828.0F, 828.0F,
  1000.0F, 1500.0F, 1300.0F, 1000.0F, 828.0F, 828.0F } ;
                             /* Referenced by: '<S716>/MTQD_CstTqReqWhlS_Nm2' */
...
CALDATA const volatile float32 MTQD_TqDrtFacMotorSpd_c[5] = { 0.0F, 1.0F, 1.0F,
  1.0F, 0.0F } ;                  /* Referenced by: '<S758>/MTQD_TMOverDrt_c' */
...
CALDATA const volatile float32 MTQD_WhlSpdDiffMaxTqFac_c[10] = { 1.0F, 1.0F,
  0.9F, 0.85F, 0.8F, 0.6F, 0.4F, 0.2F, 0.1F, 0.0F } ;
                              /* Referenced by: '<S716>/MTQD_CstTqReqWhlS_Nm' */
...
CALDATA const volatile float32 MTQD_WhlSpdDiffMaxTq_Nm[10] = { 4000.0F, 4000.0F,
  3600.0F, 3000.0F, 2000.0F, 1200.0F, 800.0F, 400.0F, 100.0F, 0.0F } ;
                             /* Referenced by: '<S716>/MTQD_CstTqReqWhlS_Nm1' */
...
CALDATA const volatile float32 MTQF_IncEndRateFiltTmSMode_s[12] = { 0.1F, 0.2F,
  0.15F, 0.1F, 0.05F, 0.03F, 0.02F, 0.02F, 0.02F, 0.02F, 0.02F, 0.02F } ;
                              /* Referenced by: '<S778>/MTQD_CstTqReqWhlS_Nm' */
...
CALDATA const volatile float32 MTQF_IncEndRateFiltTm_s[12] = { 0.1F, 0.2F, 0.15F,
  0.1F, 0.08F, 0.07F, 0.06F, 0.06F, 0.05F, 0.05F, 0.05F, 0.05F } ;
                             /* Referenced by: '<S778>/MTQD_CstTqReqWhlS_Nm1' */
...
CALDATA const volatile float32 MTQF_IncStartRateFiltTmACC_s[12] = { 0.05F, 0.03F,
  0.03F, 0.03F, 0.03F, 0.03F, 0.03F, 0.03F, 0.03F, 0.03F, 0.02F, 0.02F } ;
                             /* Referenced by: '<S778>/MTQD_CstTqReqWhlS_Nm2' */
...
CALDATA const volatile float32 MTQF_IncStartRateFiltTmSMode_s[12] = { 0.05F,
  0.03F, 0.03F, 0.03F, 0.03F, 0.03F, 0.03F, 0.03F, 0.03F, 0.03F, 0.02F, 0.02F } ;
                             /* Referenced by: '<S778>/MTQD_CstTqReqWhlS_Nm3' */
...
CALDATA const volatile float32 MTQF_IncStartRateFiltTm_s[12] = { 0.1F, 0.2F,
  0.2F, 0.15F, 0.15F, 0.1F, 0.05F, 0.03F, 0.03F, 0.03F, 0.02F, 0.02F } ;
                             /* Referenced by: '<S778>/MTQD_CstTqReqWhlS_Nm4' */
...
CALDATA const volatile float32 MTQF_TqRateDecMaxRegenE_Nmps[91] = { -1500.0F,
  ...
  -2000.0F, -2000.0F, -2000.0F, -2000.0F, -2000.0F, -2000.0F, -2000.0F, -2000.0F,
  -2000.0F, -2000.0F } ;
                   /* Referenced by: '<S777>/MTQD_TqRateLimEndErr_Nm_IntTbl3' */
...
CALDATA const volatile float32 MTQF_TqRateDecMaxRegenN_Nmps[91] = { -2000.0F,
  ...
  -3000.0F, -3000.0F, -3000.0F, -3000.0F, -3000.0F, -3000.0F, -3000.0F, -3000.0F,
  -3000.0F, -3000.0F } ;
                   /* Referenced by: '<S777>/MTQD_TqRateLimEndErr_Nm_IntTbl5' */
...
CALDATA const volatile float32 MTQF_TqRateDecMaxRegenS_Nmps[91] = { -2000.0F,
  ...
  -3000.0F, -3000.0F, -3000.0F, -3000.0F, -3000.0F, -3000.0F, -3000.0F, -3000.0F,
  -3000.0F, -3000.0F } ;
                   /* Referenced by: '<S777>/MTQD_TqRateLimEndErr_Nm_IntTbl4' */
...
CALDATA const volatile float32 MTQF_TqRateIncMaxE_Nmps[156] = { 1635.0F, 1635.0F,
  ...
  4905.0F, 5450.0F, 5995.0F, 7085.0F, 7085.0F, 2180.0F, 2180.0F, 2180.0F,
  2180.0F, 3379.0F, 3379.0F, 3815.0F, 4905.0F, 5450.0F, 5995.0F, 7085.0F,
  7085.0F } ;       /* Referenced by: '<S778>/MTQD_TqRateLimEndErr_Nm_IntTbl' */
...
CALDATA const volatile float32 MTQF_TqRateIncMaxN_Nmps[156] = { 2180.0F, 2180.0F,
  ...
  2725.0F, 2725.0F, 3924.0F, 3924.0F, 4360.0F, 4360.0F, 6540.0F, 7630.0F,
  8720.0F, 10900.0F } ;
                   /* Referenced by: '<S778>/MTQD_TqRateLimEndErr_Nm_IntTbl2' */
...
CALDATA const volatile float32 MTQF_TqRateIncMaxS_Nmps[156] = { 2725.0F, 2725.0F,
  ...
  4905.0F, 5014.0F, 7630.0F, 7630.0F, 8175.0F, 8175.0F, 9265.0F, 9810.0F,
  10900.0F, 10900.0F } ;
                   /* Referenced by: '<S778>/MTQD_TqRateLimEndErr_Nm_IntTbl1' */
...
CALDATA const volatile float32 MTQF_TqRateLimEndErrE_Nm[154] = { 200.0F, 200.0F,
  ...
  150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F,
  150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F, 150.0F,
  150.0F, 150.0F } ;/* Referenced by: '<S776>/MTQD_TqRateLimEndErr_Nm_IntTbl' */
...
CALDATA const volatile float32 MTZX_ZeroTqOfstDec_Nm[80] = { -1.0F, -1.0F, -1.0F,
  ...
  1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F } ;
                                 /* Referenced by: '<S836>/2-D Lookup Table1' */
...
CALDATA const volatile float32 MTZX_ZeroTqOfstInc_Nm[80] = { 1.0F, 1.0F, 1.0F,
  ...
  1.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F } ;
                                  /* Referenced by: '<S836>/2-D Lookup Table' */
...
CALDATA const volatile float32 MTZX_ZeroXTmDec_s[80] = { 0.12F, 0.12F, 0.12F,
  ...
  0.05F, 0.05F, 0.05F, 0.05F, 0.05F, 0.05F, 0.05F, 0.05F, 0.05F, 0.05F, 0.05F } ;
                                 /* Referenced by: '<S836>/2-D Lookup Table2' */
...
CALDATA const volatile float32 MTZX_ZeroXTmInc_s[80] = { 0.1F, 0.1F, 0.1F, 0.1F,
  ...
  0.05F, 0.05F, 0.05F, 0.05F, 0.05F, 0.05F } ;
                                 /* Referenced by: '<S836>/2-D Lookup Table3' */

CALDATA const volatile float32 MVTM_ActPwrBacklash_kW[8] = { 0.0F, 0.0F, 0.2F,
  0.4F, 0.6F, 1.0F, 1.5F, 1.5F } ;     /* Referenced by: '<S892>/Dbnd' */
...
CALDATA const volatile float32 MVTM_MotorMaxDrvTqWT_Nm[23] = { 280.0F, 280.0F,
  ...
  85.0F } ;                       /* Referenced by: '<S887>/MTQD_PTBaseTq_Nm' */
