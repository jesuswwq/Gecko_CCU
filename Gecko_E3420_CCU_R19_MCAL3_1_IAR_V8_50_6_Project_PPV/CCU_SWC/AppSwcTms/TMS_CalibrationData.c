...
CALDATA const volatile uint8 ACDefog = 15U;/* Referenced by: '<S390>/Constant7' */
CALDATA const volatile uint8 ACOff = 8U;/* Referenced by:
                                         ...
                                         * '<S231>/Constant'
                                         */
CALDATA const volatile uint8 AC_ColdStart = 1U;/* Referenced by: '<S52>/ColdStart' */
CALDATA const volatile uint8 AC_HotStart = 2U;/* Referenced by:
                                               * '<S52>/HotStart'
                                               * '<S53>/HotStart'
                                               * '<S128>/Constant26'
                                               */
CALDATA const volatile uint8 AC_LittleColdStart = 3U;/* Referenced by: '<S52>/ColdStart6' */
...
CALDATA const volatile uint8 RECIRC = 100U;/* Referenced by:
                                            ...
                                            * '<S147>/Constant4'
                                            */
CALDATA const volatile float32 cal_ACBatHeatEnvTemp[2] = { 5.0F, 15.0F } ;/* Referenced by: '<S1509>/Constant1' */

CALDATA const volatile float32 cal_ACBatHeatT1[3] = { 0.0F, 0.0F, 0.0F } ;/* Referenced by: '<S1509>/Constant2' */

CALDATA const volatile float32 cal_ACBatHeatT2[3] = { 5.0F, 5.0F, 5.0F } ;/* Referenced by: '<S1509>/Constant3' */

CALDATA const volatile float32 cal_ACBatHeatTave[3] = { 10.0F, 10.0F, 10.0F } ;/* Referenced by: '<S1509>/Constant' */

CALDATA const volatile float32 cal_ACBatHeatTrgTemp = 45.0F;/* Referenced by:
                                                             * '<S650>/Constant5'
                                                             * '<S1509>/Constant4'
                                                             */
CALDATA const volatile float32 cal_ACCMClsEnvTemp = -14.0F;/* Referenced by: '<S446>/Relay' */
CALDATA const volatile float32 cal_ACCMCtlDownlmt = 30.0F;/* Referenced by: '<S569>/Constant2' */
CALDATA const volatile float32 cal_ACCMCtlKiDeadzoneNeg = 0.5F;/* Referenced by: '<S450>/Constant9' */
CALDATA const volatile float32 cal_ACCMCtlKiDeadzonePos = 0.5F;/* Referenced by: '<S450>/Constant8' */
CALDATA const volatile float32 cal_ACCMCtlKpDeadzoneNeg = 0.5F;/* Referenced by: '<S450>/Constant10' */
CALDATA const volatile float32 cal_ACCMCtlKpDeadzonePos = 0.5F;/* Referenced by: '<S450>/Constant11' */
CALDATA const volatile float32 cal_ACCMCtlPID_IsumMax = 4000.0F;/* Referenced by: '<S450>/Constant13' */
CALDATA const volatile float32 cal_ACCMCtlPID_IsumMin = -4000.0F;/* Referenced by: '<S450>/Constant12' */
CALDATA const volatile float32 cal_ACCMCtlUplmt = 15.0F;/* Referenced by: '<S569>/Constant1' */
CALDATA const volatile float32 cal_ACCMCtrlA1FF_1X[6] = { -15.0F, -10.0F, -5.0F,
  5.0F, 10.0F, 15.0F } ;      /* Referenced by: '<S584>/cal_ACCMCtrlA1FF_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlA2FF_2X[6] = { -10.0F, -5.0F, 0.0F,
  5.0F, 10.0F, 15.0F } ;     /* Referenced by: '<S584>/cal_ACCMCtrlA2FF_MAP ' */

CALDATA const volatile float32 cal_ACCMCtrlA2FF_2Y[5] = { 1.0F, 2.0F, 3.0F, 4.0F,
  5.0F } ;                   /* Referenced by: '<S584>/cal_ACCMCtrlA2FF_MAP ' */
...
CALDATA const volatile float32 cal_ACCMCtrlACct = 1.1F;/* Referenced by:
                                                        ...
                                                        * '<S589>/Constant2'
                                                        */
CALDATA const volatile float32 cal_ACCMCtrlADeadzone = 1.0F;/* Referenced by: '<S584>/Constant3' */
CALDATA const volatile float32 cal_ACCMCtrlADlyTime = 5.0F;/* Referenced by: '<S584>/Constant' */
...
CALDATA const volatile float32 cal_ACCMCtrlAKi_CUR[8] = { 0.5F, 0.6F, 1.0F, 0.6F,
  0.6F, 0.4F, 0.3F, 0.2F } ;   /* Referenced by: '<S584>/cal_ACCMCtrlAKi_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlAPIMax = 6000.0F;/* Referenced by: '<S584>/Constant7' */
CALDATA const volatile float32 cal_ACCMCtrlAPIMin = 0.0F;/* Referenced by: '<S584>/Constant8' */
CALDATA const volatile float32 cal_ACCMCtrlARunTime = 15.0F;/* Referenced by: '<S584>/Constant1' */
CALDATA const volatile float32 cal_ACCMCtrlBDeadzone = 0.5F;/* Referenced by: '<S585>/Constant2' */
CALDATA const volatile float32 cal_ACCMCtrlBDlyTime = 5.0F;/* Referenced by: '<S585>/Constant' */
CALDATA const volatile float32 cal_ACCMCtrlBFF_1X[6] = { -5.0F, 0.0F, 5.0F,
  10.0F, 15.0F, 20.0F } ;     /* Referenced by: '<S585>/cal_ACCMCtrlB1FF_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlBKi_CUR[8] = { 0.1F, 0.3F, 0.2F, 0.0F,
  0.0F, 0.01F, 0.03F, 0.1F } ; /* Referenced by: '<S585>/cal_ACCMCtrlBKi_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlBPIMax = 6000.0F;/* Referenced by: '<S585>/Constant7' */
CALDATA const volatile float32 cal_ACCMCtrlBPIMin = 0.0F;/* Referenced by: '<S585>/Constant8' */
CALDATA const volatile float32 cal_ACCMCtrlBRunTime = 15.0F;/* Referenced by: '<S585>/Constant1' */
CALDATA const volatile float32 cal_ACCMCtrlC1FF_1X[5] = { 15.0F, 25.0F, 35.0F,
  45.0F, 55.0F } ;            /* Referenced by: '<S586>/cal_ACCMCtrlC1FF_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlC2FF_CUR[4] = { 1200.0F, 1200.0F,
  1200.0F, 1200.0F } ;        /* Referenced by: '<S586>/cal_ACCMCtrlC2FF_CUR' */

CALDATA const volatile float32 cal_ACCMCtrlCDeadzone = 0.5F;/* Referenced by: '<S586>/Constant3' */
CALDATA const volatile float32 cal_ACCMCtrlCDlyTime = 5.0F;/* Referenced by: '<S586>/Constant' */
...
CALDATA const volatile float32 cal_ACCMCtrlCKi_CUR[8] = { 0.5F, 0.5F, 0.3F, 0.0F,
  0.0F, 0.05F, 0.15F, 0.15F } ;/* Referenced by: '<S586>/cal_ACCMCtrlCKi_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlCPIMax = 6000.0F;/* Referenced by: '<S586>/Constant7' */
CALDATA const volatile float32 cal_ACCMCtrlCPIMin = 0.0F;/* Referenced by: '<S586>/Constant8' */
CALDATA const volatile float32 cal_ACCMCtrlCRunTime = 15.0F;/* Referenced by: '<S586>/Constant1' */
...
CALDATA const volatile float32 cal_ACCMCtrlD1FF_CUR[3] = { 1000.0F, 1000.0F,
  1500.0F } ;                 /* Referenced by: '<S587>/cal_ACCMCtrlD1FF_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlD2FF_CUR[4] = { 1000.0F, 1000.0F,
  1000.0F, 1000.0F } ;        /* Referenced by: '<S587>/cal_ACCMCtrlD2FF_CUR' */

CALDATA const volatile float32 cal_ACCMCtrlDDeadzone = 0.5F;/* Referenced by: '<S587>/Constant3' */
CALDATA const volatile float32 cal_ACCMCtrlDDlyTime = 5.0F;/* Referenced by: '<S587>/Constant' */
...
CALDATA const volatile float32 cal_ACCMCtrlDPIMax_1X[5] = { 10.0F, 15.0F, 20.0F,
  25.0F, 30.0F } ;          /* Referenced by: '<S587>/cal_ACCMCtrlDPIMax_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlDPIMin = 0.0F;/* Referenced by: '<S587>/Constant8' */
CALDATA const volatile float32 cal_ACCMCtrlDRunTime = 15.0F;/* Referenced by: '<S587>/Constant1' */
...
CALDATA const volatile float32 cal_ACCMCtrlE2FF_CUR[4] = { 1200.0F, 1200.0F,
  1200.0F, 1200.0F } ;        /* Referenced by: '<S588>/cal_ACCMCtrlE2FF_CUR' */

CALDATA const volatile float32 cal_ACCMCtrlEDeadzone = 1.0F;/* Referenced by: '<S588>/Constant3' */
CALDATA const volatile float32 cal_ACCMCtrlEDlyTime = 5.0F;/* Referenced by: '<S588>/Constant' */
...
CALDATA const volatile float32 cal_ACCMCtrlEKi_CUR[8] = { 0.1F, 0.3F, 0.2F, 0.0F,
  0.0F, 0.01F, 0.03F, 0.1F } ; /* Referenced by: '<S588>/cal_ACCMCtrlEKi_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlEPIMax = 6000.0F;/* Referenced by: '<S588>/Constant7' */
CALDATA const volatile float32 cal_ACCMCtrlEPIMin = 0.0F;/* Referenced by: '<S588>/Constant8' */
CALDATA const volatile float32 cal_ACCMCtrlERunTime = 15.0F;/* Referenced by: '<S588>/Constant1' */
...
CALDATA const volatile float32 cal_ACCMCtrlF1FF_1X[5] = { -20.0F, -10.0F, 0.0F,
  10.0F, 20.0F } ;            /* Referenced by: '<S589>/cal_ACCMCtrlF1FF_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlF2FF_1X[5] = { 1.0F, 2.0F, 3.0F, 4.0F,
  5.0F } ;                    /* Referenced by: '<S589>/cal_ACCMCtrlF2FF_CUR' */

CALDATA const volatile float32 cal_ACCMCtrlF2FF_CUR[5] = { 1000.0F, 1000.0F,
  1000.0F, 1000.0F, 1000.0F } ;
                              /* Referenced by: '<S589>/cal_ACCMCtrlF2FF_CUR' */

CALDATA const volatile float32 cal_ACCMCtrlFDeadzone = 1.0F;/* Referenced by: '<S589>/Constant3' */
CALDATA const volatile float32 cal_ACCMCtrlFDlyTime = 5.0F;/* Referenced by: '<S589>/Constant' */
...
CALDATA const volatile float32 cal_ACCMCtrlFKi_CUR[8] = { 0.2F, 0.2F, 0.3F, 0.1F,
  0.2F, 0.15F, 0.1F, 0.1F } ;  /* Referenced by: '<S589>/cal_ACCMCtrlFKi_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlFPIMax_1X[5] = { 10.0F, 15.0F, 20.0F,
  25.0F, 30.0F } ;          /* Referenced by: '<S589>/cal_ACCMCtrlFPIMax_CUR' */

CALDATA const volatile float32 cal_ACCMCtrlFPIMax_CUR[5] = { 2000.0F, 3000.0F,
  4000.0F, 5000.0F, 6000.0F } ;
                            /* Referenced by: '<S589>/cal_ACCMCtrlFPIMax_CUR' */

CALDATA const volatile float32 cal_ACCMCtrlFPIMin = 0.0F;/* Referenced by: '<S589>/Constant8' */
CALDATA const volatile float32 cal_ACCMCtrlFRunTime = 15.0F;/* Referenced by: '<S589>/Constant1' */
CALDATA const volatile float32 cal_ACCMCtrlH1FF_1X[5] = { 15.0F, 25.0F, 35.0F,
  45.0F, 55.0F } ;            /* Referenced by: '<S591>/cal_ACCMCtrlH1FF_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlH2FF_CUR[4] = { 1200.0F, 1200.0F,
  1200.0F, 1200.0F } ;        /* Referenced by: '<S591>/cal_ACCMCtrlH2FF_CUR' */

CALDATA const volatile float32 cal_ACCMCtrlHCct = 1.2F;/* Referenced by: '<S591>/Constant2' */
CALDATA const volatile float32 cal_ACCMCtrlHDeadzone = 0.5F;/* Referenced by: '<S591>/Constant3' */
CALDATA const volatile float32 cal_ACCMCtrlHDlyTime = 5.0F;/* Referenced by: '<S591>/Constant' */
...
CALDATA const volatile float32 cal_ACCMCtrlHKi_CUR[8] = { 0.5F, 0.5F, 0.3F, 0.0F,
  0.0F, 0.05F, 0.15F, 0.15F } ;/* Referenced by: '<S591>/cal_ACCMCtrlHKi_CUR' */
...
CALDATA const volatile float32 cal_ACCMCtrlHPIMax = 6000.0F;/* Referenced by: '<S591>/Constant7' */
CALDATA const volatile float32 cal_ACCMCtrlHPIMin = 0.0F;/* Referenced by: '<S591>/Constant8' */
CALDATA const volatile float32 cal_ACCMCtrlHRunTime = 15.0F;/* Referenced by: '<S591>/Constant1' */
CALDATA const volatile float32 cal_ACCMCtrlKi = 0.0F;/* Referenced by: '<S450>/Constant3' */
CALDATA const volatile float32 cal_ACCMCtrlKp = 0.0F;/* Referenced by: '<S450>/Constant2' */
CALDATA const volatile float32 cal_ACCMCtrlSpdData = 0.0F;/* Referenced by: '<S570>/Constant' */
CALDATA const volatile boolean cal_ACCMCtrlSpdDataEnb = false;/* Referenced by: '<S570>/Constant1' */
CALDATA const volatile boolean cal_ACCMEnbData = false;/* Referenced by: '<S462>/Constant' */
CALDATA const volatile boolean cal_ACCMEnbDataEnb = false;/* Referenced by: '<S462>/Constant1' */
CALDATA const volatile boolean cal_ACCMForbidCtrl = true;/* Referenced by:
                                                          * '<S442>/Constant'
                                                          * '<S956>/Constant3'
                                                          * '<S1659>/Constant'
                                                          */
CALDATA const volatile float32 cal_ACCMHiTempData = 0.0F;/* Referenced by: '<S1858>/Constant' */
CALDATA const volatile boolean cal_ACCMHiTempDataEnb = false;/* Referenced by: '<S1858>/Constant1' */
CALDATA const volatile uint8 cal_ACCMHiTempFanCtrl = 84U;/* Referenced by: '<S926>/Constant5' */
CALDATA const volatile float32 cal_ACCMHiTempFanOff = 70.0F;/* Referenced by: '<S926>/Relay' */
CALDATA const volatile float32 cal_ACCMHiTempFanOn = 85.0F;/* Referenced by: '<S926>/Relay' */
...
CALDATA const volatile float32 cal_ACCMOpenEnvTemp = -12.0F;/* Referenced by: '<S446>/Relay' */
...
CALDATA const volatile float32 cal_ACDVTPreSetEnvCor_1X[16] = { -25.0F, -20.0F,
  ...
  40.0F, 45.0F, 50.0F } ;/* Referenced by: '<S187>/cal_ACDVTPreSetEnvCor_CUR' */
...
CALDATA const volatile float32 cal_ACDVTPreSetEnvCor_CUR[16] = { 15.0F, 13.0F,
  ...
  -3.0F, -3.0F } ;       /* Referenced by: '<S187>/cal_ACDVTPreSetEnvCor_CUR' */
...
CALDATA const volatile float32 cal_ACDrDVTSolarCor_2Y[15] = { -25.0F, -20.0F,
  ...
  45.0F, 50.0F } ;         /* Referenced by: '<S183>/cal_ACDrDVTSolarCor_MAP' */
...
CALDATA const volatile float32 cal_ACDrDVTSolarCor_MAP[225] = { 0.0F, 0.0F,
  ...
  -5.0F, -5.0F, -5.0F } ;  /* Referenced by: '<S183>/cal_ACDrDVTSolarCor_MAP' */
...
CALDATA const volatile uint8 cal_ACFanMaxSpdCellTempLim_CUR[5] = { 43U, 42U, 41U,
  40U, 39U } ;           /* Referenced by: '<S52>/cal_ACFanMaxSpdCellTempLim' */

CALDATA const volatile float32 cal_ACFanMaxSpdDvtLim_1X[5] = { 10.0F, 20.0F,
  45.0F, 64.0F, 70.0F } ; /* Referenced by: '<S52>/cal_ACFanMaxSpdDvtLim_CUR' */

CALDATA const volatile uint8 cal_ACFanMaxSpdDvtLim_CUR[5] = { 78U, 59U, 41U, 34U,
  23U } ;                 /* Referenced by: '<S52>/cal_ACFanMaxSpdDvtLim_CUR' */
...
CALDATA const volatile float32 cal_ACFanSpdDvtSet_CUR[14] = { 78.0F, 56.0F,
  ...
  78.0F } ;                 /* Referenced by: '<S58>/cal_ACFanSpdDvtSet_CUR ' */

CALDATA const volatile float32 cal_ACFanSpdRecircCor_1X[4] = { 0.0F, 20.0F,
  80.0F, 100.0F } ;       /* Referenced by: '<S58>/cal_ACFanSpdRecircCor_CUR' */

CALDATA const volatile float32 cal_ACFanSpdRecircCor_CUR[4] = { 0.0F, 0.0F, 0.0F,
  0.0F } ;                /* Referenced by: '<S58>/cal_ACFanSpdRecircCor_CUR' */
...
CALDATA const volatile float32 cal_ACFanSpdSolarCorByEnv_MAP[225] = { 0.0F, 0.0F,
  ...
  7.0F, 7.0F } ;      /* Referenced by: '<S58>/cal_ACFanSpdSolarCorByEnv_MAP' */
...
CALDATA const volatile float32 cal_ACFanSpdSolarCor_2Y[15] = { -10.0F, -5.0F,
  ...
  60.0F, 70.0F } ;         /* Referenced by: '<S58>/cal_ACFanSpdSolarCor_MAP' */
...
CALDATA const volatile uint8 cal_ACInletEnvPrtSetCool_CUR[5] = { 0U, 0U, 0U, 0U,
  0U } ;              /* Referenced by: '<S125>/cal_ACInletEnvPrtSetCool_CUR' */
...
CALDATA const volatile uint8 cal_ACInletEnvPrtSetHeat_CUR[5] = { 80U, 80U, 0U,
  0U, 0U } ;          /* Referenced by: '<S125>/cal_ACInletEnvPrtSetHeat_CUR' */

CALDATA const volatile uint8 cal_ACPMPSpdDiffVal = 10U;/* Referenced by: '<S1031>/Constant' */
...
CALDATA const volatile float32 cal_ACPTCDesEnvCor_2Y[6] = { 10.0F, 20.0F, 60.0F,
  80.0F, 100.0F, 120.0F } ; /* Referenced by: '<S343>/cal_ACPTCDesEnvCor_MAP' */
...
CALDATA const volatile float32 cal_ACPTCDesFanCor_CUR[4] = { 0.0F, 1.0F, 2.0F,
  3.0F } ;                  /* Referenced by: '<S343>/cal_ACPTCDesFanCor_CUR' */
...
CALDATA const volatile float32 cal_ACPTCPsDesFanCor_CUR[4] = { 0.0F, 1.0F, 2.0F,
  3.0F } ;                /* Referenced by: '<S365>/cal_ACPTCPsDesFanCor_CUR' */
...
CALDATA const volatile uint16 cal_ACPTCPwrPreSetByEnv_MAP[100] = { 0U, 500U,
  ...
  1500U, 5500U } ;      /* Referenced by: '<S96>/cal_ACPTCPwrPreSetByEnv_MAP' */
...
CALDATA const volatile float32 cal_ACPsDVTSetCorByEnv_2Y[14] = { -25.0F, -20.0F,
  -15.0F, -10.0F, 0.0F, 5.0F, 10.0F, 15.0F, 20.0F, 25.0F, 30.0F, 35.0F, 40.0F,
  45.0F } ;             /* Referenced by: '<S184>/cal_ACPsDVTSetCorByEnv_MAP' */
...
CALDATA const volatile float32 cal_ACPsDVTSetCorByEnv_MAP[196] = { -40.0F,
  ...
  40.0F } ;             /* Referenced by: '<S184>/cal_ACPsDVTSetCorByEnv_MAP' */
...
CALDATA const volatile float32 cal_ACPsDVTSolarCor_2Y[15] = { -25.0F, -20.0F,
  -15.0F, -10.0F, 0.0F, 5.0F, 10.0F, 15.0F, 20.0F, 25.0F, 30.0F, 35.0F, 40.0F,
  45.0F, 50.0F } ;         /* Referenced by: '<S184>/cal_ACPsDVTSolarCor_MAP' */
...
CALDATA const volatile float32 cal_ACPsDVTSolarCor_MAP[225] = { 0.0F, 0.0F,
  ...
  -3.5F, -4.0F, -4.0F, -4.5F, -5.0F, -5.0F, -5.0F, -5.0F, -5.0F, -5.0F, 0.0F,
  0.0F, -2.0F, -2.5F, -3.0F, -3.5F, -4.0F, -4.0F, -4.5F, -5.0F, -5.0F, -5.0F,
  -5.0F, -5.0F, -5.0F } ;  /* Referenced by: '<S184>/cal_ACPsDVTSolarCor_MAP' */

CALDATA const volatile uint8 cal_ACPumpBatHeatSpd = 80U;/* Referenced by:
                                                         * '<S1031>/Constant18'
                                                         * '<S1031>/Constant6'
                                                         */
CALDATA const volatile uint8 cal_ACPumpCtrlASpd = 80U;/* Referenced by: '<S1031>/Constant1' */
CALDATA const volatile uint8 cal_ACPumpDefSpd = 10U;/* Referenced by:
                                                     * '<S1031>/Constant17'
                                                     * '<S1031>/Constant2'
                                                     */
CALDATA const volatile uint8 cal_ACPumpDehSpd = 80U;/* Referenced by: '<S1031>/Constant8' */
CALDATA const volatile uint8 cal_ACPumpDoubleHeatSpd = 80U;/* Referenced by: '<S1031>/Constant7' */
...
CALDATA const volatile float32 cal_AEXVClsValRunTimeEvapPrt = 10.0F;
                                   /* Referenced by: '<S692>/EvapTemperature' */
CALDATA const volatile float32 cal_AEXVCtlKi = 0.0F;/* Referenced by: '<S689>/Constant11' */
CALDATA const volatile float32 cal_AEXVCtlKisumMax = 50.0F;/* Referenced by: '<S689>/Constant8' */
CALDATA const volatile float32 cal_AEXVCtlKisumMin = -50.0F;/* Referenced by: '<S689>/Constant9' */
CALDATA const volatile float32 cal_AEXVCtlKp = 0.0F;/* Referenced by: '<S689>/Constant10' */
...
CALDATA const volatile float32 cal_AEXVCtrlBDeadzone = 0.5F;/* Referenced by: '<S724>/Constant3' */
CALDATA const volatile float32 cal_AEXVCtrlBDelayTime = 10.0F;/* Referenced by: '<S724>/Constant' */
CALDATA const volatile float32 cal_AEXVCtrlBFF_1X[5] = { 1000.0F, 2000.0F,
  3000.0F, 5000.0F, 7000.0F } ;/* Referenced by: '<S724>/cal_AEXVCtrlBFF_CUR' */

CALDATA const volatile float32 cal_AEXVCtrlBFF_CUR[5] = { 30.0F, 30.0F, 30.0F,
  30.0F, 30.0F } ;             /* Referenced by: '<S724>/cal_AEXVCtrlBFF_CUR' */
...
CALDATA const volatile float32 cal_AEXVCtrlBKp_CUR[8] = { 2.0F, 2.5F, 2.0F, 0.2F,
  0.2F, 1.0F, 2.0F, 1.5F } ;   /* Referenced by: '<S724>/cal_AEXVCtrlBKp_CUR' */

CALDATA const volatile float32 cal_AEXVCtrlBOpenVal = 30.0F;/* Referenced by: '<S724>/Constant1' */
CALDATA const volatile float32 cal_AEXVCtrlBPIMax = 100.0F;/* Referenced by: '<S724>/Constant6' */
CALDATA const volatile float32 cal_AEXVCtrlBPIMin = 15.0F;/* Referenced by: '<S724>/Constant7' */
...
CALDATA const volatile float32 cal_AEXVCtrlCDeadzone = 0.5F;/* Referenced by: '<S725>/Constant3' */
CALDATA const volatile float32 cal_AEXVCtrlCDelayTime = 10.0F;/* Referenced by: '<S725>/Constant' */
CALDATA const volatile float32 cal_AEXVCtrlCFF_1X[5] = { 1000.0F, 2000.0F,
  3000.0F, 5000.0F, 7000.0F } ;/* Referenced by: '<S725>/cal_AEXVCtrlCFF_CUR' */

CALDATA const volatile float32 cal_AEXVCtrlCFF_CUR[5] = { 100.0F, 100.0F, 100.0F,
  100.0F, 100.0F } ;           /* Referenced by: '<S725>/cal_AEXVCtrlCFF_CUR' */

CALDATA const volatile float32 cal_AEXVCtrlCKi_1X[7] = { -10.0F, -5.0F, -2.0F,
  0.0F, 4.0F, 10.0F, 15.0F } ; /* Referenced by: '<S725>/cal_AEXVCtrlCKi_CUR' */

CALDATA const volatile float32 cal_AEXVCtrlCKi_CUR[7] = { 0.03F, 0.03F, 0.0F,
  0.0F, 0.0F, 0.02F, 0.02F } ; /* Referenced by: '<S725>/cal_AEXVCtrlCKi_CUR' */

CALDATA const volatile float32 cal_AEXVCtrlCKp_1X[7] = { -10.0F, -5.0F, -2.0F,
  0.0F, 4.0F, 10.0F, 15.0F } ; /* Referenced by: '<S725>/cal_AEXVCtrlCKp_CUR' */

CALDATA const volatile float32 cal_AEXVCtrlCKp_CUR[7] = { 1.5F, 1.0F, 0.0F, 0.0F,
  0.0F, 0.6F, 1.0F } ;         /* Referenced by: '<S725>/cal_AEXVCtrlCKp_CUR' */

CALDATA const volatile float32 cal_AEXVCtrlCOpenVal = 100.0F;/* Referenced by: '<S725>/Constant1' */
CALDATA const volatile float32 cal_AEXVCtrlCPIMax = 100.0F;/* Referenced by: '<S725>/Constant6' */
CALDATA const volatile float32 cal_AEXVCtrlCPIMin = 10.0F;/* Referenced by: '<S725>/Constant7' */
CALDATA const volatile float32 cal_AEXVCtrlCTrgflt = 0.015F;/* Referenced by: '<S725>/Constant9' */
...
CALDATA const volatile float32 cal_AEXVCtrlDDeadzone = 1.0F;/* Referenced by: '<S726>/Constant3' */
CALDATA const volatile float32 cal_AEXVCtrlDDelayTime = 10.0F;/* Referenced by: '<S726>/Constant' */
CALDATA const volatile float32 cal_AEXVCtrlDFF_1X[5] = { 800.0F, 1000.0F,
  1500.0F, 2000.0F, 4000.0F } ;/* Referenced by: '<S726>/cal_AEXVCtrlDFF_CUR' */

CALDATA const volatile float32 cal_AEXVCtrlDFF_CUR[5] = { 100.0F, 100.0F, 100.0F,
  100.0F, 100.0F } ;           /* Referenced by: '<S726>/cal_AEXVCtrlDFF_CUR' */
...
CALDATA const volatile float32 cal_AEXVCtrlDKp_CUR[8] = { 2.0F, 2.0F, 0.4F, 0.0F,
  0.0F, 0.0F, 1.5F, 1.5F } ;   /* Referenced by: '<S726>/cal_AEXVCtrlDKp_CUR' */

CALDATA const volatile float32 cal_AEXVCtrlDOpenVal = 80.0F;/* Referenced by: '<S726>/Constant1' */
CALDATA const volatile float32 cal_AEXVCtrlDPIMax = 100.0F;/* Referenced by: '<S726>/Constant6' */
CALDATA const volatile float32 cal_AEXVCtrlDPIMin = 20.0F;/* Referenced by: '<S726>/Constant7' */
...
CALDATA const volatile float32 cal_AEXVCtrlDefaultPos = 100.0F;/* Referenced by: '<S727>/Constant1' */
CALDATA const volatile float32 cal_AEXVDiffDown = 5.0F;/* Referenced by: '<S748>/Constant8' */
CALDATA const volatile float32 cal_AEXVDiffDownRate = 5.0F;/* Referenced by: '<S748>/Constant7' */
CALDATA const volatile float32 cal_AEXVDiffUp = 5.0F;/* Referenced by: '<S748>/Constant6' */
CALDATA const volatile float32 cal_AEXVDiffUpRate = 5.0F;/* Referenced by: '<S748>/Constant5' */
CALDATA const volatile float32 cal_AEXVDownSpdLmt = 0.5F;/* Referenced by:
                                                          * '<S753>/DownLmt'
                                                          * '<S753>/DownLmt1'
                                                          */
CALDATA const volatile boolean cal_AEXVEnbData = false;/* Referenced by: '<S695>/Constant' */
CALDATA const volatile boolean cal_AEXVEnbDataEnb = false;/* Referenced by: '<S695>/Constant1' */
CALDATA const volatile float32 cal_AEXVFloorDiff1 = 0.2F;/* Referenced by: '<S751>/Constant1' */
CALDATA const volatile float32 cal_AEXVFloorDiff2 = 0.7F;/* Referenced by: '<S751>/Constant' */
CALDATA const volatile float32 cal_AEXVFltClsSpd = 0.5F;/* Referenced by: '<S692>/Constant7' */
CALDATA const volatile float32 cal_AEXVHighPressLmtOn = 2.2F;/* Referenced by: '<S748>/Constant3' */
CALDATA const volatile float32 cal_AEXVHighPressProhOn = 2.4F;/* Referenced by: '<S692>/Constant' */
CALDATA const volatile uint8 cal_AEXVInitReqData = 0U;/* Referenced by: '<S705>/Constant' */
CALDATA const volatile boolean cal_AEXVInitReqDataeEnb = false;/* Referenced by: '<S705>/Constant1' */
CALDATA const volatile float32 cal_AEXVLowPressLmtOn = 0.16F;/* Referenced by: '<S748>/Constant4' */
CALDATA const volatile float32 cal_AEXVLowPressProhOn = 0.14F;/* Referenced by: '<S692>/Constant2' */
...
CALDATA const volatile float32 cal_AEXVOpenValEvapNOPrt = 10.0F;
                                   /* Referenced by: '<S692>/EvapTemperature' */
CALDATA const volatile float32 cal_AEXVOpenValveSpd = 0.2F;/* Referenced by: '<S692>/Constant1' */
CALDATA const volatile float32 cal_AEXVPosData = 0.0F;/* Referenced by: '<S749>/Constant' */
CALDATA const volatile boolean cal_AEXVPosDataEnb = false;/* Referenced by: '<S749>/Constant1' */
CALDATA const volatile float32 cal_AEXVSubCoolflt = 0.015F;/* Referenced by: '<S724>/Constant9' */
CALDATA const volatile float32 cal_AEXVUpSpdLmt = 0.5F;/* Referenced by:
                                                        * '<S753>/UpLmt'
                                                        * '<S753>/UpLmt2'
                                                        */
CALDATA const volatile uint8 cal_AQS2InRecThreVal = 60U;/* Referenced by: '<S129>/Constant3' */
CALDATA const volatile uint8 cal_AQS2OutRecThreVal = 20U;/* Referenced by: '<S129>/Constant4' */
CALDATA const volatile boolean cal_AcPMPFaultFlgData = false;/* Referenced by: '<S1045>/Constant' */
CALDATA const volatile boolean cal_AcPMPFaultFlgDataEnb = false;/* Referenced by: '<S1045>/Constant1' */
CALDATA const volatile uint8 cal_AcPMPSpdSetData = 0U;/* Referenced by: '<S1044>/Constant' */
CALDATA const volatile boolean cal_AcPMPSpdSetDataEnb = false;/* Referenced by: '<S1044>/Constant1' */
...
CALDATA const volatile float32 cal_AccmSpdLimByHiPressDownSide_CUR[12] = { 0.0F,
  ...
  0.0F } ;     /* Referenced by: '<S547>/cal_AccmSpdLimByHiPressDownSide_CUR' */
...
CALDATA const volatile float32 cal_AccmSpdLimByHiPressUpSide_CUR[12] = { 0.0F,
  ...
  0.0F } ;       /* Referenced by: '<S547>/cal_AccmSpdLimByHiPressUpSide_CUR' */
...
CALDATA const volatile uint8 cal_AirInletPerData = 0U;/* Referenced by: '<S1233>/Constant' */
CALDATA const volatile boolean cal_AirInletPerEnb = false;/* Referenced by: '<S1233>/Constant1' */
CALDATA const volatile float32 cal_AirInletRecInPCUTemp = 60.0F;/* Referenced by: '<S133>/Constant6' */
CALDATA const volatile float32 cal_AirInletRecOutPCUTemp = 50.0F;/* Referenced by: '<S133>/Constant1' */
CALDATA const volatile boolean cal_AutoDefogEnable = false;/* Referenced by: '<S142>/Constant1' */
CALDATA const volatile boolean cal_AvgSwitch = false;/* Referenced by:
                                                      ...
                                                      * '<S685>/Constant6'
                                                      */
CALDATA const volatile uint8 cal_BATPMPSpdDiffVal = 10U;/* Referenced by: '<S1032>/Constant' */
CALDATA const volatile uint8 cal_BCVFltStsDelayTime = 3U;/* Referenced by: '<S673>/Constant5' */
CALDATA const volatile float32 cal_BCVPosDiffDelayTime = 0.5F;/* Referenced by: '<S673>/Constant2' */
CALDATA const volatile float32 cal_BEXVCtlKi = 0.0F;/* Referenced by: '<S759>/Constant11' */
CALDATA const volatile float32 cal_BEXVCtlKisumMax = 50.0F;/* Referenced by: '<S759>/Constant8' */
CALDATA const volatile float32 cal_BEXVCtlKisumMin = -50.0F;/* Referenced by: '<S759>/Constant9' */
CALDATA const volatile float32 cal_BEXVCtlKp = 0.0F;/* Referenced by: '<S759>/Constant10' */
...
CALDATA const volatile float32 cal_BEXVCtrlBDeadzone = 0.5F;/* Referenced by: '<S792>/Constant3' */
CALDATA const volatile float32 cal_BEXVCtrlBDelayTime = 10.0F;/* Referenced by: '<S792>/Constant' */
CALDATA const volatile float32 cal_BEXVCtrlBFF_1X[5] = { 1000.0F, 2000.0F,
  3000.0F, 5000.0F, 7000.0F } ;/* Referenced by: '<S792>/cal_BEXVCtrlBFF_CUR' */

CALDATA const volatile float32 cal_BEXVCtrlBFF_CUR[5] = { 30.0F, 30.0F, 25.0F,
  25.0F, 25.0F } ;             /* Referenced by: '<S792>/cal_BEXVCtrlBFF_CUR' */

CALDATA const volatile float32 cal_BEXVCtrlBKi_1X[7] = { -10.0F, -6.0F, -3.0F,
  -2.0F, 2.0F, 4.0F, 10.0F } ; /* Referenced by: '<S792>/cal_BEXVCtrlBKi_CUR' */

CALDATA const volatile float32 cal_BEXVCtrlBKi_CUR[7] = { 0.02F, 0.02F, 0.01F,
  0.0F, 0.0F, 0.01F, 0.01F } ; /* Referenced by: '<S792>/cal_BEXVCtrlBKi_CUR' */

CALDATA const volatile float32 cal_BEXVCtrlBKp_1X[7] = { -10.0F, -6.0F, -4.0F,
  -2.0F, 2.0F, 4.0F, 10.0F } ; /* Referenced by: '<S792>/cal_BEXVCtrlBKp_CUR' */

CALDATA const volatile float32 cal_BEXVCtrlBKp_CUR[7] = { 1.5F, 1.0F, 0.5F, 0.1F,
  0.1F, 0.4F, 1.0F } ;         /* Referenced by: '<S792>/cal_BEXVCtrlBKp_CUR' */

CALDATA const volatile float32 cal_BEXVCtrlBOpenVal = 60.0F;/* Referenced by: '<S792>/Constant1' */
CALDATA const volatile float32 cal_BEXVCtrlBPIDown = 10.0F;/* Referenced by: '<S792>/Constant7' */
CALDATA const volatile float32 cal_BEXVCtrlBPIUp = 100.0F;/* Referenced by: '<S792>/Constant6' */
...
CALDATA const volatile float32 cal_BEXVCtrlCDeadzone = 0.5F;/* Referenced by: '<S793>/Constant3' */
CALDATA const volatile float32 cal_BEXVCtrlCDelayTime = 10.0F;/* Referenced by: '<S793>/Constant' */
CALDATA const volatile float32 cal_BEXVCtrlCFF_1X[5] = { 1000.0F, 2000.0F,
  3000.0F, 5000.0F, 7000.0F } ;/* Referenced by: '<S793>/cal_BEXVCtrlCFF_CUR' */

CALDATA const volatile float32 cal_BEXVCtrlCFF_CUR[5] = { 30.0F, 30.0F, 25.0F,
  25.0F, 25.0F } ;             /* Referenced by: '<S793>/cal_BEXVCtrlCFF_CUR' */
...
CALDATA const volatile float32 cal_BEXVCtrlCKp_CUR[8] = { 1.5F, 1.0F, 0.5F, 0.1F,
  0.1F, 0.4F, 0.5F, 0.5F } ;   /* Referenced by: '<S793>/cal_BEXVCtrlCKp_CUR' */

CALDATA const volatile float32 cal_BEXVCtrlCOpenVal = 60.0F;/* Referenced by: '<S793>/Constant1' */
CALDATA const volatile float32 cal_BEXVCtrlCPIMax = 100.0F;/* Referenced by: '<S793>/Constant6' */
CALDATA const volatile float32 cal_BEXVCtrlCPIMin = 10.0F;/* Referenced by: '<S793>/Constant7' */
...
CALDATA const volatile float32 cal_BEXVCtrlCTrg_CUR[5] = { 8.0F, 8.0F, 8.0F,
  8.0F, 8.0F } ;              /* Referenced by: '<S793>/cal_BEXVCtrlCTrg_CUR' */

CALDATA const volatile float32 cal_BEXVDiffDown = 5.0F;/* Referenced by: '<S818>/Constant8' */
CALDATA const volatile float32 cal_BEXVDiffDownRate = 5.0F;/* Referenced by: '<S818>/Constant7' */
CALDATA const volatile float32 cal_BEXVDiffUp = 5.0F;/* Referenced by: '<S818>/Constant6' */
CALDATA const volatile float32 cal_BEXVDiffUpRate = 5.0F;/* Referenced by: '<S818>/Constant5' */
CALDATA const volatile float32 cal_BEXVDownSpdLmt = 0.5F;/* Referenced by:
                                                          * '<S823>/DownLmt'
                                                          * '<S823>/DownLmt1'
                                                          */
CALDATA const volatile boolean cal_BEXVEnbData = false;/* Referenced by: '<S814>/Constant' */
CALDATA const volatile boolean cal_BEXVEnbDataEnb = false;/* Referenced by: '<S814>/Constant1' */
CALDATA const volatile float32 cal_BEXVFloorDiff1 = 0.2F;/* Referenced by: '<S821>/Constant1' */
CALDATA const volatile float32 cal_BEXVFloorDiff2 = 0.7F;/* Referenced by: '<S821>/Constant' */
CALDATA const volatile float32 cal_BEXVHighPressLmtOn = 2.2F;/* Referenced by: '<S818>/Constant3' */
CALDATA const volatile float32 cal_BEXVHighPressProhOn = 2.4F;/* Referenced by: '<S763>/Constant' */
CALDATA const volatile uint8 cal_BEXVInitReqData = 0U;/* Referenced by: '<S773>/Constant' */
CALDATA const volatile boolean cal_BEXVInitReqDataeEnb = false;/* Referenced by: '<S773>/Constant1' */
CALDATA const volatile float32 cal_BEXVLowPressLmtOn = 0.16F;/* Referenced by: '<S818>/Constant4' */
CALDATA const volatile float32 cal_BEXVLowPressProhOn = 0.14F;/* Referenced by: '<S763>/Constant2' */
...
CALDATA const volatile float32 cal_BEXVOpenCtrlUpSpdLmt = 2.0F;/* Referenced by:
                                                                ...
                                                                * '<S824>/UpLmt2'
                                                                */
CALDATA const volatile float32 cal_BEXVOpenValveSpd = 0.2F;/* Referenced by: '<S763>/Constant1' */
CALDATA const volatile float32 cal_BEXVPosData = 0.0F;/* Referenced by: '<S819>/Constant' */
CALDATA const volatile boolean cal_BEXVPosDataEnb = false;/* Referenced by: '<S819>/Constant1' */
CALDATA const volatile float32 cal_BEXVSubCoolflt = 0.015F;/* Referenced by: '<S793>/Constant10' */
CALDATA const volatile float32 cal_BEXVSubHeatflt = 0.045F;/* Referenced by: '<S792>/Constant12' */
CALDATA const volatile float32 cal_BEXVUpSpdLmt = 0.5F;/* Referenced by:
                                                        * '<S823>/UpLmt'
                                                        * '<S823>/UpLmt2'
                                                        */
CALDATA const volatile float32 cal_BMSInletTempHighOffMCV = 47.0F;/* Referenced by: '<S643>/Relay' */
CALDATA const volatile float32 cal_BMSInletTempLowOnMCV = 43.0F;/* Referenced by: '<S643>/Relay' */
...
CALDATA const volatile float32 cal_BatCoolInletTrgTemp = 18.0F;/* Referenced by:
                                                                ...
                                                                * '<S792>/Constant11'
                                                                */
CALDATA const volatile boolean cal_BatCoolOverData = false;/* Referenced by: '<S1380>/Constant' */
CALDATA const volatile boolean cal_BatCoolOverEnb = false;/* Referenced by: '<S1380>/Constant1' */
CALDATA const volatile uint16 cal_BatCoolStopBatPMPRunTime = 10U;/* Referenced by: '<S1032>/Constant16' */
CALDATA const volatile uint8 cal_BatCoolStopBatPMPSpd = 30U;/* Referenced by: '<S1032>/Constant15' */
...
CALDATA const volatile boolean cal_BatHeatACCMEnb = false;/* Referenced by:
                                                           ...
                                                           * '<S593>/Constant9'
                                                           */
CALDATA const volatile boolean cal_BatHeatOverData = false;/* Referenced by: '<S1461>/Constant' */
CALDATA const volatile boolean cal_BatHeatOverEnb = false;/* Referenced by: '<S1461>/Constant1' */
CALDATA const volatile float32 cal_BatHeatPwrLoLmt = 0.5F;/* Referenced by:
                                                           * '<S1403>/Constant'
                                                           * '<S1486>/Constant'
                                                           */
CALDATA const volatile float32 cal_BatHeatTrgTemp = 45.0F;/* Referenced by: '<S956>/Constant5' */
...
CALDATA const volatile BatModes cal_BatModeData = Off;/* Referenced by: '<S1456>/Constant' */
CALDATA const volatile boolean cal_BatModeEnb = false;/* Referenced by: '<S1456>/Constant1' */
CALDATA const volatile boolean cal_BatModeSwitch = false;/* Referenced by:
                                                          * '<S34>/Constant1'
                                                          * '<S1304>/Constant'
                                                          */
CALDATA const volatile boolean cal_BatModeTestCtrl = false;/* Referenced by: '<S672>/Constant' */
CALDATA const volatile uint8 cal_BatPMPBatHeatSpd = 80U;/* Referenced by: '<S1032>/Constant6' */
CALDATA const volatile boolean cal_BatPMPFaultFlgData = false;/* Referenced by: '<S1061>/Constant' */
CALDATA const volatile boolean cal_BatPMPFaultFlgDataEnb = false;/* Referenced by: '<S1061>/Constant1' */
CALDATA const volatile uint8 cal_BatPMPSpdSetData = 0U;/* Referenced by: '<S1060>/Constant' */
CALDATA const volatile boolean cal_BatPMPSpdSetDataEnb = false;/* Referenced by: '<S1060>/Constant1' */
...
CALDATA const volatile uint8 cal_BatPumpCtrlASpd = 80U;/* Referenced by: '<S1032>/Constant1' */
CALDATA const volatile uint8 cal_BatPumpMotHeatBatSpd = 100U;/* Referenced by: '<S1032>/Constant13' */
CALDATA const volatile uint8 cal_BatPumpMotLTRAndBatCHSpd = 100U;/* Referenced by: '<S1032>/Constant14' */
CALDATA const volatile float32 cal_BatPumpThSto_1X[4] = { 2.0F, 5.0F, 10.0F,
  15.0F } ;                  /* Referenced by: '<S1032>/cal_BatPumpThSto_CUR' */

CALDATA const volatile uint8 cal_BatPumpThSto_CUR[4] = { 22U, 60U, 80U, 80U } ;
                             /* Referenced by: '<S1032>/cal_BatPumpThSto_CUR' */

CALDATA const volatile float32 cal_BatTrgTempData = 0.0F;/* Referenced by: '<S1323>/Constant' */
CALDATA const volatile boolean cal_BatTrgTempEnb = false;/* Referenced by: '<S1323>/Constant1' */
...
CALDATA const volatile uint8 cal_BetwT1AndT2DownMCV_CUR[6] = { 12U, 12U, 8U, 8U,
  5U, 5U } ;            /* Referenced by: '<S649>/cal_BetwT1AndT2DownMCV_CUR' */
...
CALDATA const volatile uint8 cal_BetwT1AndT2StbyMCV_CUR[6] = { 12U, 12U, 12U, 8U,
  8U, 8U } ;            /* Referenced by: '<S649>/cal_BetwT1AndT2StbyMCV_CUR' */

CALDATA const volatile float32 cal_BetwT1AndT2UpMCV_1X[6] = { -4.0F, -2.0F, 0.0F,
  2.0F, 4.0F, 6.0F } ;    /* Referenced by: '<S649>/cal_BetwT1AndT2UpMCV_CUR' */

CALDATA const volatile uint8 cal_BetwT1AndT2UpMCV_CUR[6] = { 12U, 12U, 8U, 8U,
  5U, 5U } ;              /* Referenced by: '<S649>/cal_BetwT1AndT2UpMCV_CUR' */

CALDATA const volatile uint8 cal_BlowerFanSpdLL = 0U;/* Referenced by: '<S53>/Constant14' */
CALDATA const volatile uint8 cal_BlowerFanSpdVentUL = 78U;/* Referenced by: '<S52>/Constant29' */
CALDATA const volatile uint8 cal_BlwFanData = 0U;/* Referenced by: '<S1252>/Constant' */
CALDATA const volatile boolean cal_BlwFanEnb = false;/* Referenced by: '<S1252>/Constant1' */
CALDATA const volatile uint16 cal_BlwFrqVal = 1000U;/* Referenced by: '<S1237>/Constant5' */
CALDATA const volatile uint8 cal_C3WVExhPosVal = 10U;/* Referenced by: '<S643>/Constant7' */
CALDATA const volatile uint8 cal_C3WVSLStsData = 0U;/* Referenced by: '<S669>/Constant' */
CALDATA const volatile boolean cal_C3WVSLStsDataEnb = false;/* Referenced by: '<S669>/Constant1' */
CALDATA const volatile uint8 cal_C5WVExhPosVal = 12U;/* Referenced by: '<S672>/Constant11' */
CALDATA const volatile uint8 cal_C5WVSLStsData = 0U;/* Referenced by: '<S679>/Constant' */
CALDATA const volatile boolean cal_C5WVSLStsDataEnb = false;/* Referenced by: '<S679>/Constant1' */
...
CALDATA const volatile uint8 cal_CO2RecircRatio = 40U;/* Referenced by: '<S48>/Constant14' */
...
CALDATA const volatile float32 cal_COMPATNoiseSpdLmt_MAP[100] = { 800.0F, 800.0F,
  ...
  4300.0F, 4300.0F, 4300.0F, 5000.0F, 5000.0F, 5000.0F, 5000.0F, 8000.0F,
  8000.0F } ;            /* Referenced by: '<S547>/cal_COMPATNoiseSpdLmt_MAP' */

CALDATA const volatile float32 cal_COMPActlSpd1 = 800.0F;/* Referenced by: '<S543>/Constant' */
CALDATA const volatile float32 cal_COMPActlSpd2 = 1200.0F;/* Referenced by: '<S544>/Constant' */
CALDATA const volatile float32 cal_COMPActlSpd3 = 2000.0F;/* Referenced by: '<S545>/Constant' */
CALDATA const volatile float32 cal_COMPBatMaxSpdLmt = 4000.0F;/* Referenced by: '<S548>/Constant2' */
CALDATA const volatile float32 cal_COMPCabinCoolMaxSpdLmt = 6000.0F;/* Referenced by: '<S548>/Constant3' */
CALDATA const volatile float32 cal_COMPClosePwrMaxLmt = 1.0F;/* Referenced by: '<S464>/Relay' */
...
CALDATA const volatile float32 cal_COMPEvapTFrbVal = -1.0F;/* Referenced by: '<S459>/Relay2' */
CALDATA const volatile float32 cal_COMPEvapTNmlVal = 4.0F;/* Referenced by: '<S459>/Relay2' */
CALDATA const volatile float32 cal_COMPExhTDownSpd = 150.0F;/* Referenced by: '<S572>/Constant1' */
CALDATA const volatile float32 cal_COMPExhTFrbVal = 125.0F;/* Referenced by: '<S459>/Relay1' */
CALDATA const volatile float32 cal_COMPExhTLmtRlybVal = 120.0F;/* Referenced by: '<S459>/Relay1' */
CALDATA const volatile float32 cal_COMPExhTLmtVal = 115.0F;/* Referenced by: '<S459>/Relay' */
CALDATA const volatile float32 cal_COMPExhTNmlVal = 110.0F;/* Referenced by: '<S459>/Relay' */
CALDATA const volatile uint8 cal_COMPFanLevelLmt_1X[9] = { 0U, 1U, 2U, 3U, 4U,
  5U, 6U, 7U, 8U } ;       /* Referenced by: '<S548>/cal_COMPFanLevelLmt_CUR' */
...
CALDATA const volatile uint8 cal_COMPFanSpdLmt[3] = { 40U, 50U, 60U } ;/* Referenced by: '<S445>/Constant14' */

CALDATA const volatile float32 cal_COMPONMinSpd = 1000.0F;/* Referenced by: '<S453>/Relay' */
CALDATA const volatile float32 cal_COMPOffMaxSpd = 750.0F;/* Referenced by: '<S453>/Relay' */
CALDATA const volatile float32 cal_COMPPwrMaxLmt = 10.0F;/* Referenced by: '<S33>/Constant3' */
CALDATA const volatile float32 cal_COMPSpdDiffDown = 1000.0F;/* Referenced by: '<S573>/Constant6' */
CALDATA const volatile float32 cal_COMPSpdDiffDownRate = 60.0F;/* Referenced by: '<S573>/Constant7' */
CALDATA const volatile float32 cal_COMPSpdDiffUp = 1000.0F;/* Referenced by: '<S573>/Constant' */
CALDATA const volatile float32 cal_COMPSpdDiffUpRate = 60.0F;/* Referenced by: '<S573>/Constant5' */
CALDATA const volatile float32 cal_COMPSpdLmt[4] = { 1200.0F, 2500.0F, 4000.0F,
  5000.0F } ;                          /* Referenced by: '<S445>/Constant13' */

CALDATA const volatile float32 cal_COMPStartPwrMinLmt = 2.0F;/* Referenced by: '<S464>/Relay' */
CALDATA const volatile float32 cal_CabinCondToCoolHPEXVPos1 = 80.0F;/* Referenced by: '<S1664>/Constant' */
CALDATA const volatile float32 cal_CabinCondToCoolHPEXVPos2 = 20.0F;/* Referenced by: '<S1665>/Constant' */
CALDATA const volatile float32 cal_CabinCondToEvpHPEXVPos = 6.0F;/* Referenced by: '<S1683>/Constant' */
...
CALDATA const volatile float32 cal_CabinDesTempSolarCorECO_2Y[14] = { -25.0F,
  -20.0F, -15.0F, -10.0F, 0.0F, 5.0F, 10.0F, 15.0F, 20.0F, 25.0F, 30.0F, 35.0F,
  40.0F, 45.0F } ; /* Referenced by: '<S187>/cal_CabinDesTempSolarCorECO_MAP' */
...
CALDATA const volatile float32 cal_CabinDesTempSolarCor_2Y[14] = { -25.0F,
  -20.0F, -15.0F, -10.0F, 0.0F, 5.0F, 10.0F, 15.0F, 20.0F, 25.0F, 30.0F, 35.0F,
  40.0F, 45.0F } ;    /* Referenced by: '<S187>/cal_CabinDesTempSolarCor_MAP' */
...
CALDATA const volatile uint16 cal_CabinEvpToCondCompLmt = 850U;/* Referenced by: '<S1682>/Constant' */
CALDATA const volatile float32 cal_CabinEvpToHPEnvTemp = 5.0F;/* Referenced by: '<S1696>/Constant' */
...
CALDATA const volatile float32 cal_CabinMD2F2MaxEnvTemp = 30.0F;/* Referenced by:
                                                                 ...
                                                                 * '<S1690>/Constant11'
                                                                 */
CALDATA const volatile CabinMode cal_CabinModeData = CabinMode_MD_Off;/* Referenced by: '<S1702>/Constant' */
CALDATA const volatile boolean cal_CabinModeEnb = false;/* Referenced by: '<S1702>/Constant1' */
CALDATA const volatile float32 cal_CabinModeKeepStandbyTime = 0.2F;/* Referenced by: '<S1659>/Constant2' */
CALDATA const volatile float32 cal_CabinModeTransF1Constant = 1.0F;/* Referenced by: '<S1651>/Constant3' */
CALDATA const volatile float32 cal_CabinModeTransF1Slope = 1.2F;/* Referenced by: '<S1651>/Constant2' */
CALDATA const volatile float32 cal_CabinModeTransF2Constant = 10.5F;/* Referenced by: '<S1651>/Constant4' */
CALDATA const volatile float32 cal_CabinModeTransF2Slope = 1.3F;/* Referenced by: '<S1651>/Constant1' */
CALDATA const volatile boolean cal_CabinSetPTCSwitch = true;/* Referenced by: '<S181>/Constant9' */
CALDATA const volatile uint8 cal_CabinTCorSelect = 0U;/* Referenced by: '<S178>/Constant1' */
CALDATA const volatile float32 cal_CabinTempData = 24.0F;/* Referenced by: '<S1733>/Constant' */
...
CALDATA const volatile boolean cal_CabinTempEnb = false;/* Referenced by: '<S1733>/Constant1' */
...
CALDATA const volatile float32 cal_ChiTempData = 0.0F;/* Referenced by: '<S1785>/Constant' */
CALDATA const volatile boolean cal_ChiTempDataEnb = false;/* Referenced by: '<S1785>/Constant1' */
...
CALDATA const volatile float32 cal_ClsCoolInletTemp = 15.0F;/* Referenced by: '<S1312>/Constant' */
CALDATA const volatile float32 cal_ClsCoolInletTempTime = 15.0F;/* Referenced by: '<S1312>/Constant2' */
CALDATA const volatile float32 cal_ColdPCUTempMinByEnv_1X[15] = { -13.0F, -12.0F,
  ...
  25.5F, 35.0F } ;    /* Referenced by: '<S1717>/cal_ColdPCUTempMinByEnv_CUR' */
...
CALDATA const volatile float32 cal_ColdPCUTempMinByEnv_CUR[15] = { 10.0F, 10.0F,
  ...
  35.0F, 40.0F } ;    /* Referenced by: '<S1717>/cal_ColdPCUTempMinByEnv_CUR' */
...
CALDATA const volatile float32 cal_CondDepFilter = 0.9F;/* Referenced by: '<S904>/Constant2' */
CALDATA const volatile float32 cal_CondDep_1X[28] = { 0.029451F, 0.039117F,
  ...
  3.2442F, 3.9724F, 4.0541F } ;    /* Referenced by: '<S685>/cal_CondDep_CUR' */
...
CALDATA const volatile float32 cal_CondDep_CUR[28] = { -50.0F, -45.0F, -40.0F,
  ...
  80.0F, 90.0F, 100.0F, 101.0F } ; /* Referenced by: '<S685>/cal_CondDep_CUR' */

CALDATA const volatile float32 cal_CoolFanCtrl_2X[4] = { 0.0F, 40.0F, 80.0F,
  120.0F } ;                   /* Referenced by: '<S924>/cal_CoolFanCtrl_MAP' */
...
CALDATA const volatile uint8 cal_CoolFanData = 0U;/* Referenced by: '<S930>/Constant' */
CALDATA const volatile boolean cal_CoolFanEnb = false;/* Referenced by: '<S930>/Constant1' */
CALDATA const volatile float32 cal_CoolStartCompensate = 10.0F;/* Referenced by: '<S281>/Constant8' */
...
CALDATA const volatile float32 cal_CtrlFPTCOffPowerVal = 0.5F;/* Referenced by: '<S589>/Constant6' */
...
CALDATA const volatile float32 cal_DCBatHeatEnvTemp[2] = { 0.0F, 15.0F } ;/* Referenced by: '<S1512>/Constant1' */

CALDATA const volatile float32 cal_DCBatHeatT1[3] = { 10.0F, 15.0F, 20.0F } ;/* Referenced by: '<S1512>/Constant2' */

CALDATA const volatile float32 cal_DCBatHeatT2[3] = { 25.0F, 25.0F, 25.0F } ;/* Referenced by: '<S1512>/Constant3' */

CALDATA const volatile float32 cal_DCBatHeatTave[3] = { 20.0F, 25.0F, 30.0F } ;/* Referenced by: '<S1512>/Constant' */
...
CALDATA const volatile float32 cal_DLTRBatInlet2MaxTempDiff = 0.0F;/* Referenced by: '<S1554>/Constant' */
...
CALDATA const volatile float32 cal_DLTRIPUTempExitVal = 55.0F;/* Referenced by: '<S1547>/Constant' */
...
CALDATA const volatile float32 cal_DcutTempPid_pWinPos = 80.0F;/* Referenced by:
                                                                ...
                                                                * '<S232>/Kp3'
                                                                */
CALDATA const volatile float32 cal_DefaultSetTemp = 24.0F;/* Referenced by: '<S209>/Constant' */
...
CALDATA const volatile float32 cal_DrDuctFaceFloorFaFactor = 0.6F;/* Referenced by: '<S228>/Constant3' */
CALDATA const volatile float32 cal_DrDuctFaceFloorFoFactor = 0.4F;/* Referenced by: '<S228>/Constant4' */
...
/* Referenced by: '<S391>/On:cal_DrErrOfPtcDVT2HeatMixOn Off:cal_DrErrOfPtcDVT2HeatMixOff' */
CALDATA const volatile float32 cal_DrEvaDesValPIDIntegDeadBandNeg = 2.0F;/* Referenced by: '<S283>/Kp12' */
CALDATA const volatile float32 cal_DrEvaDesValPIDIntegDeadBandPos = 2.0F;/* Referenced by: '<S283>/Kp11' */
CALDATA const volatile float32 cal_DrEvaDesValPIDKi = 0.0F;/* Referenced by: '<S283>/Kp7' */
CALDATA const volatile float32 cal_DrEvaDesValPIDKiNeg = 0.002F;/* Referenced by: '<S283>/Kp9' */
CALDATA const volatile float32 cal_DrEvaDesValPIDKiPos = 0.002F;/* Referenced by: '<S283>/Kp10' */
CALDATA const volatile float32 cal_DrEvaDesValPIDKp = 0.3F;/* Referenced by: '<S283>/Kp' */
CALDATA const volatile float32 cal_DrEvaDesValPIDKpNeg = 0.6F;/* Referenced by: '<S283>/Kp1' */
CALDATA const volatile float32 cal_DrEvaDesValPIDKpPos = 1.0F;/* Referenced by: '<S283>/Kp2' */
...
CALDATA const volatile float32 cal_DrEvaDesValPIDUL = 25.0F;/* Referenced by:
                                                             ...
                                                             * '<S309>/Constant3'
                                                             */
CALDATA const volatile float32 cal_DrEvaDesValPID_IsumMax = 5.0F;/* Referenced by: '<S283>/Kp8' */
CALDATA const volatile float32 cal_DrEvaDesValPID_IsumMin = -5.0F;/* Referenced by: '<S283>/Kp13' */
CALDATA const volatile float32 cal_DrEvaDesValPID_pWinNeg = 1.0F;/* Referenced by: '<S283>/Kp4' */
CALDATA const volatile float32 cal_DrEvaDesValPID_pWinPos = 1.0F;/* Referenced by: '<S283>/Kp3' */
CALDATA const volatile float32 cal_DrEvapDesFilterByDvt_1X[4] = { 0.0F, 2.0F,
  3.0F, 4.0F } ;      /* Referenced by: '<S283>/cal_DrEvapDesFilterByDvt_CUR' */
...
CALDATA const volatile float32 cal_DrMixDesValPIDIntegDeadBand = 3.0F;/* Referenced by: '<S392>/Kp11' */
CALDATA const volatile uint8 cal_DrMixDesValPIDLL = 0U;/* Referenced by: '<S392>/Kp6' */
CALDATA const volatile uint8 cal_DrMixDesValPIDUL = 100U;/* Referenced by: '<S392>/Kp5' */
CALDATA const volatile float32 cal_DrMixDesValPID_IsumMax = 30.0F;/* Referenced by: '<S392>/Kp8' */
CALDATA const volatile float32 cal_DrMixDesValPID_IsumMin = -30.0F;/* Referenced by: '<S392>/Kp13' */
CALDATA const volatile float32 cal_DrMixDesValPID_Ki = 0.0F;/* Referenced by: '<S392>/Kp7' */
CALDATA const volatile float32 cal_DrMixDesValPID_KiNeg = 0.05F;/* Referenced by: '<S392>/Kp9' */
CALDATA const volatile float32 cal_DrMixDesValPID_KiPos = 0.05F;/* Referenced by: '<S392>/Kp10' */
CALDATA const volatile float32 cal_DrMixDesValPID_Kp = 1.0F;/* Referenced by: '<S392>/Kp' */
CALDATA const volatile float32 cal_DrMixDesValPID_KpNeg = 2.0F;/* Referenced by: '<S392>/Kp1' */
CALDATA const volatile float32 cal_DrMixDesValPID_KpPos = 2.0F;/* Referenced by: '<S392>/Kp2' */
CALDATA const volatile float32 cal_DrMixDesValPID_pWinNeg = 3.0F;/* Referenced by: '<S392>/Kp4' */
CALDATA const volatile float32 cal_DrMixDesValPID_pWinPos = 3.0F;/* Referenced by: '<S392>/Kp3' */
CALDATA const volatile float32 cal_DrPtcDesValPIDIntegDeadBand4InHeat = 2.0F;/* Referenced by: '<S344>/Kp16' */
CALDATA const volatile float32 cal_DrPtcDesValPIDIntegDeadBand4OutHeat = 2.0F;/* Referenced by: '<S344>/Kp26' */
CALDATA const volatile float32 cal_DrPtcDesValPIDKi = 0.0F;/* Referenced by: '<S344>/Kp7' */
CALDATA const volatile float32 cal_DrPtcDesValPIDKiNeg = 0.005F;/* Referenced by: '<S344>/Kp9' */
CALDATA const volatile float32 cal_DrPtcDesValPIDKiPos = 0.004F;/* Referenced by: '<S344>/Kp10' */
CALDATA const volatile float32 cal_DrPtcDesValPIDKp = 0.5F;/* Referenced by: '<S344>/Kp' */
CALDATA const volatile float32 cal_DrPtcDesValPIDKpNeg = 1.0F;/* Referenced by: '<S344>/Kp1' */
CALDATA const volatile float32 cal_DrPtcDesValPIDKpPos = 1.5F;/* Referenced by: '<S344>/Kp2' */
CALDATA const volatile float32 cal_DrPtcDesValPIDLL = 0.0F;/* Referenced by: '<S344>/Kp6' */
CALDATA const volatile float32 cal_DrPtcDesValPIDUL = 60.0F;/* Referenced by: '<S344>/Kp5' */
CALDATA const volatile float32 cal_DrPtcDesValPID_IsumMax = 20.0F;/* Referenced by: '<S344>/Kp8' */
CALDATA const volatile float32 cal_DrPtcDesValPID_IsumMin = -20.0F;/* Referenced by: '<S344>/Kp13' */
CALDATA const volatile float32 cal_DrPtcDesValPID_pWinNeg = 2.0F;/* Referenced by: '<S344>/Kp4' */
CALDATA const volatile float32 cal_DrPtcDesValPID_pWinPos = 2.0F;/* Referenced by: '<S344>/Kp3' */
CALDATA const volatile float32 cal_DvtCoff = 0.9F;/* Referenced by: '<S185>/Constant' */
...
CALDATA const volatile float32 cal_DvtDesValPIDIntegDeadBand = 2.0F;/* Referenced by: '<S189>/Constant7' */
...
CALDATA const volatile float32 cal_DvtDesValPID_Ki = 0.0F;/* Referenced by: '<S189>/Kp7' */
CALDATA const volatile float32 cal_DvtDesValPID_Kp = 0.5F;/* Referenced by: '<S189>/Kp' */
...
CALDATA const volatile float32 cal_DvtDesValPID_UL = 60.0F;/* Referenced by:
                                                            ...
                                                            * '<S184>/Kp5'
                                                            */
CALDATA const volatile float32 cal_DvtDesValPID_pWinNeg = 1.0F;/* Referenced by: '<S189>/Kp4' */
CALDATA const volatile float32 cal_DvtDesValPID_pWinPos = 1.0F;/* Referenced by: '<S189>/Kp3' */
CALDATA const volatile float32 cal_ECOEvaDesValLL_2X[6] = { 10.0F, 15.0F, 20.0F,
  25.0F, 30.0F, 35.0F } ;   /* Referenced by: '<S180>/cal_ECOEvaDesValLL_MAP' */
...
CALDATA const volatile float32 cal_EEEnvAndEnvDiffVal = 15.0F;/* Referenced by: '<S1717>/Switch12' */
CALDATA const volatile float32 cal_EVAPSufTempClsSOV = 8.0F;/* Referenced by: '<S448>/Relay' */
CALDATA const volatile float32 cal_EVAPSufTempOpenSOV = 3.0F;/* Referenced by: '<S448>/Relay' */
...
CALDATA const volatile float32 cal_EntExtDefTime = 10.0F;/* Referenced by: '<S1704>/Constant3' */
CALDATA const volatile boolean cal_EnvFailSwFlg = false;/* Referenced by: '<S1724>/Constant' */
...
CALDATA const volatile float32 cal_EnvTempCorData = 0.0F;/* Referenced by: '<S1751>/Constant' */
CALDATA const volatile boolean cal_EnvTempCorEnb = false;/* Referenced by: '<S1751>/Constant1' */
CALDATA const volatile float32 cal_EnvTempRiseStep = 0.5F;/* Referenced by: '<S1717>/Constant3' */
CALDATA const volatile float32 cal_EnvTempStep = 0.1F;/* Referenced by: '<S182>/Constant3' */
...
CALDATA const volatile float32 cal_ErrAmbTDvtForEvaLL = 2.0F;/* Referenced by: '<S180>/Constant4' */
CALDATA const volatile float32 cal_ErrAmbTDvtForEvaUL = 4.0F;/* Referenced by: '<S180>/Constant3' */
CALDATA const volatile float32 cal_ErrAmbTDvtForPtcLL = 2.0F;/* Referenced by: '<S181>/Constant2' */
CALDATA const volatile float32 cal_ErrAmbTDvtForPtcUL = 4.0F;/* Referenced by: '<S181>/Constant1' */
...
CALDATA const volatile float32 cal_EvaDesLLMin = 2.5F;/* Referenced by:
                                                       ...
                                                       * '<S281>/Constant6'
                                                       */
CALDATA const volatile boolean cal_EvaDesLLSelect = false;/* Referenced by: '<S281>/Constant' */
...
CALDATA const volatile float32 cal_EvapBacTempDesAC_1X[6] = { -1.0F, 2.0F, 10.0F,
  25.0F, 29.0F, 30.0F } ; /* Referenced by: '<S284>/cal_EvapBacTempDesAC_CUR' */
...
CALDATA const volatile float32 cal_EvapDesTempFanCor_CUR[4] = { 0.0F, -1.0F,
  -2.0F, -3.0F } ;       /* Referenced by: '<S284>/cal_EvapDesTempFanCor_CUR' */
...
CALDATA const volatile float32 cal_EvapDesTempPsFanCor_CUR[4] = { 0.0F, -1.0F,
  -2.0F, -3.0F } ;     /* Referenced by: '<S309>/cal_EvapDesTempPsFanCor_CUR' */

CALDATA const volatile float32 cal_EvapSurTempData = 0.0F;/* Referenced by: '<S1817>/Constant' */
CALDATA const volatile boolean cal_EvapSurTempDataEnb = false;/* Referenced by: '<S1817>/Constant1' */
CALDATA const volatile float32 cal_EvapTempData = 0.0F;/* Referenced by: '<S1807>/Constant' */
CALDATA const volatile boolean cal_EvapTempDataEnb = false;/* Referenced by: '<S1807>/Constant1' */
CALDATA const volatile float32 cal_ExhSuperHeatFilter = 0.9F;/* Referenced by: '<S908>/Constant1' */
CALDATA const volatile uint16 cal_ExhaustTime = 600U;/* Referenced by: '<S11>/Constant7' */
CALDATA const volatile float32 cal_ExitExtDefTime = 3.0F;/* Referenced by: '<S1705>/Constant' */
CALDATA const volatile float32 cal_ExtDefBatMinT = 20.0F;/* Referenced by: '<S948>/Constant' */
CALDATA const volatile float32 cal_ExtDefEnvMaxTemp = 5.0F;/* Referenced by: '<S1704>/Constant' */
CALDATA const volatile float32 cal_ExtDefEnvMinTemp = -15.0F;/* Referenced by: '<S1704>/Constant1' */
CALDATA const volatile boolean cal_ExtDefFlgData = false;/* Referenced by: '<S1707>/Constant' */
CALDATA const volatile boolean cal_ExtDefFlgDataEnb = false;/* Referenced by: '<S1707>/Constant1' */
CALDATA const volatile float32 cal_ExtDefOHXOffTemp = 12.0F;/* Referenced by: '<S1709>/Constant' */
CALDATA const volatile float32 cal_ExtDefOHXOnTemp = 1.0F;/* Referenced by: '<S1708>/Constant' */
CALDATA const volatile float32 cal_ExtDefPTCTrgTemp = 25.0F;/* Referenced by: '<S446>/Constant6' */
CALDATA const volatile float32 cal_ExtDefTempDiff = 12.0F;/* Referenced by: '<S1704>/Constant2' */
CALDATA const volatile uint8 cal_FANSpdHotStartLL = 15U;/* Referenced by: '<S53>/Constant12' */
CALDATA const volatile uint8 cal_FANSpdHotStartUL = 40U;/* Referenced by: '<S52>/Constant27' */
CALDATA const volatile uint8 cal_FANSpdModeShiftMax = 60U;/* Referenced by: '<S52>/Constant3' */
CALDATA const volatile float32 cal_FaceDuctTempData = 0.0F;/* Referenced by: '<S1756>/Constant' */
CALDATA const volatile boolean cal_FaceDuctTempEnb = false;/* Referenced by: '<S1756>/Constant1' */
...
CALDATA const volatile uint8 cal_FanCtrlOff = 10U;/* Referenced by: '<S929>/Constant2' */
...
CALDATA const volatile boolean cal_FixPIDSecletFlag = true;/* Referenced by:
                                                            ...
                                                            * '<S186>/Constant'
                                                            */
CALDATA const volatile float32 cal_FootDuctTempData = 0.0F;/* Referenced by: '<S1766>/Constant' */
CALDATA const volatile boolean cal_FootDuctTempEnb = false;/* Referenced by: '<S1766>/Constant1' */
...
CALDATA const volatile uint16 cal_HAPtimelim2activtic = 100U;
                             /* Referenced by: '<S41>/AirConditionStartState' */
CALDATA const volatile boolean cal_HMIUnlckVentEnb = false;/* Referenced by: '<S1213>/Constant1' */
CALDATA const volatile uint8 cal_HMIUnlckVentEnbData = 0U;/* Referenced by: '<S1213>/Constant' */
CALDATA const volatile float32 cal_HPAndLPDiffMaxVal = 0.3F;/* Referenced by: '<S523>/Constant' */
CALDATA const volatile float32 cal_HPEXVCtlKi = 0.0F;/* Referenced by: '<S830>/Constant11' */
CALDATA const volatile float32 cal_HPEXVCtlKiDeadzoneNeg = 0.0F;/* Referenced by: '<S830>/Constant7' */
CALDATA const volatile float32 cal_HPEXVCtlKiDeadzonePos = 0.0F;/* Referenced by: '<S830>/Constant6' */
CALDATA const volatile float32 cal_HPEXVCtlKisumMax = 50.0F;/* Referenced by: '<S830>/Constant8' */
CALDATA const volatile float32 cal_HPEXVCtlKisumMin = -50.0F;/* Referenced by: '<S830>/Constant9' */
CALDATA const volatile float32 cal_HPEXVCtlKp = 0.0F;/* Referenced by: '<S830>/Constant10' */
CALDATA const volatile float32 cal_HPEXVCtlKpDeadzoneNeg = 0.0F;/* Referenced by: '<S830>/Constant5' */
CALDATA const volatile float32 cal_HPEXVCtlKpDeadzonePos = 0.0F;/* Referenced by: '<S830>/Constant4' */
CALDATA const volatile float32 cal_HPEXVCtrlADeadzone = 1.0F;/* Referenced by: '<S867>/Constant6' */
CALDATA const volatile float32 cal_HPEXVCtrlADelayTime = 10.0F;/* Referenced by: '<S867>/Constant2' */
CALDATA const volatile float32 cal_HPEXVCtrlAFFLolmt = 4.0F;/* Referenced by: '<S867>/Constant1' */
CALDATA const volatile float32 cal_HPEXVCtrlAFFUplmt = 12.0F;/* Referenced by: '<S867>/Constant' */
...
CALDATA const volatile float32 cal_HPEXVCtrlAFF_CUR[5] = { 6.0F, 8.0F, 10.0F,
  10.0F, 10.0F } ;            /* Referenced by: '<S867>/cal_HPEXVCtrlAFF_CUR' */

CALDATA const volatile float32 cal_HPEXVCtrlAKi_1X[6] = { 0.0F, 1.0F, 2.0F, 5.0F,
  10.0F, 15.0F } ;            /* Referenced by: '<S867>/cal_HPEXVCtrlAKi_CUR' */

CALDATA const volatile float32 cal_HPEXVCtrlAKi_CUR[6] = { 0.0F, 0.006F, 0.005F,
  0.004F, 0.005F, 0.01F } ;   /* Referenced by: '<S867>/cal_HPEXVCtrlAKi_CUR' */

CALDATA const volatile float32 cal_HPEXVCtrlAKp_1X[6] = { 1.0F, 2.0F, 3.0F, 5.0F,
  8.0F, 12.0F } ;             /* Referenced by: '<S867>/cal_HPEXVCtrlAKp_CUR' */

CALDATA const volatile float32 cal_HPEXVCtrlAKp_CUR[6] = { 0.0F, 0.7F, 0.9F,
  0.7F, 1.0F, 0.9F } ;        /* Referenced by: '<S867>/cal_HPEXVCtrlAKp_CUR' */

CALDATA const volatile float32 cal_HPEXVCtrlAMax = 80.0F;/* Referenced by: '<S867>/Constant8' */
CALDATA const volatile float32 cal_HPEXVCtrlAMin = 10.0F;/* Referenced by: '<S867>/Constant9' */
CALDATA const volatile float32 cal_HPEXVCtrlAOpenVal = 20.0F;/* Referenced by: '<S867>/Constant3' */
...
CALDATA const volatile float32 cal_HPEXVCtrlCDeadzone = 0.5F;/* Referenced by: '<S869>/Constant6' */
CALDATA const volatile float32 cal_HPEXVCtrlCDelayTime = 10.0F;/* Referenced by: '<S869>/Constant2' */
...
CALDATA const volatile float32 cal_HPEXVCtrlCFF_CUR[5] = { 40.0F, 40.0F, 40.0F,
  40.0F, 40.0F } ;            /* Referenced by: '<S869>/cal_HPEXVCtrlCFF_CUR' */
...
CALDATA const volatile float32 cal_HPEXVCtrlCMax = 100.0F;/* Referenced by: '<S869>/Constant7' */
CALDATA const volatile float32 cal_HPEXVCtrlCMin = 25.0F;/* Referenced by: '<S869>/Constant8' */
CALDATA const volatile float32 cal_HPEXVCtrlCOpenVal = 25.0F;/* Referenced by: '<S869>/Constant3' */
CALDATA const volatile float32 cal_HPEXVCtrlDDeadzone = 1.0F;/* Referenced by: '<S870>/Constant6' */
CALDATA const volatile float32 cal_HPEXVCtrlDDelayTime = 10.0F;/* Referenced by: '<S870>/Constant2' */
CALDATA const volatile float32 cal_HPEXVCtrlDFFLolmt = 4.0F;/* Referenced by: '<S870>/Constant1' */
CALDATA const volatile float32 cal_HPEXVCtrlDFFUplmt = 100.0F;/* Referenced by: '<S870>/Constant' */
...
CALDATA const volatile float32 cal_HPEXVCtrlDFF_CUR[5] = { 25.0F, 25.0F, 25.0F,
  25.0F, 25.0F } ;            /* Referenced by: '<S870>/cal_HPEXVCtrlDFF_CUR' */
...
CALDATA const volatile float32 cal_HPEXVCtrlDMax = 100.0F;/* Referenced by: '<S870>/Constant8' */
CALDATA const volatile float32 cal_HPEXVCtrlDMin = 10.0F;/* Referenced by: '<S870>/Constant9' */
CALDATA const volatile float32 cal_HPEXVCtrlDOpenVal = 20.0F;/* Referenced by: '<S870>/Constant3' */
...
CALDATA const volatile float32 cal_HPEXVCtrlEDeadzone = 1.0F;/* Referenced by: '<S871>/Constant6' */
CALDATA const volatile float32 cal_HPEXVCtrlEDelayTime = 10.0F;/* Referenced by: '<S871>/Constant2' */
CALDATA const volatile float32 cal_HPEXVCtrlEFFLolmt = 4.0F;/* Referenced by: '<S871>/Constant1' */
CALDATA const volatile float32 cal_HPEXVCtrlEFFUplmt = 12.0F;/* Referenced by: '<S871>/Constant' */
...
CALDATA const volatile float32 cal_HPEXVCtrlEFF_CUR[5] = { 6.0F, 8.0F, 10.0F,
  10.0F, 10.0F } ;            /* Referenced by: '<S871>/cal_HPEXVCtrlEFF_CUR' */

CALDATA const volatile float32 cal_HPEXVCtrlEKi_1X[6] = { 0.0F, 1.0F, 2.0F, 5.0F,
  10.0F, 15.0F } ;            /* Referenced by: '<S871>/cal_HPEXVCtrlEKi_CUR' */

CALDATA const volatile float32 cal_HPEXVCtrlEKi_CUR[6] = { 0.0F, 0.006F, 0.005F,
  0.004F, 0.005F, 0.01F } ;   /* Referenced by: '<S871>/cal_HPEXVCtrlEKi_CUR' */

CALDATA const volatile float32 cal_HPEXVCtrlEKp_1X[6] = { 1.0F, 2.0F, 3.0F, 5.0F,
  8.0F, 12.0F } ;             /* Referenced by: '<S871>/cal_HPEXVCtrlEKp_CUR' */

CALDATA const volatile float32 cal_HPEXVCtrlEKp_CUR[6] = { 0.0F, 0.7F, 0.9F,
  0.7F, 1.0F, 0.9F } ;        /* Referenced by: '<S871>/cal_HPEXVCtrlEKp_CUR' */

CALDATA const volatile float32 cal_HPEXVCtrlEMax = 80.0F;/* Referenced by: '<S871>/Constant8' */
CALDATA const volatile float32 cal_HPEXVCtrlEMin = 10.0F;/* Referenced by: '<S871>/Constant9' */
CALDATA const volatile float32 cal_HPEXVCtrlEOpenVal = 20.0F;/* Referenced by: '<S871>/Constant3' */
...
CALDATA const volatile float32 cal_HPEXVDiffDown = 5.0F;/* Referenced by: '<S834>/Constant8' */
CALDATA const volatile float32 cal_HPEXVDiffDownRate = 5.0F;/* Referenced by: '<S834>/Constant7' */
CALDATA const volatile float32 cal_HPEXVDiffUp = 5.0F;/* Referenced by: '<S834>/Constant6' */
CALDATA const volatile float32 cal_HPEXVDiffUpRate = 5.0F;/* Referenced by: '<S834>/Constant5' */
CALDATA const volatile float32 cal_HPEXVDownSpdLmt = 0.5F;/* Referenced by:
                                                           * '<S839>/DownLmt'
                                                           * '<S839>/DownLmt1'
                                                           */
CALDATA const volatile boolean cal_HPEXVEnbData = false;/* Referenced by: '<S845>/Constant' */
CALDATA const volatile boolean cal_HPEXVEnbDataEnb = false;/* Referenced by: '<S845>/Constant1' */
CALDATA const volatile float32 cal_HPEXVFloorDiff1 = 0.2F;/* Referenced by: '<S837>/Constant1' */
CALDATA const volatile float32 cal_HPEXVFloorDiff2 = 0.7F;/* Referenced by: '<S837>/Constant' */
CALDATA const volatile float32 cal_HPEXVHiPressLmtOff = 2.1F;/* Referenced by: '<S873>/HiPressLmt' */
CALDATA const volatile float32 cal_HPEXVHiPressLmtOn = 2.3F;/* Referenced by: '<S873>/HiPressLmt' */
CALDATA const volatile float32 cal_HPEXVHiPressProOpenSpd = 0.1F;/* Referenced by:
                                                                  * '<S834>/Constant1'
                                                                  * '<S834>/Constant3'
                                                                  */
CALDATA const volatile float32 cal_HPEXVHiPressProhOff = 2.2F;/* Referenced by: '<S834>/HiProRelay' */
CALDATA const volatile float32 cal_HPEXVHiPressProhOn = 2.4F;/* Referenced by: '<S834>/HiProRelay' */
CALDATA const volatile uint8 cal_HPEXVInitReqData = 0U;/* Referenced by: '<S902>/Constant' */
CALDATA const volatile boolean cal_HPEXVInitReqDataeEnb = false;/* Referenced by: '<S902>/Constant1' */
CALDATA const volatile float32 cal_HPEXVLowPressLmtOff = 0.17F;/* Referenced by: '<S873>/LowPressLmt' */
CALDATA const volatile float32 cal_HPEXVLowPressLmtOn = 0.15F;/* Referenced by: '<S873>/LowPressLmt' */
...
CALDATA const volatile float32 cal_HPEXVOpenCtrlUpSpdLmt = 1.0F;/* Referenced by:
                                                                 ...
                                                                 * '<S840>/UpLmt2'
                                                                 */
CALDATA const volatile float32 cal_HPEXVPosData = 0.0F;/* Referenced by: '<S835>/Constant' */
CALDATA const volatile boolean cal_HPEXVPosDataEnb = false;/* Referenced by: '<S835>/Constant1' */
CALDATA const volatile boolean cal_HPEXVStepLmtSw = true;/* Referenced by: '<S827>/Constant2' */
...
CALDATA const volatile float32 cal_HPEXVUpSpdLmt = 0.5F;/* Referenced by:
                                                         ...
                                                         * '<S839>/UpLmt2'
                                                         */
CALDATA const volatile float32 cal_HPEXVlowPressLmtTrg = 5.0F;/* Referenced by: '<S831>/Constant' */
CALDATA const volatile float32 cal_HPEXVlowPressProhOff = 0.16F;/* Referenced by: '<S834>/LowProRelay' */
CALDATA const volatile float32 cal_HPEXVlowPressProhOn = 0.14F;/* Referenced by: '<S834>/LowProRelay' */
CALDATA const volatile float32 cal_HPHighLmtVal = 5.0F;/* Referenced by: '<S1730>/Constant' */
CALDATA const volatile float32 cal_HPProVal1 = 1.5F;/* Referenced by: '<S533>/Relay' */
CALDATA const volatile float32 cal_HPProVal1Relay = 1.3F;/* Referenced by: '<S533>/Relay' */
...
CALDATA const volatile float32 cal_HPProVal3Relay = 2.3F;/* Referenced by:
                                                          ...
                                                          * '<S533>/Relay2'
                                                          */
CALDATA const volatile float32 cal_HPProVal4 = 2.7F;/* Referenced by: '<S530>/Relay2' */
CALDATA const volatile uint8 cal_HVPartModeData = 0U;/* Referenced by: '<S1710>/Constant' */
CALDATA const volatile boolean cal_HVPartModeEnb = false;/* Referenced by: '<S1710>/Constant1' */
CALDATA const volatile float32 cal_HeatCOMPEnvTempLmtOff = -14.0F;/* Referenced by: '<S502>/Relay1' */
CALDATA const volatile float32 cal_HeatCOMPEnvTempLmtOn = -12.0F;/* Referenced by: '<S502>/Relay1' */
CALDATA const volatile uint8 cal_HeatCabinAndCoolBatFanSpd = 80U;/* Referenced by: '<S445>/Constant1' */
CALDATA const volatile float32 cal_HeatFanCtrl_2X[4] = { 0.0F, 40.0F, 80.0F,
  120.0F } ;                   /* Referenced by: '<S927>/cal_HeatFanCtrl_MAP' */
...
CALDATA const volatile float32 cal_HeatPumpCOMPHPrsDownSpd = 60.0F;/* Referenced by: '<S457>/Constant1' */
CALDATA const volatile float32 cal_HeatPumpCOMPHPrsP1 = 0.15F;/* Referenced by: '<S457>/Relay13' */
CALDATA const volatile float32 cal_HeatPumpCOMPHPrsP2 = 0.16F;/* Referenced by: '<S457>/Relay13' */
CALDATA const volatile float32 cal_HeatPumpCOMPHPrsP3 = 0.16F;/* Referenced by: '<S457>/Relay12' */
CALDATA const volatile float32 cal_HeatPumpCOMPHPrsP4 = 0.18F;/* Referenced by: '<S457>/Relay12' */
CALDATA const volatile float32 cal_HeatPumpCOMPHPrsP5 = 2.2F;/* Referenced by: '<S457>/Relay14' */
CALDATA const volatile float32 cal_HeatPumpCOMPHPrsP6 = 2.4F;/* Referenced by: '<S457>/Relay14' */
CALDATA const volatile float32 cal_HeatPumpCOMPHPrsP7 = 2.4F;/* Referenced by: '<S457>/Relay15' */
CALDATA const volatile float32 cal_HeatPumpCOMPHPrsP8 = 2.6F;/* Referenced by: '<S457>/Relay15' */
CALDATA const volatile float32 cal_HeatPumpCOMPLPrsDownSpd = 30.0F;/* Referenced by: '<S457>/Constant3' */
CALDATA const volatile float32 cal_HeatPumpCOMPLPrsP1 = 0.11F;/* Referenced by: '<S457>/Relay5' */
CALDATA const volatile float32 cal_HeatPumpCOMPLPrsP2 = 0.13F;/* Referenced by: '<S457>/Relay5' */
CALDATA const volatile float32 cal_HeatPumpCOMPLPrsP3 = 0.13F;/* Referenced by: '<S457>/Relay4' */
CALDATA const volatile float32 cal_HeatPumpCOMPLPrsP4 = 0.15F;/* Referenced by: '<S457>/Relay4' */
CALDATA const volatile float32 cal_HeatPumpCOMPLPrsP5 = 0.6F;/* Referenced by: '<S457>/Relay6' */
CALDATA const volatile float32 cal_HeatPumpCOMPLPrsP6 = 0.65F;/* Referenced by: '<S457>/Relay6' */
CALDATA const volatile float32 cal_HeatPumpCOMPLPrsP7 = 0.65F;/* Referenced by: '<S457>/Relay7' */
CALDATA const volatile float32 cal_HeatPumpCOMPLPrsP8 = 0.7F;/* Referenced by: '<S457>/Relay7' */
CALDATA const volatile float32 cal_HeatPwrOn = 1.0F;/* Referenced by:
                                                     ...
                                                     * '<S1479>/Constant'
                                                     */
CALDATA const volatile float32 cal_HiPressData = 0.0F;/* Referenced by: '<S1851>/Constant' */
CALDATA const volatile boolean cal_HiPressDataEnb = false;/* Referenced by: '<S1851>/Constant1' */
CALDATA const volatile float32 cal_IGBTDownLmtTemp = 55.0F;/* Referenced by: '<S1308>/Relay1' */
CALDATA const volatile float32 cal_IGBTUpLmtTemp = 65.0F;/* Referenced by: '<S1308>/Relay1' */
CALDATA const volatile uint8 cal_IGNONDelayTime = 40U;/* Referenced by: '<S32>/Constant3' */
CALDATA const volatile uint8 cal_InnerRecTrgPos = 95U;/* Referenced by: '<S1866>/Constant1' */
...
CALDATA const volatile uint8 cal_LPFanCtrl = 60U;/* Referenced by: '<S928>/Constant11' */
CALDATA const volatile float32 cal_LPFanOff = 0.17F;/* Referenced by: '<S941>/Constant' */
CALDATA const volatile float32 cal_LPFanOn = 0.14F;/* Referenced by: '<S940>/Constant' */
CALDATA const volatile float32 cal_LPProOffTimer = 10.0F;/* Referenced by: '<S928>/Constant1' */
CALDATA const volatile float32 cal_LPProOnTimer = 20.0F;/* Referenced by: '<S928>/Constant' */
CALDATA const volatile float32 cal_LTRExitBatMaxCellTemp = 36.0F;/* Referenced by: '<S1452>/Constant' */
...
CALDATA const volatile float32 cal_LTRIGBTMaxExitTempB = 55.0F;/* Referenced by: '<S1620>/Constant' */
...
CALDATA const volatile float32 cal_LTRMotorInletMaxExitTempA = 50.0F;/* Referenced by: '<S1619>/Constant' */
CALDATA const volatile float32 cal_LTRMotorMaxEntTemp = 65.0F;/* Referenced by: '<S1645>/Constant' */
CALDATA const volatile float32 cal_LTRMotorMaxExitTemp = 55.0F;/* Referenced by: '<S1622>/Constant' */
...
CALDATA const volatile float32 cal_LTT1DownMCV_1X[5] = { 37.0F, 39.0F, 41.0F,
  43.0F, 45.0F } ;             /* Referenced by: '<S651>/cal_LTT1DownMCV_CUR' */
...
CALDATA const volatile float32 cal_LTT1StbyMCV_1X[6] = { 38.0F, 40.0F, 42.0F,
  44.0F, 46.0F, 48.0F } ;      /* Referenced by: '<S651>/cal_LTT1StbyMCV_CUR' */

CALDATA const volatile uint8 cal_LTT1StbyMCV_CUR[6] = { 5U, 5U, 5U, 12U, 12U,
  12U } ;                      /* Referenced by: '<S651>/cal_LTT1StbyMCV_CUR' */

CALDATA const volatile float32 cal_LTT1UpMCV_1X[5] = { 39.0F, 41.0F, 43.0F,
  45.0F, 47.0F } ;               /* Referenced by: '<S651>/cal_LTT1UpMCV_CUR' */
...
CALDATA const volatile boolean cal_LessThanT1CalSwt = true;/* Referenced by:
                                                            ...
                                                            * '<S651>/Constant3'
                                                            */
CALDATA const volatile float32 cal_LoPressData = 0.0F;/* Referenced by: '<S1775>/Constant' */
CALDATA const volatile boolean cal_LoPressDataEnb = false;/* Referenced by: '<S1775>/Constant1' */
...
CALDATA const volatile float32 cal_MBIGBTHighExitTempG = 65.0F;/* Referenced by: '<S1609>/Constant' */
CALDATA const volatile float32 cal_MBIPUDevHighExitTempI = 65.0F;/* Referenced by: '<S1613>/Constant' */
CALDATA const volatile float32 cal_MBMotorInletHighExitTempH = 60.0F;/* Referenced by: '<S1610>/Constant' */
CALDATA const volatile uint8 cal_MCVFltStsDelayTime = 3U;/* Referenced by: '<S644>/Constant5' */
CALDATA const volatile float32 cal_MCVPosDiffDelayTime = 0.5F;/* Referenced by: '<S644>/Constant2' */
CALDATA const volatile uint8 cal_MixCoolTrgPos = 7U;/* Referenced by: '<S1867>/Constant1' */
CALDATA const volatile uint8 cal_MixDoor2CabinCoolingEn_OFF = 60U;/* Referenced by: '<S90>/Constant7' */
CALDATA const volatile uint8 cal_MixDoor2CabinCoolingEn_ON = 40U;/* Referenced by: '<S90>/Constant6' */
...
CALDATA const volatile float32 cal_MixDoorKi_CUR[8] = { 0.0F, 0.0F, 0.0F, 0.0F,
  0.0F, 0.0F, 0.0F, 0.0F } ;     /* Referenced by: '<S392>/cal_MixDoorKi_CUR' */
...
CALDATA const volatile float32 cal_MixDoorKp_CUR[8] = { 0.0F, 0.0F, 0.0F, 0.0F,
  0.0F, 0.0F, 0.0F, 0.0F } ;     /* Referenced by: '<S392>/cal_MixDoorKp_CUR' */

CALDATA const volatile uint8 cal_MixDoorNData = 0U;/* Referenced by: '<S1880>/Constant' */
CALDATA const volatile float32 cal_MixDoorNErr = 5.0F;/* Referenced by: '<S1867>/Judge' */
CALDATA const volatile uint8 cal_MixDoorPData = 0U;/* Referenced by: '<S1881>/Constant' */
CALDATA const volatile float32 cal_MixDoorPErr = 5.0F;/* Referenced by: '<S1867>/Judge' */
CALDATA const volatile float32 cal_MixDoorPercData = 0.0F;/* Referenced by: '<S1219>/Constant' */
CALDATA const volatile boolean cal_MixDoorPercDataEnb = false;/* Referenced by: '<S1219>/Constant1' */
...
CALDATA const volatile uint8 cal_MixWarmTrgPos = 94U;/* Referenced by: '<S1867>/Constant' */
...
CALDATA const volatile boolean cal_ModeMotorEnb = false;/* Referenced by:
                                                         ...
                                                         * '<S1889>/Constant1'
                                                         */
CALDATA const volatile uint8 cal_ModeMotorNData = 0U;/* Referenced by: '<S1888>/Constant' */
CALDATA const volatile float32 cal_ModeMotorNErr = 0.5F;/* Referenced by: '<S1868>/Judge' */
CALDATA const volatile uint8 cal_ModeMotorPData = 0U;/* Referenced by: '<S1889>/Constant' */
CALDATA const volatile float32 cal_ModeMotorPErr = 0.5F;/* Referenced by: '<S1868>/Judge' */
CALDATA const volatile float32 cal_ModeMotorTrgPosData = 0.0F;/* Referenced by: '<S1887>/Constant' */
...
CALDATA const volatile float32 cal_ModeMotorTrgPos_CUR[5] = { 0.5F, 2.5F, 1.65F,
  3.4F, 4.5F } ;          /* Referenced by: '<S1868>/cal_ModeMotorTrgPos_CUR' */

CALDATA const volatile float32 cal_MotHeatBatMinTempDiff = 5.0F;/* Referenced by: '<S1351>/Constant' */
...
CALDATA const volatile uint8 cal_MotPMPDefaultSpd = 22U;/* Referenced by: '<S1033>/Constant4' */
CALDATA const volatile boolean cal_MotPMPFaultFlgData = false;/* Referenced by: '<S1075>/Constant' */
CALDATA const volatile boolean cal_MotPMPFaultFlgDataEnb = false;/* Referenced by: '<S1075>/Constant1' */
CALDATA const volatile uint8 cal_MotPMPMotHeatBatSpd = 100U;/* Referenced by: '<S1033>/Constant11' */
CALDATA const volatile uint8 cal_MotPMPSpdDiffVal = 10U;/* Referenced by: '<S1033>/Constant' */
CALDATA const volatile uint8 cal_MotPMPSpdSetData = 0U;/* Referenced by: '<S1074>/Constant' */
CALDATA const volatile boolean cal_MotPMPSpdSetDataEnb = false;/* Referenced by: '<S1074>/Constant1' */
CALDATA const volatile uint8 cal_MotPMPThStoSpd = 60U;/* Referenced by: '<S1033>/Constant12' */
CALDATA const volatile float32 cal_MotTempData = 0.0F;/* Referenced by: '<S1823>/Constant' */
CALDATA const volatile boolean cal_MotTempDataEnb = false;/* Referenced by: '<S1823>/Constant1' */
CALDATA const volatile float32 cal_MotTempDownLmt = 45.0F;/* Referenced by: '<S1308>/Relay' */
CALDATA const volatile float32 cal_MotTempUpLmt = 60.0F;/* Referenced by: '<S1308>/Relay' */
CALDATA const volatile float32 cal_MotorModeData = 0.0F;/* Referenced by: '<S1226>/Constant' */
CALDATA const volatile boolean cal_MotorModeEnb = false;/* Referenced by: '<S1226>/Constant1' */
CALDATA const volatile float32 cal_NmCOMPEnvTempLmtOff = 0.0F;/* Referenced by: '<S502>/Relay' */
CALDATA const volatile float32 cal_NmCOMPEnvTempLmtOn = 4.0F;/* Referenced by: '<S502>/Relay' */
CALDATA const volatile float32 cal_NmlBatHeatEnvTemp[2] = { 5.0F, 15.0F } ;/* Referenced by: '<S1513>/Constant1' */

CALDATA const volatile float32 cal_NmlBatHeatT1[3] = { 0.0F, 0.0F, 0.0F } ;/* Referenced by: '<S1513>/Constant2' */

CALDATA const volatile float32 cal_NmlBatHeatT2[3] = { 5.0F, 5.0F, 5.0F } ;/* Referenced by: '<S1513>/Constant3' */

CALDATA const volatile float32 cal_NmlBatHeatTave[3] = { 10.0F, 10.0F, 10.0F } ;/* Referenced by: '<S1513>/Constant' */

CALDATA const volatile float32 cal_NmlBatHeatTrgTemp = 45.0F;/* Referenced by:
                                                              * '<S650>/Constant6'
                                                              * '<S1513>/Constant4'
                                                              */
CALDATA const volatile float32 cal_NmlCOMPHPrsDownSpd = 150.0F;/* Referenced by: '<S457>/Constant' */
CALDATA const volatile float32 cal_NmlCOMPHPrsP1 = 0.23F;/* Referenced by: '<S457>/Relay1' */
CALDATA const volatile float32 cal_NmlCOMPHPrsP2 = 0.25F;/* Referenced by: '<S457>/Relay1' */
CALDATA const volatile float32 cal_NmlCOMPHPrsP3 = 0.25F;/* Referenced by: '<S457>/Relay' */
CALDATA const volatile float32 cal_NmlCOMPHPrsP4 = 0.27F;/* Referenced by: '<S457>/Relay' */
CALDATA const volatile float32 cal_NmlCOMPHPrsP5 = 2.2F;/* Referenced by: '<S457>/Relay2' */
CALDATA const volatile float32 cal_NmlCOMPHPrsP6 = 2.4F;/* Referenced by: '<S457>/Relay2' */
CALDATA const volatile float32 cal_NmlCOMPHPrsP7 = 2.4F;/* Referenced by: '<S457>/Relay3' */
CALDATA const volatile float32 cal_NmlCOMPHPrsP8 = 2.7F;/* Referenced by: '<S457>/Relay3' */
CALDATA const volatile float32 cal_NmlCOMPLPrsDownSpd = 150.0F;/* Referenced by: '<S457>/Constant2' */
CALDATA const volatile float32 cal_NmlCOMPLPrsP1 = 0.11F;/* Referenced by: '<S457>/Relay9' */
CALDATA const volatile float32 cal_NmlCOMPLPrsP2 = 0.13F;/* Referenced by: '<S457>/Relay9' */
CALDATA const volatile float32 cal_NmlCOMPLPrsP3 = 0.13F;/* Referenced by: '<S457>/Relay8' */
CALDATA const volatile float32 cal_NmlCOMPLPrsP4 = 0.15F;/* Referenced by: '<S457>/Relay8' */
CALDATA const volatile float32 cal_NmlCOMPLPrsP5 = 0.6F;/* Referenced by: '<S457>/Relay10' */
CALDATA const volatile float32 cal_NmlCOMPLPrsP6 = 0.65F;/* Referenced by: '<S457>/Relay10' */
CALDATA const volatile float32 cal_NmlCOMPLPrsP7 = 0.65F;/* Referenced by: '<S457>/Relay11' */
CALDATA const volatile float32 cal_NmlCOMPLPrsP8 = 0.7F;/* Referenced by: '<S457>/Relay11' */
CALDATA const volatile float32 cal_OHXTempData = 0.0F;/* Referenced by: '<S1833>/Constant' */
CALDATA const volatile boolean cal_OHXTempDataEnb = false;/* Referenced by: '<S1833>/Constant1' */
...
CALDATA const volatile float32 cal_OpenCoolInletTemp = 19.0F;/* Referenced by: '<S1312>/Constant1' */
CALDATA const volatile float32 cal_OpenCtrlCOMPDownlmt = 100.0F;/* Referenced by: '<S569>/Constant4' */
CALDATA const volatile float32 cal_OpenCtrlCOMPUplmt = 100.0F;/* Referenced by: '<S569>/Constant3' */
CALDATA const volatile uint8 cal_OutRecTrgPos = 5U;/* Referenced by: '<S1866>/Constant' */
...
CALDATA const volatile float32 cal_PTCAuxHeatPwrLmt_2Y[6] = { 0.0F, 1.0F, 3.0F,
  6.0F, 9.0F, 10.0F } ;   /* Referenced by: '<S584>/cal_PTCAuxHeatPwrLmt_MAP' */
...
CALDATA const volatile uint8 cal_PTCDelOffTime = 1U;/* Referenced by: '<S956>/Constant12' */
CALDATA const volatile uint8 cal_PTCEnableData = 0U;/* Referenced by: '<S1022>/Constant' */
CALDATA const volatile boolean cal_PTCEnableDataEnb = false;/* Referenced by: '<S1022>/Constant1' */
CALDATA const volatile float32 cal_PTCMaxTemp = 80.0F;/* Referenced by: '<S446>/Constant1' */
CALDATA const volatile float32 cal_PTCMinTemp = -40.0F;/* Referenced by: '<S446>/Constant3' */
CALDATA const volatile uint8 cal_PTCOffAcPMPSpd = 80U;/* Referenced by: '<S1031>/Constant16' */
CALDATA const volatile float32 cal_PTCOffPowerVal = 0.5F;/* Referenced by: '<S584>/Constant6' */
CALDATA const volatile float32 cal_PTCOnReqPower_1X[6] = { 0.0F, 10.0F, 20.0F,
  30.0F, 40.0F, 50.0F } ;    /* Referenced by: '<S584>/cal_PTCOnReqPower_CUR' */

CALDATA const volatile float32 cal_PTCOnReqPower_CUR[6] = { 0.0F, 5.0F, 5.0F,
  5.0F, 5.0F, 5.0F } ;       /* Referenced by: '<S584>/cal_PTCOnReqPower_CUR' */

CALDATA const volatile float32 cal_PTCPwrOffFlt = 2.0F;/* Referenced by: '<S956>/Constant11' */
CALDATA const volatile float32 cal_PTCReqTempData = -40.0F;/* Referenced by: '<S953>/Constant' */
CALDATA const volatile boolean cal_PTCReqTempDataEnb = false;/* Referenced by: '<S953>/Constant1' */
CALDATA const volatile float32 cal_PTCReqtPowerData = 0.0F;/* Referenced by: '<S1029>/Constant' */
CALDATA const volatile boolean cal_PTCReqtPowerDataEnb = false;/* Referenced by: '<S1029>/Constant1' */
CALDATA const volatile uint8 cal_PTCRunAcPMPFFSpd = 25U;/* Referenced by:
                                                         * '<S1031>/Constant12'
                                                         * '<S1031>/Constant14'
                                                         */
CALDATA const volatile float32 cal_PTCRunAcPMPFFTime = 5.0F;/* Referenced by: '<S1031>/Constant15' */
CALDATA const volatile float32 cal_PTCTempRecircOff = 70.0F;/* Referenced by: '<S134>/Constant5' */
CALDATA const volatile float32 cal_PTCTempRecircOn = 90.0F;/* Referenced by: '<S134>/Constant6' */
CALDATA const volatile float32 cal_PressRateVal1 = 8.0F;/* Referenced by: '<S534>/Relay' */
CALDATA const volatile float32 cal_PressRateVal1Relay = 6.0F;/* Referenced by: '<S534>/Relay' */
...
CALDATA const volatile float32 cal_PressRateVal3Relay = 14.0F;/* Referenced by:
                                                               ...
                                                               * '<S534>/Relay2'
                                                               */
CALDATA const volatile float32 cal_PressRateVal4 = 20.0F;/* Referenced by: '<S536>/Relay1' */
CALDATA const volatile float32 cal_PsDVTWeight = 0.0F;
                    /* Referenced by: '<S60>/ACCtl_facLeftBlowerFanSpdWeight' */
CALDATA const volatile float32 cal_PsDuctFaceFloorFaFactor = 0.6F;/* Referenced by: '<S229>/Constant3' */
CALDATA const volatile float32 cal_PsDuctFaceFloorFoFactor = 0.4F;/* Referenced by: '<S229>/Constant4' */
CALDATA const volatile float32 cal_PsDuctSensorFailDeflt = 25.0F;
                       /* Referenced by: '<S177>/cal_PsDuctSensorFailDefault' */
CALDATA const volatile float32 cal_PsEnv4SetSelect = 0.0F;/* Referenced by: '<S187>/Constant3' */
...
/* Referenced by: '<S417>/On:cal_PsErrOfPtcDVT2HeatMixOn Off:cal_PsErrOfPtcDVT2HeatMixOff' */
CALDATA const volatile float32 cal_PsEvaDesValPIDIntegDeadBandNeg = 0.5F;/* Referenced by: '<S308>/Kp12' */
CALDATA const volatile float32 cal_PsEvaDesValPIDIntegDeadBandPos = 0.5F;/* Referenced by: '<S308>/Kp11' */
CALDATA const volatile float32 cal_PsEvaDesValPIDKi = 0.0F;/* Referenced by: '<S308>/Kp7' */
CALDATA const volatile float32 cal_PsEvaDesValPIDKiNeg = 0.004F;/* Referenced by: '<S308>/Kp9' */
CALDATA const volatile float32 cal_PsEvaDesValPIDKiPos = 0.004F;/* Referenced by: '<S308>/Kp10' */
CALDATA const volatile float32 cal_PsEvaDesValPIDKp = 0.3F;/* Referenced by: '<S308>/Kp' */
CALDATA const volatile float32 cal_PsEvaDesValPIDKpNeg = 1.0F;/* Referenced by: '<S308>/Kp1' */
CALDATA const volatile float32 cal_PsEvaDesValPIDKpPos = 1.0F;/* Referenced by: '<S308>/Kp2' */
CALDATA const volatile float32 cal_PsEvaDesValPIDLL = 2.5F;/* Referenced by: '<S308>/Kp6' */
...
CALDATA const volatile float32 cal_PsEvaDesValPIDUL = 25.0F;/* Referenced by: '<S308>/Kp5' */
CALDATA const volatile float32 cal_PsEvaDesValPID_IsumMax = 2.5F;/* Referenced by: '<S308>/Kp8' */
CALDATA const volatile float32 cal_PsEvaDesValPID_IsumMin = -2.5F;/* Referenced by: '<S308>/Kp13' */
CALDATA const volatile float32 cal_PsEvaDesValPID_pWinNeg = 3.0F;/* Referenced by: '<S308>/Kp4' */
CALDATA const volatile float32 cal_PsEvaDesValPID_pWinPos = 3.0F;/* Referenced by: '<S308>/Kp3' */
CALDATA const volatile float32 cal_PsEvapDesFilterByDvt_1X[4] = { 0.0F, 2.0F,
  3.0F, 4.0F } ;      /* Referenced by: '<S308>/cal_PsEvapDesFilterByDvt_CUR' */
...
CALDATA const volatile float32 cal_PsMixDesValPIDIntegDeadBand = 3.0F;/* Referenced by: '<S418>/Kp11' */
CALDATA const volatile uint8 cal_PsMixDesValPIDLL = 0U;/* Referenced by: '<S418>/Kp6' */
CALDATA const volatile uint8 cal_PsMixDesValPIDUL = 100U;/* Referenced by: '<S418>/Kp5' */
CALDATA const volatile float32 cal_PsMixDesValPID_IsumMax = 40.0F;/* Referenced by: '<S418>/Kp8' */
CALDATA const volatile float32 cal_PsMixDesValPID_IsumMin = -30.0F;/* Referenced by: '<S418>/Kp13' */
CALDATA const volatile float32 cal_PsMixDesValPID_Ki = 0.008F;/* Referenced by: '<S418>/Kp7' */
CALDATA const volatile float32 cal_PsMixDesValPID_KiNeg = 0.02F;/* Referenced by: '<S418>/Kp9' */
CALDATA const volatile float32 cal_PsMixDesValPID_KiPos = 0.02F;/* Referenced by: '<S418>/Kp10' */
CALDATA const volatile float32 cal_PsMixDesValPID_Kp = 1.0F;/* Referenced by: '<S418>/Kp' */
CALDATA const volatile float32 cal_PsMixDesValPID_KpNeg = 1.5F;/* Referenced by: '<S418>/Kp1' */
CALDATA const volatile float32 cal_PsMixDesValPID_KpPos = 1.5F;/* Referenced by: '<S418>/Kp2' */
CALDATA const volatile float32 cal_PsMixDesValPID_pWinNeg = 3.0F;/* Referenced by: '<S418>/Kp4' */
CALDATA const volatile float32 cal_PsMixDesValPID_pWinPos = 3.0F;/* Referenced by: '<S418>/Kp3' */
CALDATA const volatile float32 cal_PsPtcDesValPIDIntegDeadBand4InHeat = 5.0F;/* Referenced by: '<S366>/Kp16' */
CALDATA const volatile float32 cal_PsPtcDesValPIDIntegDeadBand4OutHeat = 3.0F;/* Referenced by: '<S366>/Kp24' */
CALDATA const volatile float32 cal_PsPtcDesValPIDKi = 0.0F;/* Referenced by: '<S366>/Kp7' */
CALDATA const volatile float32 cal_PsPtcDesValPIDKiNeg = 0.004F;/* Referenced by: '<S366>/Kp9' */
CALDATA const volatile float32 cal_PsPtcDesValPIDKiPos = 0.004F;/* Referenced by: '<S366>/Kp10' */
CALDATA const volatile float32 cal_PsPtcDesValPIDKp = 0.5F;/* Referenced by: '<S366>/Kp' */
CALDATA const volatile float32 cal_PsPtcDesValPIDKpNeg = 1.0F;/* Referenced by: '<S366>/Kp1' */
CALDATA const volatile float32 cal_PsPtcDesValPIDKpPos = 1.0F;/* Referenced by: '<S366>/Kp2' */
CALDATA const volatile float32 cal_PsPtcDesValPIDLL = 0.0F;/* Referenced by: '<S366>/Kp6' */
CALDATA const volatile float32 cal_PsPtcDesValPIDUL = 60.0F;/* Referenced by: '<S366>/Kp5' */
CALDATA const volatile float32 cal_PsPtcDesValPID_IsumMax = 2.0F;/* Referenced by: '<S366>/Kp8' */
CALDATA const volatile float32 cal_PsPtcDesValPID_IsumMin = -2.0F;/* Referenced by: '<S366>/Kp13' */
CALDATA const volatile float32 cal_PsPtcDesValPID_pWinNeg = 4.0F;/* Referenced by: '<S366>/Kp4' */
CALDATA const volatile float32 cal_PsPtcDesValPID_pWinPos = 3.0F;/* Referenced by: '<S366>/Kp3' */
CALDATA const volatile boolean cal_PtcEnable = false;/* Referenced by:
                                                      * '<S388>/Constant5'
                                                      * '<S389>/Constant5'
                                                      */
CALDATA const volatile float32 cal_PtcPwrDesValPIDDeadBandNeg = 1.5F;/* Referenced by: '<S96>/Constant6' */
CALDATA const volatile float32 cal_PtcPwrDesValPIDDeadBandPos = 4.0F;/* Referenced by: '<S96>/Constant7' */
CALDATA const volatile float32 cal_PtcPwrDesValPID_IsumMax = 3000.0F;/* Referenced by: '<S96>/Kp8' */
CALDATA const volatile float32 cal_PtcPwrDesValPID_IsumMin = -4000.0F;/* Referenced by: '<S96>/Kp13' */
CALDATA const volatile float32 cal_PtcPwrDesValPID_Ki = 0.1F;/* Referenced by: '<S96>/Kp7' */
CALDATA const volatile float32 cal_PtcPwrDesValPID_KiNeg = 0.3F;/* Referenced by: '<S96>/Kp9' */
CALDATA const volatile float32 cal_PtcPwrDesValPID_KiPos = 0.2F;/* Referenced by: '<S96>/Kp10' */
CALDATA const volatile float32 cal_PtcPwrDesValPID_Kp = 50.0F;/* Referenced by: '<S96>/Kp' */
CALDATA const volatile float32 cal_PtcPwrDesValPID_KpNeg = 200.0F;/* Referenced by: '<S96>/Kp1' */
CALDATA const volatile float32 cal_PtcPwrDesValPID_KpPos = 150.0F;/* Referenced by: '<S96>/Kp2' */
CALDATA const volatile uint16 cal_PtcPwrDesValPID_LL = 0U;/* Referenced by: '<S96>/Kp6' */
CALDATA const volatile uint16 cal_PtcPwrDesValPID_UL = 7000U;/* Referenced by: '<S96>/Kp5' */
CALDATA const volatile float32 cal_PtcPwrDesValPID_pWinNeg = 2.0F;/* Referenced by: '<S96>/Kp4' */
CALDATA const volatile float32 cal_PtcPwrDesValPID_pWinPos = 4.0F;/* Referenced by: '<S96>/Kp3' */
CALDATA const volatile boolean cal_PwrACPumpData = false;/* Referenced by: '<S1250>/Constant' */
CALDATA const volatile boolean cal_PwrACPumpEnb = false;/* Referenced by: '<S1250>/Constant1' */
CALDATA const volatile boolean cal_PwrBlwData = false;/* Referenced by: '<S1253>/Constant' */
CALDATA const volatile boolean cal_PwrBlwEnb = false;/* Referenced by: '<S1253>/Constant1' */
CALDATA const volatile uint8 cal_PwrFanAndPumpData = 0U;/* Referenced by: '<S1261>/Constant' */
CALDATA const volatile boolean cal_PwrFanAndPumpDataEnb = false;/* Referenced by: '<S1261>/Constant1' */
CALDATA const volatile boolean cal_PwrFanData = false;/* Referenced by: '<S1245>/Constant' */
CALDATA const volatile boolean cal_PwrFanEnb = false;/* Referenced by: '<S1245>/Constant1' */
CALDATA const volatile boolean cal_PwrHVPartData = false;/* Referenced by: '<S1264>/Constant' */
CALDATA const volatile boolean cal_PwrHVPartEnb = false;/* Referenced by: '<S1264>/Constant1' */
CALDATA const volatile float32 cal_PwrOffsetVal = 0.2F;/* Referenced by:
                                                        * '<S33>/Constant4'
                                                        * '<S33>/Constant5'
                                                        */
CALDATA const volatile boolean cal_PwrSensorData = false;/* Referenced by: '<S1246>/Constant' */
CALDATA const volatile boolean cal_PwrSensorEnb = false;/* Referenced by: '<S1246>/Constant1' */
CALDATA const volatile float32 cal_REC_DVTFresh = 18.0F;/* Referenced by: '<S138>/Constant6' */
CALDATA const volatile float32 cal_REC_DVTRecirc = 12.0F;/* Referenced by: '<S138>/Constant5' */
CALDATA const volatile float32 cal_RFace2FaceFloorByEnv_1X[14] = { -20.0F,
  -15.0F, -10.0F, -5.0F, 0.0F, 5.0F, 10.0F, 15.0F, 20.0F, 25.0F, 30.0F, 35.0F,
  40.0F, 45.0F } ;     /* Referenced by: '<S82>/cal_RFace2FaceFloorByEnv_CUR' */
...
CALDATA const volatile float32 cal_RFace2FaceFloorByEnv_CUR[14] = { 21.0F, 21.0F,
  ...
  27.0F } ;            /* Referenced by: '<S82>/cal_RFace2FaceFloorByEnv_CUR' */

CALDATA const volatile float32 cal_RFaceFloor2FaceByEnv_1X[14] = { -20.0F,
  -15.0F, -10.0F, -5.0F, 0.0F, 5.0F, 10.0F, 15.0F, 20.0F, 25.0F, 30.0F, 35.0F,
  40.0F, 45.0F } ;     /* Referenced by: '<S82>/cal_RFaceFloor2FaceByEnv_CUR' */
...
CALDATA const volatile float32 cal_RFaceFloor2FaceByEnv_CUR[14] = { 19.0F, 19.0F,
  ...
  25.0F } ;            /* Referenced by: '<S82>/cal_RFaceFloor2FaceByEnv_CUR' */

CALDATA const volatile float32 cal_RFaceFloor2FloorByEnv_1X[14] = { -20.0F,
  -15.0F, -10.0F, -5.0F, 0.0F, 5.0F, 10.0F, 15.0F, 20.0F, 25.0F, 30.0F, 35.0F,
  40.0F, 45.0F } ;    /* Referenced by: '<S82>/cal_RFaceFloor2FloorByEnv_CUR' */
...
CALDATA const volatile float32 cal_RFaceFloor2FloorByEnv_CUR[14] = { 30.0F,
  ...
  32.0F, 32.0F } ;    /* Referenced by: '<S82>/cal_RFaceFloor2FloorByEnv_CUR' */

CALDATA const volatile float32 cal_RFloor2FaceFloorByEnv_1X[14] = { -20.0F,
  -15.0F, -10.0F, -5.0F, 0.0F, 5.0F, 10.0F, 15.0F, 20.0F, 25.0F, 30.0F, 35.0F,
  40.0F, 45.0F } ;    /* Referenced by: '<S82>/cal_RFloor2FaceFloorByEnv_CUR' */
...
CALDATA const volatile float32 cal_RFloor2FaceFloorByEnv_CUR[14] = { 26.0F,
  ...
  30.0F, 30.0F } ;    /* Referenced by: '<S82>/cal_RFloor2FaceFloorByEnv_CUR' */
...
CALDATA const volatile float32 cal_RecircDoorNErr = 5.0F;/* Referenced by: '<S1866>/Judge' */
CALDATA const volatile float32 cal_RecircDoorPErr = 5.0F;/* Referenced by: '<S1866>/Judge' */
...
CALDATA const volatile boolean cal_RecircMotorEnb = false;/* Referenced by:
                                                           ...
                                                           * '<S1874>/Constant1'
                                                           */
CALDATA const volatile uint8 cal_RecircMotorNData = 0U;/* Referenced by: '<S1873>/Constant' */
CALDATA const volatile uint8 cal_RecircMotorPData = 0U;/* Referenced by: '<S1874>/Constant' */
CALDATA const volatile uint8 cal_RecircTrgPosData = 0U;/* Referenced by: '<S1875>/Constant' */
CALDATA const volatile boolean cal_RecircTrgPosDataEnb = false;/* Referenced by:
                                                                * '<S1866>/Constant5'
                                                                * '<S1875>/Constant1'
                                                                */
CALDATA const volatile RefModes cal_RefModeData = RefModes_Ref_Off;/* Referenced by: '<S1711>/Constant' */
CALDATA const volatile boolean cal_RefModeEnb = false;/* Referenced by: '<S1711>/Constant1' */
CALDATA const volatile boolean cal_RemtACDefEnbData = false;/* Referenced by:
                                                             * '<S1136>/Constant'
                                                             * '<S1136>/Constant1'
                                                             */
CALDATA const volatile boolean cal_RemtACEnb = false;/* Referenced by: '<S1137>/Constant1' */
CALDATA const volatile boolean cal_RemtACEnbData = false;/* Referenced by: '<S1137>/Constant' */
...
CALDATA const volatile float32 cal_SOCHighPTCPwrLmtOff = 93.0F;/* Referenced by: '<S956>/Relay' */
CALDATA const volatile float32 cal_SOCHighPTCPwrLmtOn = 95.0F;/* Referenced by: '<S956>/Relay' */
...
CALDATA const volatile float32 cal_SOCHighPTCPwrLmt_CUR[6] = { 2.0F, 2.0F, 2.0F,
  3.0F, 5.0F, 7.0F } ;    /* Referenced by: '<S956>/cal_SOCHighPTCPwrLmt_CUR' */

CALDATA const volatile boolean cal_SOVData = false;/* Referenced by: '<S1266>/Constant' */
CALDATA const volatile boolean cal_SOVEnb = false;/* Referenced by: '<S1266>/Constant1' */
...
CALDATA const volatile float32 cal_SensorVolUpFlg = 4950.0F;/* Referenced by:
                                                             ...
                                                             * '<S1853>/Constant'
                                                             */
CALDATA const volatile float32 cal_SetLeftMixDoorTrgData = 0.0F;/* Referenced by: '<S1882>/Constant' */
CALDATA const volatile boolean cal_SetLeftMixDoorTrgDataEnb = false;/* Referenced by:
                                                                     * '<S1867>/Constant5'
                                                                     * '<S1882>/Constant1'
                                                                     */
CALDATA const volatile float32 cal_SetPtcDesCoff = 0.9F;/* Referenced by: '<S181>/Constant5' */
...
CALDATA const volatile float32 cal_SetPtcDesTempMin = 0.0F;/* Referenced by: '<S181>/Constant8' */
CALDATA const volatile uint16 cal_SolarData = 0U;/* Referenced by: '<S1780>/Constant' */
CALDATA const volatile boolean cal_SolarEnb = false;/* Referenced by: '<S1780>/Constant1' */
...
CALDATA const volatile float32 cal_StartPrsProTimes = 0.5F;/* Referenced by: '<S457>/Constant4' */
...
CALDATA const volatile float32 cal_SuperHeat_1X[28] = { 0.029451F, 0.039117F,
  ...
  0.24334F, 0.2928F, 0.34966F, 0.41461F, 0.48837F, 0.57171F, 0.66538F, 0.7702F,
  0.88698F, 1.0166F, 1.1599F, 1.3179F, 1.4915F, 1.6818F, 2.1168F, 2.6332F,
  3.2442F, 3.9724F, 4.0541F } ;  /* Referenced by: '<S685>/cal_SuperHeat_CUR' */
...
CALDATA const volatile float32 cal_TACCMOutRaw_1X[30] = { 66.1F, 144.1F, 191.8F,
  ...
  49795.9F, 94331.5F } ;          /* Referenced by: '<S1731>/cal_ACCMTHi_CUR' */
...
CALDATA const volatile float32 cal_TCabinRaw_CUR[27] = { 90.0F, 85.0F, 80.0F,
  ...
  -35.0F, -40.0F } ;            /* Referenced by: '<S1715>/cal_TCabinRaw_CUR' */
...
CALDATA const volatile float32 cal_TChillOutRaw_CUR[27] = { 90.0F, 85.0F, 80.0F,
  75.0F, 70.0F, 65.0F, 60.0F, 55.0F, 50.0F, 45.0F, 40.0F, 35.0F, 30.0F, 25.0F,
  20.0F, 15.0F, 10.0F, 5.0F, 0.0F, -5.0F, -10.0F, -15.0F, -20.0F, -25.0F, -30.0F,
  -35.0F, -40.0F } ;         /* Referenced by: '<S1723>/cal_TChillOutRaw_CUR' */
...
CALDATA const volatile float32 cal_TEnvRaw_CUR[27] = { 90.0F, 85.0F, 80.0F,
  75.0F, 70.0F, 65.0F, 60.0F, 55.0F, 50.0F, 45.0F, 40.0F, 35.0F, 30.0F, 25.0F,
  20.0F, 15.0F, 10.0F, 5.0F, 0.0F, -5.0F, -10.0F, -15.0F, -20.0F, -25.0F, -30.0F,
  -35.0F, -40.0F } ;              /* Referenced by: '<S1724>/cal_TEnvRaw_CUR' */

CALDATA const volatile float32 cal_TEvapOutRaw_1X[30] = { 66.1F, 144.1F, 191.8F,
  222.4F, 258.9F, 302.6F, 355.1F, 418.4F, 495.2F, 588.7F, 703.2F, 844.0F,
  1018.2F, 1234.9F, 1505.8F, 1846.7F, 2278.2F, 2828.0F, 3533.1F, 4443.7F,
  5628.2F, 7180.4F, 9230.6F, 11960.2F, 15625.5F, 20590.3F, 27377.1F, 36742.9F,
  49795.9F, 94331.5F } ;      /* Referenced by: '<S1725>/cal_TEvapOutRaw_CUR' */
...
CALDATA const volatile float32 cal_TEvapSurfRaw_1X[23] = { 0.1578F, 0.2102F,
  ...
  63.91F, 124.6F } ;             /* Referenced by: '<S1726>/cal_TEvapSur_CUR' */
...
CALDATA const volatile float32 cal_TLCCOutRaw_1X[20] = { 189.0F, 240.3F, 308.4F,
  ...
  316181.0F } ;                 /* Referenced by: '<S1729>/cal_WCCTHiRaw_CUR' */
...
CALDATA const volatile PwrModes cal_TMSStatusData = PwrOff;/* Referenced by: '<S1285>/Constant' */
CALDATA const volatile uint8 cal_TMSStatusEnb = 0U;/* Referenced by: '<S1285>/Constant1' */
...
CALDATA const volatile float32 cal_TMotEntRaw_CUR[17] = { 120.0F, 110.0F, 100.0F,
  ...
  -20.0F, -30.0F, -40.0F } ;         /* Referenced by: '<S1727>/cal_TMot_CUR' */

CALDATA const volatile float32 cal_TOHXOutRaw_1X[30] = { 66.1F, 144.1F, 191.8F,
  222.4F, 258.9F, 302.6F, 355.1F, 418.4F, 495.2F, 588.7F, 703.2F, 844.0F,
  1018.2F, 1234.9F, 1505.8F, 1846.7F, 2278.2F, 2828.0F, 3533.1F, 4443.7F,
  5628.2F, 7180.4F, 9230.6F, 11960.2F, 15625.5F, 20590.3F, 27377.1F, 36742.9F,
  49795.9F, 94331.5F } ;          /* Referenced by: '<S1728>/cal_OHXTRaw_CUR' */
...
CALDATA const volatile float32 cal_TSACBatMinEntTempA = 5.0F;/* Referenced by: '<S1356>/Constant' */
CALDATA const volatile float32 cal_TSACBatMinEntTempB = 25.0F;/* Referenced by: '<S1630>/Constant' */
CALDATA const volatile float32 cal_TSACBatMinExitTempM = 24.0F;/* Referenced by: '<S1624>/Constant4' */
CALDATA const volatile float32 cal_TSACBatMinExitTempN = 4.0F;/* Referenced by: '<S1367>/Constant4' */
CALDATA const volatile float32 cal_TSBatInletTempOffsetP = 5.0F;/* Referenced by: '<S1362>/Constant1' */
...
CALDATA const volatile float32 cal_TSBatMinExitTempJ = -14.0F;/* Referenced by: '<S1366>/Constant4' */
CALDATA const volatile float32 cal_TSBatMinTempOffsetD = 5.0F;/* Referenced by: '<S1362>/Constant5' */
CALDATA const volatile float32 cal_TSBatMinTemplowValB = -13.0F;/* Referenced by: '<S1352>/Constant2' */
CALDATA const volatile float32 cal_TSDCBatMinEntTempC = 25.0F;/* Referenced by: '<S1631>/Constant' */
CALDATA const volatile float32 cal_TSDCBatMinExitTempK = 24.0F;/* Referenced by: '<S1623>/Constant4' */
CALDATA const volatile float32 cal_TSIGBTMinTempEntC = 58.0F;/* Referenced by: '<S1352>/Constant3' */
CALDATA const volatile float32 cal_TSIGBTMinTempExitG = 65.0F;/* Referenced by: '<S1363>/Constant3' */
CALDATA const volatile float32 cal_TSIPUExitTempI = 65.0F;/* Referenced by:
                                                           * '<S1365>/Constant'
                                                           * '<S1625>/Constant'
                                                           */
CALDATA const volatile float32 cal_TSMotorMinTempEntC = 58.0F;/* Referenced by: '<S1352>/Constant' */
CALDATA const volatile float32 cal_TSMotorMinTempExitH = 60.0F;/* Referenced by: '<S1364>/Constant' */
CALDATA const volatile float32 cal_TempRampStepFast = 0.5F;/* Referenced by: '<S1717>/Constant2' */
CALDATA const volatile float32 cal_TempRampStepLoVSpeed = 0.5F;
                                    /* Referenced by: '<S1717>/TempRampStep4' */
CALDATA const volatile float32 cal_TempRampStepSlow = 0.25F;/* Referenced by: '<S1717>/Constant1' */
CALDATA const volatile float32 cal_TevapLoStepMin = 3.0F;/* Referenced by:
                                                          * '<S180>/Constant2'
                                                          * '<S180>/Constant5'
                                                          */
CALDATA const volatile uint16 cal_TevapLoTime = 10U;/* Referenced by: '<S180>/Constant6' */
...
CALDATA const volatile float32 cal_U_DVTFFSolarFilterRate = 0.001F;/* Referenced by:
                                                                    ...
                                                                    */
CALDATA const volatile boolean cal_UnlockVentEnb = false;/* Referenced by: '<S1290>/Constant1' */
CALDATA const volatile boolean cal_UnlockVentEnbData = false;/* Referenced by: '<S1290>/Constant' */
...
CALDATA const volatile float32 cal_VehHeatSOCOn = 5.0F;/* Referenced by:
                                                        ...
                                                        * '<S1483>/Constant'
                                                        */
CALDATA const volatile float32 cal_VehicleSpeedHighVs = 60.0F;/* Referenced by: '<S1742>/Constant' */
CALDATA const volatile float32 cal_VehicleSpeedLowVs = 10.0F;/* Referenced by: '<S1743>/Constant' */
...
CALDATA const volatile float32 cal_WCCTempData = 0.0F;/* Referenced by: '<S1843>/Constant' */
CALDATA const volatile boolean cal_WCCTempDataEnb = false;/* Referenced by: '<S1843>/Constant1' */
CALDATA const volatile WaterModes cal_WaterModeData = WaterOff;/* Referenced by: '<S1703>/Constant' */
CALDATA const volatile boolean cal_WaterModeEnb = false;/* Referenced by: '<S1703>/Constant1' */
CALDATA const volatile boolean cal_bACAutoData = false;/* Referenced by: '<S1169>/Constant' */
CALDATA const volatile boolean cal_bACAutoEnb = false;/* Referenced by: '<S1169>/Constant1' */
CALDATA const volatile boolean cal_bACDefrostData = false;/* Referenced by: '<S1183>/Constant' */
CALDATA const volatile boolean cal_bACDefrostEnb = false;/* Referenced by: '<S1183>/Constant1' */
CALDATA const volatile boolean cal_bACOnOffData = false;/* Referenced by: '<S1196>/Constant' */
CALDATA const volatile boolean cal_bACOnOffEnb = false;/* Referenced by: '<S1196>/Constant1' */
CALDATA const volatile boolean cal_bExhFlgData = false;/* Referenced by: '<S1094>/Constant' */
CALDATA const volatile boolean cal_bExhFlgEnb = false;/* Referenced by: '<S1094>/Constant1' */
CALDATA const volatile boolean cal_bLeftSetHighData = false;/* Referenced by: '<S1148>/Constant' */
CALDATA const volatile boolean cal_bLeftSetHighEnb = false;/* Referenced by: '<S1148>/Constant1' */
CALDATA const volatile boolean cal_bLeftSetLowData = false;/* Referenced by: '<S1149>/Constant' */
CALDATA const volatile boolean cal_bLeftSetLowEnb = false;/* Referenced by: '<S1149>/Constant1' */
CALDATA const volatile uint8 cal_eACStsData = 0U;/* Referenced by: '<S1208>/Constant' */
CALDATA const volatile boolean cal_eACStsEnb = false;/* Referenced by: '<S1208>/Constant1' */
CALDATA const volatile uint8 cal_eBlwStsData = 0U;/* Referenced by: '<S1107>/Constant' */
CALDATA const volatile boolean cal_eBlwStsEnb = false;/* Referenced by: '<S1107>/Constant1' */
CALDATA const volatile uint8 cal_eC3WVValueData = 0U;/* Referenced by: '<S641>/Constant' */
CALDATA const volatile boolean cal_eC3WVValueEnb = false;/* Referenced by: '<S641>/Constant1' */
CALDATA const volatile uint8 cal_eC5WVValueData = 0U;/* Referenced by: '<S642>/Constant' */
CALDATA const volatile boolean cal_eC5WVValueEnb = false;/* Referenced by: '<S642>/Constant1' */
CALDATA const volatile uint8 cal_eInnerData = 0U;/* Referenced by: '<S1123>/Constant' */
CALDATA const volatile boolean cal_eInnerEnb = false;/* Referenced by: '<S1123>/Constant1' */
CALDATA const volatile uint8 cal_eModeMotorData = 0U;/* Referenced by: '<S1130>/Constant' */
CALDATA const volatile boolean cal_eModeMotorEnb = false;/* Referenced by: '<S1130>/Constant1' */
CALDATA const volatile float32 cal_rCabinCoolToCondMixDoor = 90.0F;/* Referenced by: '<S1668>/Constant' */
CALDATA const volatile uint8 cal_rCabinEvpToHPInnRatio = 10U;/* Referenced by: '<S1695>/Constant' */
CALDATA const volatile uint8 cal_rCabinHPToEvpInnRatio = 10U;/* Referenced by: '<S1694>/Constant' */
CALDATA const volatile float32 cal_sMixDoorData = 0.0F;/* Referenced by: '<S1125>/Constant' */
CALDATA const volatile boolean cal_sMixDoorEnb = false;/* Referenced by: '<S1125>/Constant1' */
CALDATA const volatile float32 cal_tACBatCoolCellTempOn = 36.0F;/* Referenced by: '<S1387>/Constant' */
CALDATA const volatile float32 cal_tBatBalExitACChrgMinCellTemp = 4.0F;/* Referenced by: '<S1347>/Constant' */
CALDATA const volatile float32 cal_tBatBalExitBal1ToBatDiff = 2.0F;/* Referenced by: '<S1340>/Constant' */
CALDATA const volatile float32 cal_tBatBalExitBatToBal2Diff = 2.0F;/* Referenced by: '<S1337>/Constant' */
CALDATA const volatile float32 cal_tBatBalExitDCChrgMinCellTemp = 24.0F;/* Referenced by: '<S1342>/Constant' */
CALDATA const volatile float32 cal_tBatBalExitMaxToMinCellDiff = 3.0F;/* Referenced by: '<S1345>/Constant' */
CALDATA const volatile float32 cal_tBatBalONACChrgMinCellTemp = 5.0F;/* Referenced by: '<S1335>/Constant' */
CALDATA const volatile float32 cal_tBatCoolACChrgCellTempOff = 34.0F;/* Referenced by: '<S1415>/Constant' */
CALDATA const volatile float32 cal_tBatCoolCellTempOn = 36.0F;/* Referenced by: '<S1399>/Constant' */
CALDATA const volatile float32 cal_tBatCoolDCChrgCellTempOff = 31.0F;/* Referenced by: '<S1414>/Constant' */
CALDATA const volatile float32 cal_tBatCoolVehReadyCellTempOff = 34.0F;/* Referenced by: '<S1416>/Constant' */
CALDATA const volatile float32 cal_tBatHeatACChrgCellTempOff = 5.0F;/* Referenced by: '<S1505>/Constant' */
CALDATA const volatile float32 cal_tBatHeatACChrgCellTempOn = 3.0F;/* Referenced by: '<S1469>/Constant' */
CALDATA const volatile float32 cal_tBatHeatACChrgSOCHighTempOff = 25.0F;/* Referenced by: '<S1508>/Constant' */
CALDATA const volatile float32 cal_tBatHeatACChrgSOCHighTempOn = 15.0F;/* Referenced by: '<S1472>/Constant' */
CALDATA const volatile float32 cal_tBatHeatDCChrgCellTempOff = 25.0F;/* Referenced by: '<S1503>/Constant' */
CALDATA const volatile float32 cal_tBatHeatDCChrgCellTempOn = 20.0F;/* Referenced by: '<S1468>/Constant' */
CALDATA const volatile float32 cal_tBatHeatExitMaxToMinCellDiff = 20.0F;/* Referenced by:
                                                                      ...
                                                                      * '<S1555>/Constant'
                                                                      */
CALDATA const volatile float32 cal_tBatHeatVehReadyCellTempOff = -13.0F;/* Referenced by: '<S1507>/Constant' */
CALDATA const volatile float32 cal_tBatHeatVehReadyCellTempOn = -15.0F;/* Referenced by: '<S1482>/Constant' */
CALDATA const volatile float32 cal_tCabinCondToCoolDvtDiff = -3.0F;/* Referenced by: '<S1663>/Constant' */
CALDATA const volatile float32 cal_tCabinCondToCoolEvapTemp = 5.0F;/* Referenced by: '<S1666>/Constant' */
CALDATA const volatile float32 cal_tCabinCondToEvpEvapTemp = 1.0F;/* Referenced by: '<S1684>/Constant' */
...
CALDATA const volatile float32 cal_tCabinCoolEnvTempLow = 15.0F;/* Referenced by:
                                                                 ...
                                                                 * '<S1689>/Constant13'
                                                                 */
CALDATA const volatile float32 cal_tCabinCoolToCondDvtDiff = 3.0F;/* Referenced by: '<S1667>/Constant' */
CALDATA const volatile float32 cal_tCabinEvpToCondDvtDiff = -4.0F;/* Referenced by:
                                                                   * '<S1680>/Constant'
                                                                   * '<S1681>/Constant'
                                                                   */
CALDATA const volatile float32 cal_tCabinHPToEvpEnvTemp = 16.0F;/* Referenced by: '<S1693>/Constant' */
CALDATA const volatile float32 cal_tDCBatCoolCellTempOn = 33.0F;/* Referenced by: '<S1386>/Constant' */
CALDATA const volatile float32 cal_tLTROffBatBal2ToMaxCellDiff = 3.0F;/* Referenced by:
                                                                      * '<S1451>/Constant'
                                                                      * '<S1551>/Constant'
                                                                      */
CALDATA const volatile float32 cal_tLTROffIPUTemp = 45.0F;/* Referenced by: '<S1446>/Constant' */
...
CALDATA const volatile float32 cal_tLTROnMaxCellToMotDiff = 3.0F;/* Referenced by:
                                                                  ...
                                                                  * '<S1543>/Constant'
                                                                  */
CALDATA const volatile float32 cal_tLTROnMotInletTemp = 65.0F;/* Referenced by: '<S1641>/Constant' */
CALDATA const volatile float32 cal_tLTROnMotTemp = 65.0F;/* Referenced by: '<S1642>/Constant' */
CALDATA const volatile float32 cal_tLeftSetPointData = 24.0F;/* Referenced by: '<S1150>/Constant' */
CALDATA const volatile boolean cal_tLeftSetPointEnb = false;/* Referenced by: '<S1150>/Constant1' */
...
CALDATA const volatile float32 cal_tMotStorExitMaxCellTemp = 28.0F;/* Referenced by:
                                                                    ...
                                                                    * '<S1612>/Constant'
                                                                    */
CALDATA const volatile float32 cal_tMotStorExitMotToMinCellDiff = 5.0F;/* Referenced by: '<S1556>/Constant3' */
CALDATA const volatile float32 cal_tMotStorMinCellTempLow = 20.0F;/* Referenced by: '<S1569>/Constant' */
CALDATA const volatile float32 cal_tMotStorOnMotToMinCellDiff = 2.0F;/* Referenced by: '<S1556>/Constant1' */
CALDATA const volatile uint16 cal_tiAQSFresh2RecircDelay = 6U;/* Referenced by: '<S129>/Constant5' */
CALDATA const volatile uint16 cal_tiAQSRecirc2FreshDelay = 1800U;/* Referenced by: '<S129>/Constant11' */
CALDATA const volatile uint16 cal_tiCO2Fresh2RecircMax = 300U;/* Referenced by: '<S130>/Constant12' */
CALDATA const volatile uint16 cal_tiCO2Recirc2FreshMax = 18000U;/* Referenced by: '<S130>/Constant5' */
CALDATA const volatile uint16 cal_tiColdStartTimeMax = 1200U;/* Referenced by: '<S41>/Constant2' */
