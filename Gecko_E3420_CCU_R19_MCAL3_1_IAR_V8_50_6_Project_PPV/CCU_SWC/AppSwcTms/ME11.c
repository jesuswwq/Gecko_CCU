...
#define ME11_IN_ClearFlt               ((uint8)1U)
#define ME11_IN_Init                   ((uint8)2U)
...
#define ME11_IN_judge                  ((uint8)3U)
#define ME11_IN_wait_go                ((uint8)4U)
...
#define ME11_IN_wait_o                 ((uint8)7U)
...
#define ME11_IN_wait_p                 ((uint8)2U)
...
#define ME11_IN_Default_c              ((uint8)2U)
...
#define ME11_IN_Default_d              ((uint8)4U)
...
boolean rtu_Service_0x14, uint8 *rty_SenSts, ARID_DEF_Judge_ME11_T
*ME11__ARID_DEF_arg);
...
if (ME11_TMSIODriverFunc_ARID_DEF.temporalCounter_i1 < 1U) {
ME11_TMSIODriverFunc_ARID_DEF.temporalCounter_i1++;
}

if (ME11_TMSIODriverFunc_ARID_DEF.is_active_c156_ME11 == 0U) {
ME11_TMSIODriverFunc_ARID_DEF.is_active_c156_ME11 = 1U;
ME11_TMSIODriverFunc_ARID_DEF.is_c156_ME11 = ME11_IN_Counter_Init;
ME11_TMSIODriverFunc_ARID_DEF.temporalCounter_i1 = 0U;
PWRCtl_uTMSRunTimer20ms = 0U;
} else if (ME11_TMSIODriverFunc_ARID_DEF.is_c156_ME11 == ME11_IN_Counter_Cal)
{
...
} else if (ME11_TMSIODriverFunc_ARID_DEF.temporalCounter_i1 >= 1) {
ME11_TMSIODriverFunc_ARID_DEF.is_c156_ME11 = ME11_IN_Counter_Cal;
}
}
...
void ME11_Judge(boolean rtu_MaxFlg, boolean rtu_MinFlg, uint8 rtu_timer, boolean
rtu_Service_0x14, uint8 *rty_SenSts, ARID_DEF_Judge_ME11_T
*ME11__ARID_DEF_arg)
{
sint32 tmp;
...
ME11__ARID_DEF_arg->T = (uint8)tmp;
} else if (rtu_Service_0x14) {
ME11__ARID_DEF_arg->is_judge = ME11_IN_NO_ACTIVE_CHILD_g;
ME11__ARID_DEF_arg->is_c2_ME11Lib = ME11_IN_ClearFlt;
*rty_SenSts = 0U;
} else {
...
{
float32 rtb_Init_h;
uint8 rtb_Compare_aal;
uint8 rtb_Compare_cbb;
uint8 rtb_Compare_is;
uint8 rtb_Compare_m0;
uint8 rtb_Compare_nd4;
uint8 rtb_Compare_pph;
SENCtl_uMixDoorVol = get_MixDoorValtage();
rtb_Init_h = (float32)((sint16)SENCtl_uMixDoorVol -
...
Buffer_DcmDspData_F272H[0] = (uint8)(uint16)rtb_Init_h;
Buffer_DcmDspData_F272H[1] = (uint8)((uint32)(uint16)rtb_Init_h >> 8);
ME11_Judge(rtb_Init_h > cal_SensorVolUpFlg, rtb_Init_h < cal_SensorVolDownFlg,
20, ME11_ARID_DEF.Compare, &ME11_TMSADCSampleFunc_ARID_DEF.SenSts_o,
...
ACSen_eMixDoorSenSts = 0U;
}

rtb_Compare_pph = (uint8)(ACSen_eMixDoorSenSts == Ground);
if (rtb_Compare_pph != ME11_TMSADCSampleFunc_ARID_DEF.DelayInput1_DSTATE) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943411), rtb_Compare_pph);
}

rtb_Compare_cbb = (uint8)(ACSen_eMixDoorSenSts == Power);
if (rtb_Compare_cbb != ME11_TMSADCSampleFunc_ARID_DEF.DelayInput1_DSTATE_e) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943415), rtb_Compare_cbb);
}

ME11_TMSADCSampleFunc_ARID_DEF.Compare = (ACSen_eMixDoorSenSts != Normal);
ME11_ARID_DEF.VectorConcatenate[32] = (rtb_Compare_pph != 0);
ME11_ARID_DEF.VectorConcatenate[33] = (rtb_Compare_cbb != 0);
SEN_MixDoorRaw = look1_iflf_binlca(rtb_Init_h, (const float32 *)
...
rtb_Init_h = (float32)((sint16)SENCtl_uModeDoorVol -
...
1U));
Buffer_DcmDspData_F270H[0] = (uint8)(uint16)rtb_Init_h;
Buffer_DcmDspData_F270H[1] = (uint8)((uint32)(uint16)rtb_Init_h >> 8);
ME11_Judge(rtb_Init_h > cal_SensorVolUpFlg, rtb_Init_h < cal_SensorVolDownFlg,
20, ME11_ARID_DEF.Compare, &ME11_TMSADCSampleFunc_ARID_DEF.SenSts_l,
&ME11_TMSADCSampleFunc_ARID_DEF.ARID_DEF_Judge_m);
if (PWRCtl_bKL15swtSt) {
ACSen_eModeSenSts = ME11_TMSADCSampleFunc_ARID_DEF.SenSts_l;
} else {
ACSen_eModeSenSts = 0U;
}

rtb_Compare_aal = (uint8)(ACSen_eModeSenSts == Ground);
if (rtb_Compare_aal != ME11_TMSADCSampleFunc_ARID_DEF.DelayInput1_DSTATE_m) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943311), rtb_Compare_aal);
}

rtb_Compare_m0 = (uint8)(ACSen_eModeSenSts == Power);
if (rtb_Compare_m0 != ME11_TMSADCSampleFunc_ARID_DEF.DelayInput1_DSTATE_c) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943315), rtb_Compare_m0);
}

ME11_TMSADCSampleFunc_ARID_DEF.Compare_n = (ACSen_eModeSenSts != Normal);
ME11_ARID_DEF.VectorConcatenate[29] = (rtb_Compare_aal != 0);
ME11_ARID_DEF.VectorConcatenate[30] = (rtb_Compare_m0 != 0);
rtb_Init_h *= 0.001F;
if (ME11_TMSADCSampleFunc_ARID_DEF.FixPtUnitDelay2_DSTATE_l != 0) {
ME11_TMSADCSampleFunc_ARID_DEF.FixPtUnitDelay1_DSTATE_g = rtb_Init_h;
}

ME11_TMSADCSampleFunc_ARID_DEF.FixPtUnitDelay1_DSTATE_g = rtb_Init_h * 0.9F +
...
rtb_Init_h = (float32)((sint16)SENCtl_uRecircDoorVol -
...
1U));
Buffer_DcmDspData_F271H[0] = (uint8)(uint16)rtb_Init_h;
Buffer_DcmDspData_F271H[1] = (uint8)((uint32)(uint16)rtb_Init_h >> 8);
ME11_Judge(rtb_Init_h > cal_SensorVolUpFlg, rtb_Init_h < cal_SensorVolDownFlg,
20, ME11_ARID_DEF.Compare, &ME11_TMSADCSampleFunc_ARID_DEF.SenSts,
&ME11_TMSADCSampleFunc_ARID_DEF.ARID_DEF_Judge);
if (PWRCtl_bKL15swtSt) {
ACSen_eRecircSenSts = ME11_TMSADCSampleFunc_ARID_DEF.SenSts;
} else {
ACSen_eRecircSenSts = 0U;
}

rtb_Compare_is = (uint8)(ACSen_eRecircSenSts == Ground);
if (rtb_Compare_is != ME11_TMSADCSampleFunc_ARID_DEF.DelayInput1_DSTATE_cw) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943211), rtb_Compare_is);
}

rtb_Compare_nd4 = (uint8)(ACSen_eRecircSenSts == Power);
if (rtb_Compare_nd4 != ME11_TMSADCSampleFunc_ARID_DEF.DelayInput1_DSTATE_f) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943215), rtb_Compare_nd4);
}

ME11_TMSADCSampleFunc_ARID_DEF.Compare_l = (ACSen_eRecircSenSts != Normal);
ME11_ARID_DEF.VectorConcatenate[26] = (rtb_Compare_is != 0);
ME11_ARID_DEF.VectorConcatenate[27] = (rtb_Compare_nd4 != 0);
if (cal_AirInletPerEnb) {
ACSen_eAirInletPer = cal_AirInletPerData;
} else {
ACSen_eAirInletPer = look1_iflftu8Df_binlca(0.001F * rtb_Init_h, (const
float32 *)&cal_RecirActVal_1X[0], (const uint8 *)&cal_RecirActVal_CUR[0],
1U);
}

ME11_TMSADCSampleFunc_ARID_DEF.DelayInput1_DSTATE = rtb_Compare_pph;
ME11_TMSADCSampleFunc_ARID_DEF.DelayInput1_DSTATE_e = rtb_Compare_cbb;
ME11_TMSADCSampleFunc_ARID_DEF.FixPtUnitDelay2_DSTATE = 0U;
ME11_TMSADCSampleFunc_ARID_DEF.DelayInput1_DSTATE_m = rtb_Compare_aal;
ME11_TMSADCSampleFunc_ARID_DEF.DelayInput1_DSTATE_c = rtb_Compare_m0;
ME11_TMSADCSampleFunc_ARID_DEF.FixPtUnitDelay2_DSTATE_l = 0U;
ME11_TMSADCSampleFunc_ARID_DEF.DelayInput1_DSTATE_cw = rtb_Compare_is;
ME11_TMSADCSampleFunc_ARID_DEF.DelayInput1_DSTATE_f = rtb_Compare_nd4;
}
...
uint32 rtb_Subtract9;
uint32 rtb_Subtract9_o;
...
uint8 rtb_Add_a;
uint8 rtb_Add_d;
uint8 rtb_BatPMP_SpdSet;
uint8 rtb_Compare_a;
uint8 rtb_Compare_bc;
uint8 rtb_Compare_bi3;
uint8 rtb_Compare_bmr;
uint8 rtb_Compare_bv;
uint8 rtb_Compare_bx;
uint8 rtb_Compare_bzi;
uint8 rtb_Compare_cds;
uint8 rtb_Compare_cjk;
uint8 rtb_Compare_e;
uint8 rtb_Compare_e5v;
uint8 rtb_Compare_f;
uint8 rtb_Compare_fg;
uint8 rtb_Compare_g;
uint8 rtb_Compare_hfs;
uint8 rtb_Compare_huq;
uint8 rtb_Compare_hwx;
uint8 rtb_Compare_i;
uint8 rtb_Compare_icx;
uint8 rtb_Compare_ip;
uint8 rtb_Compare_ith;
uint8 rtb_Compare_j;
uint8 rtb_Compare_jm;
uint8 rtb_Compare_jo;
uint8 rtb_Compare_jsz;
uint8 rtb_Compare_k;
uint8 rtb_Compare_l;
uint8 rtb_Compare_l4e;
uint8 rtb_Compare_lf;
uint8 rtb_Compare_lo;
uint8 rtb_Compare_m;
uint8 rtb_Compare_ml;
uint8 rtb_Compare_mxx;
uint8 rtb_Compare_n1l;
uint8 rtb_Compare_n5;
uint8 rtb_Compare_nj;
uint8 rtb_Compare_ntr;
uint8 rtb_Compare_ouy;
uint8 rtb_Compare_oz;
uint8 rtb_Compare_p;
uint8 rtb_Compare_ph;
uint8 rtb_Compare_pw;
uint8 rtb_DataTypeConversion1_e;
uint8 rtb_DataTypeConversion1_f;
uint8 rtb_DataTypeConversion1_g;
uint8 rtb_DataTypeConversion1_i;
uint8 rtb_DataTypeConversion1_l;
uint8 rtb_DataTypeConversion1_m;
uint8 rtb_DataTypeConversion1_on;
uint8 rtb_DataTypeConversion2_c;
uint8 rtb_DataTypeConversion2_j;
uint8 rtb_DataTypeConversion2_ku;
uint8 rtb_DataTypeConversion2_l;
uint8 rtb_DataTypeConversion3_e;
uint8 rtb_DataTypeConversion3_j;
uint8 rtb_DataTypeConversion3_o;
uint8 rtb_DataTypeConversion4_n;
uint8 rtb_DataTypeConversion5;
uint8 rtb_DataTypeConversion5_l;
uint8 rtb_DataTypeConversion5_o;
uint8 rtb_DataTypeConversion6;
uint8 rtb_DataTypeConversion6_i;
uint8 rtb_DataTypeConversion6_j;
uint8 rtb_DataTypeConversion7;
uint8 rtb_DataTypeConversion7_e;
uint8 rtb_DataTypeConversion7_l;
uint8 rtb_DataTypeConversion_f4;
uint8 rtb_DataTypeConversion_ig5;
uint8 rtb_Delay1_m;
uint8 rtb_Delay3_jo;
uint8 rtb_Delay_ku;
...
uint8 rtb_MotPMP_SpdSet;
uint8 rtb_MultiportSwitch1;
uint8 rtb_SOMCtl_WaterMode;
uint8 rtb_Switch1_ha;
uint8 rtb_Switch1_mn;
uint8 rtb_Switch2_a0;
uint8 rtb_Switch2_f0;
uint8 rtb_Switch2_ht;
uint8 rtb_Switch3_cn;
uint8 rtb_Switch4_b;
uint8 rtb_Switch6_ng;
uint8 rtb_Switch7_g;
uint8 rtb_Switch_e2s;
uint8 rtb_Switch_fmz;
uint8 rtb_Switch_ia;
uint8 rtb_Switch_ig;
uint8 rtb_Switch_ijm;
uint8 rtb_Switch_jkj;
uint8 rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR;
boolean rtb_Compare_ci[7];
boolean rtb_Compare_ac[6];
boolean rtb_Compare_hc2[5];
boolean FixPtRelationalOperator;
boolean guard1 = false;
boolean guard2 = false;
boolean rtb_ACTCtl_bCOMPDiagFlg;
boolean rtb_ACTCtl_bEXVDiagFlg;
...
boolean rtb_AND4_f;
boolean rtb_AND_ll;
boolean rtb_Compare_ace;
boolean rtb_Compare_ani;
boolean rtb_Compare_ar;
boolean rtb_Compare_c02;
boolean rtb_Compare_chc;
boolean rtb_Compare_cne;
boolean rtb_Compare_e5j;
boolean rtb_Compare_edj;
boolean rtb_Compare_end;
boolean rtb_Compare_eux;
boolean rtb_Compare_fd;
boolean rtb_Compare_fi;
boolean rtb_Compare_go0;
boolean rtb_Compare_gr;
boolean rtb_Compare_gre;
boolean rtb_Compare_h1;
boolean rtb_Compare_h5;
boolean rtb_Compare_hke;
boolean rtb_Compare_hs;
boolean rtb_Compare_if;
boolean rtb_Compare_jg;
boolean rtb_Compare_jwo;
boolean rtb_Compare_k4;
boolean rtb_Compare_kt;
boolean rtb_Compare_lt0;
boolean rtb_Compare_m4;
boolean rtb_Compare_msu;
boolean rtb_Compare_n2_0;
boolean rtb_Compare_nbr;
boolean rtb_Compare_ne;
boolean rtb_Compare_obw;
boolean rtb_Compare_of3;
boolean rtb_Compare_ofq;
boolean rtb_Compare_ok;
boolean rtb_Compare_ox;
boolean rtb_Compare_pew;
boolean rtb_Compare_plm;
boolean rtb_Compare_psm;
boolean rtb_FixPtRelationalOperator_bv1;
boolean rtb_FixPtRelationalOperator_in;
boolean rtb_FixPtRelationalOperator_io;
boolean rtb_FixPtRelationalOperator_jt;
boolean rtb_FixPtRelationalOperator_nt;
...
boolean rtb_RelationalOperator_de;
boolean rtb_RelationalOperator_j5;
boolean rtb_RelationalOperator_lt;
boolean rtb_RelationalOperator_pq;
boolean rtb_Switch_a5w;
boolean rtb_Switch_irj;
...
RMTCtl_bRemtACFlg = (rtb_Compare_chc && rtb_Compare_edj);
}

rtb_Compare_chc = ((HU_LeftTempSet != ME11_ARID_DEF.DelayInput1_DSTATE_d12) &&
(HU_LeftTempSet != 0));
if (rtb_Compare_chc) {
ME11_ARID_DEF.Delay_DSTATE_d = HU_LeftTempSet;
}

FixPtRelationalOperator = (rtb_Compare_chc !=
...
FixPtRelationalOperator = ME11_ARID_DEF.Delay3_DSTATE_kci;
...
RMTCtl_bRemtACDefFlg = (rtb_Compare_edj && rtb_Compare_ofq);
}

rtb_FixPtRelationalOperator_bv1 =
((Rte_IRead_Task_100ms_Bcm2VcuTms_outputs_Bcm2VcuTms_outputs())
->BCM_SysPowerSts == 2);
rtb_Delay3_jo = HMICtl_eACSts;
rtb_Compare_edj = ME11_ARID_DEF.Delay_DSTATE_by;
rtb_Compare_ofq = ME11_ARID_DEF.Delay1_DSTATE_c1;
ME11_ARID_DEF.DelayInput1_DSTATE_fy = ME11_ARID_DEF.DelayInput1_DSTATE_op;
rtb_FixPtRelationalOperator_nt =
((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUBlwrModeSet_enum != ME11_ARID_DEF.DelayInput1_DSTATE_fy);
rtb_Compare_ok = ((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUBlwrModeSet_enum != 0);
rtb_FixPtRelationalOperator_nt = (rtb_FixPtRelationalOperator_nt &&
rtb_Compare_ok);
ME11_ARID_DEF.DelayInput1_DSTATE_fy = ME11_ARID_DEF.Delay_DSTATE_hx;
if (rtb_FixPtRelationalOperator_nt) {
...
if (ME11_ARID_DEF.temporalCounter_i2_kn >= 10U) {
ME11_ARID_DEF.is_Add_p = ME11_IN_wait_p;
}
} else if
((Rte_IRead_Task_100ms_IPM_CCP_PanelStatus_BOD_IPM_CCP_PanelStatus_BOD
())->VIPM_CCPBlwngModeNextKey_flg) {
...
if (ME11_ARID_DEF.temporalCounter_i2_kn >= 10U) {
ME11_ARID_DEF.is_Dec_j = ME11_IN_wait_p;
}
} else if
((Rte_IRead_Task_100ms_IPM_CCP_PanelStatus_BOD_IPM_CCP_PanelStatus_BOD
())->VIPM_CCPBlwngModePrevKey_flg) {
...
if (rtb_FixPtRelationalOperator_bv1) {
ME11_ARID_DEF.Delay_DSTATE_hv = RMTCtl_bRemtACDefFlg;
} else if (PWRCtl_bKL15swtSt) {
if (((HMICtl_eACSts != ME11_ARID_DEF.DelayInput1_DSTATE_lb) &&
(HMICtl_eACSts == 3)) || ((sint32)rtb_Compare_edj < (sint32)
ME11_ARID_DEF.DelayInput1_DSTATE_cl) || ((sint32)
...
rtb_FixPtRelationalOperator_io =
((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUManlDefrstCtl_enum != ME11_ARID_DEF.DelayInput1_DSTATE_ov);
rtb_Compare_psm = ((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUManlDefrstCtl_enum == 2);
if (rtb_Compare_psm && rtb_FixPtRelationalOperator_io) {
...
HMICtl_bACDefrost = ME11_ARID_DEF.Delay_DSTATE_hv;
}

rtb_FixPtRelationalOperator_io = HMICtl_bACDefrost;
rtb_Compare_psm = ((sint32)
(Rte_IRead_Task_100ms_IPM_CCP_PanelStatus_BOD_IPM_CCP_PanelStatus_BOD
())->VIPM_CCPModeKey_flg > (sint32)
...
ME11_ARID_DEF.is_c100_ME11 = ME11_IN_Default_c;
...
ME11_ARID_DEF.DelayInput1_DSTATE_ea) || ((sint32)
ME11_ARID_DEF.Delay1_DSTATE_c1 > (sint32)
ME11_ARID_DEF.DelayInput1_DSTATE_bc)) &&
(ME11_ARID_DEF.Delay_DSTATE_cf == 3)) {
ME11_ARID_DEF.Delay_DSTATE_cf = 1U;
} else {
rtb_Compare_psm = ((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUHybEcoModeSet_enum !=
ME11_ARID_DEF.DelayInput1_DSTATE_kx);
rtb_AND_ll = ((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUHybEcoModeSet_enum == 2);
rtb_AND_ll = (rtb_AND_ll && rtb_Compare_psm);
if (rtb_AND_ll) {
...
ME11_ARID_DEF.DelayInput1_DSTATE_pd);
rtb_AND_ll = ((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
...
rtb_AND_ll = (RMTCtl_bRemtACFlg && (!RMTCtl_bRemtACDefFlg));
ME11_ARID_DEF.DelayInput1_DSTATE_fy = ME11_ARID_DEF.DelayInput1_DSTATE_iv;
rtb_Compare_ok = ((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUAirInletModeSet_enum >
ME11_ARID_DEF.DelayInput1_DSTATE_fy);
rtb_FixPtRelationalOperator_jt = ((sint32)
(Rte_IRead_Task_100ms_IPM_CCP_PanelStatus_BOD_IPM_CCP_PanelStatus_BOD())
->VIPM_CCPAirInletModeKey_flg > (sint32)
ME11_ARID_DEF.DelayInput1_DSTATE_br);
rtb_Compare_psm = (rtb_Compare_ok || rtb_FixPtRelationalOperator_jt);
ME11_ARID_DEF.DelayInput1_DSTATE_fy = ME11_ARID_DEF.DelayInput1_DSTATE_di;
rtb_Compare_ok = ((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUFrntFanSpdSet_enum >
ME11_ARID_DEF.DelayInput1_DSTATE_fy);
rtb_FixPtRelationalOperator_bv1 = ((sint32)
(Rte_IRead_Task_100ms_IPM_CCP_PanelStatus_BOD_IPM_CCP_PanelStatus_BOD())
->VIPM_CCPBlwrLvlAddKey_flg > (sint32)ME11_ARID_DEF.DelayInput1_DSTATE_hg);
rtb_FixPtRelationalOperator_nt = ((sint32)
(Rte_IRead_Task_100ms_IPM_CCP_PanelStatus_BOD_IPM_CCP_PanelStatus_BOD())
->VIPM_CCPBlwrLvlDecKey_flg > (sint32)ME11_ARID_DEF.DelayInput1_DSTATE_bx);
rtb_FixPtRelationalOperator_nt = (rtb_Compare_ok ||
rtb_FixPtRelationalOperator_bv1 || rtb_FixPtRelationalOperator_nt);
rtb_Compare_ok = ((!rtb_Compare_edj) || HMICtl_bACDefrost);
...
case ME11_IN_After:
if (rtb_Compare_ok && ME11_ARID_DEF.Delay_DSTATE_ly) {
...
if ((rtb_Compare_psm != ME11_ARID_DEF.DelayInput1_DSTATE_m1) ||
((HMICtl_eACSts != ME11_ARID_DEF.DelayInput1_DSTATE_n4b) &&
(HMICtl_eACSts == 3)) || rtb_FixPtRelationalOperator_nt ||
(HMICtl_eModeMotor != ME11_ARID_DEF.DelayInput1_DSTATE_m2)) {
ME11_ARID_DEF.Delay_DSTATE_ly = false;
} else {
rtb_Compare_ok = ((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUACAutoCtl_enum !=
ME11_ARID_DEF.DelayInput1_DSTATE_hx);
rtb_Compare_gre = ((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUACAutoCtl_enum == 2);
if (rtb_Compare_gre && rtb_Compare_ok) {
...
ME11_ARID_DEF.DelayInput1_DSTATE_goa)) {
...
if ((sint32)HMICtl_bACDefrost > (sint32)ME11_ARID_DEF.DelayInput1_DSTATE_chh)
{
ME11_ARID_DEF.Delay1_DSTATE_gu = 8U;
} else if (((sint32)HMICtl_bACDefrost < (sint32)
ME11_ARID_DEF.DelayInput1_DSTATE_p2) ||
(ME11_ARID_DEF.Delay_DSTATE_oz !=
ME11_ARID_DEF.DelayInput1_DSTATE_l0)) {
ME11_ARID_DEF.Delay1_DSTATE_gu = ME11_ARID_DEF.Delay_DSTATE_oz;
}

if (cal_eBlwStsEnb) {
HMICtl_eBlwSts = cal_eBlwStsData;
} else if (ME11_ARID_DEF.Delay2_DSTATE_pb) {
HMICtl_eBlwSts = ME11_ARID_DEF.Delay1_DSTATE_gu;
} else {
HMICtl_eBlwSts = 0U;
}
...
rtb_Compare_ok = (HMICtl_bLeftSetLow || HMICtl_bLeftSetHigh);
if (rtb_Compare_ok) {
rtb_Switch2_ht = 0U;
} else {
...
if (rtb_Compare_ok || HMICtl_bACAuto) {
ME11_ARID_DEF.Delay_DSTATE_fp = 1U;
} else if (rtb_FixPtRelationalOperator_jt) {
...
} else if (ME11_ARID_DEF.Delay_DSTATE_fp > 3) {
HMICtl_eInner = 3U;
} else if (ME11_ARID_DEF.Delay_DSTATE_fp < 1) {
HMICtl_eInner = 1U;
} else {
...
rtb_FixPtRelationalOperator_jt = ((sint32)ME11_ARID_DEF.Delay1_DSTATE_c1 >
(sint32)ME11_ARID_DEF.DelayInput1_DSTATE_ovb);
rtb_Compare_gre = ((sint32)HMICtl_bACDefrost > (sint32)
ME11_ARID_DEF.DelayInput1_DSTATE_in);
ME11_ARID_DEF.DelayInput1_DSTATE_fy = ME11_ARID_DEF.DelayInput1_DSTATE_bli;
rtb_Compare_ok = ((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUHybEcoModeSet_enum >
ME11_ARID_DEF.DelayInput1_DSTATE_fy);
rtb_FixPtRelationalOperator_bv1 =
(Rte_IRead_Task_100ms_IPM_CCP_PanelStatus_BOD_IPM_CCP_PanelStatus_BOD())
->VIPM_CCPModeKey_flg;
rtb_AND1_gd = (rtb_Compare_ok || rtb_FixPtRelationalOperator_bv1);
rtb_Compare_ok = ((sint32)
(Rte_IRead_Task_100ms_IPM_CCP_PanelStatus_BOD_IPM_CCP_PanelStatus_BOD
())->VIPM_CCPTempAddKey_flg > (sint32)
ME11_ARID_DEF.DelayInput1_DSTATE_eyy);
rtb_FixPtRelationalOperator_bv1 = ((sint32)
(Rte_IRead_Task_100ms_IPM_CCP_PanelStatus_BOD_IPM_CCP_PanelStatus_BOD())
->VIPM_CCPTempDecKey_flg > (sint32)ME11_ARID_DEF.DelayInput1_DSTATE_jm);
rtb_Compare_ok = ((HU_LeftTempSet != ME11_ARID_DEF.DelayInput1_DSTATE_nm) ||
rtb_Compare_ok || rtb_FixPtRelationalOperator_bv1);
ME11_ARID_DEF.DelayInput1_DSTATE_fy = ME11_ARID_DEF.DelayInput1_DSTATE_fm;
rtb_FixPtRelationalOperator_bv1 =
((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())->VIPM_HUACPwrCtl_enum
!= ME11_ARID_DEF.DelayInput1_DSTATE_fy);
rtb_FixPtRelationalOperator_in = ((sint32)
(Rte_IRead_Task_100ms_IPM_CCP_PanelStatus_BOD_IPM_CCP_PanelStatus_BOD())
->VIPM_CCPACSwKey_flg > (sint32)ME11_ARID_DEF.DelayInput1_DSTATE_id);
...
if (((rtb_FixPtRelationalOperator_bv1 &&
((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUACPwrCtl_enum == 1)) || rtb_FixPtRelationalOperator_in) &&
ME11_ARID_DEF.HMICtl_bACOnOff_e) {
ME11_ARID_DEF.is_c101_ME11 = ME11_IN_Off_l;
ME11_ARID_DEF.HMICtl_bACOnOff_e = false;
} else if ((((rtb_FixPtRelationalOperator_bv1 &&
((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUACPwrCtl_enum == 2)) ||
rtb_FixPtRelationalOperator_in) &&
(!ME11_ARID_DEF.HMICtl_bACOnOff_e)) || (rtb_Compare_gre ||
rtb_FixPtRelationalOperator_jt || rtb_AND1_gd ||
rtb_Compare_ok || rtb_FixPtRelationalOperator_nt)) {
...
if ((((rtb_FixPtRelationalOperator_bv1 &&
((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUACPwrCtl_enum == 2)) || rtb_FixPtRelationalOperator_in)
&& (!ME11_ARID_DEF.HMICtl_bACOnOff_e)) || (rtb_Compare_gre ||
rtb_FixPtRelationalOperator_jt || rtb_AND1_gd || rtb_Compare_ok ||
rtb_FixPtRelationalOperator_nt)) {
ME11_ARID_DEF.is_c101_ME11 = ME11_IN_On_kf;
ME11_ARID_DEF.HMICtl_bACOnOff_e = true;
}
...
->BCM_SysPowerSts == 2);
if (rtb_FixPtRelationalOperator_nt) {
ME11_ARID_DEF.Switch_c = (RMTCtl_bRemtACDefFlg || rtb_AND_ll);
} else {
ME11_ARID_DEF.Switch_c = HMICtl_bACOnOff;
}
} else {
...
1) && rtb_Compare_ok && (!HMICtl_bACDefrost) && (!ME11_ARID_DEF.Switch_c));
...
(Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_TBOXACTempSet_enum;
ME11_ARID_DEF.DelayInput1_DSTATE_d12 = HU_LeftTempSet;
ME11_ARID_DEF.DelayInput1_DSTATE_kr = rtb_Compare_chc;
ME11_ARID_DEF.DelayInput1_DSTATE_gt = ME11_ARID_DEF.Fb;
ME11_ARID_DEF.Delay3_DSTATE_kci = HMICtl_bACDefrost;
ME11_ARID_DEF.DelayInput1_DSTATE_f0 = FixPtRelationalOperator;
ME11_ARID_DEF.DelayInput1_DSTATE_lb = rtb_Delay3_jo;
ME11_ARID_DEF.Delay_DSTATE_by = ME11_ARID_DEF.Switch_c;
ME11_ARID_DEF.DelayInput1_DSTATE_cl = rtb_Compare_edj;
ME11_ARID_DEF.Delay1_DSTATE_c1 = HMICtl_bACAuto;
ME11_ARID_DEF.DelayInput1_DSTATE_fq = rtb_Compare_ofq;
...
ME11_ARID_DEF.DelayInput1_DSTATE_ea = rtb_FixPtRelationalOperator_io;
ME11_ARID_DEF.DelayInput1_DSTATE_bc = rtb_Compare_ofq;
ME11_ARID_DEF.DelayInput1_DSTATE_kx =
(Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUHybEcoModeSet_enum;
ME11_ARID_DEF.DelayInput1_DSTATE_gy =
...
ME11_ARID_DEF.DelayInput1_DSTATE_m1 = rtb_Compare_psm;
ME11_ARID_DEF.DelayInput1_DSTATE_n4b = HMICtl_eACSts;
...
ME11_ARID_DEF.DelayInput1_DSTATE_goa = HMICtl_bACAuto;
ME11_ARID_DEF.DelayInput1_DSTATE_fp =
(Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUFrntFanSpdSet_enum;
ME11_ARID_DEF.DelayInput1_DSTATE_p2 = HMICtl_bACDefrost;
ME11_ARID_DEF.DelayInput1_DSTATE_l0 = ME11_ARID_DEF.Delay_DSTATE_oz;
ME11_ARID_DEF.Delay2_DSTATE_pb = ME11_ARID_DEF.Switch_c;
ME11_ARID_DEF.DelayInput1_DSTATE_chh = HMICtl_bACDefrost;
...
ME11_ARID_DEF.DelayInput1_DSTATE_ovb = rtb_Compare_ofq;
ME11_ARID_DEF.DelayInput1_DSTATE_in = HMICtl_bACDefrost;
ME11_ARID_DEF.DelayInput1_DSTATE_bli =
(Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUHybEcoModeSet_enum;
...
ME11_enter_internal_Sts(&rtb_Delay3_jo);
} else {
...
PWRCtl_eTMSStatus = rtb_Delay3_jo;
}
...
if (rtb_Add_ax > 0.0F) {
rtb_Switch4_a = rtb_Add / rtb_Add_ax;
} else {
rtb_Switch4_a = 1.0F;
}

SEN_TEnvRaw = look1_iflf_binlca(rtb_Switch4_a * 5.1F, (const float32 *)
...
rtb_Add_ax = rtb_Switch4_a;
}

SENCtl_uMotInletTempVol = get_MotInletTempValtage();
rtb_Delay_ci = (float32)((sint16)SENCtl_uMotInletTempVol -
...
rtb_Add_kz = cal_ADCVCCVal - rtb_Delay_ci;
if (rtb_Add_kz > 0.0F) {
rtb_Switch4_a = rtb_Delay_ci / rtb_Add_kz;
} else {
rtb_Switch4_a = 1.0F;
}

SEN_TMotRaw = look1_iflf_binlca(rtb_Switch4_a * 10000.0F, (const float32 *)
...
if (rtb_Add_ax > rtb_Switch4_a) {
if (GLB_ESC_VehicleSpeedValid) {
if (GLB_ESC_VehicleSpeed >= cal_VehicleSpeedHighVs) {
rtb_Switch4_a = cal_TempRampStepFast;
} else if (GLB_ESC_VehicleSpeed <= cal_VehicleSpeedLowVs) {
if (ACSen_sMotTempFilter >= ColdPCUTempMinByEnv) {
rtb_Switch4_a = 0.0F;
} else {
rtb_Switch4_a = cal_TempRampStepLoVSpeed;
}
} else {
rtb_Switch4_a = cal_TempRampStepSlow;
}
} else {
rtb_Switch4_a = 0.0F;
}
} else {
rtb_Switch4_a = cal_EnvTempRiseStep;
}

rtb_Add_kz = rtb_Delay + rtb_Switch4_a;
if (rtb_Add_kz > 80.0F) {
rtb_Add_kz = 80.0F;
}

if (rtb_Delay - -40.0F >= rtb_Switch4_a) {
rtb_Switch4_a = rtb_Delay - rtb_Switch4_a;
} else {
rtb_Switch4_a = -40.0F;
}
...
if (rtb_Delay <= rtb_Add_ax) {
ME11_ARID_DEF.is_DecreaseTemp = ME11_IN_NO_ACTIVE_CHILD_gl;
ME11_ARID_DEF.is_c50_ME11 = ME11_IN_DontChange;
ME11_ARID_DEF.count = 0U;
} else {
rtb_Subtract9 = ME11_ARID_DEF.count + 1U;
if (ME11_ARID_DEF.count + 1U > 65535U) {
rtb_Subtract9 = 65535U;
}

ME11_ARID_DEF.count = (uint16)rtb_Subtract9;
...
ME11_ARID_DEF.OutData = rtb_Switch4_a;
ME11_ARID_DEF.count = 0U;
} else {
...
ME11_ARID_DEF.OutData = rtb_Add_kz;
ME11_ARID_DEF.count = 0U;
} else {
ME11_ARID_DEF.is_IncreaseTemp = ME11_IN_Delay;
ME11_ARID_DEF.OutData = rtb_Delay;
}
} else if (rtb_Delay > rtb_Add_ax) {
...
{
rtb_Delay = ME11_ARID_DEF.OutData;
} else {
rtb_Delay = ACSen_sEnvTempFilter;
}

ACSen_sEnvTAme = look1_iflf_binlca(rtb_Delay, (const float32 *)
&cal_EnvTAme_1X[0], (const float32 *)&cal_EnvTAme_CUR[0], 10U);
if (cal_EnvTempCorEnb) {
ACSen_sEnvTempCor = cal_EnvTempCorData;
} else {
ACSen_sEnvTempCor = ACSen_sEnvTAme + rtb_Delay;
}

FixPtRelationalOperator = (cal_tCabinCoolEnvTempLow <= ACSen_sEnvTempCor);
rtb_Compare_edj = (ACSen_sEnvTempCor < cal_tCabinCoolEnvTempHigh);
if (HMICtl_sLeftSetPoint == cal_DefaultSetTemp) {
rtb_ACFanLevel8EnvCor = 0.0F;
} else {
rtb_ACFanLevel8EnvCor = cal_PsEnv4SetSelect;
}

ACCtl_tRightSetPointModeCor = rtb_ACFanLevel8EnvCor + HMICtl_sLeftSetPoint;
...
rtb_Add_kz = (float32)AC_rSolarRight * cal_U_DVTFFSolarFilterRate;
ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_m = (1.0F - cal_U_DVTFFSolarFilterRate) *
ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_m + rtb_Add_kz;
...
&cal_ACPsDVTSolarCor_MAP[0], ME11_ConstP.pooled32, 15U);
if ((Rte_IRead_Task_100ms_Bcm2VcuTms_outputs_Bcm2VcuTms_outputs())
->BCM_SysPwrModeV > 0) {
rtb_Delay3_jo = (Rte_IRead_Task_100ms_Bcm2VcuTms_outputs_Bcm2VcuTms_outputs())
->BCM_SysPwrMode;
} else {
rtb_Delay3_jo = 0U;
}
...
if (PWRCtl_bKL15swtSt || (rtb_Delay3_jo == 2) || (PWRCtl_eBatChargSts != 0))
{
...
} else if ((!PWRCtl_bKL15swtSt) && (rtb_Delay3_jo == 0) &&
...
rtb_Add_ax = ME11_ARID_DEF.Delay_DSTATE_o + cal_EnvTempStep;
if (rtb_Add_ax > 80.0F) {
rtb_Add_ax = 80.0F;
}
...
rtb_Subtract9 = ME11_ARID_DEF.count_o + 1U;
if (ME11_ARID_DEF.count_o + 1U > 65535U) {
rtb_Subtract9 = 65535U;
}

ME11_ARID_DEF.count_o = (uint16)rtb_Subtract9;
...
rtb_ACFanLevel8EnvCor = ACSen_sEnvTempCor - cal_EnvTempStep;
} else {
rtb_ACFanLevel8EnvCor = -40.0F;
}

if (ME11_ARID_DEF.Delay_DSTATE_o < rtb_ACFanLevel8EnvCor) {
...
ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_h + rtb_Add_kz;
...
rtb_Subtract9 = ME11_ARID_DEF.count_g + 1U;
if (ME11_ARID_DEF.count_g + 1U > 65535U) {
rtb_Subtract9 = 65535U;
}

ME11_ARID_DEF.count_g = (uint16)rtb_Subtract9;
...
ME11_ARID_DEF.count_g = 0U;
rtb_Subtract9 = (uint32)(uint16)
ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_h + cal_SolarFalseStep;
if (rtb_Subtract9 > 65535U) {
rtb_Subtract9 = 65535U;
}

if (AC_rSunloadFlt > (sint32)rtb_Subtract9) {
rtb_Subtract9 = (uint32)AC_rSunloadFlt - cal_SolarFalseStep;
if (rtb_Subtract9 > AC_rSunloadFlt) {
rtb_Subtract9 = 0U;
}

ME11_ARID_DEF.OutData_f = (uint16)rtb_Subtract9;
} else {
...
ME11_ARID_DEF.is_DecreaseTemp_ji = ME11_IN_Delaychecked;
ME11_ARID_DEF.count_g = 0U;
rtb_Subtract9 = (uint32)(uint16)ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_h
+ cal_SolarFalseStep;
if (rtb_Subtract9 > 65535U) {
rtb_Subtract9 = 65535U;
}
...
case ME11_IN_DontChange:
rtb_Subtract9 = (uint16)ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_h - 20U;
...
ME11_ARID_DEF.count_g = (uint16)rtb_Subtract9;
rtb_Subtract9 = cal_UpAndDownStartTime - 10U;
if (cal_UpAndDownStartTime - 10U > cal_UpAndDownStartTime) {
rtb_Subtract9 = 0U;
}

if (ME11_ARID_DEF.count_g > (sint32)rtb_Subtract9) {
...
if (rtb_Subtract9 > (uint16)ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_h)
{
rtb_Subtract9 = 0U;
}

if (AC_rSunloadFlt < (sint32)rtb_Subtract9) {
rtb_Subtract9 = (uint32)AC_rSunloadFlt + cal_SolarRiseStep;
if (rtb_Subtract9 > 65535U) {
rtb_Subtract9 = 65535U;
}
...
&cal_ACDVTPreSetSolarCorByVx_MAP[0], ME11_ConstP.pooled36, 6U);
...
&cal_ACCabinPreSetByEnv_MAP[0], ME11_ConstP.pooled37, 12U);
...
&cal_CabinDesTempSolarCor_MAP[0], ME11_ConstP.pooled35, 14U);
if (HMICtl_eACSts == 0) {
...
&cal_ACCabinPreSetByEnvECO_MAP[0], ME11_ConstP.pooled37, 12U);
...
&cal_CabinDesTempSolarCorECO_MAP[0], ME11_ConstP.pooled35, 14U);
...
rtb_Delay = (float32)((sint16)SENCtl_uCabinVoltage -
look1_iu16lu64n48ts16Ds32_binlcas(SENCtl_uCabinVoltage,
(const uint16 *)&cal_CabinVolAmend_1X[0], (const sint16 *)
&cal_CabinVolAmend_CUR[0], 1U));
rtb_Add_ax = cal_ADCVCCVal - rtb_Delay;
if (rtb_Add_ax > 0.0F) {
rtb_Add_ax = rtb_Delay / rtb_Add_ax;
} else {
rtb_Add_ax = 1.0F;
}

SEN_TCabinRaw = look1_iflf_binlca(rtb_Add_ax * 3.0F, (const float32 *)
...
rtb_Compare_ofq = (HMICtl_sLeftSetPoint != ME11_ARID_DEF.DelayInput1_DSTATE);
rtb_FixPtRelationalOperator_io = (HMICtl_sLeftSetPoint !=
ME11_ARID_DEF.DelayInput1_DSTATE_j);
rtb_Compare_chc = (rtb_Delay > cal_SensorTempUpFlt);
rtb_Compare_psm = (rtb_Delay < cal_SensorTempDownFlg);
rtb_Switch7_g = Get_SrvClrDTCReq();
ME11_ARID_DEF.Compare = (rtb_Switch7_g == 1);
ME11_Judge(rtb_Compare_chc, rtb_Compare_psm, 20, ME11_ARID_DEF.Compare,
&ME11_ARID_DEF.SenSts_k, &ME11_ARID_DEF.ARID_DEF_Judge_d);
if (PWRCtl_bKL15swtSt) {
ACSen_eCabinSenSts = ME11_ARID_DEF.SenSts_k;
} else {
ACSen_eCabinSenSts = 0U;
}

ACTCtl_bCabinFltFlg = (ACSen_eCabinSenSts != Normal);
rtb_Compare_chc = ((!ACTCtl_bCabinFltFlg) && (ME11_ARID_DEF.Switch1_nv !=
ACOff) && ME11_ARID_DEF.Switch_c);
rtb_Delay = ME11_ARID_DEF.UnitDelay3_DSTATE;
...
rtb_LogicalOperator_j0 = (rtb_Compare_ofq || rtb_FixPtRelationalOperator_io ||
((sint32)rtb_Compare_chc > (sint32)ME11_ARID_DEF.DelayInput1_DSTATE_gyl) ||
(((rtb_Delay > ME11_ARID_DEF.UnitDelay3_DSTATE + 1.0F) ||
(ME11_ARID_DEF.UnitDelay3_DSTATE > ME11_ARID_DEF.UnitDelay2_DSTATE + 1.0F))
&& (ME11_ARID_DEF.UnitDelay3_DSTATE > ME11_ARID_DEF.DelayInput1_DSTATE_d)));
...
rtb_ACFanLevel8EnvCor = ACCtl_tDesFrontCabin -
ME11_ARID_DEF.UnitDelay1_DSTATE;
} else {
rtb_ACFanLevel8EnvCor = ME11_ARID_DEF.UnitDelay1_DSTATE -
ACCtl_tDesFrontCabin;
}

SENCtl_uFaceDuctVal = get_FaceDuctValtage();
rtb_Delay = (float32)((sint16)SENCtl_uFaceDuctVal -
look1_iu16lu64n48ts16Ds32_binlcas(SENCtl_uFaceDuctVal, (
const uint16 *)&cal_FaceDuctVolAmend_1X[0], (const sint16 *)
&cal_FaceDuctVolAmend_CUR[0], 1U));
ME11_Judge(rtb_Delay > cal_SensorTempUpFlt, rtb_Delay < cal_SensorTempDownFlg,
20, ME11_ARID_DEF.Compare, &ME11_ARID_DEF.SenSts_c,
&ME11_ARID_DEF.ARID_DEF_Judge_j);
if (PWRCtl_bKL15swtSt) {
ACSen_eFaceDuctSenSts = ME11_ARID_DEF.SenSts_c;
} else {
ACSen_eFaceDuctSenSts = 0U;
}

rtb_OR_i4 = (ACSen_eFaceDuctSenSts != Normal);
SENCtl_uFootDuctVal = get_FootDuctValtage();
rtb_Add_kz = (float32)((sint16)SENCtl_uFootDuctVal -
...
1U));
ME11_Judge(rtb_Add_kz > cal_SensorTempUpFlt, rtb_Add_kz <
cal_SensorTempDownFlg, 20, ME11_ARID_DEF.Compare,
&ME11_ARID_DEF.SenSts_no, &ME11_ARID_DEF.ARID_DEF_Judge_l);
if (PWRCtl_bKL15swtSt) {
ACSen_eFootDuctSenSts = ME11_ARID_DEF.SenSts_no;
} else {
ACSen_eFootDuctSenSts = 0U;
}

rtb_Compare_h1 = (ACSen_eFootDuctSenSts != Normal);
rtb_RelationalOperator_de = (rtb_OR_i4 || rtb_Compare_h1);
rtb_Delay_n2 = ME11_ARID_DEF.Delay_DSTATE_fl;
rtb_Add_o4 = cal_ADCVCCVal - rtb_Delay;
if (rtb_Add_o4 > 0.0F) {
rtb_Gain8 = rtb_Delay / rtb_Add_o4;
} else {
rtb_Gain8 = 1.0F;
}

SEN_TDuctRaw = look1_iflf_binlca(rtb_Gain8 * 10.0F, (const float32 *)
...
rtb_Delay = cal_ADCVCCVal - rtb_Add_kz;
if (rtb_Delay > 0.0F) {
rtb_Gain8 = rtb_Add_kz / rtb_Delay;
} else {
rtb_Gain8 = 1.0F;
}

SEN_TFootDuctRaw = look1_iflf_binlca(rtb_Gain8 * 10.0F, (const float32 *)
&cal_TDuctRaw_1X[0], (const float32 *)&cal_TDuctRaw_CUR[0], 25U);
...
rtb_Add_kz = look1_iflf_binlca(rtb_Delay, (const float32 *)
&cal_DvtDesValPIDKi_1X[0], (const float32 *)&cal_DvtDesValPIDKi_CUR[0], 8U);
ME11_P_NEG(!ACCtl_tErrDVTFlag, ACCtl_tErrDVT, ACCtl_DVTIDeadBand, rtb_Add_kz,
cal_DvtDesValPID_Ki, (float32 *)&ACCtl_tDvtICor);
ME11_P_POS(ACCtl_tErrDVTFlag, ACCtl_tErrDVT, ACCtl_DVTIDeadBand, rtb_Add_kz,
cal_DvtDesValPID_Ki, (float32 *)&ACCtl_tDvtICor);
if (ACCtl_tErrDVTFlag) {
rtb_ACFanLevel8EnvCor = ACCtl_tErrDVT;
} else {
rtb_ACFanLevel8EnvCor = 0.0F;
}

PidCabinX_IsumMax = look1_iflf_binlca(rtb_ACFanLevel8EnvCor, (const float32 *)
...
PidCabinX_IsumMin = look1_iflf_binlca(rtb_ACFanLevel8EnvCor, (const float32 *)
...
ME11_PI_Controller1(!rtb_Compare_chc, ACCtl_tDVTFeedfoward, (float32 *)
...
AC_PidCabinT_UL = look2_iflf_binlca(rtb_ACFanLevel8EnvCor, ACSen_sEnvTempCor,
(const float32 *)&cal_DvtDesLmtByCabinTDiff_2X[0], (const float32 *)
&cal_DvtDesLmtByCabinTDiff_2Y[0], (const float32 *)
&cal_DvtDesLmtByCabinTDiff_MAP[0], ME11_ConstP.pooled33, 10U);
ME11_PI_Controller(rtb_Compare_chc, ACCtl_tErrDVTFlag, ACCtl_tDVTFeedfoward,
...
&cal_ACDrDVTSolarCor_MAP[0], ME11_ConstP.pooled32, 15U);
if (HMICtl_bLeftSetLow) {
...
SOMCtl_bMD1CLMSts = false;
if ((FixPtRelationalOperator && rtb_Compare_edj &&
...
SOMCtl_bMD1CLMSts = true;
rtb_ACFanLevel8EnvCor = cal_tCabinCoolEnvTempLow - cal_CabinHys1TempOffset;
if ((rtb_ACFanLevel8EnvCor > ACSen_sEnvTempCor) || ((rtb_ACFanLevel8EnvCor <=
ACSen_sEnvTempCor) && (ACSen_sEnvTempCor < cal_tCabinCoolEnvTempHigh -
...
SOMCtl_bMD2DHMD1Flg = true;
rtb_ACFanLevel8EnvCor = cal_tCabinCoolEnvTempHigh + cal_CabinHys1TempOffset;
rtb_Add_o4 = cal_tCabinCoolEnvTempLow - cal_CabinHys1TempOffset;
if ((rtb_ACFanLevel8EnvCor <= ACSen_sEnvTempCor) || ((rtb_Add_o4 <=
ACSen_sEnvTempCor) && (ACSen_sEnvTempCor < rtb_ACFanLevel8EnvCor) &&
(ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_dn < SOMCtl_sF1Value -
cal_CabinHys2TempOffset)) || ((rtb_Add_o4 <= ACSen_sEnvTempCor) &&
...
SOMCtl_bMD3DHMD2Flg = true;
rtb_ACFanLevel8EnvCor = cal_tCabinCoolEnvTempLow - cal_CabinHys1TempOffset;
rtb_Add_o4 = cal_CabinMD2F2MaxEnvTemp + cal_CabinHys1TempOffset;
if ((rtb_ACFanLevel8EnvCor > ACSen_sEnvTempCor) || ((rtb_ACFanLevel8EnvCor <=
ACSen_sEnvTempCor) && (ACSen_sEnvTempCor < rtb_Add_o4) &&
(ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_dn < SOMCtl_sF2Value -
cal_CabinHys2TempOffset)) || (rtb_Add_o4 <= ACSen_sEnvTempCor)) {
ME11_ARID_DEF.is_c16_ME11 = ME11_IN_Off_a;
SOMCtl_bMD3DHMD2Flg = false;
...
rtb_Compare_edj = (rtb_Gain8 < cal_tCabinCondToCoolDvtDiff);
FixPtRelationalOperator = ME11_ARID_DEF.Delay1_DSTATE_b;
rtb_Divide_ox =
...
rtb_FixPtRelationalOperator_io = (rtb_Compare_edj &&
...
ME11_ARID_DEF.SOMCtl_Two2OneA = true;
} else if (!rtb_FixPtRelationalOperator_io) {
ME11_ARID_DEF.is_c19_ME11 = ME11_IN_Off_a;
ME11_ARID_DEF.SOMCtl_Two2OneA = false;
}
break;
...
rtb_FixPtRelationalOperator_io = (HP_EXV_CurrentPosition_B <=
cal_CabinCondToCoolHPEXVPos2);
SENCtl_uEVAPSurfTempVol = get_EVAPSurfTempValtage();
rtb_Add_isn = (float32)((sint16)SENCtl_uEVAPSurfTempVol -
...
rtb_Delay = cal_ADCVCCVal - rtb_Add_isn;
if (rtb_Delay > 0.0F) {
rtb_LowPressLmt = rtb_Add_isn / rtb_Delay;
} else {
rtb_LowPressLmt = 1.0F;
}

SEN_TEvapSurRaw = look1_iflf_binlca(rtb_LowPressLmt * 3.0F, (const float32 *)
...
rtb_Compare_edj = (rtb_FixPtRelationalOperator_io && rtb_Compare_edj &&
(SOMCtl_bMD1CLMSts && (ACSen_sEvapSurTemp <=
cal_tCabinCondToCoolEvapTemp)));
...
rtb_Compare_edj = (ME11_ARID_DEF.Delay_DSTATE_he && (rtb_Gain8 >
cal_tCabinCoolToCondDvtDiff));
ME11_TMSADCSampleFunc();
rtb_Compare_edj = (rtb_Compare_edj && ((ACSen_sMixDoorPerc >
...
rtb_Compare_edj = (COMP_EcompActSpd < cal_CabinEvpToCondCompLmt);
rtb_FixPtRelationalOperator_io = (((ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_dn -
...
SOMCtl_bMD2DHMD1Flg && rtb_Compare_edj));
...
rtb_Compare_edj = (rtb_Compare_edj && SOMCtl_bMD3DHMD2Flg &&
...
rtb_Compare_edj = ((ACSen_sEnvTempCor > cal_tCabinHPToEvpEnvTemp) &&
...
rtb_Compare_edj = ((ACSen_eAirInletPer < cal_rCabinEvpToHPInnRatio) &&
(rtb_Compare_ofq && (ACSen_sEnvTempCor <
...
ME11_ARID_DEF.ModeSts = rtb_Delay3_jo;
} else if (ME11_ARID_DEF.is_c38_ME11 == ME11_IN_Init_i) {
if ((rtb_Delay3_jo != ME11_ARID_DEF.DelayInput1_DSTATE_h) && ((rtb_Delay3_jo
!= 0) || (rtb_Delay3_jo != 7))) {
...
rtb_Subtract9 = ME11_ARID_DEF.Counter_b + 1U;
if (ME11_ARID_DEF.Counter_b + 1U < ME11_ARID_DEF.Counter_b) {
rtb_Subtract9 = MAX_uint32_T;
}

ME11_ARID_DEF.Counter_b = rtb_Subtract9;
}
...
if (!rtb_FixPtRelationalOperator_jt) {
ME11_ARID_DEF.is_c124_ME11 = ME11_IN_Normal_k;
ME11_ARID_DEF.ACTCtl_bAcPMPFaultFlg_m = false;
}
break;
...
rtb_Add_kz = (float32)fabs(rtb_Delay);
...
((rtb_Add_kz >= cal_tBatHeatExitMaxToMinCellDiff) << 3)) + (uint32)
((PWRCtl_VCUACCMLimitPwr <= cal_BatHeatPwrLoLmt) << 4)) + (uint32)
(ACTCtl_bCOMPCoolEnvPrtFlg << 5));
rtb_FixPtRelationalOperator_jt = (SOMCtl_eBatCoolB2tB1 != 0);
rtb_Compare_ace = !ACTCtl_bBatPMPFaultFlg;
b_previousEvent = ((!ACTCtl_bAEXVFaultFlg) && (!ACTCtl_bBEXVFaultFlg) &&
(!ACTCtl_bHPEXVFaultFlg) && rtb_Compare_ace &&
(!ACTCtl_bCOMPForbidFlg));
rtb_Compare_jg = !ACTCtl_bCOMPCoolEnvPrtFlg;
...
((PWRCtl_VCUACCMLimitPwr >= cal_HeatPwrOn) << 2)) + (uint32)((rtb_Add_kz <
cal_tBatHeatExitMaxToMinCellDiff) << 3)) + (uint32)(rtb_Compare_jg << 4));
...
rtb_FixPtRelationalOperator_jt = MotPMP_RESP_ERROR;
MotPMP_PumpMotorSta =
Rte_IRead_Task_100ms_MotPMP_PumpMotorSta_MotPMP_PumpMotorSta();
rtb_Compare_ok = (MotPMP_PumpMotorSta != 0);
MotPMP_PumpDryRunningSta =
Rte_IRead_Task_100ms_MotPMP_PumpDryRunningSta_MotPMP_PumpDryRunningSta();
rtb_Compare_gre = MotPMP_PumpDryRunningSta;
MotPMP_PumpPowerSta =
Rte_IRead_Task_100ms_MotPMP_PumpPowerSta_MotPMP_PumpPowerSta();
rtb_AND1_gd = (MotPMP_PumpPowerSta != 0);
MotPMP_PumpTempSta =
Rte_IRead_Task_100ms_MotPMP_PumpTempSta_MotPMP_PumpTempSta();
rtb_FixPtRelationalOperator_bv1 = (MotPMP_PumpTempSta != 0);
ME11_AcPMPFaultJudge(MotPMP_RESP_ERROR || rtb_Compare_ok ||
MotPMP_PumpDryRunningSta || rtb_AND1_gd ||
rtb_FixPtRelationalOperator_bv1,
&ME11_ARID_DEF.ACTCtl_bAcPMPFaultFlg_e,
&ME11_ARID_DEF.ARID_DEF_MOTPMPFaultJudge);
...
rtb_AND1_h0y = (rtb_Compare_ace && (!ACTCtl_bMotPMPFaultFlg));
...
rtb_Subtract9 = (uint32)(rtb_AND1_h0y << 3);
SOMCtl_eBatLTROnFlg = (uint8)((((uint32)(((ACSen_sMotTempFilter >=
cal_tLTROnMotInletTemp) || rtb_Compare_if || rtb_Compare_hs) << 2) + (uint32)
((BMS_HVBatCellTempMax < cal_BatBalCellTemp2) << 1)) + (uint32)
(ME11_ARID_DEF.DataTypeConversion1 >= 2)) + rtb_Subtract9);
rtb_Compare_hs =
((Rte_IRead_Task_100ms_IPM_INV_2_Value_EPT_IPM_INV_2_Value_EPT())
...
SOMCtl_eMotLTRAndBatBalOffFlg = (uint8)((((((uint32)(rtb_Compare_hs &&
(ACSen_sMotTempFilter <= cal_LTRMotorInletMaxExitTempA) && rtb_Compare_if) +
...
rtb_Compare_hs = (SOMCtl_bBatCoolFlg || (((ME11_ARID_DEF.DataTypeConversion1 ==
3) || (ME11_ARID_DEF.DataTypeConversion1 == 4)) && SOMCtl_bBatHeatFlg));
...
(!SOMCtl_bMotLTRAndBatBalOffFlg) && (!rtb_Compare_hs)) {
ME11_ARID_DEF.is_c142_ME11 = ME11_IN_On_li;
SOMCtl_bMotorLTRAndBatBalFlg = true;
}
} else {
SOMCtl_bMotorLTRAndBatBalFlg = true;
if (SOMCtl_bMotLTRAndBatBalOffFlg || rtb_Compare_hs) {
ME11_ARID_DEF.is_c142_ME11 = ME11_IN_Off_a;
SOMCtl_bMotorLTRAndBatBalFlg = false;
}
}

rtb_Add_o4 = BMS_HVBatCellTempMax - ACSen_sMotTempFilter;
...
((ME11_ARID_DEF.DataTypeConversion1 == 2) ||
(ME11_ARID_DEF.DataTypeConversion1 == 5))) + (uint32)((rtb_Add_o4 >=
...
rtb_ACFanLevel8EnvCor)) || ((ME11_ARID_DEF.DataTypeConversion1 == 3) &&
(BMS_HVBatCellTempMax >= rtb_ACFanLevel8EnvCor))) + (uint32)((rtb_Add_o4 >=
cal_tLTROnMaxCellToMotDiff) << 1));
SOMCtl_bMotLTRAndBatBalOn2Flg = (SOMCtl_eMotLTRAndBatBalOn2Flg == 3);
rtb_Compare_if = (SOMCtl_bMotLTRAndBatBalOn1Flg || (rtb_Compare_hs &&
(ME11_ARID_DEF.DataTypeConversion1 >= 2)) || SOMCtl_bMotLTRAndBatBalOn2Flg);
rtb_Compare_hs =
((Rte_IRead_Task_100ms_IPM_IPU_OBC_2_Inlet_EPT_IPM_IPU_OBC_2_Inlet_EPT())
->VIPM_IPUDeviceIntTemp_C <= cal_DLTRIPUTempExitVal);
SOMCtl_bDBatLTROffFlg = ((rtb_Compare_hs && ((BMS_InletCooltActlTemp -
BMS_HVBatCellTempMax >= cal_DLTRBatInlet2MaxTempDiff) ||
(cal_BatBalCellTemp2 - BMS_HVBatCellTempMax >=
cal_tLTROffBatBal2ToMaxCellDiff))) ||
...
(ME11_ARID_DEF.DataTypeConversion1 == 5)))) && rtb_Compare_jg) ||
(rtb_Delay >= cal_tBatHeatExitMaxToMinCellDiff) || rtb_AND4_f));
rtb_Compare_hs = (SOMCtl_bBatCoolFlg || (((ME11_ARID_DEF.DataTypeConversion1 ==
3) || (ME11_ARID_DEF.DataTypeConversion1 == 4)) &&
ME11_ARID_DEF.Delay_DSTATE_jf));
...
SOMCtl_bMotAndBatLTRFlg = false;
if (rtb_Compare_if && rtb_AND1_h0y && (rtb_Delay <
cal_tBatHeatExitMaxToMinCellDiff) && (!SOMCtl_bDBatLTROffFlg) &&
(!rtb_Compare_hs) && (b_previousEvent == 0)) {
ME11_ARID_DEF.is_c144_ME11 = ME11_IN_On_li;
SOMCtl_bMotAndBatLTRFlg = true;
}
} else {
SOMCtl_bMotAndBatLTRFlg = true;
if (SOMCtl_bDBatLTROffFlg || rtb_Compare_hs || (b_previousEvent == 1)) {
ME11_ARID_DEF.is_c144_ME11 = ME11_IN_Off_a;
SOMCtl_bMotAndBatLTRFlg = false;
}
}
...
rtb_ACTCtl_bEXVDiagFlg = (BMS_HVBatCellTempMin <=
...
rtb_Compare_kt = (AcPMP_PumpTempSta != 0);
ME11_AcPMPFaultJudge(AcPMP_RESP_ERROR || rtb_Compare_if ||
AcPMP_PumpDryRunningSta || rtb_RelationalOperator3_d ||
rtb_Compare_kt, &ME11_ARID_DEF.ACTCtl_bAcPMPFaultFlg_c,
...
if ((ME11_ARID_DEF.DataTypeConversion1 <= 1) || ME11_ARID_DEF.Compare) {
rtb_Switch2_ek = 0U;
} else {
rtb_Switch2_ek =
...
->VIPM_HVCHSt_enum != 2);
ACTCtl_bHVCHFaultFlg = ((rtb_Switch2_ek == 0) && rtb_Compare_ar);
}

SOMCtl_bBatHeatTempDiffE = (rtb_Add_kz < cal_tBatHeatExitMaxToMinCellDiff);
rtb_Add_o4 = PWRCtl_VCUACCMLimitPwr + PWRCtl_VCUACCMLimitPwr;
SOMCtl_bBatHeatPwrLmtF = (rtb_Add_o4 >= cal_HeatPwrOn);
rtb_Compare_ace = ((!ACTCtl_bAcPMPFaultFlg) && rtb_Compare_ace &&
ACTCtl_bHVCHFaultFlg);
SOMCtl_bBatB1TB41Flg = (SOMCtl_bBatHeatChrgFlgAB && rtb_Compare_ace &&
...
if ((ME11_ARID_DEF.DataTypeConversion1 == 3) ||
(ME11_ARID_DEF.DataTypeConversion1 == 4)) {
rtb_Compare_ar = false;
} else {
rtb_Compare_ar = (BMS_BatSOCAct_pct <= cal_VehHeatSOCOff);
}
...
&& rtb_ACTCtl_bEXVDiagFlg) || ((ME11_ARID_DEF.DataTypeConversion1 == 5) &&
...
<< 2)) + (uint32)(rtb_Compare_ar << 3)) + (uint32)(rtb_Add_kz >=
cal_tBatHeatExitMaxToMinCellDiff)) + (uint32)((rtb_Add_o4 <=
...
(BMS_HVBatCellTempMin <= cal_tBatHeatVehReadyCellTempOn) && rtb_Compare_ace &&
(BMS_BatSOCAct_pct >= cal_VehHeatSOCOn) && (rtb_Add_kz <
cal_tBatHeatExitMaxToMinCellDiff) && (rtb_Add_o4 >= cal_HeatPwrOn));
...
cal_BatBalCellTemp1) && (rtb_Compare_hke || rtb_Compare_msu));
SOMCtl_bBatTSEntBFlg = ((cal_TSACBatMinEntTempA <= BMS_HVBatCellTempMin) &&
(BMS_HVBatCellTempMax < cal_BatBalCellTemp2) &&
(ME11_ARID_DEF.DataTypeConversion1 == 3) && (BMS_BatSOCAct_pct <=
cal_ACChgBatLowSOCHeat) && (rtb_Delay < cal_tBatHeatExitMaxToMinCellDiff) &&
rtb_AND1_h0y);
...
(ME11_ARID_DEF.B_a && ME11_ARID_DEF.B_i) || rtb_ACTCtl_bEXVDiagFlg ||
(ACSen_sMotTempFilter >= cal_TSMotorMinTempExitH) || rtb_Compare_ar ||
...
(uint32)((rtb_Delay >= cal_tBatHeatExitMaxToMinCellDiff) << 4)) + (uint32)
(rtb_AND4_f << 5)) + (uint32)(ME11_ARID_DEF.B_b << 6)) + (uint32)
...
ME11_ARID_DEF.is_c133_ME11 = ME11_IN_Default_c;
rtb_Switch2_ht = 0U;
...
case ME11_IN_Init_i:
ACCtl_bExhFlg = false;
if (((sint32)ACCtl_bExhaustFlg > (sint32)
ME11_ARID_DEF.DelayInput1_DSTATE_iy) &&
(ME11_ARID_DEF.DataTypeConversion1 >= 2)) {
...
rtb_Add_ei = (float32)((sint16)SENCtl_uOHXTempVol -
...
rtb_Delay = cal_ADCVCCVal - rtb_Add_ei;
if (rtb_Delay > 0.0F) {
rtb_Gain8 = rtb_Add_ei / rtb_Delay;
} else {
rtb_Gain8 = 1.0F;
}

SEN_OHXTRaw = look1_iflf_binlca(rtb_Gain8 * 20000.0F, (const float32 *)
...
rtb_Compare_ci[b_previousEvent] = (SOMCtl_eRefModes ==
ME11_ConstP.Constant_Value_dw[b_previousEvent]);
}

rtb_ACTCtl_bEXVDiagFlg = rtb_Compare_ci[0];
for (b_previousEvent = 0; b_previousEvent < 6; b_previousEvent++) {
rtb_ACTCtl_bEXVDiagFlg = (rtb_ACTCtl_bEXVDiagFlg ||
rtb_Compare_ci[b_previousEvent + 1]);
}

if (rtb_ACTCtl_bEXVDiagFlg) {
...
rtb_Compare_n2_0 = (ACTCtl_bAEXVFaultFlg || ACTCtl_bBEXVFaultFlg ||
...
&ME11_ARID_DEF.ARID_DEF_Flg3Cal_o);
...
ME11_ARID_DEF.Sts_d);
ACTCtl_bCOMPForbidFlg = (ACTCrl_bEnvCOMPLmt || rtb_Compare_n2_0 ||
...
rtb_ACTCtl_bCOMPDiagFlg = (rtb_Compare_fd || rtb_Compare_eux || rtb_Compare_m4
|| rtb_Compare_of3 || rtb_Compare_ani || rtb_Compare_lt0 ||
...
rtb_Compare_ar = (cal_LTRIGBTTempMotPMPCtrl_1X[0] >
(Rte_IRead_Task_100ms_IPM_INV_2_Value_EPT_IPM_INV_2_Value_EPT
())->VIPM_INV2IgbtMaxTemp_C);
if (rtb_Compare_ar) {
rtb_Switch7_g = cal_LTRIGBTTempMotPMPCtrl_1Y[0];
} else {
rtb_AND1_h0y =
((Rte_IRead_Task_100ms_IPM_INV_2_Value_EPT_IPM_INV_2_Value_EPT())
->VIPM_INV2IgbtMaxTemp_C >= cal_LTRIGBTTempMotPMPCtrl_1X[1]);
if (rtb_AND1_h0y) {
rtb_Switch7_g = cal_LTRIGBTTempMotPMPCtrl_1Y[2];
} else {
rtb_Switch7_g = cal_LTRIGBTTempMotPMPCtrl_1Y[1];
}
}

rtb_Compare_ar = (cal_LTRMotorTempMotPMPCtrl_1X[0] >
(Rte_IRead_Task_100ms_IPM_INV_2_Value_EPT_IPM_INV_2_Value_EPT
())->VIPM_INV2MotorMaxTemp_C);
if (rtb_Compare_ar) {
rtb_Switch_ia = cal_LTRMotorTempMotPMPCtrl_1Y[0];
} else {
rtb_AND1_h0y =
((Rte_IRead_Task_100ms_IPM_INV_2_Value_EPT_IPM_INV_2_Value_EPT())
->VIPM_INV2MotorMaxTemp_C >= cal_LTRMotorTempMotPMPCtrl_1X[1]);
if (rtb_AND1_h0y) {
rtb_Switch_ia = cal_LTRMotorTempMotPMPCtrl_1Y[2];
} else {
rtb_Switch_ia = cal_LTRMotorTempMotPMPCtrl_1Y[1];
}
}

rtb_Compare_ar = (cal_LTRIPUTempMotPMPCtrl_1X[0] >
(Rte_IRead_Task_100ms_IPM_IPU_OBC_2_Inlet_EPT_IPM_IPU_OBC_2_Inlet_EPT
())->VIPM_IPUDeviceIntTemp_C);
if (rtb_Compare_ar) {
rtb_Switch3_cn = cal_LTRIPUTempMotPMPCtrl_1Y[0];
} else {
rtb_AND1_h0y =
((Rte_IRead_Task_100ms_IPM_IPU_OBC_2_Inlet_EPT_IPM_IPU_OBC_2_Inlet_EPT()
)->VIPM_IPUDeviceIntTemp_C >= cal_LTRIPUTempMotPMPCtrl_1X[1]);
if (rtb_AND1_h0y) {
rtb_Switch3_cn = cal_LTRIPUTempMotPMPCtrl_1Y[2];
} else {
rtb_Switch3_cn = cal_LTRIPUTempMotPMPCtrl_1Y[1];
}
}

if (rtb_Switch7_g >= rtb_Switch_ia) {
rtb_Switch_ia = rtb_Switch7_g;
}

if (rtb_Switch_ia < rtb_Switch3_cn) {
rtb_Switch_ia = rtb_Switch3_cn;
}

BCV_PosRec = Rte_IRead_Task_100ms_C5WVPosRec_C5WVPosRec();
if (ACCtl_bExhFlg) {
rtb_Switch3_cn = cal_C5WVExhPosVal;
...
rtb_RelationalOperator_lt = ((uint16)(BCV_PosRec - rtb_Switch3_cn) >=
...
rtb_Switch_ia = cal_MotPMPSpdSetData;
...
switch (SOMCtl_eWaterMode) {
case 1:
rtb_IndexVector8_j = look1_iflftu8Df_binlca(BMS_HVBatCellTempMax -
BMS_HVBatCellTempMin, (const float32 *)&cal_BatPumpLTR_1X[0], (const
uint8 *)&cal_BatPumpLTR_CUR[0], 3U);
if (rtb_IndexVector8_j >= rtb_Switch_ia) {
rtb_Switch_ia = rtb_IndexVector8_j;
}
break;
...
case 5:
rtb_Switch_ia = cal_MotPMPMotHeatBatSpd;
break;

case 3:
rtb_Switch_ia = cal_MotPMPThStoSpd;
break;
}

if (rtb_Switch_ia < cal_MotPMPDefaultSpd) {
rtb_Switch_ia = cal_MotPMPDefaultSpd;
}
}
} else {
rtb_Switch_ia = 10U;
...
if (rtb_Switch_ia > 100) {
rtb_Switch2_a0 = 100U;
} else if (rtb_Switch_ia < 10) {
rtb_Switch2_a0 = 10U;
} else {
rtb_Switch2_a0 = rtb_Switch_ia;
}

rtb_Compare_ace = (ME11_ARID_DEF.Delay_DSTATE_lv == 1);
...
if (rtb_Compare_ace && (ME11_ARID_DEF.Delay_DSTATE_lv !=
...
case 1:
rtb_MultiportSwitch1 = rtb_Switch2_a0;
break;
...
rtb_Compare_ace = ((sint32)ME11_ARID_DEF.Delay_DSTATE_po < (sint32)
ME11_ARID_DEF.DelayInput1_DSTATE_kph);
...
rtb_Add_kz = cal_ExtDefPTCTrgTemp;
} else {
rtb_Add_kz = -40.0F;
}

rtb_AND1_c = ((rtb_Add_kz >= 1.0F) && (rtb_Switch2_ht == 10));
...
rtb_Compare_ace = (ME11_ARID_DEF.DataTypeConversion1 == 3);
if (ME11_ARID_DEF.DataTypeConversion1 == 4) {
...
&cal_SetPtcDesTempMax_MAP[0], ME11_ConstP.pooled33, 10U);
if (ACCtl_tPsDVT >= ACCtl_tDrDVT) {
...
rtb_Add_dq = (float32)((sint16)SENCtl_uEVAPXTempVol -
...
1U));
rtb_Add_o4 = cal_ADCVCCVal - rtb_Add_dq;
if (rtb_Add_o4 > 0.0F) {
rtb_Add_o4 = rtb_Add_dq / rtb_Add_o4;
} else {
rtb_Add_o4 = 1.0F;
}

SEN_EvapTRaw = look1_iflf_binlca(rtb_Add_o4 * 3000.0F, (const float32 *)
...
ACCtl_stACPTCHeated = false;
if ((rtb_Delay > ACPTC_HeatingCond1) && (rtb_Delay < ACPTC_HeatingCond2))
{
...
default:
ACCtl_stACPTCHeated = false;
if ((ME11_ARID_DEF.EvapTempUpWaiteTime > cal_TevapUpTime) || (rtb_Delay >
ACPtc_CloseCond1)) {
ME11_ARID_DEF.EvapTempUpWaiteTime = 0U;
ME11_ARID_DEF.is_c53_ME11 = ME11_IN_PTC_Heating;
ACCtl_stACPTCHeated = false;
...
&cal_ACPTCDesEnvCor_MAP[0], ME11_ConstP.pooled36, 6U);
...
switch (rtb_Delay_n2) {
case BlowerModes_FaceMode:
rtb_Add_o4 = look1_iflf_binlca(ACCtl_tDrDVT, (const float32 *)
...
rtb_ACFanLevel8EnvCor = ACPTCDrDesEnvCor;
} else {
rtb_ACFanLevel8EnvCor = ACPTCDrDesCabinCor;
}

ACCtl_tDrSetBasicPTC = (ACPTCDrDesFanCor + rtb_ACFanLevel8EnvCor) + rtb_Add_o4;
...
rtb_Compare_ar = ((rtb_Delay_n2 != BlowerModes_DeforstMode) &&
((ME11_ARID_DEF.Switch1_nv != ACOff) &&
ME11_ARID_DEF.Switch_c));
rtb_ACTCtl_bEXVDiagFlg = !rtb_RelationalOperator_de;
rtb_LogicalOperator1_f = (rtb_ACTCtl_bEXVDiagFlg && rtb_Compare_ar);
if (cal_FixPIDSecletFlag) {
rtb_Delay = ACCtl_tDrDVT - ACCtl_tLeftDuct;
ME11_deadzone_h(rtb_Delay, 0.5, &rtb_flag_nk);
rtb_RelationalOperator_j5 = (ACCtl_tDrDVT >= ACCtl_tLeftDuct);
if (rtb_flag_nk) {
rtb_Delay = 0.0F;
} else if (!rtb_RelationalOperator_j5) {
rtb_Delay = ACCtl_tLeftDuct - ACCtl_tDrDVT;
}

if (rtb_RelationalOperator_j5) {
rtb_Add_o4 = cal_DrPtcDesValPIDIntegDeadBand4InHeat;
} else {
rtb_Add_o4 = cal_DrPtcDesValPIDIntegDeadBand4OutHeat;
}

ME11_P_NEG(!rtb_RelationalOperator_j5, rtb_Delay, rtb_Add_o4,
cal_DrPtcDesValPIDKiNeg, cal_DrPtcDesValPIDKi, (float32 *)
&ACCtl_tDrPTCICor);
ME11_P_POS(rtb_RelationalOperator_j5, rtb_Delay, rtb_Add_o4,
...
ME11_P_NEG_p(!rtb_RelationalOperator_j5, rtb_Delay,
cal_DrPtcDesValPID_pWinNeg, cal_DrPtcDesValPIDKpNeg,
cal_DrPtcDesValPIDKp, (float32 *)&ACCtl_tDrPTCPCor);
ME11_P_POS_l(rtb_RelationalOperator_j5, rtb_Delay,
cal_DrPtcDesValPID_pWinPos, cal_DrPtcDesValPIDKpPos,
cal_DrPtcDesValPIDKp, (float32 *)&ACCtl_tDrPTCPCor);
ME11_PI_Controller(rtb_LogicalOperator1_f, rtb_RelationalOperator_j5,
...
&cal_ACPTCPsDesEnvCor_MAP[0], ME11_ConstP.pooled36, 6U);
...
switch (rtb_Delay_n2) {
case BlowerModes_FaceMode:
rtb_Add_o4 = look1_iflf_binlca(ACCtl_tPsDVT, (const float32 *)
...
if (ACSen_eAirInletPer < cal_ACRecirRatioLmt) {
rtb_ACFanLevel8EnvCor = ACPTCPsDesEnvCor;
} else {
rtb_ACFanLevel8EnvCor = ACPTCPsDesCabinCor;
}

ACCtl_tPsSetBasicPTC = (ACPTCPsDesFanCor + rtb_ACFanLevel8EnvCor) + rtb_Add_o4;
...
rtb_LogicalOperator5 = (rtb_Compare_ar && rtb_ACTCtl_bEXVDiagFlg);
if (cal_FixPIDSecletFlag) {
rtb_Delay = ACCtl_tPsDVT - ACCtl_tRightDuct;
ME11_deadzone_h(rtb_Delay, 0.5, &rtb_flag_n);
rtb_RelationalOperator_de = (ACCtl_tPsDVT >= ACCtl_tRightDuct);
if (rtb_flag_n) {
rtb_Delay = 0.0F;
...
if (rtb_RelationalOperator_de) {
rtb_Add_o4 = cal_PsPtcDesValPIDIntegDeadBand4InHeat;
} else {
rtb_Add_o4 = cal_PsPtcDesValPIDIntegDeadBand4OutHeat;
}

ME11_P_NEG(!rtb_RelationalOperator_de, rtb_Delay, rtb_Add_o4,
cal_PsPtcDesValPIDKiNeg, cal_PsPtcDesValPIDKi, (float32 *)
&ACCtl_tPsPTCICor);
ME11_P_POS(rtb_RelationalOperator_de, rtb_Delay, rtb_Add_o4,
...
ME11_P_NEG_p(!rtb_RelationalOperator_de, rtb_Delay,
cal_PsPtcDesValPID_pWinNeg, cal_PsPtcDesValPIDKpNeg,
cal_PsPtcDesValPIDKp, (float32 *)&ACCtl_tPsPTCPCor);
ME11_P_POS_l(rtb_RelationalOperator_de, rtb_Delay,
cal_PsPtcDesValPID_pWinPos, cal_PsPtcDesValPIDKpPos,
cal_PsPtcDesValPIDKp, (float32 *)&ACCtl_tPsPTCPCor);
ME11_PI_Controller(rtb_LogicalOperator5, rtb_RelationalOperator_de,
...
rtb_Delay = (Rte_IRead_Task_100ms_IPM_HVCH_Status1_BOD_IPM_HVCH_Status1_BOD())
->VIPM_HVCHOutlTemp_C;
if (rtb_Delay > 0.0F) {
rtb_Delay = 0.0F;
}
} else if (rtb_DataTypeConversion_f == ACEconMode_Economy) {
rtb_Delay = ME11_ARID_DEF.PI_Cor_p;
} else if (ME11_ARID_DEF.PI_Cor >= ME11_ARID_DEF.PI_Cor_p) {
rtb_Delay = ME11_ARID_DEF.PI_Cor;
} else {
rtb_Delay = ME11_ARID_DEF.PI_Cor_p;
}

if (ME11_ARID_DEF.FixPtUnitDelay2_DSTATE_gm != 0) {
ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_b = rtb_Delay;
}

ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_b = (1.0F - cal_SetPtcDesCoff) *
ME11_ARID_DEF.FixPtUnitDelay1_DSTATE_b + rtb_Delay * cal_SetPtcDesCoff;
if (cal_CabinSetPTCSwitch) {
ACCtl_tSetPointPTC = ((((rtb_Delay + ME11_ARID_DEF.Delay1_DSTATE_f) +
...
rtb_Add_kz = SOMCtl_sBatTrgTemp;
} else {
rtb_Add_kz = ACCtl_tSetPointPTC;
}
} else {
switch (rtb_Switch2_ht) {
case 5:
...
if (rtb_Add_kz > cal_PTCMaxTemp) {
ACTCtl_sPTCRequestTemp = cal_PTCMaxTemp;
} else if (rtb_Add_kz < cal_PTCMinTemp) {
ACTCtl_sPTCRequestTemp = cal_PTCMinTemp;
} else {
ACTCtl_sPTCRequestTemp = rtb_Add_kz;
}
}
...
SOMCtl_sBatHeatT2)) {
rtb_Add_kz = ACTCtl_sBatHeatInletTrgT - BMS_InletCooltActlTemp;
if (rtb_Add_kz > ME11_ARID_DEF.Delay_DSTATE_i1) {
ACTCtl_bBatTempDiff = 1U;
} else if (ME11_ARID_DEF.Delay_DSTATE_i1 > rtb_Add_kz) {
...
(rtb_Add_kz, (const float32 *)&cal_BetwT1AndT2DownMCV_1X[0], 5U)];
break;

case 2:
ME11_ARID_DEF.Merge = cal_BetwT1AndT2UpMCV_CUR[plook_u32f_binckan
(rtb_Add_kz, (const float32 *)&cal_BetwT1AndT2UpMCV_1X[0], 5U)];
break;

default:
ME11_ARID_DEF.Merge = cal_BetwT1AndT2StbyMCV_CUR[plook_u32f_binckan
(rtb_Add_kz, (const float32 *)&cal_BetwT1AndT2StbyMCV_1X[0], 5U)];
break;
}
} else {
ME11_ARID_DEF.Merge = 0U;
...
ME11_ARID_DEF.Delay_DSTATE_i1 = rtb_Add_kz;
}
...
if (ACCtl_bExhFlg) {
rtb_Switch7_g = cal_C3WVExhPosVal;
...
rtb_Switch7_g = ME11_ARID_DEF.Merge;
} else {
rtb_Switch7_g = 0U;
}

rtb_RelationalOperator_pq = ((uint16)(MCV_PosRec - rtb_Switch7_g) >=
...
if (C3WVLostComm) {
rtb_ACTCtl_bEXVDiagFlg = true;
} else {
rtb_ACTCtl_bEXVDiagFlg = !rtb_RelationalOperator_pq;
}

if (rtb_ACTCtl_bEXVDiagFlg || ME11_ARID_DEF.C_o) {
if (ACCtl_bExhFlg) {
ACTCtl_eAcPMPSpdPerc = 50U;
} else {
for (b_previousEvent = 0; b_previousEvent < 5; b_previousEvent++) {
rtb_Compare_hc2[b_previousEvent] = (rtb_Switch2_ht ==
ME11_ConstP.pooled84[b_previousEvent]);
}
...
if (ME11_ARID_DEF.Delay_DSTATE_po || (rtb_Compare_hc2[0] ||
rtb_Compare_hc2[1] || rtb_Compare_hc2[2] || rtb_Compare_hc2[3] ||
rtb_Compare_hc2[4])) {
...
if (rtb_SOMCtl_WaterMode >= rtb_Switch_jkj) {
rtb_Switch_jkj = rtb_SOMCtl_WaterMode;
}

if (rtb_Switch_jkj >= ACTCtl_eAcPMPSpdPerc) {
ACTCtl_eAcPMPSpdPerc = rtb_Switch_jkj;
}
}
} else {
ACTCtl_eAcPMPSpdPerc = 10U;
...
rtb_Switch2_f0 = ACTCtl_eAcPMPSpdPerc;
}
...
case ME11_IN_Default_k:
ME11_ARID_DEF.ACTCtl_bAcPMPSpdFlt_a = false;
if ((rtb_Switch2_f0 > AcPMP_RealRPM + (float32)cal_ACPMPSpdDiffVal) ||
(rtb_Switch2_f0 < AcPMP_RealRPM - (float32)cal_ACPMPSpdDiffVal)) {
...
ME11_ARID_DEF.ACTCtl_bAcPMPSpdFlt_a = true;
} else if ((rtb_Switch2_f0 < AcPMP_RealRPM + (float32)cal_ACPMPSpdDiffVal)
&& (rtb_Switch2_f0 > AcPMP_RealRPM - (float32)
cal_ACPMPSpdDiffVal)) {
ME11_ARID_DEF.is_c94_ME11 = ME11_IN_Default_k;
ME11_ARID_DEF.ACTCtl_bAcPMPSpdFlt_a = false;
}
...
ACTCtl_bAcPMPSpdFlt = ((rtb_Switch2_f0 > 12) &&
ME11_ARID_DEF.ACTCtl_bAcPMPSpdFlt_a);
rtb_Compare_ar = (ACTCtl_bBatPMPSpdFlt || ACTCtl_bAcPMPSpdFlt);
rtb_OR_bx_0 = (ACTCtl_bAcPMPFaultFlg || ACTCtl_bBatPMPFaultFlg);
...
rtb_ACTCtl_bPTCDiagFlg = ((!rtb_Compare_ar) && (!rtb_OR_bx_0) &&
ACTCtl_bHVCHFaultFlg && ME11_ARID_DEF.ACTCtl_bAcPMPRunFFForPTC);
rtb_ACTCtl_bEXVDiagFlg = (ACTCtl_bAEXVFaultFlg || ACTCtl_bBEXVFaultFlg ||
ACTCtl_bHPEXVFaultFlg);
...
case ME11_IN_Default_k:
ACTCtl_bMotPMPSpdFlt = false;
if (rtb_Switch2_a0 > MotPMP_RealRPM + (float32)cal_MotPMPSpdDiffVal) {
...
if ((rtb_Switch2_a0 < MotPMP_RealRPM + (float32)cal_MotPMPSpdDiffVal) &&
(rtb_Switch2_a0 > MotPMP_RealRPM - (float32)cal_MotPMPSpdDiffVal)) {
ME11_ARID_DEF.is_c127_ME11 = ME11_IN_Default_k;
ACTCtl_bMotPMPSpdFlt = false;
}
break;
...
ACTCtl_bMotPMPSpdFlt = true;
} else if ((rtb_Switch2_a0 < MotPMP_RealRPM + (float32)
cal_MotPMPSpdDiffVal) && (rtb_Switch2_a0 > MotPMP_RealRPM -
...
ACSen_eMOTORTSenSts = 0U;
}

rtb_Compare_ecv_tmp_tmp = ACSen_eMOTORTSenSts;
ME11_Judge(rtb_Add > cal_SensorTempUpFlt, rtb_Add < cal_SensorTempDownFlg, 20,
ME11_ARID_DEF.Compare, &ME11_ARID_DEF.SenSts_a,
&ME11_ARID_DEF.ARID_DEF_Judge_g1);
rtb_Switch_irj = (ME11_ARID_DEF.DataTypeConversion1 >= 2);
if (rtb_Switch_irj) {
...
if (cal_EnvFailSwFlg) {
rtb_RelationalOperator_de = false;
} else {
rtb_RelationalOperator_de = (ACSen_eEnvSenSts != Normal);
}

SENCtl_uACCMHighTempVol = get_ACCMHighTempValtage();
rtb_Add_kz = (float32)((sint16)SENCtl_uACCMHighTempVol -
...
ME11_Judge(rtb_Add_kz > cal_SensorTempUpFlt, rtb_Add_kz <
cal_SensorTempDownFlg, 20, ME11_ARID_DEF.Compare,
&ME11_ARID_DEF.SenSts, &ME11_ARID_DEF.ARID_DEF_Judge);
if (rtb_Switch_irj) {
ACSen_eACCMHTSenSts = ME11_ARID_DEF.SenSts;
} else {
ACSen_eACCMHTSenSts = 0U;
}

rtb_Compare_gt_tmp_tmp = ACSen_eACCMHTSenSts;
SENCtl_uWCCHighTempVol = get_WCCHighTempValtage();
rtb_Add = (float32)((sint16)SENCtl_uWCCHighTempVol -
look1_iu16lu64n48ts16Ds32_binlcas(SENCtl_uWCCHighTempVol,
(const uint16 *)&cal_WCCHighTempVolAmend_1X[0], (const sint16 *)
&cal_WCCHighTempVolAmend_CUR[0], 1U));
ME11_Judge(rtb_Add > cal_SensorTempUpFlt, rtb_Add < cal_SensorTempDownFlg, 20,
ME11_ARID_DEF.Compare, &ME11_ARID_DEF.SenSts_fm,
&ME11_ARID_DEF.ARID_DEF_Judge_b);
if (rtb_Switch_irj) {
ACSen_eWCCHTSenSts = ME11_ARID_DEF.SenSts_fm;
} else {
ACSen_eWCCHTSenSts = 0U;
}

rtb_Compare_dz_tmp_tmp = ACSen_eWCCHTSenSts;
ME11_Judge(rtb_Add_ei > cal_SensorTempUpFlt, rtb_Add_ei <
cal_SensorTempDownFlg, 20, ME11_ARID_DEF.Compare,
&ME11_ARID_DEF.SenSts_l, &ME11_ARID_DEF.ARID_DEF_Judge_p);
if (rtb_Switch_irj) {
ACSen_eOHXTSenSts = ME11_ARID_DEF.SenSts_l;
} else {
ACSen_eOHXTSenSts = 0U;
}

rtb_Compare_oik_tmp_tmp = ACSen_eOHXTSenSts;
ME11_Judge(rtb_Add_dq > cal_SensorTempUpFlt, rtb_Add_dq <
cal_SensorTempDownFlg, 20, ME11_ARID_DEF.Compare,
&ME11_ARID_DEF.SenSts_n, &ME11_ARID_DEF.ARID_DEF_Judge_g);
if (PWRCtl_bKL15swtSt) {
ACSen_eEVAPTSenSts = ME11_ARID_DEF.SenSts_n;
} else {
ACSen_eEVAPTSenSts = 0U;
}

rtb_Compare_jvo_tmp_tmp = ACSen_eEVAPTSenSts;
SENCtl_uChillTempVol = get_ChillTempValtage();
rtb_Delay_ci = (float32)((sint16)SENCtl_uChillTempVol -
...
ACSen_eChillerTSenSts = 0U;
}

ME11_Judge(rtb_Add_isn > cal_SensorTempUpFlt, rtb_Add_isn <
cal_SensorTempDownFlg, 20, ME11_ARID_DEF.Compare,
&ME11_ARID_DEF.SenSts_f4, &ME11_ARID_DEF.ARID_DEF_Judge_f);
if (PWRCtl_bKL15swtSt) {
ACSen_eEVAPSurfTSenSts = ME11_ARID_DEF.SenSts_f4;
} else {
ACSen_eEVAPSurfTSenSts = 0U;
}

ME11_Judge(rtb_Gain8 > cal_SensorVolUpFlg, rtb_Gain8 < cal_SensorVolDownFlg,
20, ME11_ARID_DEF.Compare, &ME11_ARID_DEF.SenSts_f,
&ME11_ARID_DEF.ARID_DEF_Judge_c);
if (rtb_Switch_irj) {
rtb_Switch_ia = ME11_ARID_DEF.SenSts_f;
} else {
rtb_Switch_ia = 0U;
}

rtb_Compare_fi = (rtb_Switch_ia != 0);
ME11_Judge(rtb_LowPressLmt > cal_SensorVolUpFlg, rtb_LowPressLmt <
cal_SensorVolDownFlg, 20, ME11_ARID_DEF.Compare,
&ME11_ARID_DEF.SenSts_e, &ME11_ARID_DEF.ARID_DEF_Judge_pp);
if (rtb_Switch_irj) {
rtb_Switch_ig = ME11_ARID_DEF.SenSts_e;
} else {
rtb_Switch_ig = 0U;
}

rtb_Compare_ace = (rtb_Switch_ig != 0);
ME11_Judge(rtb_Switch4_a > cal_SensorVolUpFlg, rtb_Switch4_a <
cal_SensorVolDownFlg, 20, ME11_ARID_DEF.Compare,
&ME11_ARID_DEF.SenSts_fr, &ME11_ARID_DEF.ARID_DEF_Judge_n);
if (PWRCtl_bKL15swtSt) {
ACSen_eSOLARSenSts = ME11_ARID_DEF.SenSts_fr;
} else {
ACSen_eSOLARSenSts = 0U;
}

rtb_OR_i4 = (ME11_TMSADCSampleFunc_ARID_DEF.Compare ||
ME11_TMSADCSampleFunc_ARID_DEF.Compare_l ||
ME11_TMSADCSampleFunc_ARID_DEF.Compare_n ||
(rtb_Compare_ecv_tmp_tmp != Normal) || rtb_RelationalOperator_de ||
ACTCtl_bCabinFltFlg || rtb_OR_i4 || rtb_Compare_h1 ||
...
!= Normal) || rtb_Compare_fi || rtb_Compare_ace || (ACSen_eSOLARSenSts !=
Normal));
ME11_ARID_DEF.GLB_TMSFaultSort[0] = (rtb_ACTCtl_bCOMPDiagFlg ||
rtb_ACTCtl_bPTCDiagFlg || rtb_ACTCtl_bEXVDiagFlg || rtb_ACTCtl_bPMPDiagFlg ||
rtb_Switch_a5w || rtb_OR_i4);
ME11_ARID_DEF.GLB_TMSFaultSort[1] = rtb_ACTCtl_bCOMPDiagFlg;
ME11_ARID_DEF.GLB_TMSFaultSort[2] = rtb_ACTCtl_bPTCDiagFlg;
ME11_ARID_DEF.GLB_TMSFaultSort[3] = rtb_ACTCtl_bEXVDiagFlg;
ME11_ARID_DEF.GLB_TMSFaultSort[4] = rtb_ACTCtl_bPMPDiagFlg;
ME11_ARID_DEF.GLB_TMSFaultSort[5] = rtb_Switch_a5w;
ME11_ARID_DEF.GLB_TMSFaultSort[6] = false;
ME11_ARID_DEF.GLB_TMSFaultSort[7] = rtb_OR_i4;
ACDIA_bFltVal = ME11_ARID_DEF.GLB_TMSFaultSort[0];
...
rtb_Add_isn = ACCtl_tDrDVT - ACCtl_tLeftDuct;
rtb_Switch4_a = rtb_Add_isn;
ME11_deadzone_h(rtb_Add_isn, 0.5, &rtb_flag_de);
rtb_Switch_irj = (ACCtl_tDrDVT >= ACCtl_tLeftDuct);
if (rtb_flag_de) {
rtb_Switch4_a = 0.0F;
} else if (!rtb_Switch_irj) {
rtb_Switch4_a = ACCtl_tLeftDuct - ACCtl_tDrDVT;
}

ME11_P_NEG(!rtb_Switch_irj, rtb_Switch4_a, cal_DcutTPidDeadBand,
cal_DcutTempPid_KiNeg, cal_DcutTempPid_Ki, &rtb_Merge1);
ME11_P_POS(rtb_Switch_irj, rtb_Switch4_a, cal_DcutTPidDeadBand,
...
ME11_P_NEG(!rtb_Switch_irj, rtb_Merge, cal_DcutTPidDeadBand,
cal_DcutTempPid_KiNeg, cal_DcutTempPid_Ki, &rtb_Merge1_m);
ME11_P_POS(rtb_Switch_irj, rtb_Merge, cal_DcutTPidDeadBand,
...
&rtb_IFreezFlag_d);
ME11_P_NEG_p(!rtb_Switch_irj, rtb_Merge, cal_DcutTempPid_pWinNeg,
cal_DcutTempPid_KpNeg, cal_DcutTempPid_Kp, &rtb_Merge_g);
ME11_P_POS_l(rtb_Switch_irj, rtb_Merge, cal_DcutTempPid_pWinPos,
cal_DcutTempPid_KpPos, cal_DcutTempPid_Kp, &rtb_Merge_g);
ME11_PI_Controller(rtb_LogicalOperator5, rtb_Switch_irj, 0.0F, rtb_Merge_g,
...
&cal_EvapDesTempEnvCor_MAP[0], ME11_ConstP.pooled36, 6U);
...
if (ACSen_eAirInletPer < cal_ACRecirRatioLmt) {
rtb_ACFanLevel8EnvCor = EvapDesTempDrEnvCor;
} else {
rtb_ACFanLevel8EnvCor = EvapDesTempDrCabinCor;
}

ACCtl_tDrSetBasicEvap = (EvapDesTempDrFanCor + rtb_ACFanLevel8EnvCor) +
rtb_Add_o4;
...
if (cal_FixPIDSecletFlag) {
ACCtl_tErrDrDVT2Duct = rtb_Add_isn;
...
ME11_P_NEG_p(!rtb_Switch_irj, ACCtl_tErrDrDVT2Duct,
cal_DrEvaDesValPID_pWinNeg, cal_DrEvaDesValPIDKpNeg,
cal_DrEvaDesValPIDKp, (float32 *)&ACCtl_tDrEvapPCor);
ME11_P_POS_l(rtb_Switch_irj, ACCtl_tErrDrDVT2Duct,
cal_DrEvaDesValPID_pWinPos, cal_DrEvaDesValPIDKpPos,
cal_DrEvaDesValPIDKp, (float32 *)&ACCtl_tDrEvapPCor);
ME11_PI_Controller(rtb_LogicalOperator1_f, rtb_Switch_irj,
...
&cal_EvapDesTempPsEnvCor_MAP[0], ME11_ConstP.pooled36, 6U);
...
if (ACSen_eAirInletPer < cal_ACRecirRatioLmt) {
rtb_ACFanLevel8EnvCor = EvapDesTempPsEnvCor;
} else {
rtb_ACFanLevel8EnvCor = EvapDesTempPsCabinCor;
}

ACCtl_tPsSetBasicEvap = (EvapDesTempPsFanCor + rtb_ACFanLevel8EnvCor) +
rtb_Add_o4;
...
ME11_PI_Controller(rtb_LogicalOperator5, rtb_Switch_irj,
...
ACCAN_TBOX_BJS_Time_Hour =
(Rte_IRead_Task_100ms_IPM_TBOX_BJS_Time_BAC_IPM_TBOX_BJS_Time_BAC())
->VIPM_TBOXBJSTimeHour_nu;
ACCAN_TBOX_BJS_Time_Min =
(Rte_IRead_Task_100ms_IPM_TBOX_BJS_Time_BAC_IPM_TBOX_BJS_Time_BAC())
->VIPM_TBOXBJSTimeMin_nu;
ACCAN_TBOX_BJS_Time_Day =
(Rte_IRead_Task_100ms_IPM_TBOX_BJS_Time_BAC_IPM_TBOX_BJS_Time_BAC())
->VIPM_TBOXBJSTimeDay_nu;
if (ME11_ARID_DEF.Delay_DSTATE_kq == 0) {
ME11_ARID_DEF.EEWrite_TimeHour = ACCAN_TBOX_BJS_Time_Hour;
ME11_ARID_DEF.EEWrite_TimeMin = ACCAN_TBOX_BJS_Time_Min;
ME11_ARID_DEF.EEWrite_TimeDay = ACCAN_TBOX_BJS_Time_Day;
rtb_Switch_irj = ((ACCAN_TBOX_BJS_Time_Day >= 1) && (ACCAN_TBOX_BJS_Time_Day
<= 31));
if (rtb_Switch_irj) {
rtb_IFreezFlag_k = ACCAN_TBOX_BJS_Time_Day;
} else {
rtb_IFreezFlag_k = 1U;
}

rtb_Subtract9 = ((uint16)(rtb_IFreezFlag_k - 1) * 1440U +
ACCAN_TBOX_BJS_Time_Hour * 60U) + ACCAN_TBOX_BJS_Time_Min;
if ((ME11_ARID_DEF.EERead_TimeDay >= 1) && (ME11_ARID_DEF.EERead_TimeDay <=
31)) {
rtb_Switch1_ha = ME11_ARID_DEF.EERead_TimeDay;
} else {
rtb_Switch1_ha = rtb_IFreezFlag_k;
}

rtb_Subtract9_o = ((uint16)(rtb_Switch1_ha - 1) * 1440U +
ME11_ARID_DEF.EERead_TimeHour * 60U) +
ME11_ARID_DEF.EERead_TimeMin;
if (rtb_Switch_irj) {
if (rtb_IFreezFlag_k >= rtb_Switch1_ha) {
if (rtb_Subtract9 >= rtb_Subtract9_o) {
AC_tiAfterRun = (uint16)((sint32)rtb_Subtract9 - (sint32)
rtb_Subtract9_o);
} else {
AC_tiAfterRun = 1440U;
}
} else if (rtb_IFreezFlag_k == 1) {
AC_tiAfterRun = (uint16)((uint16)((uint16)rtb_Subtract9 + 44640U) -
(sint32)rtb_Subtract9_o);
} else {
AC_tiAfterRun = 1440U;
}

if (AC_tiAfterRun > 1440) {
AC_tiAfterRun = 1440U;
}
} else {
AC_tiAfterRun = 0U;
...
rtb_Switch_irj = (((ME11_ARID_DEF.Switch1_nv & 1U) != 0U) &&
...
rtb_ACTCtl_bEXVDiagFlg = !HMICtl_bACDefrost;
if ((rtb_DataTypeConversion4 < cal_CAPStartCoolantMin) &&
rtb_ACTCtl_bEXVDiagFlg && (rtb_DataTypeConversion1_kh > 8) &&
rtb_Switch_irj && (rtb_DataTypeConversion3 < 15)) {
ME11_ARID_DEF.is_ACStartModeMng = ME11_IN_Cold_Air_Protection;
ACCtl_stStartState = ME11_ColdStart;
ME11_ARID_DEF.time = 0U;
} else if (rtb_Switch_irj && rtb_ACTCtl_bEXVDiagFlg &&
...
rtb_Subtract9 = ME11_ARID_DEF.BlowerFanRunTime + 1U;
if (ME11_ARID_DEF.BlowerFanRunTime + 1U > 65535U) {
rtb_Subtract9 = 65535U;
}

ME11_ARID_DEF.BlowerFanRunTime = (uint16)rtb_Subtract9;
}
} else {
}

rtb_Subtract9 = ME11_ARID_DEF.IGN_ONTime + 1U;
if (ME11_ARID_DEF.IGN_ONTime + 1U > 65535U) {
rtb_Subtract9 = 65535U;
}

ME11_ARID_DEF.IGN_ONTime = (uint16)rtb_Subtract9;
}
...
rtb_Subtract9 = ME11_ARID_DEF.time + 1U;
if (ME11_ARID_DEF.time + 1U > 65535U) {
rtb_Subtract9 = 65535U;
}

ME11_ARID_DEF.time = (uint16)rtb_Subtract9;
}
break;
...
HMICtl_bACDefrost || (!rtb_Switch_irj)) {
ME11_ARID_DEF.is_ACStartModeMng = ME11_IN_Normal_Op;
ACCtl_stStartState = ME11_NormalStart;
}
break;
...
(!rtb_Switch_irj) || (ME11_ARID_DEF.time >= rtb_Gain_az)) {
ME11_ARID_DEF.is_ACStartModeMng = ME11_IN_Normal_Op;
ACCtl_stStartState = ME11_NormalStart;
} else {
rtb_Subtract9 = ME11_ARID_DEF.time + 1U;
...
default:
ACCtl_stStartState = ME11_NormalStart;
if (rtb_Switch_irj && (!HMICtl_bACDefrost) && (rtb_DataTypeConversion2 <
...
rtb_ACTCtl_bEXVDiagFlg = !HMICtl_bACDefrost;
if ((rtb_DataTypeConversion_f == ACEconMode_Economy) && rtb_ACTCtl_bEXVDiagFlg)
{
...
rtb_Switch_irj = ((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUACUnlckVentSet_enum !=
ME11_ARID_DEF.DelayInput1_DSTATE_ez);
rtb_Switch_a5w = ((Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUACUnlckVentSet_enum != 0);
rtb_Switch_irj = (rtb_Switch_irj && rtb_Switch_a5w);
if (rtb_Switch_irj) {
...
rtb_Switch_irj = ((Rte_IRead_Task_100ms_Bcm2VcuTms_outputs_Bcm2VcuTms_outputs())
->BCM_BodyWarnSts == 0);
rtb_LogicalOperator_j0 = (rtb_Switch_irj && (ME11_ARID_DEF.Delay1_DSTATE_d ==
1));
rtb_Switch_irj = (ME11_ARID_DEF.DataTypeConversion1 < 2);
rtb_Switch1_ha = (uint8)((((uint32)((AC_tiAfterRun >= 120) << 1) + (uint32)
(HMICtl_eUnlckVentSts == 2)) + (uint32)(rtb_LogicalOperator_j0 << 2)) +
(uint32)(rtb_Switch_irj << 3));
rtb_LogicalOperator_j0 =
((Rte_IRead_Task_100ms_Bcm2VcuTms_outputs_Bcm2VcuTms_outputs())
->BCM_DoorAjarSta_FL > ME11_ARID_DEF.DelayInput1_DSTATE_j5);
ME11_ARID_DEF.DelayInput1_DSTATE_j5 = ME11_ARID_DEF.DelayInput1_DSTATE_mu;
rtb_OR_i4 = ((Rte_IRead_Task_100ms_Bcm2VcuTms_outputs_Bcm2VcuTms_outputs())
->BCM_DoorAjarSta_FR > ME11_ARID_DEF.DelayInput1_DSTATE_j5);
...
(rtb_LogicalOperator_j0 || rtb_OR_i4) || (!rtb_Switch_irj)) {
...
AC_FanLevelAct = 0U;
AC_FanLeVel = rtb_Delay_ku;
}

ACCtl_stRecTempLowEna = HMICtl_bLeftSetLow;
if (ACCtl_stRecTempLowEna) {
ME11_ARID_DEF.DelayInput1_DSTATE_j5 = cal_ACCtlRecLevelForTempLow;
} else {
ME11_ARID_DEF.DelayInput1_DSTATE_j5 = 0U;
}
...
rtb_Subtract9 = ME11_ARID_DEF.ACCtl_tiAQSLo + 1U;
if (ME11_ARID_DEF.ACCtl_tiAQSLo + 1U > 65535U) {
rtb_Subtract9 = 65535U;
}

ME11_ARID_DEF.ACCtl_tiAQSLo = (uint16)rtb_Subtract9;
} else {
...
rtb_ACFanLevel8EnvCor = (float32)rtb_Gain_az * 0.5F - 200.0F;
if (rtb_ACFanLevel8EnvCor >= cal_PTCTempRecircOn) {
ACCtl_stRecPTCDvtEna = true;
} else {
ACCtl_stRecPTCDvtEna = ((rtb_ACFanLevel8EnvCor > cal_PTCTempRecircOff) &&
...
((Rte_IRead_Task_100ms_IPM_BMS_10_DC_ChargeStates_EPT_IPM_BMS_10_DC_ChargeStates_EPT
())->VIPM_BMSDCSActOprtMode_enum == 5);
ACCtl_stRecQkChargeCoolingEna = (rtb_Switch_a5w &&
...
rtb_Switch_jkj = cal_ACCtlRecLevelForForceChange;
} else {
rtb_Switch_jkj = 0U;
}

if (ACCtl_stRecAQSEna) {
rtb_Compare_l4e = cal_ACCtlRecLevelForAQS;
} else {
rtb_Compare_l4e = 0U;
}

if (ACCtl_stRecNormalDefogEna) {
rtb_Compare_ntr = cal_ACCtlRecLevelForNormalDefog;
} else {
rtb_Compare_ntr = 0U;
}

if (ACCtl_stRecTargetOutTempEna) {
rtb_Compare_pw = cal_ACCtlRecLevelForTargetOutTemp;
} else {
rtb_Compare_pw = 0U;
}

if (ACCtl_stRecVentEna) {
rtb_Add_d = cal_ACCtlRecLevelForVent;
} else {
rtb_Add_d = 0U;
}

if (ACCtl_stRecWinterCondEna) {
rtb_Add7_i = cal_ACCtlRecLevelForWinter;
} else {
rtb_Add7_i = 0U;
}

if (ACCtl_stRecSummerCondEna) {
rtb_Add2_j5 = cal_ACCtlRecLevelForSummer;
} else {
rtb_Add2_j5 = 0U;
}

if (ACCtl_stRecPTCDvtEna) {
rtb_Add3_do = cal_ACCtlRecLevelForPTCDvt;
} else {
rtb_Add3_do = 0U;
}

if (ACCtl_stRecACHotStartEna) {
rtb_Add6_d = cal_ACCtlRecLevelForACHotStart;
} else {
rtb_Add6_d = 0U;
}

if (ACCtl_stRecForceDefogEna) {
rtb_Add5_d = cal_ACCtlRecLevelForForceDefog;
} else {
rtb_Add5_d = 0U;
}

if (ACCtl_stRecManualEna) {
rtb_Add4_ox = cal_ACCtlRecLevelForManual;
} else {
rtb_Add4_ox = 0U;
}

if (ACCtl_stRecRemoteACEna) {
rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR = cal_ACCtlRecLevelForRemoteAC;
} else {
rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR = 0U;
}
...
if (ME11_ARID_DEF.DelayInput1_DSTATE_j5 >= rtb_Switch_jkj) {
rtb_Switch_jkj = ME11_ARID_DEF.DelayInput1_DSTATE_j5;
}

if (rtb_Switch_jkj >= rtb_Compare_l4e) {
rtb_Compare_l4e = rtb_Switch_jkj;
}

if (rtb_Compare_l4e >= rtb_Compare_ntr) {
rtb_Compare_ntr = rtb_Compare_l4e;
}

if (rtb_Compare_ntr >= rtb_Compare_pw) {
rtb_Compare_pw = rtb_Compare_ntr;
}

if (rtb_Compare_pw >= rtb_Add_d) {
rtb_Add_d = rtb_Compare_pw;
}

if (rtb_Add_d >= rtb_Add7_i) {
rtb_Add7_i = rtb_Add_d;
}
...
if (rtb_Add4_ox >= rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR) {
rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR = rtb_Add4_ox;
}

if (rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR >= rtb_IFreezFlag_k) {
rtb_IFreezFlag_k = rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR;
}
...
rtb_Switch_e2s = look1_iflftu8Df_binlca(ACSen_sEnvTempCor, (const float32 *)
...
[0], 1U);
if (rtb_IndexVector8_j <= rtb_Switch_e2s) {
rtb_Switch_e2s = rtb_IndexVector8_j;
}

if ((uint8)(100 - rtb_Switch_e2s) <= 100) {
ACCtl_IntakeRatio = (uint8)(100 - rtb_Switch_e2s);
} else {
...
if (ACCtl_stRecForceDefogEna) {
if ((sint32)HMICtl_bACDefrost > (sint32)ME11_ARID_DEF.DelayInput1_DSTATE_nej)
{
rtb_Switch_e2s = DriveFRESH;
} else if (rtb_IFreezFlag_k != 0) {
rtb_Switch_e2s = RECIRC;
} else {
rtb_Switch_e2s = DriveFRESH;
}
} else {
...
rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR = 13U;
} else {
rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR = 0U;
}
...
if (rtb_IndexVector8_j >= rtb_Switch_jkj) {
rtb_Switch_jkj = rtb_IndexVector8_j;
}
...
switch (rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR) {
case 1:
...
case 9:
ACCtl_stRecOut = (rtb_ACTCtl_bEXVDiagFlg && (rtb_IFreezFlag_k != 0));
if (HMICtl_bACDefrost) {
...
if (rtb_Switch_e2s <= rtb_Switch1_mn) {
rtb_Switch1_mn = rtb_Switch_e2s;
}

if (rtb_Switch1_mn <= rtb_Switch_jkj) {
rtb_Switch_jkj = rtb_Switch1_mn;
}

if (rtb_Switch_jkj <= ACCtl_IntakeRatio) {
ACCtl_IntakeRatio = rtb_Switch_jkj;
}
break;
...
[0], 1U);
rtb_Add_o4 = look1_iflf_binlca(ACSen_sEnvTempCor, (const float32 *)
&cal_ACFanLevel6EnvCor_1X[0], (const float32 *)&cal_ACFanLevel6EnvCor_CUR
[0], 1U);
rtb_Add_isn = look1_iflf_binlca(ACSen_sEnvTempCor, (const float32 *)
...
cal_ACRecirRatioLmt));
if (rtb_LogicalOperator_j0) {
rtb_LowPressLmt = look1_iflf_binlca
((Rte_IRead_Task_100ms_IPM_ESC_7_FuncStatus_CHA_IPM_ESC_7_FuncStatus_CHA
...
&cal_ACFanSpdSolarCor_MAP[0], ME11_ConstP.pooled32, 15U);
...
&cal_ACFanSpdSolarCorByEnv_MAP[0], ME11_ConstP.pooled32, 15U);
rtb_Gain8 = (float32)cal_FanLevelToPWM[8] + rtb_ACFanLevel8EnvCor;
if (rtb_Gain8 > 100.0F) {
rtb_IndexVector8_j = 100U;
} else if (rtb_Gain8 < 0.0F) {
rtb_IndexVector8_j = 0U;
} else {
rtb_IndexVector8_j = (uint8)rtb_Gain8;
}

ACCCtl_sBlowerFanSpd = ((((float32)(uint8)(look1_iflf_binlca
(ACCtl_tDVTFlt, (const float32 *)&cal_ACFanSpdDvtSet_1X[0], (const
float32 *)&cal_ACFanSpdDvtSet_CUR[0], 13U) - rtb_LowPressLmt) +
...
rtb_Add_d = (uint8)(((float32)cal_FanLevelToPWM[0] + rtb_Add_ax) +
100.0F);
rtb_IndexVector8_j = (uint8)(((float32)cal_FanLevelToPWM[1] +
rtb_Merge_g) + 100.0F);
...
100.0F);
rtb_Add6_d = (uint8)(((float32)cal_FanLevelToPWM[6] + rtb_Add_o4) +
100.0F);
rtb_Add7_i = (uint8)(((float32)cal_FanLevelToPWM[7] + rtb_Add_isn) +
100.0F);
if (rtb_Add_d > 200) {
rtb_Add_d = 100U;
} else if (rtb_Add_d < 100) {
rtb_Add_d = 0U;
} else {
rtb_Add_d = (uint8)(rtb_Add_d + -100);
}
...
case ME11_IN_Fan_0:
ME11_ARID_DEF.AC_FanLevel = 0U;
if ((uint8)ACCCtl_sBlowerFanSpd > (sint32)(rtb_Add_d + 10U)) {
...
case ME11_IN_Fan_01:
ME11_ARID_DEF.AC_FanLevel = 1U;
if ((uint8)ACCCtl_sBlowerFanSpd < (sint32)(rtb_Add_d + 5U)) {
ME11_ARID_DEF.is_AmbienceTempHighZero = ME11_IN_Fan_0;
ME11_ARID_DEF.AC_FanLevel = 0U;
...
rtb_DataTypeConversion_f4 = 100U;
} else if (rtb_IndexVector8_j < 100) {
rtb_DataTypeConversion_f4 = 0U;
} else {
rtb_DataTypeConversion_f4 = (uint8)(rtb_IndexVector8_j + -100);
}

if ((uint8)ACCCtl_sBlowerFanSpd < rtb_DataTypeConversion_f4) {
ME11_ARID_DEF.is_AmbienceTempHighZero = ME11_IN_Fan_01;
ME11_ARID_DEF.AC_FanLevel = 1U;
...
if ((uint8)(rtb_Gain8 + 100.0F) > 200) {
rtb_DataTypeConversion_f4 = 100U;
} else if ((uint8)(rtb_Gain8 + 100.0F) < 100) {
rtb_DataTypeConversion_f4 = 0U;
} else {
rtb_DataTypeConversion_f4 = (uint8)((uint8)(rtb_Gain8 + 100.0F)
+ -100);
}
...
ME11_ARID_DEF.AC_FanLevel = rtb_Delay_ku;
} else {
...
if (rtb_Delay_ku >= ME11_ARID_DEF.AC_FanLevel) {
ME11_ARID_DEF.AC_FanLevel = rtb_Delay_ku;
}
}
...
case 0:
rtb_Gain8 = rtb_Add_ax;
break;

case 1:
rtb_Gain8 = rtb_Merge_g;
break;

case 2:
rtb_Gain8 = rtb_Merge1_m;
break;
...
case 4:
rtb_Gain8 = rtb_Merge1;
break;

case 5:
rtb_Gain8 = rtb_Switch4_a;
break;

case 6:
rtb_Gain8 = rtb_Add_o4;
break;

case 7:
rtb_Gain8 = rtb_Add_isn;
break;

default:
rtb_Gain8 = rtb_ACFanLevel8EnvCor;
break;
}

rtb_IndexVector8_j = (uint8)(((float32)
cal_FanLevelToPWM[ME11_ARID_DEF.AC_FanLevel] + rtb_Gain8) + 100.0F);
if (rtb_IndexVector8_j > 200) {
...
switch (rtb_Delay_ku) {
case 0:
rtb_ACFanLevel8EnvCor = rtb_Add_ax;
break;

case 1:
rtb_ACFanLevel8EnvCor = rtb_Merge_g;
break;

case 2:
rtb_ACFanLevel8EnvCor = rtb_Merge1_m;
break;
...
case 5:
rtb_ACFanLevel8EnvCor = rtb_Switch4_a;
break;

case 6:
rtb_ACFanLevel8EnvCor = rtb_Add_o4;
break;

case 7:
rtb_ACFanLevel8EnvCor = rtb_Add_isn;
break;
}

rtb_IndexVector8_j = (uint8)(((float32)cal_FanLevelToPWM[rtb_Delay_ku] +
...
->VIPM_HVCHOutlTemp_C;
if (PWRCtl_bUnlockVentTimeFlg) {
rtb_DataTypeConversion_f4 = 4U;
} else {
rtb_DataTypeConversion_f4 = HMICtl_eModeMotor;
}

rtb_LogicalOperator_j0 = (ME11_ARID_DEF.Switch1_nv != ACOff);
ME11_ManualMode(!rtb_LogicalOperator_j0, rtb_DataTypeConversion_f4,
...
rtb_DataTypeConversion1_f = ACCtl_BlowerMode;
...
ME11_ARID_DEF.p = 1U;
ME11_ARID_DEF.n = 0U;
if (ME11_ARID_DEF.temporalCounter_i1_g >= 5U) {
ME11_ARID_DEF.is_Move = ME11_IN_Default_o;
ME11_ARID_DEF.p = 0U;
ME11_ARID_DEF.n = 0U;
ME11_ARID_DEF.MoveSts = false;
...
if (rtb_Switch_a5w && (ME11_ARID_DEF.Delay_DSTATE_lv == 1)) {
rtb_IndexVector8_j = look1_iflftu8Df_binlca(BMS_HVBatCellTempMax, (const
float32 *)&cal_ACFanMaxSpdCellTempLim_1X[0], (const uint8 *)
&cal_ACFanMaxSpdCellTempLim_CUR[0], 4U);
} else {
rtb_IndexVector8_j = 93U;
}

ME11_ARID_DEF.Relay_Mode_b = ((ACSen_sEnvTempCor >= cal_BlowerFanEnvLmtTmpOff)
|| ((ACSen_sEnvTempCor > cal_BlowerFanEnvLmtTmpOn) &&
ME11_ARID_DEF.Relay_Mode_b));
if (ME11_ARID_DEF.Switch1_nv == ACAuto) {
if (ME11_ARID_DEF.Relay_Mode_b) {
AC_BlowerFanSpeedMax = cal_BlowerFanMaxNormal;
} else {
AC_BlowerFanSpeedMax = cal_BlowerFanMaxLowTmp;
}
} else {
...
if (rtb_LogicalOperator_j0) {
rtb_Switch_jkj = cal_FANSpdModeShiftMax;
} else {
rtb_Switch_jkj = 93U;
}

if (ACCtl_stStartState == AC_HotStart) {
rtb_Compare_l4e = cal_FANSpdHotStartUL;
} else {
rtb_Compare_l4e = 93U;
}

if (rtb_DataTypeConversion_f == ACEconMode_FanOnly) {
rtb_Compare_ntr = cal_BlowerFanSpdVentUL;
} else {
rtb_Compare_ntr = 93U;
}

if (rtb_Delay_ku <= rtb_Switch_jkj) {
rtb_Switch_jkj = rtb_Delay_ku;
}
...
if (rtb_Compare_ntr <= rtb_IndexVector8_j) {
rtb_IndexVector8_j = rtb_Compare_ntr;
}

if (rtb_IndexVector8_j <= AC_BlowerFanSpeedMax) {
AC_BlowerFanSpeedMax = rtb_IndexVector8_j;
}
...
rtb_Delay_ku = (uint8)(rtb_Switch2_ek == 14);
if (ME11_ARID_DEF.Switch1_nv != ACOff) {
if (rtb_Compare_ace || rtb_Compare_fi) {
rtb_Add_ax = 0.0F;
} else {
...
rtb_ACFanLevel8EnvCor = (float32)floor((rtb_Add_ax - ACCtl_tDrDVT) * 2.0F);
if (rtb_ACFanLevel8EnvCor < 32768.0F) {
if (rtb_ACFanLevel8EnvCor >= -32768.0F) {
rtb_DataTypeConversion_dt = (sint16)rtb_ACFanLevel8EnvCor;
} else {
...
rtb_ACFanLevel8EnvCor = (float32)floor(rtb_Merge_g + 0.5F);
} else {
rtb_ACFanLevel8EnvCor = 0.0F;
}

if ((float32)fabs(rtb_Add_ax) >= 0.5F) {
rtb_Add_o4 = (float32)floor(rtb_Add_ax + 0.5F);
} else {
rtb_Add_o4 = 0.0F;
}
...
= ((rtb_DataTypeConversion_dt >= (sint16)rtb_ACFanLevel8EnvCor) ||
((rtb_DataTypeConversion_dt > (sint16)rtb_Add_o4) &&
ME11_ARID_DEF.Oncal_DrErrOfEvaDVT2CoolMixOnOffcal_DrErrOfEvaDVT2CoolMixOff_Mode));
rtb_ACFanLevel8EnvCor = (float32)floor((ACCtl_tDrDVT -
(Rte_IRead_Task_100ms_IPM_HVCH_Status1_BOD_IPM_HVCH_Status1_BOD())
...
rtb_Subtract9 = (uint32)(ACCtl_DrfacPtc2NominalTemp * rtb_Add_ax * 256.0F);
if (rtb_Subtract9 > 25600U) {
ACCtl_rDrBasicMixDoor = 100U;
} else {
ACCtl_rDrBasicMixDoor = (uint8)(rtb_Subtract9 >> 8);
}
}
...
rtb_ACFanLevel8EnvCor = cal_DrMixDesValPID_pWinNeg;
}

ME11_P_NEG_p(!rtb_LogicalOperator_j0, rtb_Merge_g, rtb_ACFanLevel8EnvCor,
ACTCtl_sCOMPActure, rtb_Merge1_m, (float32 *)
&ACCtl_rDrSetMixDoorPCor);
if (rtb_OR_i4) {
rtb_ACFanLevel8EnvCor = 0.0F;
} else {
rtb_ACFanLevel8EnvCor = cal_DrMixDesValPID_pWinPos;
}

ME11_P_POS_l(rtb_LogicalOperator_j0, rtb_Merge_g, rtb_ACFanLevel8EnvCor,
...
rtb_ACFanLevel8EnvCor = (float32)floor((rtb_PI_Cor_d - ACCtl_tPsDVT) * 2.0F);
if (rtb_ACFanLevel8EnvCor < 32768.0F) {
if (rtb_ACFanLevel8EnvCor >= -32768.0F) {
rtb_DataTypeConversion_dt = (sint16)rtb_ACFanLevel8EnvCor;
} else {
...
((rtb_DataTypeConversion_dt > (sint16)rtb_Add_o4) &&
ME11_ARID_DEF.Oncal_PsErrOfEvaDVT2CoolMixOnOffcal_PsErrOfEvaDVT2CoolMixOff_Mode));
rtb_ACFanLevel8EnvCor = (float32)floor((ACCtl_tPsDVT -
(Rte_IRead_Task_100ms_IPM_HVCH_Status1_BOD_IPM_HVCH_Status1_BOD())
->VIPM_HVCHOutlTemp_C) * 2.0F);
if (rtb_ACFanLevel8EnvCor < 32768.0F) {
if (rtb_ACFanLevel8EnvCor >= -32768.0F) {
...
rtb_Subtract9 = (uint32)(ACCtl_PsfacPtc2NominalTemp *
ACCtl_rPsBlowerModeSet * 256.0F);
if (rtb_Subtract9 > 25600U) {
ACCtl_rPsBasicMixDoor = 100U;
} else {
ACCtl_rPsBasicMixDoor = (uint8)((uint32)((rtb_Subtract9 & 128U) != 0U) +
(rtb_Subtract9 >> 8));
}
}
...
rtb_Compare_h1 = (HMICtl_sLeftSetPoint < 16.5F);
rtb_LogicalOperator1_f = (HMICtl_sLeftSetPoint > 31.5F);
rtb_LogicalOperator5 = (AC_FanLevelAct == 5);
rtb_ACTCtl_bEXVDiagFlg = (rtb_DataTypeConversion_f == ACEconMode_FanOnly);
if (ME11_ARID_DEF.is_active_c57_ME11 == 0U) {
ME11_ARID_DEF.is_active_c57_ME11 = 1U;
if (rtb_OR_i4 && rtb_LogicalOperator1_f && rtb_Compare_h1 &&
rtb_LogicalOperator5 && rtb_ACTCtl_bEXVDiagFlg && ACCtl_stRecOut) {
...
AC_stExhaust = true;
} else if ((!rtb_OR_i4) || (!rtb_LogicalOperator1_f) || (!rtb_Compare_h1) ||
(!rtb_LogicalOperator5) || (!rtb_ACTCtl_bEXVDiagFlg) ||
(!ACCtl_stRecOut)) {
ME11_ARID_DEF.is_Exhaust_Check = ME11_IN_NO_ACTIVE_CHILD_gl;
ME11_ARID_DEF.is_c57_ME11 = ME11_IN_Exhaust_OFF;
AC_stExhaust = false;
...
ME11_ARID_DEF.GLB_TMSFaultCOMP[1] = rtb_Compare_fd;
ME11_ARID_DEF.GLB_TMSFaultCOMP[2] = ME11_ARID_DEF.Sts_b;
ME11_ARID_DEF.GLB_TMSFaultCOMP[3] = rtb_Compare_m4;
ME11_ARID_DEF.GLB_TMSFaultCOMP[4] = ME11_ARID_DEF.Sts_a;
ME11_ARID_DEF.GLB_TMSFaultCOMP[5] = ME11_ARID_DEF.Sts_e;
ME11_ARID_DEF.GLB_TMSFaultCOMP[6] = rtb_Compare_lt0;
ME11_ARID_DEF.GLB_TMSFaultCOMP[7] = rtb_Compare_ani;
ME11_ARID_DEF.GLB_TMSFaultCOMP[8] = rtb_Compare_of3;
ME11_ARID_DEF.GLB_TMSFaultCOMP[9] = ME11_ARID_DEF.Sts_d3;
ME11_ARID_DEF.GLB_TMSFaultCOMP[10] = ME11_ARID_DEF.Sts_d;
ME11_ARID_DEF.GLB_TMSFaultCOMP[11] = rtb_Compare_eux;
rtb_PI_Cor_a = cal_ADCVCCVal - rtb_Add_kz;
if (rtb_PI_Cor_a > 0.0F) {
rtb_Add_o4 = rtb_Add_kz / rtb_PI_Cor_a;
} else {
rtb_Add_o4 = 1.0F;
}

SEN_ACCMTHiRaw = look1_iflf_binlca(rtb_Add_o4 * 3000.0F, (const float32 *)
...
rtb_Compare_fd = ((rtb_Switch2_ht == 1) || (rtb_Switch2_ht == 2) ||
(rtb_Switch2_ht == 3));
...
rtb_Compare_eux = (COMP_EcompActSpd > 800.0F);
...
ME11_ARID_DEF.GLB_TMSFaultCOMP[15] = rtb_Compare_n2_0;
...
rtb_Compare_fd = ((rtb_DataTypeConversion1_on >= 1) &&
...
(rtb_Switch2_ht == 6))) {
rtb_Switch_a5w = false;
} else if (cal_BatHeatACCMEnb) {
rtb_Switch_a5w = ((rtb_Switch2_ht == 10) ||
((((ME11_ARID_DEF.DataTypeConversion1 == 2) ||
(ME11_ARID_DEF.DataTypeConversion1 == 5)) &&
(rtb_DataTypeConversion1_l == 6)) ||
(rtb_DataTypeConversion1_l == 1)) ||
(ME11_ARID_DEF.ACTCtl_eACCMCtlEnb_a && rtb_Compare_fd));
} else {
rtb_Switch_a5w = ((rtb_Switch2_ht == 10) || (rtb_DataTypeConversion1_l == 1)
|| (ME11_ARID_DEF.ACTCtl_eACCMCtlEnb_a && rtb_Compare_fd));
}
...
if (SOMCtl_bExtDefFlg) {
rtb_Add_o4 = (PWRCtl_VCUACCMLimitPwr -
(Rte_IRead_Task_100ms_IPM_HVCH_Status2_BOD_IPM_HVCH_Status2_BOD
())->VIPM_HVCHPwr_kW) - cal_PwrOffsetVal;
} else {
rtb_Add_o4 = PWRCtl_VCUACCMLimitPwr - cal_PwrOffsetVal;
}

if (rtb_Add_o4 <= cal_COMPPwrMaxLmt) {
PWRCtl_sLmtPwrCOMP = rtb_Add_o4;
} else {
...
(!ME11_ARID_DEF.ACTCtl_bCOMPForbidFlg_p << 1)) + rtb_Switch_a5w) + (uint32)(
!ACTCtl_bCOMPStopFlg << 4)) + (uint32)((((!rtb_Compare_hc2[0]) &&
(!rtb_Compare_hc2[1]) && (!rtb_Compare_hc2[2]) && (!rtb_Compare_hc2[3]) && (
!rtb_Compare_hc2[4])) || ME11_ARID_DEF.ACTCtl_bAcPMPRunFFForPTC) << 5)) +
...
rtb_Compare_fd = (ACTCtl_eCOMPJudgeFlg == 255);
...
&ME11_ARID_DEF.Init_la, &ME11_ARID_DEF.ARID_DEF_Descending_filter_o);
...
&ME11_ARID_DEF.Init_l, &ME11_ARID_DEF.ARID_DEF_Descending_filter_jz);
...
rtb_Add_kz, (float32 *)&ACTCtl_sACCMPIVal, (uint8 *)
&ACTCtl_bCOMPIFreeFlag);
rtb_Switch_a5w = (ME11_ARID_DEF.DataTypeConversion1 < 2);
if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_IFreezFlag_bd = 0U;
} else {
rtb_IFreezFlag_bd = (uint8)(COMP_HvError != 0);
}

if (rtb_IFreezFlag_bd != ME11_ARID_DEF.DelayInput1_DSTATE_p) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943717), rtb_IFreezFlag_bd);
}

if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_IFreezFlag_jz = 0U;
} else {
rtb_IFreezFlag_jz = (uint8)(COMP_LvError != 0);
}

if (rtb_IFreezFlag_jz != ME11_ARID_DEF.DelayInput1_DSTATE_n) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943716), rtb_IFreezFlag_jz);
}

if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_IndexVector8_j = 0U;
} else {
rtb_IndexVector8_j = COMP_TempError;
}

if (rtb_IndexVector8_j != ME11_ARID_DEF.DelayInput1_DSTATE_e3) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x94374B), rtb_IndexVector8_j);
}

if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_Add_d = 0U;
} else {
rtb_Add_d = COMP_LoseStep;
}

if (rtb_Add_d != ME11_ARID_DEF.DelayInput1_DSTATE_ju5) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943705), rtb_Add_d);
}

if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_Add7_i = 0U;
} else {
rtb_Add7_i = COMP_Commu_Error;
}

if (rtb_Add7_i != ME11_ARID_DEF.DelayInput1_DSTATE_m3) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943786), rtb_Add7_i);
}

if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_Add2_j5 = 0U;
} else {
rtb_Add2_j5 = COMP_OverDuty;
}

if (rtb_Add2_j5 != ME11_ARID_DEF.DelayInput1_DSTATE_mq) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943779), rtb_Add2_j5);
}

if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_Add3_do = 0U;
} else {
rtb_Add3_do = COMP_PI_Saturation;
}

if (rtb_Add3_do != ME11_ARID_DEF.DelayInput1_DSTATE_k) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943782), rtb_Add3_do);
}

if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_Add6_d = 0U;
} else {
rtb_Add6_d = (uint8)((COMP_SelfCheckError == 1) || (COMP_SelfCheckError == 2));
}

if (rtb_Add6_d != ME11_ARID_DEF.DelayInput1_DSTATE_h0) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943704), rtb_Add6_d);
}

if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_Add5_d = 0U;
} else {
rtb_Add5_d = COMP_IPM_Error;
}

if (rtb_Add5_d != ME11_ARID_DEF.DelayInput1_DSTATE_l) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943979), rtb_Add5_d);
}

if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_Add4_ox = 0U;
} else {
rtb_Add4_ox = (uint8)(COMP_OverCurrent == 1);
}

if (rtb_Add4_ox != ME11_ARID_DEF.DelayInput1_DSTATE_po) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943719), rtb_Add4_ox);
}
...
&cal_COMPATNoiseSpdLmt_MAP[0], ME11_ConstP.pooled33, 10U);
if ((rtb_Switch2_ht == 3) && ((ME11_ARID_DEF.DataTypeConversion1 == 3) ||
(ME11_ARID_DEF.DataTypeConversion1 == 4) || rtb_Switch_a5w)) {
ACTCtl_sCOMPCoolLmtSpd = ACTCtl_sCOMPATNoiseLmtHVSSpd;
} else {
rtb_Compare_fd =
((Rte_IRead_Task_100ms_IPM_ESC_7_FuncStatus_CHA_IPM_ESC_7_FuncStatus_CHA())
->VIPM_ESCVehSpd_kph > cal_COMPCoolLowSpd);
if (rtb_Compare_fd && (rtb_Switch2_ht == 1)) {
...
(rtb_Compare_fd && (rtb_Switch2_ht == 1))) {
...
rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR = look1_iflftu8Df_binlca
(ACSen_sHiPressFilter, (const float32 *)
&cal_AccmSpdLimByHiPressLevelCalcu_1X[0], (const uint8 *)
...
cal_AccmSpdLimByHiPressDownSide_CUR[plook_u32u8_binckan
(rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR, (const uint8 *)
&cal_AccmSpdLimByHiPressDownSide_1X[0], 11U)];
...
(rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR, (const uint8 *)
&cal_AccmSpdLimByHiPressUpSide_1X[0], 11U)];
}

rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR = look1_iflftu8Df_binlca
(ACSen_sLoPressFilter, (const float32 *)
&cal_AccmSpdLimByLoPressLevelCalcu_1X[0], (const uint8 *)
...
cal_AccmSpdLimByLoPressDownSide_CUR[plook_u32u8_binckan
(rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR, (const uint8 *)
&cal_AccmSpdLimByLoPressDownSide_1X[0], 11U)];
...
(rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR, (const uint8 *)
&cal_AccmSpdLimByLoPressUpSide_1X[0], 11U)];
}
...
6)) {
if (ACTCtl_sPTCEnable == 3) {
ACTCtl_sCOMPEnvLmtSpd = look1_iflf_binlca(ACSen_sEnvTempCor, (const
float32 *)&cal_COMPEnvSpdLmt4_1X[0], (const float32 *)
&cal_COMPEnvSpdLmt4_CUR[0], 1U);
} else {
ACTCtl_sCOMPEnvLmtSpd = look1_iflf_binlca(ACSen_sEnvTempCor, (const
float32 *)&cal_COMPEnvSpdLmt4_1X[0], (const float32 *)
&cal_COMPEnvSpdLmt4_CUR[0], 1U);
if (ACTCtl_sCOMPEnvLmtSpd > cal_COMPNoPTCLmtSpd) {
ACTCtl_sCOMPEnvLmtSpd = cal_COMPNoPTCLmtSpd;
}
}
} else {
...
rtb_Compare_fd = ((COMP_EcompActSpd <= cal_OilBackStartSpd) &&
...
(cal_OilBackJudgeTime * 60.0 * 10.0)) {
...
ME11_PwrOn(&rtb_flg_m, &ME11_ARID_DEF.ARID_DEF_PwrOn_i);
if (rtb_flg_m) {
...
ME11_PwrOn(&rtb_flg_n, &ME11_ARID_DEF.ARID_DEF_PwrOn_n);
if (rtb_flg_n) {
...
rtb_Compare_fd = ((rtb_PI_Cor_a > cal_COMPClsLowSpeed) && (COMP_EcompActSpd ==
0.0F));
if (ACTCtl_eCOMPPrsPrtSts == 8) {
if (ME11_ARID_DEF.ACTCtl_sCOMPDownSpd_g >=
ME11_ARID_DEF.ACTCtl_sCOMPDownSpd_m) {
rtb_Add_o4 = ME11_ARID_DEF.ACTCtl_sCOMPDownSpd_g;
} else {
rtb_Add_o4 = ME11_ARID_DEF.ACTCtl_sCOMPDownSpd_m;
}
...
if (rtb_Add_o4 >= ACTCtl_sCOMPDownSpd) {
ACTCtl_sCOMPDownSpd = rtb_Add_o4;
}
...
ME11_ARID_DEF.is_c52_ME11 = ME11_IN_wait_o;
...
for (b_previousEvent = 0; b_previousEvent < 6; b_previousEvent++) {
rtb_Compare_ac[b_previousEvent] = (rtb_Switch2_ht ==
ME11_ConstP.Constant_Value_ig[b_previousEvent]);
}

rtb_ACTCtl_bEXVDiagFlg = rtb_Compare_ac[0];
for (b_previousEvent = 0; b_previousEvent < 5; b_previousEvent++) {
rtb_ACTCtl_bEXVDiagFlg = (rtb_ACTCtl_bEXVDiagFlg ||
rtb_Compare_ac[b_previousEvent + 1]);
}

rtb_Compare_fd = (ME11_ARID_DEF.Delay_DSTATE_kf && rtb_ACTCtl_bEXVDiagFlg);
if (rtb_Compare_fd) {
rtb_Switch4_b = ACTCtl_eEvapProSts;
} else {
rtb_Switch4_b = 0U;
}

ACTCtl_bCOMPStopFlg = ((ACTCtl_eCOMPExhTPrtSts == 2) || (ACTCtl_eCOMPPrsPrtSts
== 16) || (rtb_Switch4_b >= 2) || ACTCtl_bCOMPSpdDiffFlt);
...
&cal_PTCAuxHeatPwrLmt_MAP[0], ME11_ConstP.pooled36, 6U);
...
&cal_CtrlFPTCAuxHeatPwrLmt_MAP[0], ME11_ConstP.pooled36, 6U);
...
ACTCtl_bCOMPEnvpTPrtFlg = ((!ME11_ARID_DEF.Relay2_Mode_o) && (rtb_Compare_hc2
[0] || rtb_Compare_hc2[1] || rtb_Compare_hc2[2] || rtb_Compare_hc2[3] ||
rtb_Compare_hc2[4]));
ME11_ARID_DEF.GLB_TMSFaultECV[0] = rtb_Compare_nbr;
ME11_ARID_DEF.GLB_TMSFaultECV[1] = rtb_RelationalOperator_j5;
ME11_ARID_DEF.GLB_TMSFaultECV[2] = rtb_Compare_pew;
ME11_ARID_DEF.GLB_TMSFaultECV[3] = rtb_Compare_obw;
ME11_ARID_DEF.GLB_TMSFaultECV[4] = rtb_Compare_hke;
ME11_ARID_DEF.GLB_TMSFaultECV[5] = rtb_Compare_msu;
ME11_ARID_DEF.GLB_TMSFaultECV[6] = rtb_Compare_e5j;
ME11_ARID_DEF.GLB_TMSFaultECV[7] = rtb_Compare_ne;
if ((ME11_ARID_DEF.DataTypeConversion1 <= 1) || ME11_ARID_DEF.Compare) {
rtb_Switch_fmz = 0U;
} else {
rtb_Switch_fmz = BCV_VoltSts;
}

rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR = (uint8)(rtb_Switch_fmz == 1);
if (rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR !=
ME11_ARID_DEF.DelayInput1_DSTATE_jj) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943C17),
rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR);
}

rtb_Switch1_mn = (uint8)(rtb_Switch_fmz == 2);
if (rtb_Switch1_mn != ME11_ARID_DEF.DelayInput1_DSTATE_b) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943C16), rtb_Switch1_mn);
}

if ((ME11_ARID_DEF.DataTypeConversion1 <= 1) || ME11_ARID_DEF.Compare) {
rtb_Switch_fmz = 0U;
} else {
rtb_Switch_fmz = MCV_FltSts;
}

rtb_Switch_e2s = (uint8)(rtb_Switch_fmz == 2);
if (rtb_Switch_e2s != ME11_ARID_DEF.DelayInput1_DSTATE_mqg) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943846), rtb_Switch_e2s);
}

rtb_Compare_bx = (uint8)(rtb_Switch_fmz == 3);
if (rtb_Compare_bx != ME11_ARID_DEF.DelayInput1_DSTATE_ee) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943811), rtb_Compare_bx);
}

rtb_Compare_bmr = (uint8)(rtb_Switch_fmz == 4);
if (rtb_Compare_bmr != ME11_ARID_DEF.DelayInput1_DSTATE_hq) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943815), rtb_Compare_bmr);
}

rtb_Compare_bi3 = (uint8)(rtb_Switch_fmz == 5);
if (rtb_Compare_bi3 != ME11_ARID_DEF.DelayInput1_DSTATE_ei) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x94384B), rtb_Compare_bi3);
}

if ((ME11_ARID_DEF.DataTypeConversion1 <= 1) || ME11_ARID_DEF.Compare) {
rtb_Add_a = 0U;
} else {
rtb_Add_a = BCV_FltSts;
}

rtb_Compare_j = (uint8)(rtb_Add_a == 1);
if (rtb_Compare_j != ME11_ARID_DEF.DelayInput1_DSTATE_jo) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943C71), rtb_Compare_j);
}

rtb_Compare_e5v = (uint8)(rtb_Add_a == 2);
if (rtb_Compare_e5v != ME11_ARID_DEF.DelayInput1_DSTATE_o2) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943C46), rtb_Compare_e5v);
}

rtb_Compare_p = (uint8)(rtb_Add_a == 3);
if (rtb_Compare_p != ME11_ARID_DEF.DelayInput1_DSTATE_p4) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943C11), rtb_Compare_p);
}

rtb_Compare_k = (uint8)(rtb_Add_a == 4);
if (rtb_Compare_k != ME11_ARID_DEF.DelayInput1_DSTATE_nc) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943C15), rtb_Compare_k);
}

rtb_Compare_mxx = (uint8)(rtb_Add_a == 5);
if (rtb_Compare_mxx != ME11_ARID_DEF.DelayInput1_DSTATE_pg) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943C4B), rtb_Compare_mxx);
}

if ((ME11_ARID_DEF.DataTypeConversion1 <= 1) || ME11_ARID_DEF.Compare) {
rtb_Add_a = 0U;
} else {
rtb_Add_a = MCV_VoltSts;
}

rtb_Compare_bc = (uint8)(rtb_Add_a == 1);
if (rtb_Compare_bc != ME11_ARID_DEF.DelayInput1_DSTATE_oa) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943817), rtb_Compare_bc);
}

rtb_Compare_huq = (uint8)(rtb_Add_a == 2);
if (rtb_Compare_huq != ME11_ARID_DEF.DelayInput1_DSTATE_d3) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943816), rtb_Compare_huq);
}

rtb_Compare_jo = (uint8)(rtb_Switch_fmz == 1);
if (rtb_Compare_jo != ME11_ARID_DEF.DelayInput1_DSTATE_mqq) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943871), rtb_Compare_jo);
}

ME11_Chart((MCV_FltSts == 1) || (MCV_FltSts == 2), (uint16)
(cal_MCVFltStsDelayTime * 10U), &ME11_ARID_DEF.Flag_a,
&ME11_ARID_DEF.ARID_DEF_Chart_j);
rtb_Compare_eux = ((ACTCtl_eC3WVSLSts <= 0) && rtb_RelationalOperator_pq);
...
&ME11_ARID_DEF.ARID_DEF_Chart_a);
rtb_Compare_eux = ((ACTCtl_eC5WVSLSts <= 0) && rtb_RelationalOperator_lt);
...
ACTCtl_eC3WVValue = rtb_Switch7_g;
}

if (cal_eC5WVValueEnb) {
ACTCtl_eC5WVValue = cal_eC5WVValueData;
} else {
ACTCtl_eC5WVValue = rtb_Switch3_cn;
}

ME11_ARID_DEF.GLB_TMSFaultEXV[0] = rtb_FixPtRelationalOperator_in;
ME11_ARID_DEF.GLB_TMSFaultEXV[1] = rtb_Compare_edj;
ME11_ARID_DEF.GLB_TMSFaultEXV[2] = rtb_Compare_go0;
ME11_ARID_DEF.GLB_TMSFaultEXV[3] = rtb_Compare_ox;
ME11_ARID_DEF.GLB_TMSFaultEXV[4] = rtb_Compare_h5;
ME11_ARID_DEF.GLB_TMSFaultEXV[5] = rtb_Compare_c02;
ME11_ARID_DEF.GLB_TMSFaultEXV[6] = rtb_Compare_jwo;
ME11_ARID_DEF.GLB_TMSFaultEXV[7] = rtb_Compare_plm;
ME11_ARID_DEF.GLB_TMSFaultEXV[8] = rtb_Compare_cne;
ME11_ARID_DEF.GLB_TMSFaultEXV[9] = rtb_Compare_gr;
ME11_ARID_DEF.GLB_TMSFaultEXV[10] = rtb_Compare_k4;
ME11_ARID_DEF.GLB_TMSFaultEXV[11] = rtb_Compare_end;
EXV_CurrentInitState =
Rte_IRead_Task_100ms_EXV_CurrentInitState_EXV_CurrentInitState();
if (((ME11_ARID_DEF.Delay1_DSTATE_hw < 2) &&
(ME11_ARID_DEF.DataTypeConversion1 >= 2)) || (EXV_CurrentInitState == 0))
{
...
rtb_Add_o4 = look1_iflf_binlca(ACSen_sHiPressFilter, (const float32 *)
&cal_CondDep_1X[0], (const float32 *)&cal_CondDep_CUR[0], 27U);
ACTCtl_sCoolCondDep = rtb_Add_o4 - ACSen_sOHXTempFilter;
...
rtb_Add_kz = cal_AEXVCtrlDefaultPos;
...
rtb_Compare_eux = (ACTCtl_sAEXVSetPoint >= ACTCtl_sAEXVActure);
if (rtb_flag_c) {
...
ACTCtl_bAEXVDvtFlg = !rtb_Compare_eux;
...
ACTCtl_sAEXVP_Cor, ACTCtl_sAEXVI_Sum, rtb_Add_kz,
...
ME11_PwrOn(&rtb_flg_f, &ME11_ARID_DEF.ARID_DEF_PwrOn_bj);
if (((ACSen_sLoPressFilter <= cal_AEXVLowPressLmtOn) || (ACSen_sHiPressFilter >=
cal_AEXVHighPressLmtOn)) && rtb_Compare_fd && (rtb_Merge_g >=
rtb_PI_Cor_d)) {
...
ME11_PwrOn(&rtb_flg_dg, &ME11_ARID_DEF.ARID_DEF_PwrOn_e);
if (rtb_flg_dg) {
...
rtb_PI_Cor_d = cal_ADCVCCVal - rtb_Delay_ci;
if (rtb_PI_Cor_d > 0.0F) {
rtb_Gain8 = rtb_Delay_ci / rtb_PI_Cor_d;
} else {
rtb_Gain8 = 1.0F;
}

SEN_ChiTRaw = look1_iflf_binlca(rtb_Gain8 * 20000.0F, (const float32 *)
...
&ME11_ARID_DEF.ARID_DEF_Descending_filter_bn);
switch (rtb_Switch2_ht) {
case 1:
case 4:
case 5:
...
case 3:
case 14:
rtb_Delay_ci = ME11_ARID_DEF.Init_b1 - ACTCtl_sBEXVActure;
if (rtb_Switch2_ht == 3) {
rtb_Merge1 = look1_iflf_binlca(COMP_EcompActSpd, (const float32 *)
...
ACTCtl_sBEXVCtrlKp = look1_iflf_binlca(rtb_Delay_ci, (const float32 *)
&cal_BEXVCtrlBKp_1X[0], (const float32 *)&cal_BEXVCtrlBKp_CUR[0], 6U);
ACTCtl_sBEXVCtrlKi = look1_iflf_binlca(rtb_Delay_ci, (const float32 *)
&cal_BEXVCtrlBKi_1X[0], (const float32 *)&cal_BEXVCtrlBKi_CUR[0], 6U);
rtb_Add_kz = cal_BEXVCtrlBPIUp;
b_previousEvent = 1;
break;

case 2:
case 13:
rtb_Delay_ci = ME11_ARID_DEF.Init_e - rtb_Switch4_a;
if (rtb_Switch2_ht == 2) {
rtb_Merge1 = look1_iflf_binlca(COMP_EcompActSpd, (const float32 *)
...
>= 2)) || (BAT_EXV_CurrentInitState_B == 0)) {
...
rtb_Compare_fd = (ACTCtl_sBEXVSetPoint >= ACTCtl_sBEXVActure);
if (rtb_flag_l) {
...
ACTCtl_bBEXVDvtFlg = !rtb_Compare_fd;
...
ACTCtl_sBEXVP_Cor, ACTCtl_sBEXVI_Sum, rtb_Add_kz,
...
rtb_Compare_fd = (ME11_ARID_DEF.Delay_DSTATE_kf && ((rtb_Switch2_ht == 2) ||
...
cal_BEXVHighPressLmtOn)) && rtb_Compare_fd) {
if (ME11_ARID_DEF.Delay_DSTATE_l >= rtb_PI_Cor_d) {
rtb_Delay_ci = ME11_ARID_DEF.Delay_DSTATE_l;
} else {
rtb_Delay_ci = rtb_PI_Cor_d;
}
} else {
rtb_Delay_ci = rtb_PI_Cor_d;
}

ME11_PwrOn(&rtb_flg_o, &ME11_ARID_DEF.ARID_DEF_PwrOn_h);
if (rtb_flg_o) {
ME11_ARID_DEF.Delay_DSTATE_c2 = rtb_Delay_ci;
} else if (rtb_Delay_ci > ME11_ARID_DEF.Delay_DSTATE_c2 + cal_BEXVUpSpdLmt) {
ME11_ARID_DEF.Delay_DSTATE_c2 += cal_BEXVUpSpdLmt;
} else if (rtb_Delay_ci < ME11_ARID_DEF.Delay_DSTATE_c2 - cal_BEXVDownSpdLmt)
{
...
ME11_PwrOn(&rtb_flg_g, &ME11_ARID_DEF.ARID_DEF_PwrOn_l);
if (rtb_flg_g) {
...
rtb_Delay_ci = cal_ADCVCCVal - rtb_Add;
if (rtb_Delay_ci > 0.0F) {
rtb_Gain8 = rtb_Add / rtb_Delay_ci;
} else {
rtb_Gain8 = 1.0F;
}

SEN_WCCTHiRaw = look1_iflf_binlca(rtb_Gain8 * 20000.0F, (const float32 *)
...
ACTCtl_sCondDep = rtb_Add_o4 - ACSen_sWCCHiTempFilter;
...
ACTCtl_sHPEXVCtrlKp = look1_iflf_binlca(rtb_Add, (const float32 *)
&cal_HPEXVCtrlCKp_1X[0], (const float32 *)&cal_HPEXVCtrlCKp_CUR[0], 7U);
ACTCtl_sHPEXVCtrlKi = look1_iflf_binlca(rtb_Add, (const float32 *)
&cal_HPEXVCtrlCKi_1X[0], (const float32 *)&cal_HPEXVCtrlCKi_CUR[0], 7U);
rtb_Add_kz = cal_HPEXVCtrlCMax;
...
rtb_Add = ME11_ARID_DEF.Init_h - ACTCtl_sHPEXVActure;
...
rtb_Add = (float32)fabs(ME11_ARID_DEF.Init - ACTCtl_sHPEXVActure);
...
rtb_Compare_fd = (ACTCtl_sHPEXVSetPoint >= ACTCtl_sHPEXVActure);
ACTCtl_bHPEXVDvtFlg = !rtb_Compare_fd;
...
rtb_Add_kz, rtb_Merge1, (float32 *)&ACTCtl_sHPEXVPI_Cor,
&rtb_IFreezFlag_c);
if (cal_HPEXVDiffUp <= ACTCtl_sHPEXVPI_Cor - ME11_ARID_DEF.Delay_DSTATE_ny) {
rtb_Add = cal_HPEXVDiffUpRate + ME11_ARID_DEF.Delay_DSTATE_ny;
} else if (ME11_ARID_DEF.Delay_DSTATE_ny - ACTCtl_sHPEXVPI_Cor >=
cal_HPEXVDiffDown) {
rtb_Add = ME11_ARID_DEF.Delay_DSTATE_ny - cal_HPEXVDiffDownRate;
} else {
rtb_Add = ACTCtl_sHPEXVPI_Cor;
}

ME11_PwrOn(&rtb_flg_d, &ME11_ARID_DEF.ARID_DEF_PwrOn_b);
if (rtb_flg_d) {
ME11_ARID_DEF.Delay_DSTATE_hq = rtb_Add;
} else if (rtb_Add > ME11_ARID_DEF.Delay_DSTATE_hq + cal_HPEXVUpSpdLmt) {
ME11_ARID_DEF.Delay_DSTATE_hq += cal_HPEXVUpSpdLmt;
} else if (rtb_Add < ME11_ARID_DEF.Delay_DSTATE_hq - cal_HPEXVDownSpdLmt) {
...
rtb_ACFanLevel8EnvCor = cal_HPEXVLowPressProOpenSpd;
} else {
rtb_ACFanLevel8EnvCor = cal_HPEXVHiPressProOpenSpd;
}

ME11_ARID_DEF.Delay_DSTATE_ny += rtb_ACFanLevel8EnvCor;
...
rtb_Add = ME11_ARID_DEF.Delay_DSTATE_ny - ACTCtl_sHPEXVStepLmt;
if (cal_HPEXVFloorDiff2 < rtb_Add) {
ACTCtl_sHPEXVStepLmt = ACTCtl_sHPEXVStepLmt + 1.0F;
} else if (cal_HPEXVFloorDiff1 < rtb_Add) {
...
if (((ME11_ARID_DEF.Delay1_DSTATE_gf < 2) &&
(ME11_ARID_DEF.DataTypeConversion1 >= 2)) || (HP_EXV_initialize_status ==
0)) {
...
ACTCtl_sExhSuperHeat = ACSen_sACCMHiTempFilter - rtb_Add_o4;
...
ME11_ARID_DEF.GLB_TMSFaultPTC[0] = (uint8)rtb_Switch2_ek;
ME11_ARID_DEF.GLB_TMSFaultPTC[1] = rtb_Compare_ar;
ME11_ARID_DEF.GLB_TMSFaultPTC[2] = rtb_OR_bx_0;
...
ME11_ARID_DEF.is_Dec_g = ME11_IN_wait_p;
}
} else {
...
rtb_Switch_fmz = (uint8)
((Rte_IRead_Task_100ms_IPM_HVCH_Status1_BOD_IPM_HVCH_Status1_BOD())
->VIPM_HVCHInletTemp_C + 40.0F);
Rte_DIDReadData(rtb_Switch_fmz, ((uint8)DID_0xF277));
Rte_DIDReadData
((Rte_IRead_Task_100ms_IPM_HVCH_Status1_BOD_IPM_HVCH_Status1_BOD())
->VIPM_HVCHSt_enum, ((uint8)DID_0xF278));
Rte_DIDReadData
((Rte_IRead_Task_100ms_IPM_HVCH_Status1_BOD_IPM_HVCH_Status1_BOD())
->VIPM_HVCHSt_enum, ((uint8)DID_0xF286));
rtb_Switch3_cn = (uint8)(rtb_Switch2_ek == 1);
if (rtb_Switch3_cn != ME11_ARID_DEF.DelayInput1_DSTATE_go) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942386), rtb_Switch3_cn);
}

rtb_Switch7_g = (uint8)(rtb_Switch2_ek == 2);
if (rtb_Switch7_g != ME11_ARID_DEF.DelayInput1_DSTATE_gf) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942229), rtb_Switch7_g);
}

rtb_Switch4_b = (uint8)(rtb_Switch2_ek == 11);
if (rtb_Switch4_b != ME11_ARID_DEF.DelayInput1_DSTATE_mt) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942929), rtb_Switch4_b);
}

rtb_Compare_icx = (uint8)(rtb_Switch2_ek == 12);
if (rtb_Compare_icx != ME11_ARID_DEF.DelayInput1_DSTATE_bs) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942A29), rtb_Compare_icx);
}

rtb_Compare_bzi = (uint8)(rtb_Switch2_ek == 13);
if (rtb_Compare_bzi != ME11_ARID_DEF.DelayInput1_DSTATE_f) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942B29), rtb_Compare_bzi);
}

if (rtb_Delay_ku != ME11_ARID_DEF.DelayInput1_DSTATE_gfw) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942C29), rtb_Delay_ku);
}

rtb_Compare_hwx = (uint8)(rtb_Switch2_ek == 15);
if (rtb_Compare_hwx != ME11_ARID_DEF.DelayInput1_DSTATE_dp) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942D98), rtb_Compare_hwx);
}

rtb_Compare_lo = (uint8)(rtb_Switch2_ek == 16);
if (rtb_Compare_lo != ME11_ARID_DEF.DelayInput1_DSTATE_c) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942E98), rtb_Compare_lo);
}

rtb_Compare_jsz = (uint8)(rtb_Switch2_ek == 17);
if (rtb_Compare_jsz != ME11_ARID_DEF.DelayInput1_DSTATE_py) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942B98), rtb_Compare_jsz);
}

rtb_Compare_g = (uint8)(rtb_Switch2_ek == 18);
if (rtb_Compare_g != ME11_ARID_DEF.DelayInput1_DSTATE_eb) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942C98), rtb_Compare_g);
}

rtb_Compare_nj = (uint8)(rtb_Switch2_ek == 19);
if (rtb_Compare_nj != ME11_ARID_DEF.DelayInput1_DSTATE_bp) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942F1D), rtb_Compare_nj);
}

rtb_Compare_fg = (uint8)(rtb_Switch2_ek == 20);
if (rtb_Compare_fg != ME11_ARID_DEF.DelayInput1_DSTATE_gn) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942098), rtb_Compare_fg);
}

rtb_Compare_l = (uint8)(rtb_Switch2_ek == 3);
if (rtb_Compare_l != ME11_ARID_DEF.DelayInput1_DSTATE_cb) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942416), rtb_Compare_l);
}

rtb_Compare_n1l = (uint8)(rtb_Switch2_ek == 21);
if (rtb_Compare_n1l != ME11_ARID_DEF.DelayInput1_DSTATE_eg) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943198), rtb_Compare_n1l);
}

rtb_Compare_i = (uint8)(rtb_Switch2_ek == 4);
if (rtb_Compare_i != ME11_ARID_DEF.DelayInput1_DSTATE_ik) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942417), rtb_Compare_i);
}

rtb_Compare_ith = (uint8)(rtb_Switch2_ek == 5);
if (rtb_Compare_ith != ME11_ARID_DEF.DelayInput1_DSTATE_jc) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942516), rtb_Compare_ith);
}

rtb_Compare_a = (uint8)(rtb_Switch2_ek == 6);
if (rtb_Compare_a != ME11_ARID_DEF.DelayInput1_DSTATE_gnz) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942517), rtb_Compare_a);
}

rtb_Compare_e = (uint8)(rtb_Switch2_ek == 7);
if (rtb_Compare_e != ME11_ARID_DEF.DelayInput1_DSTATE_a) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942604), rtb_Compare_e);
}

rtb_Compare_f = (uint8)(rtb_Switch2_ek == 8);
if (rtb_Compare_f != ME11_ARID_DEF.DelayInput1_DSTATE_if) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942629), rtb_Compare_f);
}

rtb_Compare_n5 = (uint8)(rtb_Switch2_ek == 9);
if (rtb_Compare_n5 != ME11_ARID_DEF.DelayInput1_DSTATE_cw) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942719), rtb_Compare_n5);
}

rtb_Compare_bv = (uint8)(rtb_Switch2_ek == 10);
if (rtb_Compare_bv != ME11_ARID_DEF.DelayInput1_DSTATE_g1) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942803), rtb_Compare_bv);
}

rtb_Switch_fmz = (uint8)
((Rte_IRead_Task_100ms_IPM_HVCH_Status1_BOD_IPM_HVCH_Status1_BOD())
->VIPM_HVCHPCBTemp_C + 40.0F);
Rte_DIDReadData(rtb_Switch_fmz, ((uint8)DID_0xF275));
rtb_Switch_fmz = (uint8)
((Rte_IRead_Task_100ms_IPM_HVCH_Status1_BOD_IPM_HVCH_Status1_BOD())
->VIPM_HVCHOutlTemp_C + 40.0F);
Rte_DIDReadData(rtb_Switch_fmz, ((uint8)DID_0xF276));
ME11_ARID_DEF.GLB_TMSFaultPMP[0] = rtb_Compare_hs;
ME11_ARID_DEF.GLB_TMSFaultPMP[1] = rtb_Compare_if;
ME11_ARID_DEF.GLB_TMSFaultPMP[2] = rtb_Compare_jg;
ME11_ARID_DEF.GLB_TMSFaultPMP[3] = rtb_RelationalOperator3_d;
ME11_ARID_DEF.GLB_TMSFaultPMP[4] = rtb_Compare_kt;
ME11_ARID_DEF.GLB_TMSFaultPMP[5] = rtb_Compare_ofq;
ME11_ARID_DEF.GLB_TMSFaultPMP[6] = rtb_FixPtRelationalOperator_io;
ME11_ARID_DEF.GLB_TMSFaultPMP[7] = rtb_Compare_psm;
ME11_ARID_DEF.GLB_TMSFaultPMP[8] = rtb_AND_ll;
ME11_ARID_DEF.GLB_TMSFaultPMP[9] = rtb_FixPtRelationalOperator_nt;
ME11_ARID_DEF.GLB_TMSFaultPMP[10] = rtb_FixPtRelationalOperator_jt;
ME11_ARID_DEF.GLB_TMSFaultPMP[11] = rtb_Compare_ok;
ME11_ARID_DEF.GLB_TMSFaultPMP[12] = rtb_Compare_gre;
ME11_ARID_DEF.GLB_TMSFaultPMP[13] = rtb_AND1_gd;
ME11_ARID_DEF.GLB_TMSFaultPMP[14] = rtb_FixPtRelationalOperator_bv1;
...
rtb_Switch_a5w = (ME11_ARID_DEF.DataTypeConversion1 < 2);
rtb_DataTypeConversion4_n = (uint8)((!rtb_Switch_a5w) &&
(!ME11_ARID_DEF.Compare) && AcPMP_RESP_ERROR);
if (rtb_DataTypeConversion4_n != ME11_ARID_DEF.DelayInput1_DSTATE_ja) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944081),
...
rtb_Switch_fmz = AcPMP_PumpMotorSta;
}

rtb_DataTypeConversion5 = (uint8)(rtb_Switch_fmz == 1);
if (rtb_DataTypeConversion5 != ME11_ARID_DEF.DelayInput1_DSTATE_ey) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944011),
rtb_DataTypeConversion5);
}

rtb_DataTypeConversion1_e = (uint8)(rtb_Switch_fmz == 2);
if (rtb_DataTypeConversion1_e != ME11_ARID_DEF.DelayInput1_DSTATE_gu) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944015),
...
rtb_Switch_fmz = AcPMP_PumpPowerSta;
}

rtb_DataTypeConversion3_e = (uint8)(rtb_Switch_fmz == 1);
if (rtb_DataTypeConversion3_e != ME11_ARID_DEF.DelayInput1_DSTATE_f1) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944017),
rtb_DataTypeConversion3_e);
}

rtb_DataTypeConversion2_l = (uint8)(rtb_Switch_fmz == 2);
if (rtb_DataTypeConversion2_l != ME11_ARID_DEF.DelayInput1_DSTATE_ne) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944016),
...
rtb_Switch_fmz = AcPMP_PumpTempSta;
}

rtb_DataTypeConversion7 = (uint8)(rtb_Switch_fmz == 1);
if (rtb_DataTypeConversion7 != ME11_ARID_DEF.DelayInput1_DSTATE_dj) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944098),
rtb_DataTypeConversion7);
}

rtb_DataTypeConversion6 = (uint8)(rtb_Switch_fmz == 2);
if (rtb_DataTypeConversion6 != ME11_ARID_DEF.DelayInput1_DSTATE_nf) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x94404B),
rtb_DataTypeConversion6);
}

ACTCtl_eAcPMPSpdSet = (uint8)((float32)rtb_Switch2_f0 * 2.5F);
rtb_Switch_a5w = (ME11_ARID_DEF.DataTypeConversion1 < 2);
rtb_Switch2_f0 = (uint8)((!rtb_Switch_a5w) && (!ME11_ARID_DEF.Compare) &&
BatPMP_RESP_ERROR);
if (rtb_Switch2_f0 != ME11_ARID_DEF.DelayInput1_DSTATE_n4) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944181), rtb_Switch2_f0);
}

if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_Switch_fmz = 0U;
} else {
rtb_Switch_fmz = BatPMP_PumpMotorSta;
}

rtb_DataTypeConversion5_l = (uint8)(rtb_Switch_fmz == 1);
if (rtb_DataTypeConversion5_l != ME11_ARID_DEF.DelayInput1_DSTATE_ew) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944111),
rtb_DataTypeConversion5_l);
}

rtb_DataTypeConversion1_m = (uint8)(rtb_Switch_fmz == 2);
if (rtb_DataTypeConversion1_m != ME11_ARID_DEF.DelayInput1_DSTATE_d1) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944115),
...
rtb_Switch_fmz = BatPMP_PumpPowerSta;
}

rtb_DataTypeConversion3_o = (uint8)(rtb_Switch_fmz == 1);
if (rtb_DataTypeConversion3_o != ME11_ARID_DEF.DelayInput1_DSTATE_kp) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944117),
rtb_DataTypeConversion3_o);
}

rtb_DataTypeConversion2_j = (uint8)(rtb_Switch_fmz == 2);
if (rtb_DataTypeConversion2_j != ME11_ARID_DEF.DelayInput1_DSTATE_at) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944116),
...
rtb_Switch_fmz = BatPMP_PumpTempSta;
}

rtb_DataTypeConversion7_e = (uint8)(rtb_Switch_fmz == 1);
if (rtb_DataTypeConversion7_e != ME11_ARID_DEF.DelayInput1_DSTATE_g1e) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944198),
rtb_DataTypeConversion7_e);
}

rtb_DataTypeConversion6_i = (uint8)(rtb_Switch_fmz == 2);
if (rtb_DataTypeConversion6_i != ME11_ARID_DEF.DelayInput1_DSTATE_cy) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x94414B),
rtb_DataTypeConversion6_i);
}

ACTCtl_eBatPMPSpdSet = (uint8)((float32)rtb_MultiportSwitch1 * 2.5F);
rtb_Switch_a5w = (ME11_ARID_DEF.DataTypeConversion1 < 2);
rtb_MultiportSwitch1 = (uint8)((!rtb_Switch_a5w) && (!ME11_ARID_DEF.Compare) &&
MotPMP_RESP_ERROR);
if (rtb_MultiportSwitch1 != ME11_ARID_DEF.DelayInput1_DSTATE_it) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944281),
...
rtb_Switch_fmz = MotPMP_PumpMotorSta;
}

rtb_DataTypeConversion5_o = (uint8)(rtb_Switch_fmz == 1);
if (rtb_DataTypeConversion5_o != ME11_ARID_DEF.DelayInput1_DSTATE_mo) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944211),
rtb_DataTypeConversion5_o);
}

rtb_DataTypeConversion1_i = (uint8)(rtb_Switch_fmz == 2);
if (rtb_DataTypeConversion1_i != ME11_ARID_DEF.DelayInput1_DSTATE_ki) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944215),
rtb_DataTypeConversion1_i);
}

if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_Switch_fmz = 0U;
} else {
rtb_Switch_fmz = MotPMP_PumpPowerSta;
}

rtb_DataTypeConversion3_j = (uint8)(rtb_Switch_fmz == 1);
if (rtb_DataTypeConversion3_j != ME11_ARID_DEF.DelayInput1_DSTATE_ke) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944217),
rtb_DataTypeConversion3_j);
}

rtb_DataTypeConversion2_ku = (uint8)(rtb_Switch_fmz == 2);
if (rtb_DataTypeConversion2_ku != ME11_ARID_DEF.DelayInput1_DSTATE_jz) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944216),
rtb_DataTypeConversion2_ku);
}

if (rtb_Switch_a5w || ME11_ARID_DEF.Compare) {
rtb_Switch_fmz = 0U;
} else {
rtb_Switch_fmz = MotPMP_PumpTempSta;
}

rtb_DataTypeConversion7_l = (uint8)(rtb_Switch_fmz == 1);
if (rtb_DataTypeConversion7_l != ME11_ARID_DEF.DelayInput1_DSTATE_h3) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x944398),
rtb_DataTypeConversion7_l);
}

rtb_DataTypeConversion6_j = (uint8)(rtb_Switch_fmz == 2);
if (rtb_DataTypeConversion6_j != ME11_ARID_DEF.DelayInput1_DSTATE_l4) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x94434B),
rtb_DataTypeConversion6_j);
}

ACTCtl_eMotPMPSpdSet = (uint8)((float32)rtb_Switch2_a0 * 2.5F);
if (cal_LTRFanCtrl_1X[0] > ACSen_sMotTempFilter) {
rtb_Switch_jkj = cal_LTRFanCtrl_1Y[0];
} else if (ACSen_sMotTempFilter >= cal_LTRFanCtrl_1X[1]) {
rtb_Switch_jkj = cal_LTRFanCtrl_1Y[2];
} else {
rtb_Switch_jkj = cal_LTRFanCtrl_1Y[1];
}
...
ACTCtl_eCoolFanCtrl = look2_iflftu8Dfdf_binlca(rtb_Add_o4,
...
ME11_ConstP.pooled38, 4U);
if (COMP_EcompActSpd >= cal_COMPSpdLmt[3]) {
rtb_Switch2_a0 = cal_COMPFanSpdLmt[2];
...
rtb_Switch2_a0 = cal_COMPFanSpdLmt[1];
...
rtb_Switch2_a0 = cal_COMPFanSpdLmt[0];
...
ME11_ConstP.pooled38, 4U);
rtb_Compare_fd = (ACSen_sLoPressFilter <= cal_LPFanOn);
rtb_Compare_eux = (ACSen_sLoPressFilter >= cal_LPFanOff);
...
if (rtb_Compare_hc2[0] || rtb_Compare_hc2[1] || rtb_Compare_hc2[2] ||
rtb_Compare_hc2[3] || rtb_Compare_hc2[4]) {
if (ME11_ARID_DEF.B_aq) {
rtb_Switch6_ng = cal_ACCMHiTempFanCtrl;
} else {
rtb_Switch6_ng = 10U;
}
} else {
...
rtb_Switch_ijm = rtb_Switch_jkj;
} else if (rtb_DataTypeConversion1_l == 5) {
rtb_Compare_fd = (cal_LTRIPUTempFanCtrl_1X[0] >
(Rte_IRead_Task_100ms_IPM_IPU_OBC_2_Inlet_EPT_IPM_IPU_OBC_2_Inlet_EPT
())->VIPM_IPUDeviceIntTemp_C);
if (rtb_Compare_fd) {
rtb_Switch_ijm = cal_LTRIPUTempFanCtrl_1Y[0];
} else {
rtb_Compare_fd =
((Rte_IRead_Task_100ms_IPM_IPU_OBC_2_Inlet_EPT_IPM_IPU_OBC_2_Inlet_EPT
())->VIPM_IPUDeviceIntTemp_C >= cal_LTRIPUTempFanCtrl_1X[1]);
if (rtb_Compare_fd) {
rtb_Switch_ijm = cal_LTRIPUTempFanCtrl_1Y[2];
} else {
rtb_Switch_ijm = cal_LTRIPUTempFanCtrl_1Y[1];
}
}

if (rtb_Switch_jkj >= rtb_Switch_ijm) {
rtb_Switch_ijm = rtb_Switch_jkj;
}
} else {
rtb_Switch_ijm = 10U;
...
{
rtb_Switch_jkj = cal_FanCtrlOff;
} else {
rtb_Switch_jkj = 10U;
}

if (ME11_ARID_DEF.Delay_DSTATE_kf) {
rtb_Compare_l4e = ACTCtl_eCoolFanCtrl;
} else {
rtb_Compare_l4e = 10U;
}
...
rtb_Compare_ntr = ACTCtl_eHeatFanCtrl;
} else {
rtb_Compare_ntr = 10U;
}
...
if (rtb_Switch_ijm >= rtb_Switch_jkj) {
rtb_Switch_jkj = rtb_Switch_ijm;
}

if (rtb_Switch_jkj >= rtb_Switch6_ng) {
rtb_Switch6_ng = rtb_Switch_jkj;
}

if (rtb_Switch6_ng >= rtb_Compare_l4e) {
rtb_Compare_l4e = rtb_Switch6_ng;
}
...
if (rtb_Compare_pw >= ACTCtl_eFanPerc) {
ACTCtl_eFanPerc = rtb_Compare_pw;
}

if (ACTCtl_eFanPerc > 100) {
ACTCtl_eFanPerc = 100U;
} else if (ACTCtl_eFanPerc < rtb_Switch2_a0) {
ACTCtl_eFanPerc = rtb_Switch2_a0;
}
}
...
rtb_Switch2_ek = Rte_IRead_Task_100ms_EXV_CurrentPosition_EXV_CurrentPosition();
Buffer_DcmDspData_F27DH[0] = (uint8)rtb_Switch2_ek;
Buffer_DcmDspData_F27DH[1] = (uint8)((uint32)rtb_Switch2_ek >> 8);
EXV_CurrentPosition = 0.15625F * (float32)rtb_Switch2_ek;
...
Buffer_DcmDspData_F27EH[0] = (uint8)rtb_Switch2_ek;
Buffer_DcmDspData_F27EH[1] = (uint8)((uint32)rtb_Switch2_ek >> 8);
BAT_EXV_CurrentPosition_B = 0.15625F * (float32)rtb_Switch2_ek;
BAT_EXV_RunState_B =
...
rtb_ACFanLevel8EnvCor = ME11_ARID_DEF.Switch4 - PCU_StartClntTemp;
} else {
rtb_ACFanLevel8EnvCor = 0.0F;
}

ME11_ARID_DEF.Switch3 = (PCUtempOffset2ShutByEnv <= rtb_ACFanLevel8EnvCor);
}
}
...
rtb_ACFanLevel8EnvCor = ME11_ARID_DEF.Delay_DSTATE_kx;
} else {
rtb_ACFanLevel8EnvCor = ME11_ARID_DEF.Switch4;
}

ME11_ARID_DEF.EEWrite_PCUInletTemp = (uint8)((uint8)(rtb_ACFanLevel8EnvCor +
40.0F) << 1);
if (rtb_Switch_irj) {
PWRCtl_eUnlockActFlg = rtb_Switch1_ha;
} else {
PWRCtl_eUnlockActFlg = 16U;
}
...
rtb_Subtract9 = PWRCtl_uTMSRunTimer + 1U;
if (PWRCtl_uTMSRunTimer + 1U < PWRCtl_uTMSRunTimer) {
rtb_Subtract9 = MAX_uint32_T;
}

PWRCtl_uTMSRunTimer = rtb_Subtract9;
}
} else if (ME11_ARID_DEF.temporalCounter_i1_ex >= 1) {
ME11_ARID_DEF.is_c40_ME11 = ME11_IN_Counter_Cal_f;
}

rtb_DataTypeConversion1_g = (uint8)(ACSen_eCabinSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[0] = (rtb_DataTypeConversion1_g != 0);
rtb_Switch2_a0 = (uint8)(ACSen_eCabinSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[1] = (rtb_Switch2_a0 != 0);
rtb_Switch1_ha = (uint8)(ACSen_eFaceDuctSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[2] = (rtb_Switch1_ha != 0);
rtb_Switch_jkj = (uint8)(ACSen_eFaceDuctSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[3] = (rtb_Switch_jkj != 0);
rtb_Compare_l4e = (uint8)(ACSen_eFootDuctSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[4] = (rtb_Compare_l4e != 0);
rtb_Compare_ntr = (uint8)(ACSen_eFootDuctSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[5] = (rtb_Compare_ntr != 0);
rtb_Compare_pw = (uint8)(ACSen_eEVAPSurfTSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[6] = (rtb_Compare_pw != 0);
rtb_Switch6_ng = (uint8)(ACSen_eEVAPSurfTSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[7] = (rtb_Switch6_ng != 0);
rtb_Switch_ijm = (uint8)(ACSen_eEnvSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[8] = (rtb_Switch_ijm != 0);
rtb_Compare_ip = (uint8)(ACSen_eEnvSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[9] = (rtb_Compare_ip != 0);
ACSen_eWCCHPSenSts = rtb_Switch_ia;
rtb_Switch_ia = (uint8)(ACSen_eWCCHPSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[10] = (rtb_Switch_ia != 0);
rtb_Compare_oz = (uint8)(ACSen_eWCCHPSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[11] = (rtb_Compare_oz != 0);
rtb_Compare_cds = (uint8)(ACSen_eWCCHTSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[12] = (rtb_Compare_cds != 0);
rtb_Compare_ph = (uint8)(ACSen_eWCCHTSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[13] = (rtb_Compare_ph != 0);
rtb_Compare_hfs = (uint8)(ACSen_eChillerTSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[14] = (rtb_Compare_hfs != 0);
rtb_Compare_cjk = (uint8)(ACSen_eChillerTSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[15] = (rtb_Compare_cjk != 0);
ACSen_eLPSenSts = rtb_Switch_ig;
rtb_Switch_ig = (uint8)(ACSen_eLPSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[16] = (rtb_Switch_ig != 0);
rtb_Compare_ml = (uint8)(ACSen_eLPSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[17] = (rtb_Compare_ml != 0);
rtb_Compare_ouy = (uint8)(ACSen_eACCMHTSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[18] = (rtb_Compare_ouy != 0);
rtb_Compare_m = (uint8)(ACSen_eACCMHTSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[19] = (rtb_Compare_m != 0);
rtb_Compare_jm = (uint8)(ACSen_eOHXTSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[20] = (rtb_Compare_jm != 0);
rtb_Compare_lf = (uint8)(ACSen_eOHXTSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[21] = (rtb_Compare_lf != 0);
rtb_Switch_irj = (ACSen_eMOTORTSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[22] = rtb_Switch_irj;
rtb_Switch_a5w = (ACSen_eMOTORTSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[23] = rtb_Switch_a5w;
rtb_Compare_nbr = (ACSen_eEVAPTSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[24] = rtb_Compare_nbr;
rtb_RelationalOperator_j5 = (ACSen_eEVAPTSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[25] = rtb_RelationalOperator_j5;
...
if (cal_RecIODrvNotChgFlg) {
rtb_Compare_fd = true;
} else {
rtb_Compare_fd = (IOCtl_RecircTrgPos != ME11_ARID_DEF.DelayInput1_DSTATE_nw);
}
...
ME11_ARID_DEF.n_h = 0U;
if (ME11_ARID_DEF.temporalCounter_i1_mf >= 5U) {
ME11_ARID_DEF.is_Move_f = ME11_IN_Default_o;
ME11_ARID_DEF.p_c = 0U;
ME11_ARID_DEF.n_h = 0U;
ME11_ARID_DEF.MoveSts_d = false;
...
cal_RecircDoorNErr) && rtb_Compare_fd) {
ME11_ARID_DEF.Stuck_Sts_a = false;
...
if (cal_MixIODrvNotChgFlg) {
rtb_Compare_fd = true;
} else {
rtb_Compare_fd = (IOCtl_sMixDoorTrgPos !=
ME11_ARID_DEF.DelayInput1_DSTATE_dg);
}
...
ME11_ARID_DEF.is_Move_b = ME11_IN_Default_d;
...
rtb_Compare_pew = (ACSen_eSOLARSenSts == Ground);
ME11_ARID_DEF.VectorConcatenate[35] = rtb_Compare_pew;
rtb_Compare_n2_0 = (ACSen_eSOLARSenSts == Power);
ME11_ARID_DEF.VectorConcatenate[36] = rtb_Compare_n2_0;
...
if (rtb_Switch1_ha != ME11_ARID_DEF.DelayInput1_DSTATE_j54) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941311), rtb_Switch1_ha);
}

if (rtb_Switch_jkj != ME11_ARID_DEF.DelayInput1_DSTATE_dd) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941315), rtb_Switch_jkj);
}
...
if (rtb_Compare_l4e != ME11_ARID_DEF.DelayInput1_DSTATE_gp) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941411), rtb_Compare_l4e);
}

if (rtb_Compare_ntr != ME11_ARID_DEF.DelayInput1_DSTATE_h1) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941515), rtb_Compare_ntr);
}

Rte_DIDReadData((uint8)(2.0F * (ACSen_sCabinTempFilter + 40.0F)), ((uint8)
DID_0xF261));
if (rtb_DataTypeConversion1_g != ME11_ARID_DEF.DelayInput1_DSTATE_lw) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941211),
rtb_DataTypeConversion1_g);
}

if (rtb_Switch2_a0 != ME11_ARID_DEF.DelayInput1_DSTATE_bl) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941215), rtb_Switch2_a0);
}
...
if (rtb_Switch_ig != ME11_ARID_DEF.DelayInput1_DSTATE_io) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942011), rtb_Switch_ig);
}

if (rtb_Compare_ml != ME11_ARID_DEF.DelayInput1_DSTATE_fz) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942015), rtb_Compare_ml);
}

if (rtb_Compare_pew != ME11_ARID_DEF.DelayInput1_DSTATE_ch) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943F11), rtb_Compare_pew);
}

if (rtb_Compare_n2_0 != ME11_ARID_DEF.DelayInput1_DSTATE_lg) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943F15), rtb_Compare_n2_0);
}

Rte_DIDReadData((uint8)(ACSen_sChiTempFilter + 10.0F), ((uint8)DID_0xF27F));
if (rtb_Compare_hfs != ME11_ARID_DEF.DelayInput1_DSTATE_ag) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941F11), rtb_Compare_hfs);
}

if (rtb_Compare_cjk != ME11_ARID_DEF.DelayInput1_DSTATE_em) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941F15), rtb_Compare_cjk);
}

if (rtb_Switch_ijm != ME11_ARID_DEF.DelayInput1_DSTATE_d5) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941B11), rtb_Switch_ijm);
}

if (rtb_Compare_ip != ME11_ARID_DEF.DelayInput1_DSTATE_ai) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941B15), rtb_Compare_ip);
}

Rte_DIDReadData((uint8)(ACSen_sEvapTempFilter + 40.0F), ((uint8)DID_0xF263));
if (rtb_Compare_nbr != ME11_ARID_DEF.DelayInput1_DSTATE_ib) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943D11), rtb_Compare_nbr);
}

if (rtb_RelationalOperator_j5 != ME11_ARID_DEF.DelayInput1_DSTATE_er) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943D15),
rtb_RelationalOperator_j5);
}

Rte_DIDReadData((uint8)(ACSen_sEvapSurTemp + 50.0F), ((uint8)DID_0xF262));
if (rtb_Compare_pw != ME11_ARID_DEF.DelayInput1_DSTATE_ga) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941A11), rtb_Compare_pw);
}

if (rtb_Switch6_ng != ME11_ARID_DEF.DelayInput1_DSTATE_nq) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941A15), rtb_Switch6_ng);
}

rtb_DataTypeConversion_ig5 = rtb_Switch_irj;
if (rtb_Switch_irj != ME11_ARID_DEF.DelayInput1_DSTATE_ce) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943E11), rtb_Switch_irj);
}

rtb_DataTypeConversion2_c = rtb_Switch_a5w;
if (rtb_Switch_a5w != ME11_ARID_DEF.DelayInput1_DSTATE_d4) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x943E15), rtb_Switch_a5w);
}

Rte_DIDReadData((uint8)(ACSen_sOHXTempFilter + 40.0F), ((uint8)DID_0xF280));
if (rtb_Compare_jm != ME11_ARID_DEF.DelayInput1_DSTATE_bl5) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942211), rtb_Compare_jm);
}

if (rtb_Compare_lf != ME11_ARID_DEF.DelayInput1_DSTATE_gz) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942215), rtb_Compare_lf);
}

Rte_DIDReadData((uint8)(ACSen_sWCCHiTempFilter + 40.0F), ((uint8)DID_0xF265));
if (rtb_Compare_cds != ME11_ARID_DEF.DelayInput1_DSTATE_ob) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941E11), rtb_Compare_cds);
}

if (rtb_Compare_ph != ME11_ARID_DEF.DelayInput1_DSTATE_cp) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941E15), rtb_Compare_ph);
}

Rte_DIDReadData((uint8)(10.0F * ACSen_sHiPressFilter), ((uint8)DID_0xF264));
if (rtb_Switch_ia != ME11_ARID_DEF.DelayInput1_DSTATE_cv) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941D11), rtb_Switch_ia);
}

if (rtb_Compare_oz != ME11_ARID_DEF.DelayInput1_DSTATE_ku) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x941D15), rtb_Compare_oz);
}

Rte_DIDReadData((uint8)(ACSen_sACCMHiTempFilter + 10.0F), ((uint8)DID_0xF281));
if (rtb_Compare_ouy != ME11_ARID_DEF.DelayInput1_DSTATE_hr) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942111), rtb_Compare_ouy);
}

if (rtb_Compare_m != ME11_ARID_DEF.DelayInput1_DSTATE_h0c) {
Dem_SetEventStatus(((uint16)DemEventParameter_0x942115), rtb_Compare_m);
}

ME11_ARID_DEF.EEWrite_UnlockVentSts = HMICtl_eUnlckVentSts;
rtb_Compare_fd = ((ME11_ARID_DEF.DataTypeConversion1 >= 2) &&
PWRCtl_bKL15swtSt);
rtb_BusCreator.TMS_HVReq_flg = (ME11_ARID_DEF.Delay_DSTATE_kf ||
(ACTCtl_sPTCReqPower >= 0.5F));
rtb_Add_a = Rte_IOCtrl(((uint8)IODID_0x0x3237));
...
if (cal_PwrHVPartEnb) {
rtb_Compare_eux = cal_PwrHVPartData;
} else if (Rte_DcmDspData_3237_CtlFlg == 1) {
rtb_Compare_eux = ((rtb_Add_a & 1) == 1);
} else {
rtb_Compare_eux = ME11_ARID_DEF.C;
}

ME11_Delay(rtb_Compare_eux, &ME11_ARID_DEF.C_i,
&ME11_ARID_DEF.ARID_DEF_Delay_l);
if (cal_PwrACPumpEnb) {
rtb_Switch_irj = cal_PwrACPumpData;
} else if (Rte_DcmDspData_3237_CtlFlg == 1) {
rtb_Switch_irj = ((rtb_Add_a & 4) == 4);
} else {
rtb_Switch_irj = ME11_ARID_DEF.C_i;
}

ME11_Delay(rtb_Compare_eux, &ME11_ARID_DEF.C_g, &ME11_ARID_DEF.ARID_DEF_Delay);
if (cal_PwrFanAndPumpDataEnb) {
rtb_Switch_fmz = cal_PwrFanAndPumpData;
} else if (Rte_DcmDspData_3237_CtlFlg == 1) {
rtb_Switch_fmz = (uint8)((rtb_Add_a & 2) == 2);
} else {
rtb_Switch_fmz = ME11_ARID_DEF.C_g;
}

if (cal_SOVEnb) {
rtb_Switch_a5w = cal_SOVData;
} else if (Rte_DcmDspData_3237_CtlFlg == 1) {
rtb_Switch_a5w = ((rtb_Add_a & 8) == 8);
} else {
rtb_Switch_a5w = ((ME11_ARID_DEF.DataTypeConversion1 >= 2) && ACTCtl_bSOVCmd);
}

rtb_Add_a = (uint8)((((uint32)(rtb_Switch_irj << 3) + (uint32)(rtb_Compare_eux
<< 2)) + (uint32)(rtb_Switch_fmz << 1)) + rtb_Switch_a5w);
IOCtl_PwrNmReqFlg = (rtb_Add_a != 0);
rtb_BusCreator.AppSwcTmsVersion = 7U;
rtb_BusCreator.TMS_NMReq_flg = IOCtl_PwrNmReqFlg;
rtb_BusCreator.IOCtl_bPwrHVPart = rtb_Compare_eux;
if (ME11_ARID_DEF.DataTypeConversion1 < 2) {
rtb_Add_o4 = 0.0F;
} else {
rtb_Add_o4 = PWRCtl_sCOMPActlPwr +
(Rte_IRead_Task_100ms_IPM_HVCH_Status2_BOD_IPM_HVCH_Status2_BOD())
->VIPM_HVCHPwr_kW;
}
...
rtb_BusCreator1.AC_HighVolDCTolalPwr = rtb_Add_o4;
...
rtb_BusCreator2.AC_ActTotalPower = rtb_Add_o4;
...
rtb_BusCreator3.AC_EnvirTempV = !rtb_RelationalOperator_de;
...
rtb_BusCreator4.AC_RefrgLoPressureV = !rtb_Compare_ace;
rtb_BusCreator4.AC_RefrgLoPressure = 1000.0F * ACSen_sLoPressFilter;
...
} else if (PWRCtl_bUnlockVentTimeFlg) {
rtb_BusCreator5.AC_FrontFanSpdValue = 5U;
} else {
rtb_BusCreator5.AC_FrontFanSpdValue = ME11_ARID_DEF.Delay1_DSTATE_gu;
}
...
if (PWRCtl_bKL15swtSt) {
rtb_BusCreator5.AC_BlowerModeSta = rtb_DataTypeConversion1_f;
} else {
rtb_BusCreator5.AC_BlowerModeSta = rtb_DataTypeConversion_f4;
}

rtb_BusCreator5.AC_ACPowerFb = ME11_ARID_DEF.Switch_c;
if (PWRCtl_bKL15swtSt) {
rtb_BusCreator5.AC_AutoBlowerModeSta = rtb_DataTypeConversion1_f;
} else {
rtb_BusCreator5.AC_AutoBlowerModeSta = rtb_DataTypeConversion_f4;
}
...
rtb_DataTypeConversion_f4 = (uint8)(ME11_ARID_DEF.Stuck_Sts_a ? 3 : 0);
} else if (ME11_ARID_DEF.MoveSts_d) {
rtb_DataTypeConversion_f4 = (uint8)(ME11_ARID_DEF.MoveSts_d << 1);
} else {
rtb_DataTypeConversion_f4 = (uint8)(cal_RecircTrgPosDataEnb ||
cal_RecircMotorEnb);
}

Rte_DIDReadData(rtb_DataTypeConversion_f4, ((uint8)DID_0xF26A));
Dem_SetEventStatus(((uint16)DemEventParameter_0x943271),
ME11_ARID_DEF.Stuck_Sts_a);
if (ME11_ARID_DEF.Stuck_Sts_f) {
rtb_DataTypeConversion_f4 = (uint8)(ME11_ARID_DEF.Stuck_Sts_f ? 3 : 0);
} else if (ME11_ARID_DEF.MoveSts_m) {
rtb_DataTypeConversion_f4 = (uint8)(ME11_ARID_DEF.MoveSts_m << 1);
} else {
rtb_DataTypeConversion_f4 = (uint8)(cal_SetLeftMixDoorTrgDataEnb ||
cal_MixDoorEnb);
}

Rte_DIDReadData(rtb_DataTypeConversion_f4, ((uint8)DID_0xF26B));
Dem_SetEventStatus(((uint16)DemEventParameter_0x943571),
ME11_ARID_DEF.Stuck_Sts_f);
if (ME11_ARID_DEF.Stuck_Sts > 0) {
rtb_DataTypeConversion_f4 = (uint8)(3U * ME11_ARID_DEF.Stuck_Sts);
} else if (ME11_ARID_DEF.MoveSts) {
rtb_DataTypeConversion_f4 = (uint8)(ME11_ARID_DEF.MoveSts << 1);
} else {
rtb_DataTypeConversion_f4 = (uint8)(cal_ModeMotorTrgPosDataEnb ||
cal_ModeMotorEnb);
}

Rte_DIDReadData(rtb_DataTypeConversion_f4, ((uint8)DID_0xF269));
Dem_SetEventStatus(((uint16)DemEventParameter_0x943371),
...
rtb_DataTypeConversion_f4 = (uint8)(100 - IOCtl_BloweFanSpeed);
set_BlwFan(cal_BlwFrqVal, (uint8)(100 - IOCtl_BloweFanSpeed));
Rte_DIDReadData(rtb_DataTypeConversion_f4, ((uint8)DID_0xF26D));
if (cal_PwrBlwEnb) {
rtb_ACTCtl_bEXVDiagFlg = cal_PwrBlwData;
} else {
rtb_ACTCtl_bEXVDiagFlg = ((ME11_ARID_DEF.DataTypeConversion1 >= 2) ||
PWRCtl_bUnlockVentTimeFlg);
}

SetHw_PwrBlower(rtb_ACTCtl_bEXVDiagFlg);
if (cal_PwrFanEnb) {
rtb_ACTCtl_bEXVDiagFlg = cal_PwrFanData;
} else {
rtb_ACTCtl_bEXVDiagFlg = (ME11_ARID_DEF.DataTypeConversion1 >= 1);
}

set_PwrFanCabin(rtb_ACTCtl_bEXVDiagFlg);
if (cal_PwrSensorEnb) {
rtb_ACTCtl_bEXVDiagFlg = cal_PwrSensorData;
} else {
rtb_ACTCtl_bEXVDiagFlg = (ME11_ARID_DEF.DataTypeConversion1 >= 1);
}

set_PwrSensor(rtb_ACTCtl_bEXVDiagFlg);
set_PwrACPump(rtb_Switch_irj);
Rte_DIDReadData(rtb_Add_a, ((uint8)DID_0xF26F));
set_PwrFanAndPump(rtb_Switch_fmz);
set_PwrHVPart(rtb_Compare_eux);
set_PwrSOV(rtb_Switch_a5w);
...
rtb_Compare_eux = ACTCtl_bHPEXVEnb;
rtb_DataTypeConversion1_on = ACTCtl_bHPEXVInitReq;
rtb_Switch2_ek = (uint16)(6.4F * ACTCtl_sBEXVPos);
rtb_Compare_m4 = ACTCtl_bBEXVEnb;
rtb_DataTypeConversion1_l = ACTCtl_bBEXVInitReq;
rtb_Gain_az = (uint16)(6.4F * ACTCtl_sAEXVPos);
rtb_Compare_of3 = ACTCtl_bAEXVEnb;
rtb_IFreezFlag_k = ACTCtl_bAEXVInitReq;
rtb_DataTypeConversion_f4 = ACTCtl_eC3WVValue;
rtb_DataTypeConversion1_f = ACTCtl_eC3WVSLSts;
rtb_Switch_fmz = ACTCtl_eC5WVValue;
rtb_Add_a = ACTCtl_eC5WVSLSts;
rtb_AcPMP_SpdSet = ACTCtl_eAcPMPSpdSet;
rtb_BatPMP_SpdSet = ACTCtl_eBatPMPSpdSet;
rtb_MotPMP_SpdSet = ACTCtl_eMotPMPSpdSet;
SOMCtl_eCabinModePre = rtb_Delay3_jo;
...
ME11_ARID_DEF.Delay_DSTATE_gu[0] = ME11_ARID_DEF.Delay_DSTATE_gu[1];
ME11_ARID_DEF.Delay_DSTATE_gu[1] = rtb_Compare_fd;
...
ME11_ARID_DEF.DelayInput1_DSTATE_gyl = rtb_Compare_chc;
...
ME11_ARID_DEF.Delay_DSTATE_he = FixPtRelationalOperator;
ME11_ARID_DEF.DelayInput1_DSTATE_h = rtb_Delay3_jo;
...
ME11_ARID_DEF.DelayInput1_DSTATE_iy = ACCtl_bExhaustFlg;
...
ME11_ARID_DEF.DelayInput1_DSTATE_kph = rtb_AND1_h0y;
...
ME11_ARID_DEF.Delay3_DSTATE[3] = rtb_Delay;
...
ME11_ARID_DEF.Delay_DSTATE_bf = rtb_Delay1_m;
ME11_ARID_DEF.Delay_DSTATE_n = ME11_ARID_DEF.RecordInitialEvapTemp_o;
ME11_ARID_DEF.Delay_DSTATE_kq = AC_tiAfterRun;
ME11_ARID_DEF.DelayInput1_DSTATE_ez =
(Rte_IRead_Task_100ms_IPM_HU_B_BAC_IPM_HU_B_BAC())
->VIPM_HUACUnlckVentSet_enum;
ME11_ARID_DEF.Delay1_DSTATE_d =
(Rte_IRead_Task_100ms_Bcm2VcuTms_outputs_Bcm2VcuTms_outputs())
->BCM_BodyWarnSts;
...
ME11_ARID_DEF.DelayInput1_DSTATE_nej = HMICtl_bACDefrost;
...
ME11_ARID_DEF.DelayInput1_DSTATE_p = rtb_IFreezFlag_bd;
ME11_ARID_DEF.DelayInput1_DSTATE_n = rtb_IFreezFlag_jz;
ME11_ARID_DEF.DelayInput1_DSTATE_e3 = rtb_IndexVector8_j;
ME11_ARID_DEF.DelayInput1_DSTATE_ju5 = rtb_Add_d;
ME11_ARID_DEF.DelayInput1_DSTATE_m3 = rtb_Add7_i;
ME11_ARID_DEF.DelayInput1_DSTATE_mq = rtb_Add2_j5;
ME11_ARID_DEF.DelayInput1_DSTATE_k = rtb_Add3_do;
ME11_ARID_DEF.DelayInput1_DSTATE_h0 = rtb_Add6_d;
ME11_ARID_DEF.DelayInput1_DSTATE_l = rtb_Add5_d;
ME11_ARID_DEF.DelayInput1_DSTATE_po = rtb_Add4_ox;
...
ME11_ARID_DEF.DelayInput1_DSTATE_jj =
rtb_cal_AccmSpdLimByHiPressLevelCalcu_CUR;
ME11_ARID_DEF.DelayInput1_DSTATE_b = rtb_Switch1_mn;
ME11_ARID_DEF.DelayInput1_DSTATE_mqg = rtb_Switch_e2s;
ME11_ARID_DEF.DelayInput1_DSTATE_ee = rtb_Compare_bx;
ME11_ARID_DEF.DelayInput1_DSTATE_hq = rtb_Compare_bmr;
ME11_ARID_DEF.DelayInput1_DSTATE_ei = rtb_Compare_bi3;
ME11_ARID_DEF.DelayInput1_DSTATE_jo = rtb_Compare_j;
ME11_ARID_DEF.DelayInput1_DSTATE_o2 = rtb_Compare_e5v;
ME11_ARID_DEF.DelayInput1_DSTATE_p4 = rtb_Compare_p;
ME11_ARID_DEF.DelayInput1_DSTATE_nc = rtb_Compare_k;
ME11_ARID_DEF.DelayInput1_DSTATE_pg = rtb_Compare_mxx;
ME11_ARID_DEF.DelayInput1_DSTATE_oa = rtb_Compare_bc;
ME11_ARID_DEF.DelayInput1_DSTATE_d3 = rtb_Compare_huq;
ME11_ARID_DEF.DelayInput1_DSTATE_mqq = rtb_Compare_jo;
...
ME11_ARID_DEF.DelayInput1_DSTATE_go = rtb_Switch3_cn;
ME11_ARID_DEF.DelayInput1_DSTATE_gf = rtb_Switch7_g;
ME11_ARID_DEF.DelayInput1_DSTATE_mt = rtb_Switch4_b;
ME11_ARID_DEF.DelayInput1_DSTATE_bs = rtb_Compare_icx;
ME11_ARID_DEF.DelayInput1_DSTATE_f = rtb_Compare_bzi;
ME11_ARID_DEF.DelayInput1_DSTATE_gfw = rtb_Delay_ku;
ME11_ARID_DEF.DelayInput1_DSTATE_dp = rtb_Compare_hwx;
ME11_ARID_DEF.DelayInput1_DSTATE_c = rtb_Compare_lo;
ME11_ARID_DEF.DelayInput1_DSTATE_py = rtb_Compare_jsz;
ME11_ARID_DEF.DelayInput1_DSTATE_eb = rtb_Compare_g;
ME11_ARID_DEF.DelayInput1_DSTATE_bp = rtb_Compare_nj;
ME11_ARID_DEF.DelayInput1_DSTATE_gn = rtb_Compare_fg;
ME11_ARID_DEF.DelayInput1_DSTATE_cb = rtb_Compare_l;
ME11_ARID_DEF.DelayInput1_DSTATE_eg = rtb_Compare_n1l;
ME11_ARID_DEF.DelayInput1_DSTATE_ik = rtb_Compare_i;
ME11_ARID_DEF.DelayInput1_DSTATE_jc = rtb_Compare_ith;
ME11_ARID_DEF.DelayInput1_DSTATE_gnz = rtb_Compare_a;
ME11_ARID_DEF.DelayInput1_DSTATE_a = rtb_Compare_e;
ME11_ARID_DEF.DelayInput1_DSTATE_if = rtb_Compare_f;
ME11_ARID_DEF.DelayInput1_DSTATE_cw = rtb_Compare_n5;
ME11_ARID_DEF.DelayInput1_DSTATE_g1 = rtb_Compare_bv;
ME11_ARID_DEF.DelayInput1_DSTATE_ja = rtb_DataTypeConversion4_n;
ME11_ARID_DEF.DelayInput1_DSTATE_ey = rtb_DataTypeConversion5;
ME11_ARID_DEF.DelayInput1_DSTATE_gu = rtb_DataTypeConversion1_e;
ME11_ARID_DEF.DelayInput1_DSTATE_f1 = rtb_DataTypeConversion3_e;
ME11_ARID_DEF.DelayInput1_DSTATE_ne = rtb_DataTypeConversion2_l;
ME11_ARID_DEF.DelayInput1_DSTATE_dj = rtb_DataTypeConversion7;
ME11_ARID_DEF.DelayInput1_DSTATE_nf = rtb_DataTypeConversion6;
ME11_ARID_DEF.DelayInput1_DSTATE_n4 = rtb_Switch2_f0;
ME11_ARID_DEF.DelayInput1_DSTATE_ew = rtb_DataTypeConversion5_l;
ME11_ARID_DEF.DelayInput1_DSTATE_d1 = rtb_DataTypeConversion1_m;
ME11_ARID_DEF.DelayInput1_DSTATE_kp = rtb_DataTypeConversion3_o;
ME11_ARID_DEF.DelayInput1_DSTATE_at = rtb_DataTypeConversion2_j;
ME11_ARID_DEF.DelayInput1_DSTATE_g1e = rtb_DataTypeConversion7_e;
ME11_ARID_DEF.DelayInput1_DSTATE_cy = rtb_DataTypeConversion6_i;
ME11_ARID_DEF.DelayInput1_DSTATE_it = rtb_MultiportSwitch1;
ME11_ARID_DEF.DelayInput1_DSTATE_mo = rtb_DataTypeConversion5_o;
ME11_ARID_DEF.DelayInput1_DSTATE_ki = rtb_DataTypeConversion1_i;
ME11_ARID_DEF.DelayInput1_DSTATE_ke = rtb_DataTypeConversion3_j;
ME11_ARID_DEF.DelayInput1_DSTATE_jz = rtb_DataTypeConversion2_ku;
ME11_ARID_DEF.DelayInput1_DSTATE_h3 = rtb_DataTypeConversion7_l;
ME11_ARID_DEF.DelayInput1_DSTATE_l4 = rtb_DataTypeConversion6_j;
ME11_ARID_DEF.Delay_DSTATE_kx = ACSen_sMotTempFilter;
ME11_ARID_DEF.DelayInput1_DSTATE_nw = IOCtl_RecircTrgPos;
ME11_ARID_DEF.DelayInput1_DSTATE_dg = IOCtl_sMixDoorTrgPos;
ME11_ARID_DEF.DelayInput1_DSTATE_j54 = rtb_Switch1_ha;
ME11_ARID_DEF.DelayInput1_DSTATE_dd = rtb_Switch_jkj;
ME11_ARID_DEF.DelayInput1_DSTATE_gp = rtb_Compare_l4e;
ME11_ARID_DEF.DelayInput1_DSTATE_h1 = rtb_Compare_ntr;
ME11_ARID_DEF.DelayInput1_DSTATE_lw = rtb_DataTypeConversion1_g;
ME11_ARID_DEF.DelayInput1_DSTATE_bl = rtb_Switch2_a0;
ME11_ARID_DEF.DelayInput1_DSTATE_io = rtb_Switch_ig;
ME11_ARID_DEF.DelayInput1_DSTATE_fz = rtb_Compare_ml;
ME11_ARID_DEF.DelayInput1_DSTATE_ch = rtb_Compare_pew;
ME11_ARID_DEF.DelayInput1_DSTATE_lg = rtb_Compare_n2_0;
ME11_ARID_DEF.DelayInput1_DSTATE_ag = rtb_Compare_hfs;
ME11_ARID_DEF.DelayInput1_DSTATE_em = rtb_Compare_cjk;
ME11_ARID_DEF.DelayInput1_DSTATE_d5 = rtb_Switch_ijm;
ME11_ARID_DEF.DelayInput1_DSTATE_ai = rtb_Compare_ip;
ME11_ARID_DEF.DelayInput1_DSTATE_ib = rtb_Compare_nbr;
ME11_ARID_DEF.DelayInput1_DSTATE_er = rtb_RelationalOperator_j5;
ME11_ARID_DEF.DelayInput1_DSTATE_ga = rtb_Compare_pw;
ME11_ARID_DEF.DelayInput1_DSTATE_nq = rtb_Switch6_ng;
ME11_ARID_DEF.DelayInput1_DSTATE_ce = rtb_DataTypeConversion_ig5;
ME11_ARID_DEF.DelayInput1_DSTATE_d4 = rtb_DataTypeConversion2_c;
ME11_ARID_DEF.DelayInput1_DSTATE_bl5 = rtb_Compare_jm;
ME11_ARID_DEF.DelayInput1_DSTATE_gz = rtb_Compare_lf;
ME11_ARID_DEF.DelayInput1_DSTATE_ob = rtb_Compare_cds;
ME11_ARID_DEF.DelayInput1_DSTATE_cp = rtb_Compare_ph;
ME11_ARID_DEF.DelayInput1_DSTATE_cv = rtb_Switch_ia;
ME11_ARID_DEF.DelayInput1_DSTATE_ku = rtb_Compare_oz;
ME11_ARID_DEF.DelayInput1_DSTATE_hr = rtb_Compare_ouy;
ME11_ARID_DEF.DelayInput1_DSTATE_h0c = rtb_Compare_m;
...
(rtb_Compare_of3);
Rte_IWrite_Task_100ms_TMM_EXV_initRequest_TMM_EXV_initRequest(rtb_IFreezFlag_k);
...
Rte_IWrite_Task_100ms_C3WV_BPosSetReq_C3WV_BPosSetReq
(rtb_DataTypeConversion_f4);
Rte_IWrite_Task_100ms_C3WV_RefDrvReq_C3WV_RefDrvReq(rtb_DataTypeConversion1_f);
Rte_IWrite_Task_100ms_C3WV_SpdLvlReq_C3WV_SpdLvlReq(0U);
Rte_IWrite_Task_100ms_C5WV_BPosSetReq_C5WV_BPosSetReq(rtb_Switch_fmz);
Rte_IWrite_Task_100ms_C5WV_RefDrvReq_C5WV_RefDrvReq(rtb_Add_a);
...
Rte_IWrite_Task_100ms_AcPMP_SpdSet_AcPMP_SpdSet(rtb_AcPMP_SpdSet);
Rte_IWrite_Task_100ms_BatPMP_SpdSet_BatPMP_SpdSet(rtb_BatPMP_SpdSet);
Rte_IWrite_Task_100ms_MotPMP_SpdSet_MotPMP_SpdSet(rtb_MotPMP_SpdSet);
}
...
ME11_Descending_filter_Init(&ME11_ARID_DEF.ARID_DEF_Descending_filter_jz);
...
ME11_Descending_filter_Init(&ME11_ARID_DEF.ARID_DEF_Descending_filter_bn);
...
rtb_Divide1_n = rtb_CCaller_i[1];
ACNvm_bACAutoSts = (rtb_Divide1_n != 0);
ME11_ARID_DEF.EERead_bACAutoSts = ACNvm_bACAutoSts;
rtb_Divide1_n = rtb_CCaller_i[0];
ACNvm_bACOnOff = (rtb_Divide1_n != 0);
...
rtb_Divide1_n = rtb_CCaller_i[3];
ACNvm_sACEnvTemp = (float32)(uint8)((float64)rtb_Divide1_n / 2.0) - 40.0F;
...
rtb_Divide1_n = rtb_CCaller_i[6];
ACNvm_sPCUInletTemp = (float32)(uint8)((float64)rtb_Divide1_n / 2.0) - 40.0F;
