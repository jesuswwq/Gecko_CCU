...
#ifdef demoboard
#define NCK2910_INTN_PIN		GPIO_A6
#define PIN_NCK2910_RESET		GPIO_A15					 // NCK2910AHN芯片RST

#define NCK2910_INTN_LEVEL()		Dio_ReadChannel(NCK2910_INTN_PIN)

#define PIN_NCK2910_CS				GPIO_A10				     	// NCK2910AHNèŠ¯ç‰‡CS

#define NCK2910_CSN_HIGH()			Dio_WriteChannel(PIN_NCK2910_CS,1)
#define NCK2910_CSN_LOW()			Dio_WriteChannel(PIN_NCK2910_CS,0)

#define NCK2910_RSTN_HIGH() 		Dio_WriteChannel(PIN_NCK2910_RESET,1)
#define NCK2910_RSTN_LOW()			Dio_WriteChannel(PIN_NCK2910_RESET,0)
#else
...
#ifdef demoboard
#define 	PIN_NJJ29C0_RESET		GPIO_A4						// NCK2910AHNоƬRST

#define NJJ29C0_INTERRUPT_PIN		GPIO_D28
	
#define PIN_NJJ29C0_CS				GPIO_A9						// NJJ29C0Ð¾Æ¬CS
	
#define NJJ29C0_RSTN_HIGH() 		Dio_WriteChannel(PIN_NJJ29C0_RESET,1)
#define NJJ29C0_RSTN_LOW()			Dio_WriteChannel(PIN_NJJ29C0_RESET,0)
	
#define NJJ29C0_CSN_HIGH()			Dio_WriteChannel(PIN_NJJ29C0_CS,1)
#define NJJ29C0_CSN_LOW()			Dio_WriteChannel(PIN_NJJ29C0_CS,0)
	
#define NJJ29C0_INTN_LEVEL()		Dio_ReadChannel(NJJ29C0_INTERRUPT_PIN)//sdrv_gpio_read_pin_input_level(NJJ29C0_INTERRUPT_PIN)
#else
