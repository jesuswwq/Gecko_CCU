...
#define PEPS_TX_MAX_COUNT (uint8)3

#define PE_LF_TX_MAX_PERIOD (uint8)(150 / 2)  // PE��Ƶ���ͼ������
...
#define DOORANT_RSSI_Z3_LIMIT 0.005f
#define DOORANT_RSSI_Z2_LIMIT 0.014f
#define DOORANT_RSSI_Z1_LIMIT 0.668f
...
typedef struct
{
    uint8_t INV_LrngData02;
    uint8_t INV_LrngData03;
    uint8_t INV_LrngData04;
    uint8_t INV_LrngData05;
    uint8_t INV_LrngData06;
    uint8_t INV_LrngData07;
    uint8_t INV_LrngSts;
    uint8_t INV_LrngSubID;
} INV_IMMO_Req_EPT;
...
extern uint8_t u8PollingLockStep;
...
// void SetVehicleCalibrationPara(INV_IMMO_Req_EPT *message);
#endif
