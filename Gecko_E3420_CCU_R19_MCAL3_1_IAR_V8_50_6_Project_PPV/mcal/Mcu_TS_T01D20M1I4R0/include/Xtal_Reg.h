...
//--------------------------------------------------------------------------
// Register Name   : FS_24M_RC_CTL
// Register Offset : 0x10
// Description     : RC CONTROL REGISTGER
//--------------------------------------------------------------------------
#define FS_24M_RC_CTL                                 0x10U

#define BM_FS_24M_RC_CTL_FREQ_TUNE          (0x0U)
#define BM_FS_24M_RC_CTL_FREQ_TUNE_MASK     (0xFFU)
