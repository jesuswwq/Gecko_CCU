...
/* Version Info Begin */
#define COMSTACK_TYPES_H_VENDOR_ID    0x8C
#define COMSTACK_TYPES_H_AR_RELEASE_MAJOR_VERSION    4
#define COMSTACK_TYPES_H_AR_RELEASE_MINOR_VERSION    3
#define COMSTACK_TYPES_H_AR_RELEASE_REVISION_VERSION 1
#define COMSTACK_TYPES_H_SW_MAJOR_VERSION    1
#define COMSTACK_TYPES_H_SW_MINOR_VERSION    0
#define COMSTACK_TYPES_H_SW_PATCH_VERSION    0
/* Version Info End */

/* Version Check Begin */
#if !defined(DISABLE_MCAL_ASR_VER_CHECK)
#if ((COMSTACK_TYPES_H_AR_RELEASE_MAJOR_VERSION != STD_TYPES_H_AR_RELEASE_MAJOR_VERSION)\
    || (COMSTACK_TYPES_H_AR_RELEASE_MINOR_VERSION != STD_TYPES_H_AR_RELEASE_MINOR_VERSION)\
    || (COMSTACK_TYPES_H_AR_RELEASE_REVISION_VERSION != STD_TYPES_H_AR_RELEASE_REVISION_VERSION))
#error "Opps, ComStack_Types.h and Std_Types.h AutoSAR version not match!"
#endif
#endif  /* !DISABLE_MCAL_ASR_VER_CHECK */
#if !defined(DISABLE_MCAL_SW_VER_CHECK)
#if ((COMSTACK_TYPES_H_SW_MAJOR_VERSION != STD_TYPES_H_SW_MAJOR_VERSION)\
    || (COMSTACK_TYPES_H_SW_MINOR_VERSION != STD_TYPES_H_SW_MINOR_VERSION)\
    || (COMSTACK_TYPES_H_SW_PATCH_VERSION != STD_TYPES_H_SW_PATCH_VERSION))
#error "Opps, ComStack_Types.h and Std_Types.h Software version not match!"
#endif
#endif  /* !DISABLE_MCAL_SW_VER_CHECK */
#if !defined(DISABLE_MCAL_ASR_VER_CHECK)
#if ((COMSTACK_TYPES_H_AR_RELEASE_MAJOR_VERSION != COMSTACK_CFG_H_AR_RELEASE_MAJOR_VERSION)\
    || (COMSTACK_TYPES_H_AR_RELEASE_MINOR_VERSION != COMSTACK_CFG_H_AR_RELEASE_MINOR_VERSION)\
    || (COMSTACK_TYPES_H_AR_RELEASE_REVISION_VERSION != COMSTACK_CFG_H_AR_RELEASE_REVISION_VERSION))
#error "Opps, ComStack_Types.h and ComStack_Cfg.h AutoSAR version not match!"
#endif
#endif  /* !DISABLE_MCAL_ASR_VER_CHECK */
#if !defined(DISABLE_MCAL_SW_VER_CHECK)
#if ((COMSTACK_TYPES_H_SW_MAJOR_VERSION != COMSTACK_CFG_H_SW_MAJOR_VERSION)\
    || (COMSTACK_TYPES_H_SW_MINOR_VERSION != COMSTACK_CFG_H_SW_MINOR_VERSION)\
    || (COMSTACK_TYPES_H_SW_PATCH_VERSION != COMSTACK_CFG_H_SW_PATCH_VERSION))
#error "Opps, ComStack_Types.h and ComStack_Cfg.h Software version not match!"
#endif
#endif  /* !DISABLE_MCAL_SW_VER_CHECK */
/* Version Check End */
...
typedef struct {
    P2VAR(uint8, AUTOMATIC, AUTOSAR_COMSTACKDATA) SduDataPtr;   /**< pointer to the SDU (i.e.
                                                                *    payload data) of the PDU */
    P2VAR(uint8, AUTOMATIC, AUTOSAR_COMSTACKDATA) MetaDataPtr;  /**< Pointer to the Meta Data (eg CAN ID) of the PDU. */
    PduLengthType  SduLength;                                   /**< length of the SDU in bytes */
} PduInfoType;
#endif /* #if defined(AUTOSAR_VERSION_421) */
/**
