...
/** *****************************************************************************************************
 * \file     Wdg_140_Instance2_Wdt.c                                                                    *
 * \brief    AUTOSAR 4.3.1 MCAL WDG2 Driver                                                             *
 *                                                                                                      *
 * <table>                                                                                              *
...
/**
 *
 * \defgroup MCAL_WDG2_API WDG Driver API
 *
 * The WDG2 Driver MCAL provides low level access to onbaord WDG2 peripheral
 ...
 * The WDG2 Driver implements a standardized interface specified in the
 ...
 * The WDG2 Driver is part of the Communication Stack in the AUTOSAR Basic
 ...
 * The WDG2 Hardware Unit cntrolled by WDG Driver combines one or several WDG controllers,
...
#include "Wdg_140_Instance2_Wdt.h"
#include "Wdg.h"
#ifdef __cplusplus
extern "C" {
#endif
...
#define WDG_140_INSTANCE2_WDT_C_SW_MAJOR_VERSION    1
/** \brief Driver Implementation Minor Version */
#define WDG_140_INSTANCE2_WDT_C_SW_MINOR_VERSION    0
/** \brief Driver Implementation Patch Version */
#define WDG_140_INSTANCE2_WDT_C_SW_PATCH_VERSION    0
/** @} */
/********************************************************************************************************
...
{
    Wdg_140_Init(ConfigPtr, WDT2_INDEX);
}
...
{
    return Wdg_140_SetMode(Mode, WDT2_INDEX);
}
...
{
    Wdg_140_SetTriggerCondition(timeout, WDT2_INDEX);
}
...
{
    Wdg_140_TriggerRoutine(WDT2_INDEX);
}
...
{
    Wdg_140_GetVersionInfo(verInfoPtr, WDT2_INDEX);
}
#endif /* WDG_VERSION_INFO_API */
#define WDG2_STOP_SEC_CODE
#include "Wdg2_MemMap.h"
