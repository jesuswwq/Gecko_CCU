...
#include "SchM_62_Eep.h"

/*******************************************************************************
**                       Version  information                                 **
*******************************************************************************/
#define EEP_62_C_AR_MAJOR_VERSION     4U
#define EEP_62_C_AR_MINOR_VERSION     5U
#define EEP_62_C_AR_PATCH_VERSION     0U
#define EEP_62_C_SW_MAJOR_VERSION     1U
#define EEP_62_C_SW_MINOR_VERSION     0U
#define EEP_62_C_SW_PATCH_VERSION     0U

#define EEP_62_CFG_C_SW_MAJOR_VERSION (1U)
#define EEP_62_CFG_C_SW_MINOR_VERSION (0U)
#define EEP_62_CFG_C_SW_PATCH_VERSION (0U)
...
#include "Det.h"
#endif /* #if (EEP_62_DEV_ERROR_DETECT == STD_ON) */
/*******************************************************************************
**                      Global Data Types                                     **
*******************************************************************************/
#if (                                                                                              \
...
#if (EEP_62_C_AR_MAJOR_VERSION != EEP_62_H_AR_MAJOR_VERSION)
#error "EEP_62.c : Mismatch in Specification Major Version"
#endif
#if (EEP_62_C_AR_MINOR_VERSION != EEP_62_H_AR_MINOR_VERSION)
#error "EEP_62.c : Mismatch in Specification _MINOR Version"
#endif
#if (EEP_62_C_AR_PATCH_VERSION != EEP_62_H_AR_PATCH_VERSION)
#error "EEP_62.c : Mismatch in Specification PATCH Version"
#endif
#if (EEP_62_C_SW_MAJOR_VERSION != EEP_62_H_SW_MAJOR_VERSION)
#error "EEP_62.c : Mismatch in Software Major Version"
#endif
#if (EEP_62_C_SW_MINOR_VERSION != EEP_62_H_SW_MINOR_VERSION)
#error "EEP_62.c : Mismatch in Software MINOR Version"
#endif
#if (EEP_62_C_SW_PATCH_VERSION != EEP_62_H_SW_PATCH_VERSION)
#error "EEP_62.c : Mismatch in Software PATCH Version"
#endif

#if (EEP_62_CFG_C_SW_MAJOR_VERSION != EEP_62_CFG_H_SW_MAJOR_VERSION)
#error "EEP_62.c : Mismatch in Software PATCH Version"
#endif
#if (EEP_62_CFG_C_SW_MAJOR_VERSION != EEP_62_CFG_H_SW_MAJOR_VERSION)
#error "EEP_62.c : Mismatch in Software PATCH Version"
#endif
#if (EEP_62_CFG_C_SW_PATCH_VERSION != EEP_62_CFG_H_SW_PATCH_VERSION)
#error "EEP_62.c : Mismatch in Software PATCH Version"
#endif
...
#endif /* #if (EEP_62_NUMBER_OF_EEP_MODULE > 1u) */
        {
...
/* PRQA S 3432-- */ /* MISRA Rule 20.7 */
{
...
#endif /* (STD_ON == EEP_62_DEV_ERROR_DETECT) */
    {
        ...
        versioninfo->sw_major_version = EEP_62_H_SW_MAJOR_VERSION;
        versioninfo->sw_minor_version = EEP_62_H_SW_MINOR_VERSION;
        versioninfo->sw_patch_version = EEP_62_H_SW_PATCH_VERSION;
    }
}
